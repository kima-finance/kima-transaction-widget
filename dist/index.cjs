...
var getTokenAllowance = async ({
  ...
  try {
    ...
    const erc20Contract = new import_ethers2.Contract(tokenAddress, abi.abi, signer);
    const allowance = await erc20Contract.allowance(userAddress, poolAddress);
    const balance = await erc20Contract.balanceOf(userAddress);
    const decimals = await erc20Contract.decimals();
    console.log("evm get allowance: ", +(0, import_units2.formatUnits)(allowance, decimals));
    console.log("evm get decimals: ", decimals);
    return {
      allowance: Number((0, import_units2.formatUnits)(allowance, decimals)),
      balance: Number((0, import_units2.formatUnits)(balance, decimals)),
...
var useGetPools = (backendUrl, networkOption) => {
  const { data, error, isLoading } = (0, import_react_query.useQuery)({
...
function useEvmAllowance() {
  ...
  const { chainId: evmChainId } = (0, import_react74.useAppKitNetwork)();
  ...
  const amount = (0, import_react_redux3.useSelector)(selectAmount);
  const { totalFeeUsd } = (0, import_react_redux3.useSelector)(selectServiceFee);
  ...
  const amountToShow = (0, import_react73.useMemo)(() => {
  ...
  const approveErc20TokenTransfer = async (isCancel = false) => {
    ...
    if (!allowanceData?.decimals || !tokenAddress || !signer || !poolAddress)
      return;
    try {
      const erc20Contract = new import_ethers3.Contract(tokenAddress, erc20ABI_default2.abi, signer);
      const approveTx = await erc20Contract.approve(
        poolAddress,
        isCancel ? "0" : (0, import_units3.parseUnits)(amountToShow, allowanceData.decimals)
      );
      ...
      console.error("Error on EVM approval:", error2);
      throw new Error("Error on EVM approval");
    }
  };
  return {
    ...allowanceData,
    isApproved: allowanceData?.allowance ? allowanceData.allowance >= Number(amountToShow) : false,
...
var WalletProvider2 = ({
  ...
  return /* @__PURE__ */ import_react76.default.createElement(import_wallet_adapter_react.ConnectionProvider, { endpoint }, /* @__PURE__ */ import_react76.default.createElement(
...
var Ethereum3 = ({ width = 30, height = 30, ...rest }) => {
  return /* @__PURE__ */ import_react85.default.createElement(
    ...
    /* @__PURE__ */ import_react85.default.createElement("path", { d: "M10.9966 13.3093V0L0 18.3307L10.9966 13.3093Z", fill: "#8A92B2" }),
    ...
    /* @__PURE__ */ import_react85.default.createElement("path", { d: "M10.9966 26.9561L0 20.4297L10.9966 36V26.9561Z", fill: "#8A92B2" }),
    /* @__PURE__ */ import_react85.default.createElement("path", { d: "M22 20.4297L10.9966 26.9561V36L22 20.4297Z", fill: "#62688F" })
  );
};
...
var Solana3 = ({ width = 30, height = 30, ...rest }) => {
  return /* @__PURE__ */ import_react86.default.createElement(
    ...
    /* @__PURE__ */ import_react86.default.createElement("defs", null, /* @__PURE__ */ import_react86.default.createElement(
      "linearGradient",
      {
        id: "paint0_linear_721_5435",
        x1: "1.58985",
      ...
      /* @__PURE__ */ import_react86.default.createElement("stop", { "stop-color": "#CF41E8" }),
      /* @__PURE__ */ import_react86.default.createElement("stop", { offset: "1", "stop-color": "#10F2B0" })
    ))
  );
};
...
var USDC3 = ({ width = 37, height = 37, ...rest }) => {
  return /* @__PURE__ */ import_react94.default.createElement(
    ...
    /* @__PURE__ */ import_react94.default.createElement("rect", { width: "37", height: "37", fill: "url(#pattern4)" }),
    /* @__PURE__ */ import_react94.default.createElement("defs", null, /* @__PURE__ */ import_react94.default.createElement(
      ...
      /* @__PURE__ */ import_react94.default.createElement("use", { href: "#image0_214_308", transform: "scale(0.00552486)" })
...
var USDT5 = ({ width = 37, height = 37, ...rest }) => {
  return /* @__PURE__ */ import_react95.default.createElement(
    ...
    /* @__PURE__ */ import_react95.default.createElement("rect", { width: "37", height: "37", fill: "url(#pattern5)" }),
    /* @__PURE__ */ import_react95.default.createElement("defs", null, /* @__PURE__ */ import_react95.default.createElement(
      ...
      /* @__PURE__ */ import_react95.default.createElement("use", { href: "#image0_214_312", transform: "scale(0.00390625)" })
...
var Bank3 = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ import_react101.default.createElement(
    ...
    /* @__PURE__ */ import_react101.default.createElement("defs", null),
...
var KEUR3 = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ import_react103.default.createElement(
    ...
    /* @__PURE__ */ import_react103.default.createElement("g", { fill: "none", fillRule: "evenodd" }, /* @__PURE__ */ import_react103.default.createElement("circle", { cx: "16", cy: "16", fill: "#0f8ff8", r: "16" }), /* @__PURE__ */ import_react103.default.createElement(
      "path",
      {
        d: "M8 19.004L8.81 17h.857a16.279 16.279 0 01-.034-1.03c0-.448.019-.864.056-1.25H8l.81-2.003h1.274C11.27 8.906 13.944 7 18.103 7c1.367 0 2.666.177 3.897.532v2.524a8.92 8.92 0 00-3.683-.776c-2.493 0-4.096 1.146-4.81 3.438h7.423l-.81 2.003h-7.097a6.938 6.938 0 00-.056.995c0 .479.015.907.045 1.285h6.183l-.8 2.003H13.44c.533 1.389 1.183 2.355 1.949 2.9.765.544 1.858.816 3.277.816 1.014 0 2.125-.247 3.334-.741v2.373c-1.149.432-2.515.648-4.1.648-4.167 0-6.803-1.999-7.906-5.996z",
        fill: "#ffffff"
...
function useGetSolBalance() {
  ...
  const sourceNetwork = (0, import_react_redux4.useSelector)(selectSourceChain);
  const result = (0, import_react_query3.useQuery)({
...
var getTokenAllowance2 = async ({
  ...
  try {
    ...
    const mintPublicKey = new import_web35.PublicKey(tokenAddress);
...
function useSolanaAllowance() {
  ...
  const targetChain = (0, import_react_redux5.useSelector)(selectTargetChain);
  ...
  const { totalFeeUsd } = (0, import_react_redux5.useSelector)(selectServiceFee);
  ...
  const { pools } = useGetPools_default(backendUrl, networkOption);
  const [approvalsCount, setApprovalsCount] = (0, import_react109.useState)(0);
  const amountToShow = (0, import_react109.useMemo)(() => {
    return (feeDeduct ? +amount : +amount + totalFeeUsd).toFixed(2);
  }, [amount, totalFeeUsd, sourceChain, targetChain, feeDeduct]);
  const {
    data: allowanceData,
  ...
  const approveSPLTokenTransfer = async (isCancel = false) => {
    ...
    try {
      ...
      const approveInstruction = (0, import_spl_token2.createApproveInstruction)(
        ...
        new import_web36.PublicKey(poolAddress),
        // Delegate to approve
        userPublicKey,
        // Owner of the token account
        isCancel ? 0 : +amountToShow * Math.pow(10, allowanceData?.decimals ?? 6),
        // Amount of tokens to approve (in raw units)
        [],
        // Multi-signers (if any, otherwise leave empty)
        import_spl_token2.TOKEN_PROGRAM_ID
        // SPL Token Program ID
      );
      const transaction = new import_web36.Transaction().add(approveInstruction);
...
var WalletProvider3 = ({ children, networkOption }) => {
  const adapters = (0, import_react112.useMemo)(
    () => [
...
var Ethereum4 = ({ width = 30, height = 30, ...rest }) => {
  return /* @__PURE__ */ import_react121.default.createElement(
    ...
    /* @__PURE__ */ import_react121.default.createElement("path", { d: "M10.9966 13.3093V0L0 18.3307L10.9966 13.3093Z", fill: "#8A92B2" }),
    ...
    /* @__PURE__ */ import_react121.default.createElement("path", { d: "M10.9966 26.9561L0 20.4297L10.9966 36V26.9561Z", fill: "#8A92B2" }),
    /* @__PURE__ */ import_react121.default.createElement("path", { d: "M22 20.4297L10.9966 26.9561V36L22 20.4297Z", fill: "#62688F" })
  );
};
...
var Solana4 = ({ width = 30, height = 30, ...rest }) => {
  return /* @__PURE__ */ import_react122.default.createElement(
    ...
    /* @__PURE__ */ import_react122.default.createElement("defs", null, /* @__PURE__ */ import_react122.default.createElement(
      ...
      /* @__PURE__ */ import_react122.default.createElement("stop", { "stop-color": "#CF41E8" }),
      /* @__PURE__ */ import_react122.default.createElement("stop", { offset: "1", "stop-color": "#10F2B0" })
    ))
  );
};
...
var USDC4 = ({ width = 37, height = 37, ...rest }) => {
  return /* @__PURE__ */ import_react130.default.createElement(
    ...
    /* @__PURE__ */ import_react130.default.createElement("rect", { width: "37", height: "37", fill: "url(#pattern4)" }),
    /* @__PURE__ */ import_react130.default.createElement("defs", null, /* @__PURE__ */ import_react130.default.createElement(
      ...
      /* @__PURE__ */ import_react130.default.createElement("use", { href: "#image0_214_308", transform: "scale(0.00552486)" })
...
var USDT7 = ({ width = 37, height = 37, ...rest }) => {
  return /* @__PURE__ */ import_react131.default.createElement(
    ...
    /* @__PURE__ */ import_react131.default.createElement("rect", { width: "37", height: "37", fill: "url(#pattern5)" }),
    /* @__PURE__ */ import_react131.default.createElement("defs", null, /* @__PURE__ */ import_react131.default.createElement(
      ...
      /* @__PURE__ */ import_react131.default.createElement("use", { href: "#image0_214_312", transform: "scale(0.00390625)" })
...
var Bank4 = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ import_react137.default.createElement(
    ...
    /* @__PURE__ */ import_react137.default.createElement("defs", null),
...
var KEUR4 = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ import_react139.default.createElement(
    ...
    /* @__PURE__ */ import_react139.default.createElement("g", { fill: "none", fillRule: "evenodd" }, /* @__PURE__ */ import_react139.default.createElement("circle", { cx: "16", cy: "16", fill: "#0f8ff8", r: "16" }), /* @__PURE__ */ import_react139.default.createElement(
      "path",
      {
        d: "M8 19.004L8.81 17h.857a16.279 16.279 0 01-.034-1.03c0-.448.019-.864.056-1.25H8l.81-2.003h1.274C11.27 8.906 13.944 7 18.103 7c1.367 0 2.666.177 3.897.532v2.524a8.92 8.92 0 00-3.683-.776c-2.493 0-4.096 1.146-4.81 3.438h7.423l-.81 2.003h-7.097a6.938 6.938 0 00-.056.995c0 .479.015.907.045 1.285h6.183l-.8 2.003H13.44c.533 1.389 1.183 2.355 1.949 2.9.765.544 1.858.816 3.277.816 1.014 0 2.125-.247 3.334-.741v2.373c-1.149.432-2.515.648-4.1.648-4.167 0-6.803-1.999-7.906-5.996z",
        fill: "#ffffff"
...
function useGetTronBalance() {
  ...
  const result = (0, import_react_query5.useQuery)({
...
var getTokenAllowance3 = async ({
  ...
  try {
    ...
    return {
      allowance: Number((0, import_units4.formatUnits)(allowance, decimals)),
      balance: Number((0, import_units4.formatUnits)(balance, decimals)),
      decimals: Number(decimals)
    };
  } catch (error) {
...
function useTronAllowance() {
  ...
  const targetChain = (0, import_react_redux9.useSelector)(selectTargetChain);
  ...
  const amount = (0, import_react_redux9.useSelector)(selectAmount);
  const { totalFeeUsd } = (0, import_react_redux9.useSelector)(selectServiceFee);
  ...
  const [approvalsCount, setApprovalsCount] = (0, import_react146.useState)(0);
  const amountToShow = (0, import_react146.useMemo)(() => {
    return (feeDeduct ? +amount : +amount + totalFeeUsd).toFixed(2);
  }, [amount, totalFeeUsd, sourceChain, targetChain, feeDeduct]);
  ...
  const approveTrc20TokenTransfer = async (isCancel = false) => {
    ...
    try {
      ...
      const parameter = [
        ...
        {
          type: "uint256",
          value: isCancel ? "0" : (0, import_units5.parseUnits)(amountToShow, allowanceData?.decimals || 18).toString()
        }
      ];
...
var InternalKimaProvider = import_react149.default.memo(
  ({ walletConnectProjectId, children }) => {
    ...
    console.log("network option: ", networkOption);
    const WrappedProviders = (0, import_react149.useMemo)(() => {
    ...
    return /* @__PURE__ */ import_react149.default.createElement(import_react149.default.Fragment, null, WrappedProviders);
  }
);
var KimaProvider = ({
  walletConnectProjectId,
  ...
  return /* @__PURE__ */ import_react149.default.createElement(import_react_query7.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ import_react149.default.createElement(import_react_redux12.Provider, { store }, /* @__PURE__ */ import_react149.default.createElement(InternalKimaProvider, { walletConnectProjectId }, children)));
};
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ import_react150.default.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ import_react150.default.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ import_react150.default.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ import_react150.default.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ import_react150.default.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ import_react150.default.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react150.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react150.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react150.default.createElement(Check_default, null) : null, /* @__PURE__ */ import_react150.default.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ import_react151.default.createElement(
  "a",
  {
    className,
    href: to,
...
var NetworkLabel = ({ sourceChain, targetChain }) => {
  ...
  return /* @__PURE__ */ import_react152.default.createElement("div", { className: "header-network-labels" }, SourceInfo?.label && /* @__PURE__ */ import_react152.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react152.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react152.default.createElement(SourceInfo.icon, null)), /* @__PURE__ */ import_react152.default.createElement("p", null, SourceInfo.label)), SourceInfo?.label && TargetInfo?.label && /* @__PURE__ */ import_react152.default.createElement("div", { className: "arrow" }, /* @__PURE__ */ import_react152.default.createElement(Arrow_default, null)), TargetInfo?.label && /* @__PURE__ */ import_react152.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react152.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react152.default.createElement(TargetInfo.icon, null)), /* @__PURE__ */ import_react152.default.createElement("p", null, TargetInfo.label)));
};
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ import_react153.default.createElement(
    ...
    /* @__PURE__ */ import_react153.default.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ import_react153.default.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ import_react155.default.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ import_react155.default.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ import_react155.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react155.default.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
function useNetworkOptions() {
  ...
  const [options, setOptions] = (0, import_react157.useState)(networkOptions);
...
var Network = ({ isOriginChain = true }) => {
  const sourceChangeRef = (0, import_react158.useRef)(false);
  ...
  const originNetwork = (0, import_react_redux17.useSelector)(selectSourceChain);
  ...
  const sliderRef = (0, import_react158.useRef)();
  const [availableNetworks, setAvailableNetworks] = (0, import_react158.useState)(
    []
  );
  const { options: networkOptions3 } = useNetworkOptions();
  const selectedNetwork = (0, import_react158.useMemo)(() => {
  ...
  const networks = (0, import_react158.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react158.default.createElement("div", { className: `network-select` }, /* @__PURE__ */ import_react158.default.createElement("p", null, isOriginChain ? "Which network are you funding from?" : "Which network are you funding to?"), /* @__PURE__ */ import_react158.default.createElement("div", { className: "scroll-button" }, /* @__PURE__ */ import_react158.default.createElement(
    Arrow_default,
    {
  ...
  )), /* @__PURE__ */ import_react158.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react158.default.createElement("div", { className: "network-container" }, networks.map((network) => /* @__PURE__ */ import_react158.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react158.default.createElement(network.icon, null),
    /* @__PURE__ */ import_react158.default.createElement("span", null, network.label)
  )))));
};
...
var import_react161 = require("@reown/appkit/react");
...
function useIsWalletReady4() {
  ...
  const { walletProvider: evmProvider } = (0, import_react161.useAppKitProvider)("eip155");
  const bitcoinAddress = (0, import_react_redux20.useSelector)(selectBitcoinAddress);
  const appkitAccountInfo = (0, import_react161.useAppKitAccount)();
  const { chainId: evmChainId } = (0, import_react161.useAppKitNetwork)();
  ...
  const correctChain = (0, import_react160.useMemo)(() => {
  ...
  const correctEvmNetwork = (0, import_react160.useMemo)(() => {
  ...
  const events = (0, import_react161.useAppKitEvents)();
  ...
  const connectBitcoinWallet = (0, import_react160.useCallback)(async () => {
  ...
  const forceNetworkSwitch = (0, import_react160.useCallback)(async () => {
    if (evmProvider && correctEvmNetwork) {
...
var useGetChainData = () => {
  const [chainData, setChainData] = (0, import_react162.useState)([]);
  const plugins = (0, import_react_redux22.useSelector)(selectAllPlugins);
  const fetchChainData = (0, import_react162.useCallback)(async () => {
    try {
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = (0, import_react163.useState)(evm_default);
  ...
  const plugin = (0, import_react163.useMemo)(() => {
...
var useWidth = () => {
  const [width, setWidth] = (0, import_react164.useState)(0);
...
var import_react167 = require("@reown/appkit/react");

// src/components/reusable/CopyButton.tsx
var import_react165 = __toESM(require("react"), 1);
var CopyButton = ({ text }) => {
  const [copyClicked, setCopyClicked] = (0, import_react165.useState)(false);
  ...
  return /* @__PURE__ */ import_react165.default.createElement(
    ...
    copyClicked ? /* @__PURE__ */ import_react165.default.createElement(Check_default, null) : /* @__PURE__ */ import_react165.default.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  const { open } = (0, import_react167.useAppKit)();
  ...
  const errorMessage = (0, import_react166.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react166.default.createElement(
    ...
    /* @__PURE__ */ import_react166.default.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ import_react166.default.createElement(
      "button",
      {
      ...
      !isReady && /* @__PURE__ */ import_react166.default.createElement(Wallet_default, null),
      !isReady && "Connect Wallet"
    ), isReady && /* @__PURE__ */ import_react166.default.createElement(CopyButton_default, { text: walletAddress })),
    isReady && balance !== void 0 ? /* @__PURE__ */ import_react166.default.createElement("p", { className: "balance-info" }, balance.toFixed(2), " ", selectedCoin, " available") : null
  );
};
...
var NetworkDropdown = import_react170.default.memo(
  ({ isSourceChain = true }) => {
    const [collapsed, setCollapsed] = (0, import_react170.useState)(true);
    const [availableNetworks, setAvailableNetworks] = (0, import_react170.useState)([]);
    const ref = (0, import_react170.useRef)();
    const sourceChangeRef = (0, import_react170.useRef)(false);
    ...
    const { options: networkOptions3 } = useNetworkOptions();
    const selectedNetwork = (0, import_react170.useMemo)(() => {
      const index = networkOptions3.findIndex(
    ...
    const networks = (0, import_react170.useMemo)(() => {
    ...
    return /* @__PURE__ */ import_react170.default.createElement(
      ...
      /* @__PURE__ */ import_react170.default.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ import_react170.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react170.default.createElement(selectedNetwork.icon, null)), /* @__PURE__ */ import_react170.default.createElement("span", null, selectedNetwork.label)),
      /* @__PURE__ */ import_react170.default.createElement(
        ...
        networks.map((network) => /* @__PURE__ */ import_react170.default.createElement(
          "div",
          {
          ...
          /* @__PURE__ */ import_react170.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react170.default.createElement(network.icon, null)),
          /* @__PURE__ */ import_react170.default.createElement("p", null, network.label)
        ))
      ),
...
var ConfirmDetails = ({ isApproved }) => {
  ...
  const originNetworkOption = (0, import_react171.useMemo)(
    () => networkOptions.filter((network) => network.id === originNetwork)[0],
    [networkOptions, originNetwork]
  );
  const targetNetworkOption = (0, import_react171.useMemo)(
    () => networkOptions.filter(
  ...
  const sourceWalletAddress = (0, import_react171.useMemo)(() => {
    return width >= 916 ? walletAddress : getShortenedAddress(walletAddress || "");
  }, [walletAddress]);
  const targetWalletAddress = (0, import_react171.useMemo)(() => {
  ...
  const amountToShow = (0, import_react171.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react171.default.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ import_react171.default.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react171.default.createElement("div", null, /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react171.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react171.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react171.default.createElement(originNetworkOption.icon, null)), "FIAT"), /* @__PURE__ */ import_react171.default.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react171.default.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ import_react171.default.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ import_react171.default.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "Source wallet:"), /* @__PURE__ */ import_react171.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react171.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react171.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react171.default.createElement(originNetworkOption.icon, null)), originNetworkOption.label)), /* @__PURE__ */ import_react171.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : walletAddress : dAppOption === "LPDrain" /* LPDrain */ ? targetWalletAddress : sourceWalletAddress))), /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react171.default.createElement("span", { className: "amount-container" }, /* @__PURE__ */ import_react171.default.createElement("div", { className: "coin-details" }, /* @__PURE__ */ import_react171.default.createElement(SourceCoinIcon, null), /* @__PURE__ */ import_react171.default.createElement("p", null, amountToShow, " ", sourceCurrency)), sourceCurrency !== targetCurrency && /* @__PURE__ */ import_react171.default.createElement("div", { className: "coin-details" }, "\u2192 ", /* @__PURE__ */ import_react171.default.createElement(TargetCoinIcon, null), " ", targetCurrency), /* @__PURE__ */ import_react171.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react171.default.createElement("span", null, feeDeduct ? "Gas fee deduction" : "Gas fees (Source + Dest)"), /* @__PURE__ */ import_react171.default.createElement("span", { className: "service-fee" }, formatterFloat2.format(totalFeeUsd), " ", sourceCurrency)), /* @__PURE__ */ import_react171.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react171.default.createElement("span", null, "Total"), /* @__PURE__ */ import_react171.default.createElement("span", { className: "service-fee" }, formatterFloat2.format(parseFloat(amountToShow) - totalFeeUsd), " ", targetCurrency)))), targetNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react171.default.createElement("div", null, /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react171.default.createElement("p", null, bankDetails.iban), /* @__PURE__ */ import_react171.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react171.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react171.default.createElement(targetNetworkOption.icon, null)), "FIAT")), /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react171.default.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ import_react171.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ import_react171.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react171.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react171.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react171.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react171.default.createElement(targetNetworkOption.icon, null)), targetNetworkOption.label)), /* @__PURE__ */ import_react171.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? walletAddress : targetAddress : dAppOption === "LPDrain" /* LPDrain */ ? sourceWalletAddress : targetWalletAddress))));
};
...
var CustomCheckbox = ({ text, checked, setCheck }) => {
  ...
  return /* @__PURE__ */ import_react173.default.createElement("div", { className: "kima-custom-checkbox" }, /* @__PURE__ */ import_react173.default.createElement(
    "div",
    {
      className: "custom-checkbox-content",
      onClick: () => setCheck(!checked)
    },
    /* @__PURE__ */ import_react173.default.createElement("div", { className: `custom-checkbox-icon-wrapper ${theme.colorMode}` }, checked && /* @__PURE__ */ import_react173.default.createElement(Check_default, null)),
    /* @__PURE__ */ import_react173.default.createElement("span", null, text)
  ));
};
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  return /* @__PURE__ */ import_react174.default.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ import_react174.default.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ import_react174.default.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ import_react174.default.createElement(
    "div",
    {
      className: `info-item
    ...
    step < index && /* @__PURE__ */ import_react174.default.createElement(Lock_default, null),
    step >= index ? index === loadingStep ? /* @__PURE__ */ import_react174.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react174.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react174.default.createElement(Check_default, null) : null,
    /* @__PURE__ */ import_react174.default.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ import_react174.default.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ import_react174.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react174.default.createElement(USDK_default, null)), /* @__PURE__ */ import_react174.default.createElement("p", { className: "chain-name" }, "Kima TX ID:"), /* @__PURE__ */ import_react174.default.createElement("p", null, /* @__PURE__ */ import_react174.default.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ import_react174.default.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash ? /* @__PURE__ */ import_react174.default.createElement("div", { className: `info-item ${theme.colorMode} source-chain` }, /* @__PURE__ */ import_react174.default.createElement("div", { className: "icon" }, SourceInfo ? /* @__PURE__ */ import_react174.default.createElement(SourceInfo.icon, null) : /* @__PURE__ */ import_react174.default.createElement(Ethereum_default, null)), /* @__PURE__ */ import_react174.default.createElement("p", { className: "chain-name" }, CHAIN_NAMES_TO_STRING[data?.sourceChain || "ETH" /* ETHEREUM */], " ", "TX ID:"), /* @__PURE__ */ import_react174.default.createElement("p", null, /* @__PURE__ */ import_react174.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react174.default.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ import_react174.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react174.default.createElement("div", { className: "icon" }, TargetInfo ? /* @__PURE__ */ import_react174.default.createElement(TargetInfo.icon, null) : /* @__PURE__ */ import_react174.default.createElement(Ethereum_default, null)), /* @__PURE__ */ import_react174.default.createElement("p", { className: "chain-name" }, CHAIN_NAMES_TO_STRING[data?.targetChain || "ETH" /* ETHEREUM */], " ", "TX ID:"), /* @__PURE__ */ import_react174.default.createElement("p", null, /* @__PURE__ */ import_react174.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react174.default.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ import_react175.default.createElement("div", { className: "bank-input" }, /* @__PURE__ */ import_react175.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react175.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react175.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react175.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react175.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react175.default.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TransactionWidget = ({ theme }) => {
  const [step, setStep] = (0, import_react177.useState)(0);
  const [focus, setFocus] = (0, import_react177.useState)(-1);
  const [errorStep, setErrorStep] = (0, import_react177.useState)(-1);
  const [errorMessage, setErrorMessage] = (0, import_react177.useState)("");
  const [loadingStep, setLoadingStep] = (0, import_react177.useState)(-1);
  const [minimized, setMinimized] = (0, import_react177.useState)(false);
  const [percent, setPercent] = (0, import_react177.useState)(0);
  ...
  (0, import_react177.useEffect)(() => {
    ...
    const updateTxData = async () => {
      ...
      try {
        ...
        import_react_hot_toast9.toast.error("rpc disconnected", { icon: /* @__PURE__ */ import_react177.default.createElement(Error_default, null) });
        console.log("rpc disconnected", e);
      }
    };
    const timerId = setInterval(() => {
  ...
  (0, import_react177.useEffect)(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      import_react_hot_toast9.toast.error("Unavailable", { icon: /* @__PURE__ */ import_react177.default.createElement(Error_default, null) });
      ...
      import_react_hot_toast9.toast.error("Failed to release tokens to target!", {
        icon: /* @__PURE__ */ import_react177.default.createElement(Error_default, null)
      });
      ...
      setLoadingStep(-1);
      console.log(data.failReason);
      import_react_hot_toast9.toast.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ import_react177.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react177.default.createElement(import_react_redux39.Provider, { store }, /* @__PURE__ */ import_react177.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react177.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react177.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react177.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react177.default.createElement("h3", null, "Transferring ", formatterFloat2.format(data?.amount || 0), " ", `${data?.sourceSymbol || "USDK"} \u2192 ${data?.targetSymbol || "USDK"}`, "\xA0\xA0", `(${percent}%)`)), !minimized ? /* @__PURE__ */ import_react177.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react177.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react177.default.createElement(Minimize_default, null)
    ), loadingStep < 0 ? /* @__PURE__ */ import_react177.default.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ import_react177.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react177.default.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View"))), !minimized && data?.sourceChain && data?.targetChain && /* @__PURE__ */ import_react177.default.createElement(
    ...
    /* @__PURE__ */ import_react177.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react177.default.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    /* @__PURE__ */ import_react177.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react177.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react177.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react177.default.createElement(FooterLogo_default, { fill: "black" }), /* @__PURE__ */ import_react177.default.createElement("strong", null, "Network")))
  ));
};
...
var SourceNetworkSelectorComponent = () => {
  ...
  return /* @__PURE__ */ import_react178.default.createElement(
    ...
    /* @__PURE__ */ import_react178.default.createElement(
      ...
      networks.filter((network) => network.id !== selectedNetwork.id).map((filteredNetwork) => /* @__PURE__ */ import_react178.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react178.default.createElement("div", { className: "icon" }, filteredNetwork.icon),
        /* @__PURE__ */ import_react178.default.createElement("p", null, filteredNetwork.label)
      ))
    ),
...
var SourceNetworkSelector = import_react178.default.memo(SourceNetworkSelectorComponent);
...
var SourceTokenSelector = import_react179.default.memo(SourceTokenSelectorComponent);
...
var TargetNetworkSelectorComponent = () => {
  ...
  const { chainData } = useGetChainData_default();
  const networks = (0, import_react180.useMemo)(() => {
    const data = chainData.map((network) => ({
      id: network.symbol,
      label: network.name,
      icon: network.icon ? /* @__PURE__ */ import_react180.default.createElement(network.icon, null) : /* @__PURE__ */ import_react180.default.createElement("div", null)
      // Render the icon as JSX
    })) || [];
  ...
  const selectedNetwork = (0, import_react180.useMemo)(() => {
  ...
  const availableTargetNetworks = (0, import_react180.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react180.default.createElement(
    ...
    /* @__PURE__ */ import_react180.default.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ import_react180.default.createElement("div", { className: "icon" }, selectedNetwork.icon), /* @__PURE__ */ import_react180.default.createElement("span", null, selectedNetwork.label)),
    /* @__PURE__ */ import_react180.default.createElement(
      "div",
      {
        className: `network-menu custom-scrollbar ${theme?.colorMode ?? ""} ${collapsed ? "collapsed" : "toggled"}`
      },
      availableTargetNetworks.map((network) => /* @__PURE__ */ import_react180.default.createElement(
        "div",
        {
          key: network.id,
          className: `network-menu-item ${theme?.colorMode ?? ""}`,
        ...
        /* @__PURE__ */ import_react180.default.createElement("div", { className: "icon" }, network.icon),
        /* @__PURE__ */ import_react180.default.createElement("p", null, network.label)
      ))
    ),
...
var TargetNetworkSelector = import_react180.default.memo(TargetNetworkSelectorComponent);
...
var TargetTokenSelectorComponent = () => {
  ...
  const { chainData } = useGetChainData_default();
  const tokens = (0, import_react181.useMemo)(() => {
    const network = chainData.find(
    ...
    if (network && network.tokens) {
      return network.tokens.map((token) => ({
        id: token.symbol,
        label: token.symbol,
        icon: token.icon ? /* @__PURE__ */ import_react181.default.createElement(token.icon, null) : /* @__PURE__ */ import_react181.default.createElement("div", null)
        // Render the icon as JSX
      }));
    }
    return [];
  }, [chainData, targetNetwork]);
  const selectedToken = (0, import_react181.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react181.default.createElement(
    ...
    /* @__PURE__ */ import_react181.default.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ import_react181.default.createElement("div", { className: "icon" }, selectedToken.icon), /* @__PURE__ */ import_react181.default.createElement("span", null, selectedToken.label)),
    /* @__PURE__ */ import_react181.default.createElement(
      "div",
      {
        className: `coin-menu custom-scrollbar ${theme?.colorMode ?? ""} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokens.map((token) => /* @__PURE__ */ import_react181.default.createElement(
        "div",
        {
          key: token.id,
          className: `coin-item ${theme?.colorMode ?? ""}`,
        ...
        /* @__PURE__ */ import_react181.default.createElement("div", { className: "icon" }, token.icon),
        /* @__PURE__ */ import_react181.default.createElement("p", null, token.label)
      ))
    ),
...
var TargetTokenSelector = import_react181.default.memo(TargetTokenSelectorComponent);
...
var SingleForm = ({}) => {
  ...
  const [amountValue, setAmountValue] = (0, import_react182.useState)("");
  ...
  const errorMessage = (0, import_react182.useMemo)(
  ...
  return /* @__PURE__ */ import_react182.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react182.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react182.default.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ import_react182.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react182.default.createElement(SourceNetworkSelector_default, null), networkOpion === "mainnet" /* mainnet */ ? /* @__PURE__ */ import_react182.default.createElement(SourceTokenSelector_default, null) : /* @__PURE__ */ import_react182.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement("div", { className: `coin-wrapper ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ import_react182.default.createElement(TargetIcon, null)), targetCurrency)))), /* @__PURE__ */ import_react182.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react182.default.createElement(
      ...
      /* @__PURE__ */ import_react182.default.createElement("span", { className: "label" }, "Connect wallet:"),
      /* @__PURE__ */ import_react182.default.createElement(WalletButton_default, null)
    ),
    mode === "bridge" /* bridge */ && /* @__PURE__ */ import_react182.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react182.default.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ import_react182.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react182.default.createElement(TargetNetworkSelector_default, null), networkOpion === "mainnet" /* mainnet */ ? /* @__PURE__ */ import_react182.default.createElement(TargetTokenSelector_default, null) : /* @__PURE__ */ import_react182.default.createElement(
      "div",
      {
        className: `amount-label-container items ${theme.colorMode}`
      },
      /* @__PURE__ */ import_react182.default.createElement("div", { className: `coin-wrapper ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ import_react182.default.createElement(TargetIcon, null)), targetCurrency)
    )))
  ), mode === "bridge" /* bridge */ && sourceNetwork !== "FIAT" /* FIAT */ ? targetNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react182.default.createElement(BankInput_default, null) : /* @__PURE__ */ import_react182.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ import_react182.default.createElement(
    AddressInput_default,
    {
      theme: theme.colorMode,
      placeholder: "Target address"
    }
  )) : null, mode === "bridge" /* bridge */ ? /* @__PURE__ */ import_react182.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react182.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement(
    "input",
    {
  ...
  ))) : /* @__PURE__ */ import_react182.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react182.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "number",
  ...
  ), /* @__PURE__ */ import_react182.default.createElement("div", { className: `coin-wrapper ${theme.colorMode}` }, /* @__PURE__ */ import_react182.default.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ import_react182.default.createElement(TargetIcon, null)), targetCurrency))), mode === "bridge" /* bridge */ && totalFeeUsd > 0 ? /* @__PURE__ */ import_react182.default.createElement(
...
var CoinSelect = () => {
  ...
  return /* @__PURE__ */ import_react183.default.createElement("div", { className: `coin-select` }, /* @__PURE__ */ import_react183.default.createElement("p", null, "Select Amount of Token for Funding"), /* @__PURE__ */ import_react183.default.createElement("div", { className: `amount-input ${theme.colorMode}` }, /* @__PURE__ */ import_react183.default.createElement("span", null, "Amount:"), /* @__PURE__ */ import_react183.default.createElement("div", { className: "input-wrapper" }, /* @__PURE__ */ import_react183.default.createElement(
    "input",
    {
      type: "number",
      value: amountValue || "",
  ...
  ), /* @__PURE__ */ import_react183.default.createElement("div", { className: "coin-label" }, /* @__PURE__ */ import_react183.default.createElement(Icon, null), /* @__PURE__ */ import_react183.default.createElement("span", null, selectedCoin)))));
};
...
function createAssociatedTokenAccountInstruction(payer, associatedToken, owner, mint, programId = import_spl_token3.TOKEN_PROGRAM_ID, associatedTokenProgramId = import_spl_token3.ASSOCIATED_TOKEN_PROGRAM_ID) {
  const keys = [
    ...
    { pubkey: import_web37.SYSVAR_RENT_PUBKEY, isSigner: false, isWritable: false }
  ];
...
async function getAccountInfo(connection, address, commitment, programId = import_spl_token4.TOKEN_PROGRAM_ID) {
  ...
  if (info.data.length != import_spl_token4.AccountLayout.span) throw new Error("TokenInvalidAccountSizeError");
  const rawAccount = import_spl_token4.AccountLayout.decode(Buffer.from(info.data));
  return {
    address,
...
async function getAssociatedTokenAddress3(mint, owner, allowOwnerOffCurve = false, programId = import_spl_token5.TOKEN_PROGRAM_ID, associatedTokenProgramId = import_spl_token5.ASSOCIATED_TOKEN_PROGRAM_ID) {
  if (!allowOwnerOffCurve && !import_web38.PublicKey.isOnCurve(owner.toBuffer())) throw new Error("TokenOwnerOffCurveError");
...
// src/utils/solana/getOrCreateAssociatedTokenAccount.ts
async function getOrCreateAssociatedTokenAccount(connection, payer, mint, owner, signTransaction, allowOwnerOffCurve = false, commitment, programId = import_spl_token6.TOKEN_PROGRAM_ID, associatedTokenProgramId = import_spl_token6.ASSOCIATED_TOKEN_PROGRAM_ID) {
  const associatedToken = await getAssociatedTokenAddress3(
    mint,
    owner,
    allowOwnerOffCurve,
    programId,
  ...
  try {
    ...
    if (err.message === "TokenAccountNotFoundError" || err.message === "TokenInvalidAccountOwnerError") {
      try {
        const transaction = new import_web39.Transaction().add(
...
function createApproveTransferInstruction(source, destination, owner, amount, multiSigners = [], programId = import_spl_token7.TOKEN_PROGRAM_ID) {
...
var tronWebTestnet2 = new import_tronweb4.TronWeb({
  fullHost: "https://api.nileex.io"
});
var tronWebMainnet2 = new import_tronweb4.TronWeb({
  fullHost: "https://api.trongrid.io"
});
...
function SHA256(msgBytes) {
  ...
  const hashHex = import_ethers4.utils.sha256("0x" + msgHex).replace(/^0x/, "");
...
var import_react185 = require("@reown/appkit/react");
function useAllowance({
  setApproving,
  setCancellingApprove
}) {
  const [allowance, setAllowance] = (0, import_react184.useState)(0);
  const [decimals, setDecimals] = (0, import_react184.useState)(null);
  const appkitAccountInfo = (0, import_react185.useAppKitAccount)();
  const { chainId: evmChainId } = (0, import_react185.useAppKitNetwork)();
  const { address: signerAddress } = appkitAccountInfo || {
    address: null,
    chainId: null,
    isConnected: null
  };
  const { walletProvider } = (0, import_react185.useAppKitProvider)("eip155");
  ...
  const sourceChain = (0, import_react184.useMemo)(() => {
  ...
  const tokenAddress = (0, import_react184.useMemo)(() => {
  ...
  const [targetAddress, setTargetAddress2] = (0, import_react184.useState)();
  const [poolAddress, setPoolAddress] = (0, import_react184.useState)("");
  const amountToShow = (0, import_react184.useMemo)(() => {
    if (sourceChain === "BTC" /* BTC */ || targetChain === "BTC" /* BTC */) {
      return (feeDeduct ? +amount : +amount + totalFeeUsd).toFixed(8);
    }
    return (feeDeduct ? +amount : +amount + totalFeeUsd).toFixed(2);
  }, [amount, totalFeeUsd, sourceChain, targetChain, feeDeduct]);
  const isApproved = (0, import_react184.useMemo)(() => {
      ...
      try {
        ...
        if (!isEVMChain(sourceChain)) {
          if (solanaAddress && tokenAddress && connection) {
            const mint = new import_web311.PublicKey(tokenAddress);
            ...
            setAllowance(+(0, import_units6.formatUnits)(userAllowance2, decimals3));
          } else {
            setAllowance(0);
          }
          return;
        }
        const provider = new import_ethers5.ethers.providers.Web3Provider(
          walletProvider
        );
        const signer = provider?.getSigner();
        ...
        setAllowance(+(0, import_units6.formatUnits)(userAllowance, decimals2));
      } catch (error) {
        errorHandler(error);
      }
    })();
  ...
  const approve = (0, import_react184.useCallback)(
    async (isCancel = false) => {
      if (isEVMChain(sourceChain)) {
        ...
        try {
          ...
          const approve2 = await erc20Contract.approve(
            targetAddress,
            (0, import_units6.parseUnits)(isCancel ? "0" : amountToShow, decimals),
      ...
      if (sourceChain === "TRX" /* TRON */) {
        ...
        try {
          ...
          const parameter = [
            ...
            {
              type: "uint256",
              value: (0, import_units6.parseUnits)(
      ...
      try {
        isCancel ? setCancellingApprove(true) : setApproving(true);
        const mint = new import_web311.PublicKey(tokenAddress);
        const toPublicKey = new import_web311.PublicKey(targetAddress);
        const fromTokenAccount = await getOrCreateAssociatedTokenAccount(
          connection,
          solanaAddress,
          mint,
        ...
        const transaction = new import_web311.Transaction().add(
          createApproveTransferInstruction(
            ...
            [],
            import_spl_token8.TOKEN_PROGRAM_ID
          )
        );
...
var AddressInputWizard = () => {
  ...
  return /* @__PURE__ */ import_react186.default.createElement("div", { className: `coin-select` }, /* @__PURE__ */ import_react186.default.createElement("p", null, "Select Target Address for Funding"), /* @__PURE__ */ import_react186.default.createElement("div", { className: `address-input ${theme.colorMode}` }, /* @__PURE__ */ import_react186.default.createElement("span", null, "Target Address:"), /* @__PURE__ */ import_react186.default.createElement(AddressInput_default, { theme: theme.colorMode, placeholder: "Target address" })));
};
...
var SolanaWalletSelect = () => {
  ...
  const sliderRef = (0, import_react187.useRef)();
  const { wallets, select } = (0, import_wallet_adapter_react8.useWallet)();
  const [detected, undetected] = (0, import_react187.useMemo)(() => {
    const detected2 = [];
    const undetected2 = [];
  ...
  return /* @__PURE__ */ import_react187.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react187.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react187.default.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ import_react187.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react187.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react187.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react187.default.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ import_react187.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react187.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react187.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react187.default.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react189.default.createElement("div", null, /* @__PURE__ */ import_react189.default.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ import_react189.default.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ import_react189.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react189.default.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
var AccountDetailsModal2 = () => {
  ...
  const networkDetails = (0, import_react190.useMemo)(
    () => networkOptions.find(({ id }) => id === selectedNetwork),
    [selectedNetwork]
  );
  const explorerUrl = (0, import_react190.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react190.default.createElement(
    ...
    )))), /* @__PURE__ */ import_react190.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react190.default.createElement("div", { className: "summary" }, networkDetails && /* @__PURE__ */ import_react190.default.createElement(networkDetails.icon, { width: 60, height: 60 }), /* @__PURE__ */ import_react190.default.createElement("div", { className: "address" }, /* @__PURE__ */ import_react190.default.createElement("h2", null, getShortenedAddress(walletAddress || "")), /* @__PURE__ */ import_react190.default.createElement(CopyButton_default, { text: walletAddress })), /* @__PURE__ */ import_react190.default.createElement("h3", null, tronBalance, " ", selectedNetwork)), /* @__PURE__ */ import_react190.default.createElement(SecondaryButton_default, { className: "block-explorer" }, /* @__PURE__ */ import_react190.default.createElement(ExternalLink_default, { className: "link", to: explorerUrl }, /* @__PURE__ */ import_react190.default.createElement(Explorer_default, { fill: "#778DA3" }), /* @__PURE__ */ import_react190.default.createElement("p", null, "Block explorer"), /* @__PURE__ */ import_react190.default.createElement(ExternalUrl_default, { fill: "#778DA3" }))), /* @__PURE__ */ import_react190.default.createElement(PrimaryButton_default, { clickHandler: handleDisconnect }, "Disconnect")))
  );
};
...
var TronWalletSelect = () => {
  ...
  const sliderRef = (0, import_react191.useRef)();
  ...
  const [detected, undetected] = (0, import_react191.useMemo)(() => {
    const detected2 = [];
    const undetected2 = [];
    for (const wallet of wallets) {
  ...
  return /* @__PURE__ */ import_react191.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react191.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react191.default.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ import_react191.default.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
      onClick: () => connectWallet(wallet.adapter.name),
    ...
    /* @__PURE__ */ import_react191.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react191.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react191.default.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ import_react191.default.createElement(
    ExternalLink_default,
    {
      to: wallet.adapter.url,
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ import_react191.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react191.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react191.default.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react192.default.createElement("div", null, /* @__PURE__ */ import_react192.default.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ import_react192.default.createElement(
    "div",
    {
      className: `kima-modal wallet-connect ${theme.colorMode} ${connectModal ? "open" : ""}`
    },
    /* @__PURE__ */ import_react192.default.createElement("div", { className: "modal-overlay" }),
    /* @__PURE__ */ import_react192.default.createElement("div", { className: `modal-content-container ${theme.colorMode}` }, /* @__PURE__ */ import_react192.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react192.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react192.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react192.default.createElement("h3", null, "Connect Wallet")), /* @__PURE__ */ import_react192.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react192.default.createElement(
      "button",
      {
    ...
    )))), /* @__PURE__ */ import_react192.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react192.default.createElement(TronWalletSelect_default, null)))
  ));
};
...
var TransferWidget = ({
  ...
  const mainRef = (0, import_react193.useRef)(null);
  const [isWizard, setWizard] = (0, import_react193.useState)(false);
  const [formStep, setFormStep] = (0, import_react193.useState)(0);
  const [wizardStep, setWizardStep] = (0, import_react193.useState)(0);
  ...
  const [isCancellingApprove, setCancellingApprove] = (0, import_react193.useState)(false);
  const [isApproving, setApproving] = (0, import_react193.useState)(false);
  const [isSubmitting, setSubmitting] = (0, import_react193.useState)(false);
  const [isSigning, setSigning] = (0, import_react193.useState)(false);
  const [isConfirming, setConfirming] = (0, import_react193.useState)(false);
  const pendingTxs = (0, import_react_redux57.useSelector)(selectPendingTxs);
  const { allowance, isApproved, approve } = useAllowance({
    setApproving,
    setCancellingApprove
  });
  const balance = useBalance2()?.balance ?? 0;
  ...
  (0, import_react193.useEffect)(() => {
    if (sourceComplianceError || targetComplianceError)
      import_react_hot_toast12.toast.error("Compliance check failed", {
        icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null)
      });
  }, [sourceComplianceError, targetComplianceError]);
  const handleSubmit = async () => {
    if (totalFeeUsd < 0) {
      import_react_hot_toast12.toast.error("Fee is not calculated!", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
      errorHandler("Fee is not calculated!");
      return;
    }
    if (dAppOption !== "LPDrain" /* LPDrain */ && balance < (feeDeduct ? +amount : +amount + totalFeeUsd)) {
      import_react_hot_toast12.toast.error("Insufficient balance!", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
    ...
    try {
      ...
      if (result?.code !== 0) {
        errorHandler(result);
        import_react_hot_toast12.toast.error("Failed to submit transaction!", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
        setSubmitting(false);
        return;
      }
      let txId = -1;
      ...
      import_react_hot_toast12.toast.error("rpc disconnected", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
      import_react_hot_toast12.toast.error("Failed to submit transaction", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
    }
  };
  const onNext = () => {
    if (isWizard && wizardStep < 5) {
      if (wizardStep === 1 && !sourceAddress) {
        import_react_hot_toast12.toast.error("Wallet is not connected!", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
    ...
    if (!isWizard && !formStep) {
      if (sourceAddress) {
        if (mode === "payment" /* payment */ && !transactionOption) {
          import_react_hot_toast12.toast.error("Invalid payment details!", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
          errorHandler("Invalid payment details!");
          return;
        }
        if (mode === "bridge" /* bridge */ && +amount <= 0) {
          import_react_hot_toast12.toast.error("Invalid amount!", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
        ...
        if (!targetAddress) {
          import_react_hot_toast12.toast.error("Invalid target address!", { icon: /* @__PURE__ */ import_react193.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react193.default.createElement(
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ import_react193.default.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ import_react193.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react193.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react193.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react193.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react193.default.createElement("h3", null, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ import_react193.default.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ import_react193.default.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ import_react193.default.createElement(
      ExternalLink_default,
      {
        to: helpURL ? helpURL : "https://docs.kima.network/kima-network/try-kima-with-the-demo-app"
      },
      /* @__PURE__ */ import_react193.default.createElement("div", { className: "menu-button" }, "I need help")
    ), formStep === 1 && /* @__PURE__ */ import_react193.default.createElement(
      "button",
      {
      ...
      "Reset"
    ))), /* @__PURE__ */ import_react193.default.createElement("h4", { className: "subtitle" }, mode === "payment" /* payment */ && paymentTitleOption?.title)), /* @__PURE__ */ import_react193.default.createElement("div", { className: "kima-card-content", ref: mainRef }, isWizard ? wizardStep === 0 ? /* @__PURE__ */ import_react193.default.createElement(NetworkSelect_default, null) : wizardStep === 1 ? /* @__PURE__ */ import_react193.default.createElement("div", { className: "connect-wallet-step" }, /* @__PURE__ */ import_react193.default.createElement("p", null, "Connect your wallet"), /* @__PURE__ */ import_react193.default.createElement(WalletButton_default, { errorBelow: true })) : wizardStep === 2 ? /* @__PURE__ */ import_react193.default.createElement(NetworkSelect_default, { isOriginChain: false }) : wizardStep === 3 ? /* @__PURE__ */ import_react193.default.createElement(AddressInputWizard_default, null) : wizardStep === 4 ? /* @__PURE__ */ import_react193.default.createElement(CoinSelect_default, null) : /* @__PURE__ */ import_react193.default.createElement(ConfirmDetails_default, { isApproved }) : formStep === 0 ? /* @__PURE__ */ import_react193.default.createElement(SingleForm_default, null) : /* @__PURE__ */ import_react193.default.createElement(ConfirmDetails_default, { isApproved })), /* @__PURE__ */ import_react193.default.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ import_react193.default.createElement(
        ...
        formStep !== 0 && /* @__PURE__ */ import_react193.default.createElement(
        ...
        allowance > 0 && (isWizard && wizardStep === 5 || !isWizard && formStep === 1) ? /* @__PURE__ */ import_react193.default.createElement(
    ...
    ), /* @__PURE__ */ import_react193.default.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ import_react193.default.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ import_react193.default.createElement(
    ...
    ), /* @__PURE__ */ import_react193.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react193.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react193.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react193.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react193.default.createElement("strong", null, "Network"))))
  );
};

// src/components/KimaTransactionWidget.tsx
var import_react195 = require("@reown/appkit/react");
var KimaTransactionWidget = ({
  ...
  const { setThemeMode, setThemeVariables } = (0, import_react195.useAppKitTheme)();
  ...
  return submitted ? /* @__PURE__ */ import_react194.default.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ import_react194.default.createElement(
    TransferWidget,
    {
      theme,
      feeURL,
