...
var useEvmProvider = () => {
  ...
  const { walletProvider: appkitProvider } = (0, import_react73.useAppKitProvider)("eip155");
...
function useBalance() {
  ...
  const { data: allowanceData } = (0, import_react_query3.useQuery)({
    ...
    enabled: !!walletAddress && !!tokenOptions && !!selectedCoin && pools.length > 0 && isEVMChain(sourceChain.shortName) && !!walletProvider
  });
...
function useIsWalletReady() {
  ...
  const { chainId: walletChainId } = (0, import_react76.useAppKitNetwork)();
  ...
  const [isReady, setIsReady] = (0, import_react75.useState)(false);
  const [statusMessage, setStatusMessage] = (0, import_react75.useState)("Wallet not connected");
  const switchNetwork = (0, import_react75.useCallback)(async () => {
...
function useBalance2() {
  ...
  const { data: allowanceData } = (0, import_react_query8.useQuery)({
    ...
    enabled: !!connection && !!userPublicKey && !!selectedCoin && !!tokenOptions && pools.length > 0 && sourceChain.shortName === "SOL",
...
function useIsWalletReady2() {
  ...
  (0, import_react80.useEffect)(() => {
    solanaAddress && sourceChain.shortName === "SOL" && dispatch(setSourceAddress(solanaAddress.toBase58()));
...
var WalletProvider3 = ({ children, networkOption }) => {
  const adapters = (0, import_react82.useMemo)(
    () => [
...
function useTronAllowance() {
  ...
  const allowanceNumber = BigInt(txValues.allowanceAmount.value);
  const { pools } = useGetPools_default(backendUrl, networkOption);
  const { tronWeb, userAddress, signTronTransaction, signMessage } = useTronProvider();
...
var KimaContext = (0, import_react87.createContext)(void 0);
var useKimaContext = () => {
  const context = (0, import_react87.useContext)(KimaContext);
  if (!context) {
...
var InternalKimaProvider = React77.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children }) => {
    ...
    const plugins = (0, import_react_redux18.useSelector)(selectAllPlugins, (prev, next) => prev === next);
    console.info("Registered Plugins:", plugins);
    const WrappedProviders = (0, import_react87.useMemo)(() => {
...
var KimaProvider = ({
  ...
  return /* @__PURE__ */ React77.createElement(import_react_query13.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React77.createElement(import_react_redux18.Provider, { store }, /* @__PURE__ */ React77.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React77.createElement(
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ import_react88.default.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ import_react88.default.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ import_react88.default.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ import_react88.default.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ import_react88.default.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ import_react88.default.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react88.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react88.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react88.default.createElement(Check_default, null) : null, /* @__PURE__ */ import_react88.default.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ import_react89.default.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ import_react91.default.createElement(
    ...
    /* @__PURE__ */ import_react91.default.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ import_react91.default.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ import_react93.default.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ import_react93.default.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ import_react93.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react93.default.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ import_react94.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react94.default.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ import_react96.default.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = (0, import_react97.useState)(default_default);
  const isIndexed = (0, import_react_redux23.useSelector)(selectPluginIsIndexed);
  const sourceChain = (0, import_react_redux23.useSelector)(selectSourceChain);
...
var useWidth = () => {
  const [width, setWidth] = (0, import_react98.useState)(0);
...
var CopyButton = ({ text }) => {
  const [copyClicked, setCopyClicked] = (0, import_react99.useState)(false);
  ...
  return /* @__PURE__ */ import_react99.default.createElement(
    ...
    copyClicked ? /* @__PURE__ */ import_react99.default.createElement(Check_default, null) : /* @__PURE__ */ import_react99.default.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  const { open: isModalOpen } = (0, import_react102.useAppKitState)();
  ...
  return /* @__PURE__ */ import_react101.default.createElement(
    ...
    isReady && balance !== void 0 && decimals !== void 0 ? /* @__PURE__ */ import_react101.default.createElement("p", { className: "balance-info" }, formatUSD(bigIntToNumber({ value: balance, decimals })), " ", selectedCoin, " available") : null
  );
};
...
function useCurrencyOptions(isSourceChain) {
  ...
  const targetChain = (0, import_react_redux25.useSelector)(selectTargetChain);
  ...
  const networks = (0, import_react_redux25.useSelector)(selectNetworks);
  const output = (0, import_react103.useMemo)(() => {
...
function TokenIcon({
  ...
  return /* @__PURE__ */ import_react104.default.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ import_react104.default.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  return /* @__PURE__ */ import_react105.default.createElement(
    ...
    /* @__PURE__ */ import_react105.default.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ import_react105.default.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ import_react105.default.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ import_react105.default.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ import_react105.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react105.default.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ import_react105.default.createElement("p", null, token.symbol)
      ))
    ),
...
function ChainIcon({
  ...
  return /* @__PURE__ */ import_react106.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react106.default.createElement(Icon, null));
}
...
var FeeDeductionRadioButtons = ({ disabled }) => {
  ...
  const feeDeduct = (0, import_react_redux29.useSelector)(selectFeeDeduct);
  const amount = (0, import_react_redux29.useSelector)(selectAmount);
  const sourceNetwork = (0, import_react_redux29.useSelector)(selectSourceChain);
  const targetNetwork = (0, import_react_redux29.useSelector)(selectTargetChain);
  const { totalFee: feeTotalBigInt } = (0, import_react_redux29.useSelector)(selectServiceFee);
  ...
  return /* @__PURE__ */ import_react107.default.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ import_react107.default.createElement("div", { className: "fee-options" }, /* @__PURE__ */ import_react107.default.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ import_react107.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  ), /* @__PURE__ */ import_react107.default.createElement("span", { className: `radio-label ${theme.colorMode}` }, `Pay $${formatterFloat.format(
    Number(amount)
  )} ${sourceCurrency} in ${sourceNetwork.name} to receive $${formatterFloat.format(
    Number(amount) - totalFee
  )} ${targetCurrency} in ${targetNetwork.name}`)), /* @__PURE__ */ import_react107.default.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ import_react107.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({
  ...
  const { transactionValues, sourceFee, targetFee, kimaFee, totalFee } = (0, import_react_redux30.useSelector)(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  ...
  const networkOptions3 = (0, import_react_redux30.useSelector)(selectNetworks);
  ...
  return /* @__PURE__ */ import_react108.default.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ import_react108.default.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react108.default.createElement("div", null, /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react108.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react108.default.createElement(ChainIcon, { symbol: originNetworkOption?.shortName }), "FIAT"), /* @__PURE__ */ import_react108.default.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react108.default.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ import_react108.default.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ import_react108.default.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "Source wallet:"), /* @__PURE__ */ import_react108.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react108.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react108.default.createElement(ChainIcon, { symbol: originNetworkOption?.shortName }), originNetworkOption.name)), /* @__PURE__ */ import_react108.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : walletAddress : dAppOption === "LPDrain" /* LPDrain */ ? targetWalletAddress : sourceWalletAddress))), /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "Transaction", width > 500 && /* @__PURE__ */ import_react108.default.createElement("br", null), "Details:"), /* @__PURE__ */ import_react108.default.createElement("span", { className: "amount-container" }, /* @__PURE__ */ import_react108.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react108.default.createElement("span", null, "Source Transfer amount"), /* @__PURE__ */ import_react108.default.createElement("div", { className: "coin-details" }, /* @__PURE__ */ import_react108.default.createElement("p", null, formatBigInt(txValues.allowanceAmount), sourceCurrency))), /* @__PURE__ */ import_react108.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react108.default.createElement("span", null, "Source Network Fee (", originNetwork.shortName, ")"), /* @__PURE__ */ import_react108.default.createElement("span", { className: "service-fee" }, formatBigInt(sourceFee), " ", sourceCurrency)), /* @__PURE__ */ import_react108.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react108.default.createElement("span", null, "Kima Service Fee"), /* @__PURE__ */ import_react108.default.createElement("span", { className: "service-fee" }, formatBigInt(kimaFee), " USD")), /* @__PURE__ */ import_react108.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react108.default.createElement("span", null, "Target Network Fee (", targetNetwork.shortName, ")"), /* @__PURE__ */ import_react108.default.createElement("span", { className: "service-fee" }, formatBigInt(targetFee), " ", sourceCurrency)), /* @__PURE__ */ import_react108.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react108.default.createElement("span", null, "Target Transfer Amount"), /* @__PURE__ */ import_react108.default.createElement("span", { className: "service-fee" }, formatBigInt(totalFee), " ", targetCurrency)))), targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react108.default.createElement("div", null, /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react108.default.createElement("p", null, bankDetails.iban), /* @__PURE__ */ import_react108.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react108.default.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), "FIAT")), /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react108.default.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ import_react108.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ import_react108.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react108.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react108.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react108.default.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), targetNetworkOption?.name)), /* @__PURE__ */ import_react108.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? walletAddress : targetAddress : dAppOption === "LPDrain" /* LPDrain */ ? sourceWalletAddress : targetWalletAddress))), mode === "bridge" /* bridge */ && BigInt(totalFee.value) > BigInt(0) ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ import_react108.default.createElement(FeeDeductionRadioButtons_default, { disabled: feeOptionDisabled })
  ) : null);
};
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  const sourceChain = (0, import_react111.useMemo)(
    () => networks.find((network) => network.shortName === data?.sourceChain),
    [data, networks]
  );
  const targetChain = (0, import_react111.useMemo)(
  ...
  return /* @__PURE__ */ import_react111.default.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ import_react111.default.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ import_react111.default.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ import_react111.default.createElement(
    ...
    /* @__PURE__ */ import_react111.default.createElement(ChainIcon, { symbol: data.sourceChain }),
    /* @__PURE__ */ import_react111.default.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"),
  ...
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ import_react111.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react111.default.createElement(ChainIcon, { symbol: data.sourceChain }), /* @__PURE__ */ import_react111.default.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"), /* @__PURE__ */ import_react111.default.createElement("p", null, /* @__PURE__ */ import_react111.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react111.default.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ import_react111.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react111.default.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ import_react111.default.createElement("p", { className: "chain-name" }, targetChain?.name, " TX ID:"), /* @__PURE__ */ import_react111.default.createElement("p", null, /* @__PURE__ */ import_react111.default.createElement(
    ExternalLink_default,
    {
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ import_react115.default.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ import_react115.default.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ import_react115.default.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ import_react115.default.createElement("h3", null, transactionId), /* @__PURE__ */ import_react115.default.createElement(CopyButton_default, { text: transactionId })));
};
...
var TransactionSearch = () => {
  ...
  const [transactionId, setTransactionId] = (0, import_react116.useState)("");
  const refPollForUpdates = (0, import_react116.useRef)(false);
  const handleSearch = async () => {
    if (transactionId.length <= 0)
      return import_react_hot_toast2.default.error("You must provide a valid transaction id", {
        icon: /* @__PURE__ */ import_react116.default.createElement(Error_default, null)
      });
    try {
  ...
  return /* @__PURE__ */ import_react116.default.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ import_react116.default.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "Search Transaction:"), /* @__PURE__ */ import_react116.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react116.default.createElement(SecondaryButton_default, { clickHandler: handleSearch }, "Search"));
};
var TransactionSearch_default = TransactionSearch;

// src/components/TransactionWidget.tsx
var TransactionWidget = ({ theme }) => {
  const [step, setStep] = (0, import_react117.useState)(0);
  const [focus, setFocus] = (0, import_react117.useState)(-1);
  const [errorStep, setErrorStep] = (0, import_react117.useState)(-1);
  const [errorMessage, setErrorMessage] = (0, import_react117.useState)("");
  const [loadingStep, setLoadingStep] = (0, import_react117.useState)(-1);
  ...
  (0, import_react117.useEffect)(() => {
    if (error)
      import_react_hot_toast3.toast.error(
        ...
        {
          icon: /* @__PURE__ */ import_react117.default.createElement(Error_default, null)
        }
      );
  }, [error]);
  (0, import_react117.useEffect)(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      import_react_hot_toast3.toast.error("Unavailable", { icon: /* @__PURE__ */ import_react117.default.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      console.log(data.failReason);
      import_react_hot_toast3.toast.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ import_react117.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react117.default.createElement(import_react_redux41.Provider, { store }, /* @__PURE__ */ import_react117.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react117.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react117.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react117.default.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ import_react117.default.createElement("h3", { className: "transaction" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING" : isEmptyStatus ? "GETTING TRANSACTION STATUS" : data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING", /* @__PURE__ */ import_react117.default.createElement("div", null, mode !== "status" /* status */ ? Number(amount) !== 0 ? formatBigInt(txValues.allowanceAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `(${sourceSymbol})` : isEmptyStatus ? "" : `(${data?.sourceSymbol})`, /* @__PURE__ */ import_react117.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react117.default.createElement(
      ChainIcon,
      {
        symbol: transactionSourceChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `(${transactionSourceChain?.shortName})` : isEmptyStatus ? "" : `(${data?.sourceChain})`, " ", mode !== "status" /* status */ ? `\u2192 ` : isEmptyStatus ? "" : `\u2192 `, mode !== "status" /* status */ ? Number(amount) !== 0 ? bigIntToNumber(txValues.allowanceAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `(${targetSymbol})${" "}` : isEmptyStatus ? "" : `(${data?.targetSymbol})${" "}`, /* @__PURE__ */ import_react117.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react117.default.createElement(
      ChainIcon,
      {
        symbol: transactionTargetChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `(${transactionTargetChain?.shortName})${" "}` : isEmptyStatus ? "" : `(${data?.targetChain}) ${" "}`)) : /* @__PURE__ */ import_react117.default.createElement("div", null, /* @__PURE__ */ import_react117.default.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ import_react117.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react117.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react117.default.createElement(Minimize_default, null)
    ), !isValidTxId || loadingStep < 0 || error ? /* @__PURE__ */ import_react117.default.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ import_react117.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react117.default.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    isValidTxId && !error ? /* @__PURE__ */ import_react117.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react117.default.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ import_react117.default.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )), !error && !isEmptyStatus && /* @__PURE__ */ import_react117.default.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ import_react117.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react117.default.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ import_react117.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react117.default.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ import_react117.default.createElement(
    ...
    /* @__PURE__ */ import_react117.default.createElement("div", { className: "floating-footer status" }, /* @__PURE__ */ import_react117.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react117.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react117.default.createElement(FooterLogo_default, { fill: "black" }), /* @__PURE__ */ import_react117.default.createElement("strong", null, "Network")))
  ));
};
...
var useGetFees = ({
  ...
  return (0, import_react_query15.useQuery)({
    ...
    enabled: !!backendUrl && !!amount && !!sourceNetwork && !!sourceAddress && !!sourceSymbol && !!targetNetwork && !!targetAddress && !!targetSymbol,
...
var NetworkSelector = ({ type }) => {
  const [collapsed, setCollapsed] = (0, import_react118.useState)(true);
  ...
  const excludedSourceNetworks = (0, import_react_redux45.useSelector)(selectExcludedSourceNetworks);
  const excludedTargetNetworks = (0, import_react_redux45.useSelector)(selectExcludedTargetNetworks);
  ...
  const selectedNetwork = (0, import_react118.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react118.default.createElement(
    ...
    /* @__PURE__ */ import_react118.default.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ import_react118.default.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ import_react118.default.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ import_react118.default.createElement(
      ...
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ import_react118.default.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ import_react118.default.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ import_react118.default.createElement("p", null, network.name)
      ))
    ),
    /* @__PURE__ */ import_react118.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react118.default.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = import_react118.default.memo(NetworkSelector);
...
var SingleForm = ({
  ...
  const [amountValue, setAmountValue] = (0, import_react119.useState)("");
  ...
  const errorMessage = (0, import_react119.useMemo)(
  ...
  const maxValue = (0, import_react119.useMemo)(() => {
    if (!balance) return 0;
  ...
  return /* @__PURE__ */ import_react119.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react119.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react119.default.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ import_react119.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react119.default.createElement(NetworkSelector_default, { type: "source" }), /* @__PURE__ */ import_react119.default.createElement(CoinDropdown_default, null))), /* @__PURE__ */ import_react119.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react119.default.createElement(
      ...
      /* @__PURE__ */ import_react119.default.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ import_react119.default.createElement(WalletButton_default, null)
    ),
    mode === "bridge" /* bridge */ && /* @__PURE__ */ import_react119.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react119.default.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ import_react119.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react119.default.createElement(NetworkSelector_default, { type: "target" }), /* @__PURE__ */ import_react119.default.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react119.default.createElement(BankInput_default, null) : /* @__PURE__ */ import_react119.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react119.default.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ import_react119.default.createElement(
    AddressInput_default,
    {
      theme: theme.colorMode,
      placeholder: "Target address"
    }
  )) : null, /* @__PURE__ */ import_react119.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react119.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react119.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react119.default.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "text",
  ...
  ), /* @__PURE__ */ import_react119.default.createElement("div", { className: "max-disclaimer" }, /* @__PURE__ */ import_react119.default.createElement(
    "span",
    {
    ...
    "Max"
  ), +totalFee !== -1 && /* @__PURE__ */ import_react119.default.createElement("p", null, "Est fees: $ ", formatBigInt(totalFee), " USD")))));
};
...
var SolanaWalletSelect = () => {
  ...
  return /* @__PURE__ */ import_react120.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react120.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react120.default.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ import_react120.default.createElement(
    ...
    /* @__PURE__ */ import_react120.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react120.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react120.default.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ import_react120.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react120.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react120.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react120.default.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
...
var WarningModal = ({
  ...
  return /* @__PURE__ */ import_react128.default.createElement("div", { className: "warning-modal-overlay" }, /* @__PURE__ */ import_react128.default.createElement("div", { className: "warning-modal" }, /* @__PURE__ */ import_react128.default.createElement("h3", null, "Warning"), /* @__PURE__ */ import_react128.default.createElement("p", null, message), /* @__PURE__ */ import_react128.default.createElement("div", { className: "warning-modal-buttons" }, /* @__PURE__ */ import_react128.default.createElement(
...
var TransferWidget = ({
  ...
  const mainRef = (0, import_react129.useRef)(null);
  const [signature, setSignature2] = (0, import_react129.useState)("");
  const [formStep, setFormStep] = (0, import_react129.useState)(0);
  const [warningModalOpen, setWarningModalOpen] = (0, import_react129.useState)(null);
  ...
  const { totalFee, transactionValues } = (0, import_react_redux55.useSelector)(selectServiceFee);
  ...
  const [isCancellingApprove, setCancellingApprove] = (0, import_react129.useState)(false);
  const [isApproving, setApproving] = (0, import_react129.useState)(false);
  const [isSigning, setSigning] = (0, import_react129.useState)(false);
  const [feeOptionDisabled, setFeeOptionDisabled] = (0, import_react129.useState)(false);
  ...
  const { allowance, balance, isApproved, approve, decimals, signMessage } = useAllowance({
    setApproving,
    setCancellingApprove
  });
  ...
  const handleSubmit = async () => {
    ...
    if (error === "ValidationError" /* Error */) {
      return import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react129.default.createElement(Error_default, null) });
    }
    ...
    if (!success) return import_react_hot_toast5.toast.error(submitMessage, { icon: /* @__PURE__ */ import_react129.default.createElement(Error_default, null) });
  };
  const onNext = () => {
    ...
    import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react129.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react129.default.createElement(
    ...
    warningModalOpen && /* @__PURE__ */ import_react129.default.createElement(
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ import_react129.default.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ import_react129.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react129.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react129.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react129.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react129.default.createElement("h3", null, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ import_react129.default.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ import_react129.default.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ import_react129.default.createElement(
      ExternalLink_default,
      {
        to: helpURL ? helpURL : "https://docs.kima.network/kima-network/try-kima-with-the-demo-app"
      },
      /* @__PURE__ */ import_react129.default.createElement("div", { className: "menu-button" }, "I need help")
    ), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ import_react129.default.createElement(
      "button",
      {
      ...
      "Reset"
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ import_react129.default.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ import_react129.default.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ import_react129.default.createElement(
      SingleForm_default,
      {
        ...{
      ...
      /* @__PURE__ */ import_react129.default.createElement("div", { className: `button-group` }, formStep !== 0 && /* @__PURE__ */ import_react129.default.createElement(
        SecondaryButton_default,
        {
          clickHandler: onBack,
          theme: theme.colorMode,
      ...
      ), !!allowance && allowance > 0 && formStep !== 0 ? /* @__PURE__ */ import_react129.default.createElement(
        SecondaryButton_default,
        {
    ...
    ), /* @__PURE__ */ import_react129.default.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ import_react129.default.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ import_react129.default.createElement(
    ...
    ), /* @__PURE__ */ import_react129.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react129.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react129.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react129.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react129.default.createElement("strong", null, "Network"))))
  );
};

// src/components/KimaWidgetWrapper.tsx
var import_react131 = require("@reown/appkit/react");
var KimaWidgetWrapper = ({
  ...
  const { setThemeMode, setThemeVariables } = (0, import_react131.useAppKitTheme)();
  ...
  return submitted ? /* @__PURE__ */ import_react130.default.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ import_react130.default.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
...
var KimaTransactionWidget = ({
  ...
  return isLoadingEnvs || isLoadingChainData ? /* @__PURE__ */ import_react132.default.createElement(ring_default, null) : /* @__PURE__ */ import_react132.default.createElement(
