...
var import_react39 = require("@reown/appkit/react");
...
var setupAppKit = (projectId, networkOption) => {
  ...
  appKitModel = (0, import_react39.createAppKit)({
...
function useBalance() {
  ...
  const tokenAddress = (0, import_react75.useMemo)(() => {
...
function useIsWalletReady() {
    ...
    async function checkChainId() {
      if (externalProvider?.type === "evm" && externalProvider?.provider && sourceChain.compatibility === "EVM" /* EVM */) {
        try {
          ...
          const externalProviderSignerAddress = (await externalProvider.provider.getSigner()).address;
          setIsReady(true);
  ...
  (0, import_react78.useEffect)(() => {
    if (connectedAddress !== "" && sourceChain.compatibility === "EVM" /* EVM */) {
      logger_default.debug(
...
var checkPoolBalance = ({
  ...
  if (Number(targetFee) >= poolGasAvailable)
    return {
      isPoolAvailable: false,
...
function useEvmAllowance() {
  const { externalProvider } = useKimaContext();
  const { walletProvider: appkitProvider } = (0, import_react81.useAppKitProvider)("eip155");
  const appkitAccountInfo = (0, import_react81.useAppKitAccount)();
  ...
  const [approvalsCount, setApprovalsCount] = (0, import_react80.useState)(0);
  ...
  const approveErc20TokenTransfer = async (isCancel = false) => {
    ...
    try {
      ...
      const finalAmount = isCancel ? BigInt(0) : feeDeduct ? (0, import_viem5.parseUnits)(amount, allowanceData.decimals) : (0, import_viem5.parseUnits)((+amount + totalFee).toString(), allowanceData.decimals);
  ...
  return {
    ...allowanceData,
    isApproved: allowanceData?.allowance ? feeDeduct ? +allowanceData.allowance >= +submitAmount : +allowanceData.allowance >= +allowanceAmount : false,
...
var import_react82 = require("@reown/appkit/react");
function useDisconnectWallet() {
  const { disconnect } = (0, import_react82.useDisconnect)();
...
var WalletProvider2 = ({
  ...
  return /* @__PURE__ */ import_react84.default.createElement(import_wallet_adapter_react.ConnectionProvider, { endpoint }, /* @__PURE__ */ import_react84.default.createElement(
...
function useSolanaAllowance() {
  ...
  const { pools } = useGetPools_default(backendUrl, networkOption);
  const [approvalsCount, setApprovalsCount] = (0, import_react85.useState)(0);
...
var WalletProvider3 = ({ children, networkOption }) => {
  const adapters = (0, import_react88.useMemo)(
    () => [
...
var getTokenAllowance3 = async ({
  ...
  try {
    ...
    return {
      allowance: Number((0, import_ethers7.formatUnits)(allowance, decimals)),
      balance: Number((0, import_ethers7.formatUnits)(balance, decimals)),
      decimals: Number(decimals)
    };
  } catch (error) {
...
function useTronAllowance() {
  ...
  const [approvalsCount, setApprovalsCount] = (0, import_react90.useState)(0);
  ...
  const tronWeb = (0, import_react90.useMemo)(() => {
    if (isTronProvider2)
...
function useIsWalletReady3() {
  ...
  (0, import_react91.useEffect)(() => {
    internalTronAddress && sourceChain.shortName === "TRX" && dispatch(setSourceAddress(internalTronAddress));
...
var useIsProviderReady = () => {
  const [isReady, setIsReady] = (0, import_react93.useState)(false);
...
var CreditCardPlugin = class extends PluginBase {
  ...
  Provider = ({ children }) => {
    return /* @__PURE__ */ import_react94.default.createElement(import_react94.default.Fragment, null, children);
  };
};
...
var KimaContext = (0, import_react95.createContext)(void 0);
var useKimaContext = () => {
  const context = (0, import_react95.useContext)(KimaContext);
  if (!context) {
    throw new Error("useKimaContext must be used within a KimaProvider");
  }
  return context;
};
var InternalKimaProvider = React80.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children, logLevel }) => {
    ...
    const WrappedProviders = (0, import_react95.useMemo)(() => {
    ...
    return /* @__PURE__ */ React80.createElement(React80.Fragment, null, WrappedProviders);
  }
);
var KimaProvider = ({
  walletConnectProjectId,
  children = /* @__PURE__ */ React80.createElement(React80.Fragment, null),
  externalProvider,
  ...
  if (externalProvider && isValidExternalProvider(externalProvider)) {
    ...
    if (externalProvider.type === "evm" && externalProvider.signer instanceof import_ethers8.JsonRpcSigner)
  ...
  return /* @__PURE__ */ React80.createElement(import_react_query11.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React80.createElement(import_react_redux15.Provider, { store }, /* @__PURE__ */ React80.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React80.createElement(
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ import_react96.default.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ import_react96.default.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ import_react96.default.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ import_react96.default.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ import_react96.default.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ import_react96.default.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react96.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react96.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react96.default.createElement(Check_default, null) : null, /* @__PURE__ */ import_react96.default.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ import_react97.default.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ import_react99.default.createElement(
    ...
    /* @__PURE__ */ import_react99.default.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ import_react99.default.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ import_react101.default.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ import_react101.default.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ import_react101.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react101.default.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ import_react102.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react102.default.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ import_react104.default.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = (0, import_react105.useState)(default_default);
...
var useWidth = () => {
  const [width, setWidth] = (0, import_react106.useState)(0);
...
var import_react110 = require("@reown/appkit/react");

// src/components/reusable/CopyButton.tsx
var import_react107 = __toESM(require("react"), 1);
var CopyButton = ({ text }) => {
  const [copyClicked, setCopyClicked] = (0, import_react107.useState)(false);
  ...
  return /* @__PURE__ */ import_react107.default.createElement(
    ...
    copyClicked ? /* @__PURE__ */ import_react107.default.createElement(Check_default, null) : /* @__PURE__ */ import_react107.default.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  const { open } = (0, import_react110.useAppKit)();
  const { open: isModalOpen } = (0, import_react110.useAppKitState)();
  ...
  const errorMessage = (0, import_react109.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react109.default.createElement(
    ...
    /* @__PURE__ */ import_react109.default.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ import_react109.default.createElement(
      "button",
      {
        className: `${isReady ? "connected" : "disconnected"} ${width < 640 && "shortened"} ${theme.colorMode}`,
        onClick: handleClick
      },
      isReady ? width >= 640 ? `${connectedAddress || ""}` : getShortenedAddress(connectedAddress || "") : "",
      !isReady && /* @__PURE__ */ import_react109.default.createElement(Wallet_default, null),
      !isReady && "Connect Wallet"
    ), isReady && /* @__PURE__ */ import_react109.default.createElement(CopyButton_default, { text: connectedAddress })),
    isReady && balance !== void 0 ? /* @__PURE__ */ import_react109.default.createElement("p", { className: "balance-info" }, formatUSD(balance), " ", selectedCoin, " available") : null
  );
};
...
function useCurrencyOptions(isSourceChain) {
  ...
  const output = (0, import_react111.useMemo)(() => {
...
var CoinDropdown = ({
  ...
  return /* @__PURE__ */ import_react113.default.createElement(
    ...
    /* @__PURE__ */ import_react113.default.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ import_react113.default.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ import_react113.default.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ import_react113.default.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ import_react113.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react113.default.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ import_react113.default.createElement("p", null, token.symbol)
      ))
    ),
    /* @__PURE__ */ import_react113.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react113.default.createElement(Arrow_default, { fill: "none" }))
  );
};
...
function ChainIcon({ symbol }) {
  ...
  if (!Icon) {
    ...
    return /* @__PURE__ */ import_react114.default.createElement("div", { className: "icon" });
  }
  return /* @__PURE__ */ import_react114.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react114.default.createElement(Icon, null));
}
...
var FeeDeductionRadioButtons = ({ isSigned }) => {
  ...
  const { totalFee } = (0, import_react_redux26.useSelector)(selectServiceFee);
  ...
  return /* @__PURE__ */ import_react115.default.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ import_react115.default.createElement("div", { className: "fee-options" }, /* @__PURE__ */ import_react115.default.createElement("label", { className: "fee-option" }, /* @__PURE__ */ import_react115.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  )} ${targetCurrency} in ${targetNetwork.name}`)), /* @__PURE__ */ import_react115.default.createElement("label", { className: "fee-option" }, /* @__PURE__ */ import_react115.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({
  ...
  const {
    ...
    allowanceAmount,
    submitAmount
  } = (0, import_react_redux27.useSelector)(selectServiceFee);
  ...
  const sourceChainOption = (0, import_react116.useMemo)(
    () => networkOptions3.filter((network) => network.id === sourceChain.id)[0],
    [networkOptions3, sourceChain]
  );
  const targetChainOption = (0, import_react116.useMemo)(
  ...
  const { width, updateWidth } = useWidth_default();
  const [feeCollapsed, setFeeCollapsed] = (0, import_react116.useState)(true);
  (0, import_react116.useEffect)(() => {
    width === 0 && updateWidth(window.innerWidth);
  }, []);
  const sourceconnectedAddress = (0, import_react116.useMemo)(() => {
    return width >= 916 ? connectedAddress : getShortenedAddress(connectedAddress || "");
  }, [width, connectedAddress]);
  const targetconnectedAddress = (0, import_react116.useMemo)(() => {
  ...
  const amountToShow = (0, import_react116.useMemo)(() => {
    if (sourceChain.shortName === "BTC" /* BTC */ || targetChain.shortName === "BTC" /* BTC */) {
      return (feeDeduct ? +amount : +amount + totalFee).toFixed(8);
    }
    return formatterFloat2.format(feeDeduct ? +amount : +amount + totalFee);
  }, [amount, totalFee, sourceChain, targetChain, feeDeduct]);
  return /* @__PURE__ */ import_react116.default.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ import_react116.default.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : sourceChain.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), sourceChain.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react116.default.createElement("div", null, /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react116.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react116.default.createElement(ChainIcon, { symbol: sourceChainOption?.shortName }), "FIAT"), /* @__PURE__ */ import_react116.default.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react116.default.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ import_react116.default.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ import_react116.default.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "Source", sourceChain.shortName !== "CC" && " wallet", ":"), /* @__PURE__ */ import_react116.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react116.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react116.default.createElement(ChainIcon, { symbol: sourceChainOption?.shortName }), sourceChainOption.name)), sourceChain.shortName !== "CC" && /* @__PURE__ */ import_react116.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : connectedAddress : dAppOption === "LPDrain" /* LPDrain */ ? targetconnectedAddress : sourceconnectedAddress))), /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "amount-container" }, /* @__PURE__ */ import_react116.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react116.default.createElement("span", null, "Amount to Transfer"), /* @__PURE__ */ import_react116.default.createElement("div", { className: "coin-details" }, /* @__PURE__ */ import_react116.default.createElement("p", null, feeDeduct ? submitAmount : allowanceAmount, " ", sourceCurrency))), /* @__PURE__ */ import_react116.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react116.default.createElement("span", null, "Total Network Fees"), /* @__PURE__ */ import_react116.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react116.default.createElement("span", { className: "service-fee" }, formatterFloat2.format(totalFee || 0), " ", sourceCurrency)
  )), /* @__PURE__ */ import_react116.default.createElement("div", { className: `fee-breakdown ${feeCollapsed ? "collapsed" : ""}` }, /* @__PURE__ */ import_react116.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react116.default.createElement("span", null, sourceChain.shortName === "CC" ? "Credit Card Processing Fee" : `Source Network Fee (${sourceChain.shortName})`), /* @__PURE__ */ import_react116.default.createElement("span", { className: "service-fee" }, sourceFee || 0, " ", sourceCurrency)), /* @__PURE__ */ import_react116.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react116.default.createElement("span", null, "Target Network Fee (", targetChain.shortName, ")"), /* @__PURE__ */ import_react116.default.createElement("span", { className: "service-fee" }, targetFee || 0, " ", targetCurrency)), /* @__PURE__ */ import_react116.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react116.default.createElement("span", null, "KIMA Service Fee"), /* @__PURE__ */ import_react116.default.createElement("span", { className: "service-fee" }, kimaFee, " ", sourceCurrency))), /* @__PURE__ */ import_react116.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react116.default.createElement("span", null, "Target Amount"), /* @__PURE__ */ import_react116.default.createElement("div", { className: "coin-details" }, /* @__PURE__ */ import_react116.default.createElement("p", null, feeDeduct ? +submitAmount - totalFee : +submitAmount, " ", sourceCurrency))))), targetChain.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react116.default.createElement("div", null, /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react116.default.createElement("p", null, bankDetails.iban), /* @__PURE__ */ import_react116.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react116.default.createElement(ChainIcon, { symbol: targetChainOption?.shortName }), "FIAT")), /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react116.default.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ import_react116.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ import_react116.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react116.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react116.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react116.default.createElement(ChainIcon, { symbol: targetChainOption?.shortName }), targetChainOption?.name)), /* @__PURE__ */ import_react116.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? connectedAddress : targetAddress : dAppOption === "LPDrain" /* LPDrain */ ? sourceconnectedAddress : targetconnectedAddress))), mode === "bridge" /* bridge */ && totalFee > 0 ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ import_react116.default.createElement(FeeDeductionRadioButtons_default, { isSigned })
  ) : null);
};
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  return /* @__PURE__ */ import_react119.default.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ import_react119.default.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ import_react119.default.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ import_react119.default.createElement(
    ...
    step < index && /* @__PURE__ */ import_react119.default.createElement(Lock_default, null),
    step >= index ? index === loadingStep ? /* @__PURE__ */ import_react119.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react119.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react119.default.createElement(Check_default, null) : null,
    /* @__PURE__ */ import_react119.default.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ import_react119.default.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ import_react119.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react119.default.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ import_react119.default.createElement("p", { className: "chain-name" }, "Kima TX ID:"), /* @__PURE__ */ import_react119.default.createElement("p", null, /* @__PURE__ */ import_react119.default.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ import_react119.default.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash && sourceChain?.shortName !== "CC" ? /* @__PURE__ */ import_react119.default.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ import_react119.default.createElement(ChainIcon, { symbol: sourceChain?.shortName }),
    /* @__PURE__ */ import_react119.default.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"),
    /* @__PURE__ */ import_react119.default.createElement("p", null, /* @__PURE__ */ import_react119.default.createElement(
      ExternalLink_default,
      {
    ...
    ), /* @__PURE__ */ import_react119.default.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ import_react119.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react119.default.createElement(ChainIcon, { symbol: data.sourceChain }), /* @__PURE__ */ import_react119.default.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"), /* @__PURE__ */ import_react119.default.createElement("p", null, /* @__PURE__ */ import_react119.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react119.default.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ import_react119.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react119.default.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ import_react119.default.createElement("p", { className: "chain-name" }, targetChain?.name, " TX ID:"), /* @__PURE__ */ import_react119.default.createElement("p", null, /* @__PURE__ */ import_react119.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react119.default.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ import_react120.default.createElement("div", { className: "bank-input" }, /* @__PURE__ */ import_react120.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react120.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react120.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react120.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react120.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react120.default.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ import_react123.default.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ import_react123.default.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ import_react123.default.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ import_react123.default.createElement("h3", null, transactionId), /* @__PURE__ */ import_react123.default.createElement(CopyButton_default, { text: transactionId })));
};
...
var TransactionSearch = () => {
  ...
  const [transactionId, setTransactionId] = (0, import_react124.useState)("");
  const refPollForUpdates = (0, import_react124.useRef)(false);
  ...
  return /* @__PURE__ */ import_react124.default.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ import_react124.default.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ import_react124.default.createElement("span", { className: "label" }, "Search Transaction:"), /* @__PURE__ */ import_react124.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react124.default.createElement(SecondaryButton_default, { clickHandler: handleSearch }, "Search"));
};
var TransactionSearch_default = TransactionSearch;

// src/components/TransactionWidget.tsx
var TransactionWidget = ({ theme }) => {
  const [step, setStep] = (0, import_react125.useState)(0);
  const [focus, setFocus] = (0, import_react125.useState)(-1);
  const [errorStep, setErrorStep] = (0, import_react125.useState)(-1);
  const [errorMessage, setErrorMessage] = (0, import_react125.useState)("");
  const [loadingStep, setLoadingStep] = (0, import_react125.useState)(-1);
  const [minimized, setMinimized] = (0, import_react125.useState)(false);
  ...
  const { totalFee } = (0, import_react_redux40.useSelector)(selectServiceFee);
  ...
  (0, import_react125.useEffect)(() => {
    if (error)
      import_react_hot_toast3.toast.error(
        ...
        {
          icon: /* @__PURE__ */ import_react125.default.createElement(Error_default, null)
        }
      );
  }, [error]);
  (0, import_react125.useEffect)(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      import_react_hot_toast3.toast.error("Unavailable", { icon: /* @__PURE__ */ import_react125.default.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      logger_default.error("transaction failed:", data.failReason);
      import_react_hot_toast3.toast.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ import_react125.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react125.default.createElement(import_react_redux39.Provider, { store }, /* @__PURE__ */ import_react125.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react125.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react125.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react125.default.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ import_react125.default.createElement("h3", { className: "transaction" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING" : isEmptyStatus ? "GETTING TRANSACTION STATUS" : data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING", /* @__PURE__ */ import_react125.default.createElement("div", null, mode !== "status" /* status */ ? Number(amount) !== 0 ? formatterFloat2.format(
    ...
    ) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `(${targetSymbol})${" "}` : isEmptyStatus ? "" : `(${data?.targetSymbol})${" "}`, /* @__PURE__ */ import_react125.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react125.default.createElement(
      ChainIcon,
      {
        symbol: transactionTargetChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `(${transactionTargetChain?.shortName})${" "}` : isEmptyStatus ? "" : `(${data?.targetChain}) ${" "}`)) : /* @__PURE__ */ import_react125.default.createElement("div", null, /* @__PURE__ */ import_react125.default.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ import_react125.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react125.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react125.default.createElement(Minimize_default, null)
    ), !isValidTxId || loadingStep < 0 || error ? /* @__PURE__ */ import_react125.default.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ import_react125.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react125.default.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    isValidTxId && !error ? /* @__PURE__ */ import_react125.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react125.default.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ import_react125.default.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )), !error && !isEmptyStatus && /* @__PURE__ */ import_react125.default.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ import_react125.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react125.default.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ import_react125.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react125.default.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ import_react125.default.createElement(
    ...
    /* @__PURE__ */ import_react125.default.createElement("div", { className: "floating-footer status" }, /* @__PURE__ */ import_react125.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react125.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react125.default.createElement(FooterLogo_default, { fill: "black" }), /* @__PURE__ */ import_react125.default.createElement("strong", null, "Network")))
  ));
};
...
var NetworkSelector = ({ type }) => {
  const [collapsed, setCollapsed] = (0, import_react126.useState)(true);
  ...
  const networks = (0, import_react126.useMemo)(() => {
    if (isSourceSelector) {
  ...
  const selectedNetwork = (0, import_react126.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react126.default.createElement(
    ...
    /* @__PURE__ */ import_react126.default.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ import_react126.default.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ import_react126.default.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ import_react126.default.createElement(
      ...
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ import_react126.default.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ import_react126.default.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ import_react126.default.createElement("p", null, network.name)
      ))
    ),
    /* @__PURE__ */ import_react126.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react126.default.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = import_react126.default.memo(NetworkSelector);
...
var SingleForm = ({
  ...
  const { totalFee } = (0, import_react_redux44.useSelector)(selectServiceFee);
  ...
  const [amountValue, setAmountValue] = (0, import_react127.useState)("");
  ...
  const sourceAddress = (0, import_react_redux44.useSelector)(selectSourceAddress);
  ...
  const errorMessage = (0, import_react127.useMemo)(
  ...
  const maxValue = (0, import_react127.useMemo)(() => {
    if (!balance) return 0;
    if (totalFee < 0) return balance;
    return preciseSubtraction(balance, totalFee);
  ...
  return /* @__PURE__ */ import_react127.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react127.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react127.default.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ import_react127.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react127.default.createElement(NetworkSelector_default, { type: "source" }), /* @__PURE__ */ import_react127.default.createElement(CoinDropdown_default, null))), /* @__PURE__ */ import_react127.default.createElement(
    "div",
    {
      className: `dynamic-area ${sourceNetwork.shortName === "FIAT" /* FIAT */ ? "reverse" : "1"}`
    },
    sourceNetwork.compatibility !== "CC" /* CC */ && /* @__PURE__ */ import_react127.default.createElement(
      "div",
      {
        className: `form-item wallet-button-item ${isReady && "connected"}`
      },
      /* @__PURE__ */ import_react127.default.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ import_react127.default.createElement(WalletButton_default, null)
    ),
    mode === "bridge" /* bridge */ && /* @__PURE__ */ import_react127.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react127.default.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ import_react127.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react127.default.createElement(NetworkSelector_default, { type: "target" }), /* @__PURE__ */ import_react127.default.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react127.default.createElement(BankInput_default, null) : /* @__PURE__ */ import_react127.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react127.default.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ import_react127.default.createElement(
    AddressInput_default,
    {
      theme: theme.colorMode,
      placeholder: "Target address"
    }
  )) : null, /* @__PURE__ */ import_react127.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react127.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react127.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react127.default.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "text",
  ...
  ), /* @__PURE__ */ import_react127.default.createElement("div", { className: "max-disclaimer" }, /* @__PURE__ */ import_react127.default.createElement(
    "span",
    {
    ...
    "Max"
  ), totalFee !== -1 && /* @__PURE__ */ import_react127.default.createElement("p", null, "Est fees: $ ", totalFee, " USD")))));
};
...
var SolanaWalletSelect = () => {
  ...
  const handleWalletClick = (0, import_react128.useCallback)(
    (walletName) => {
      logger_default.debug(
  ...
  return /* @__PURE__ */ import_react128.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react128.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react128.default.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ import_react128.default.createElement(
    ...
    /* @__PURE__ */ import_react128.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react128.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react128.default.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ import_react128.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react128.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react128.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react128.default.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react130.default.createElement("div", null, /* @__PURE__ */ import_react130.default.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ import_react130.default.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ import_react130.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react130.default.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
var AccountDetailsModal2 = () => {
  ...
  const networkDetails = (0, import_react131.useMemo)(
    () => networkOptions.find(({ id }) => id === selectedNetwork.shortName),
    [selectedNetwork]
  );
  const explorerUrl = (0, import_react131.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react131.default.createElement(
    ...
    )))), /* @__PURE__ */ import_react131.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "summary" }, networkDetails && /* @__PURE__ */ import_react131.default.createElement(networkDetails.icon, { width: 60, height: 60 }), /* @__PURE__ */ import_react131.default.createElement("div", { className: "address" }, /* @__PURE__ */ import_react131.default.createElement("h2", null, getShortenedAddress(connectedAddress || "")), /* @__PURE__ */ import_react131.default.createElement(CopyButton_default, { text: connectedAddress })), /* @__PURE__ */ import_react131.default.createElement("h3", null, tronBalance, " ", selectedNetwork.shortName)), /* @__PURE__ */ import_react131.default.createElement(SecondaryButton_default, { className: "block-explorer" }, /* @__PURE__ */ import_react131.default.createElement(ExternalLink_default, { className: "link", to: explorerUrl }, /* @__PURE__ */ import_react131.default.createElement(Explorer_default, { fill: "#778DA3" }), /* @__PURE__ */ import_react131.default.createElement("p", null, "Block explorer"), /* @__PURE__ */ import_react131.default.createElement(ExternalUrl_default, { fill: "#778DA3" }))), /* @__PURE__ */ import_react131.default.createElement(PrimaryButton_default, { clickHandler: handleDisconnect }, "Disconnect")))
  );
};
...
var TronWalletSelect = () => {
  ...
  const sliderRef = (0, import_react132.useRef)();
  ...
  const [detected, undetected] = (0, import_react132.useMemo)(() => {
    const detected2 = [];
    const undetected2 = [];
  ...
  return /* @__PURE__ */ import_react132.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react132.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react132.default.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ import_react132.default.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ import_react132.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react132.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react132.default.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ import_react132.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react132.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react132.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react132.default.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react133.default.createElement("div", null, /* @__PURE__ */ import_react133.default.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ import_react133.default.createElement(
    ...
    )))), /* @__PURE__ */ import_react133.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react133.default.createElement(TronWalletSelect_default, null)))
  ));
};
...
var useValidateTransaction = ({
  ...
  const maxValue = (0, import_react134.useMemo)(() => {
    if (!balance) return 0;
    if (totalFee < 0) return balance;
...
var WarningModal = ({
  ...
  return /* @__PURE__ */ import_react136.default.createElement("div", { className: "warning-modal-overlay" }, /* @__PURE__ */ import_react136.default.createElement("div", { className: "warning-modal" }, /* @__PURE__ */ import_react136.default.createElement("h3", null, "Warning"), /* @__PURE__ */ import_react136.default.createElement("p", null, message), /* @__PURE__ */ import_react136.default.createElement("div", { className: "warning-modal-buttons" }, /* @__PURE__ */ import_react136.default.createElement(
...
var CCWidget = () => {
  ...
  const [isLoading, setIsLoading] = (0, import_react137.useState)(true);
  const { width, updateWidth } = useWidth_default();
  ...
  return /* @__PURE__ */ import_react137.default.createElement("div", { className: `cc-widget ${isLoading ? "loading" : ""}` }, isLoading && /* @__PURE__ */ import_react137.default.createElement("div", { className: "cc-widget-loader" }, /* @__PURE__ */ import_react137.default.createElement(ring_default, { width: 50, height: 50, fill: "#86b8ce" })), /* @__PURE__ */ import_react137.default.createElement(
    "iframe",
    {
...
var TransferWidget = ({
  ...
  const { submitTransaction, isSubmitting } = useSubmitTransaction_default({
    amount: (0, import_ethers9.parseUnits)(submitAmount ?? "0", feeDecimals),
    totalFee: (0, import_ethers9.parseUnits)(totalFee.toString() ?? "0", feeDecimals),
  ...
  const handleSubmit = async () => {
    ...
    if (error === "ValidationError" /* Error */) {
      return import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react138.default.createElement(Error_default, null) });
    }
    ...
    if (!success) return import_react_hot_toast5.toast.error(submitMessage, { icon: /* @__PURE__ */ import_react138.default.createElement(Error_default, null) });
  };
  const onNext = () => {
    ...
    import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react138.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react138.default.createElement(
    ...
    warningModalOpen && /* @__PURE__ */ import_react138.default.createElement(
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ import_react138.default.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ import_react138.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react138.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react138.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react138.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react138.default.createElement("h3", null, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ import_react138.default.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ import_react138.default.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ import_react138.default.createElement(
      ExternalLink_default,
      {
        to: helpURL ? helpURL : "https://docs.kima.network/kima-network/try-kima-with-the-demo-app"
      },
      /* @__PURE__ */ import_react138.default.createElement("div", { className: "menu-button" }, "I need help")
    ), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ import_react138.default.createElement(
      "button",
      {
      ...
      "Reset"
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ import_react138.default.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ import_react138.default.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ import_react138.default.createElement(
      SingleForm_default,
      {
        ...{
          allowance,
    ...
    ) : submitted && !ccWidgetProcessed ? /* @__PURE__ */ import_react138.default.createElement(CCWidget_default, null) : /* @__PURE__ */ import_react138.default.createElement(
      ...
      /* @__PURE__ */ import_react138.default.createElement("div", { className: `button-group` }, formStep !== 0 && /* @__PURE__ */ import_react138.default.createElement(
        SecondaryButton_default,
        {
          clickHandler: onBack,
          theme: theme.colorMode,
      ...
      ), allowance > 0 && formStep !== 0 && sourceChain.shortName !== "CC" ? /* @__PURE__ */ import_react138.default.createElement(
        SecondaryButton_default,
        {
      ...
      ) : null, !submitted && /* @__PURE__ */ import_react138.default.createElement(
        PrimaryButton_default,
        {
          clickHandler: onNext,
    ...
    ), /* @__PURE__ */ import_react138.default.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ import_react138.default.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ import_react138.default.createElement(
    ...
    ), /* @__PURE__ */ import_react138.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react138.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react138.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react138.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react138.default.createElement("strong", null, "Network"))))
  );
};

// src/components/KimaWidgetWrapper.tsx
var import_react141 = require("@reown/appkit/react");

// src/hooks/useDebugMode.ts
var import_react139 = require("react");
var useDebugCode = (sequence = ["D", "E", "B", "U", "G"]) => {
  const [debugMode, setDebugMode] = (0, import_react139.useState)(false);
  const [, setInputSequence] = (0, import_react139.useState)([]);
...
var KimaWidgetWrapper = ({
  ...
  if (sourceChain.shortName === "CC") {
    if (submitted && ccWidgetProcessed) {
      return /* @__PURE__ */ import_react140.default.createElement(TransactionWidget, { theme });
    }
  ...
  return submitted ? /* @__PURE__ */ import_react140.default.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ import_react140.default.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
...
var ErrorWidget = ({
  ...
  return /* @__PURE__ */ import_react143.default.createElement(
    ...
    /* @__PURE__ */ import_react143.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react143.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react143.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react143.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react143.default.createElement("h3", null, title))), /* @__PURE__ */ import_react143.default.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ import_react143.default.createElement("div", { className: "kima-card-content error" }, /* @__PURE__ */ import_react143.default.createElement(Error_default, { width: 40, height: 40 }), /* @__PURE__ */ import_react143.default.createElement("h2", null, message)), /* @__PURE__ */ import_react143.default.createElement("div", { className: `kima-card-footer` }), /* @__PURE__ */ import_react143.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react143.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react143.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react143.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react143.default.createElement("strong", null, "Network"))))
  );
};
...
var KimaTransactionWidget = ({
  ...
  if (!hydrated || !theme?.colorMode) return /* @__PURE__ */ import_react144.default.createElement(ring_default, { width: 20, height: 20, fill: "#86b8ce" });
  if (isLoadingEnvs || isLoadingChainData)
    return /* @__PURE__ */ import_react144.default.createElement(SkeletonLoader_default, { theme });
