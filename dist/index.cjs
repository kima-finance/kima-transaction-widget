...
function useSolanaAllowance() {
  ...
  const { pools } = useGetPools_default(backendUrl, networkOption);
  const [approvalsCount, setApprovalsCount] = (0, import_react76.useState)(0);
  const amountToShow = (0, import_react76.useMemo)(() => {
    return (feeDeduct ? +amount : +amount + totalFeeUsd).toFixed(2);
  }, [amount, totalFeeUsd, sourceChain, targetChain, feeDeduct]);
  const {
    data: allowanceData,
...
var WalletProvider3 = ({ children, networkOption }) => {
  const adapters = (0, import_react79.useMemo)(
    () => [
...
function useGetTronBalance() {
  ...
  const tronWeb = (0, import_react80.useMemo)(
...
function useTronAllowance() {
  ...
  const [approvalsCount, setApprovalsCount] = (0, import_react81.useState)(0);
  const amountToShow = (0, import_react81.useMemo)(() => {
    return (feeDeduct ? +amount : +amount + totalFeeUsd).toFixed(2);
  }, [amount, totalFeeUsd, sourceChain, targetChain, feeDeduct]);
...
// src/KimaProvider.tsx
var InternalKimaProvider = import_react84.default.memo(
  ({
    networkOption = "testnet" /* testnet */,
    walletConnectProjectId,
    children
    ...
    const WrappedProviders = (0, import_react84.useMemo)(() => {
    ...
    return /* @__PURE__ */ import_react84.default.createElement(import_react84.default.Fragment, null, WrappedProviders);
  }
);
var KimaProvider = ({
  walletConnectProjectId,
  ...
  return /* @__PURE__ */ import_react84.default.createElement(import_react_query9.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ import_react84.default.createElement(import_react_redux12.Provider, { store }, /* @__PURE__ */ import_react84.default.createElement(InternalKimaProvider, { walletConnectProjectId }, children)));
};
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ import_react85.default.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ import_react85.default.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ import_react85.default.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ import_react85.default.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ import_react85.default.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ import_react85.default.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react85.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react85.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react85.default.createElement(Check_default, null) : null, /* @__PURE__ */ import_react85.default.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ import_react86.default.createElement(
  "a",
  {
    className,
    href: to,
...
var NetworkLabel = ({ sourceChain, targetChain }) => {
  ...
  return /* @__PURE__ */ import_react87.default.createElement("div", { className: "header-network-labels" }, SourceInfo?.label && /* @__PURE__ */ import_react87.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react87.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react87.default.createElement(SourceInfo.icon, null)), /* @__PURE__ */ import_react87.default.createElement("p", null, SourceInfo.label)), SourceInfo?.label && TargetInfo?.label && /* @__PURE__ */ import_react87.default.createElement("div", { className: "arrow" }, /* @__PURE__ */ import_react87.default.createElement(Arrow_default, null)), TargetInfo?.label && /* @__PURE__ */ import_react87.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react87.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react87.default.createElement(TargetInfo.icon, null)), /* @__PURE__ */ import_react87.default.createElement("p", null, TargetInfo.label)));
};
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ import_react88.default.createElement(
    ...
    /* @__PURE__ */ import_react88.default.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ import_react88.default.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ import_react90.default.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ import_react90.default.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ import_react90.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react90.default.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
function ChainIcon({
  ...
  return /* @__PURE__ */ import_react92.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react92.default.createElement(Icon, { width, height }));
}

// src/components/reusable/NetworkSelect.tsx
var Network = ({ isOriginChain = true }) => {
  const sourceChangeRef = (0, import_react93.useRef)(false);
  ...
  const [availableNetworks, setAvailableNetworks] = (0, import_react93.useState)(
    []
  );
  const networkOptions3 = (0, import_react_redux15.useSelector)(selectNetworks);
  const selectedNetwork = (0, import_react93.useMemo)(() => {
  ...
  const networks = (0, import_react93.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react93.default.createElement("div", { className: `network-select` }, /* @__PURE__ */ import_react93.default.createElement("p", null, isOriginChain ? "Which network are you funding from?" : "Which network are you funding to?"), /* @__PURE__ */ import_react93.default.createElement("div", { className: "scroll-button" }, /* @__PURE__ */ import_react93.default.createElement(
    Arrow_default,
    {
  ...
  )), /* @__PURE__ */ import_react93.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react93.default.createElement("div", { className: "network-container" }, networks.map((network) => /* @__PURE__ */ import_react93.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react93.default.createElement(ChainIcon, { symbol: network.id }),
    /* @__PURE__ */ import_react93.default.createElement("span", null, network.label)
  )))));
};
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ import_react95.default.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = (0, import_react96.useState)(default_default);
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  return /* @__PURE__ */ import_react99.default.createElement(
    ...
    isReady && balance !== void 0 ? /* @__PURE__ */ import_react99.default.createElement("p", { className: "balance-info" }, balance.toFixed(2), " ", selectedCoin, " available") : null
  );
};
...
var TransactionWidget = ({ theme }) => {
  ...
  const graphqlProviderQuery = (0, import_react_redux35.useSelector)(selectGraphqlProviderQuery);
  (0, import_react110.useEffect)(() => {
    ...
    const updateTxData = async () => {
      ...
      try {
        ...
        import_react_hot_toast7.toast.error("rpc disconnected", { icon: /* @__PURE__ */ import_react110.default.createElement(Error_default, null) });
        console.log("rpc disconnected", e);
      }
    };
    const timerId = setInterval(() => {
  ...
  (0, import_react110.useEffect)(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      import_react_hot_toast7.toast.error("Unavailable", { icon: /* @__PURE__ */ import_react110.default.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      console.log(data.failReason);
      import_react_hot_toast7.toast.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ import_react110.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react110.default.createElement(import_react_redux34.Provider, { store }, /* @__PURE__ */ import_react110.default.createElement(
    "div",
    {
...
var TransferWidget = ({
  ...
  const handleSubmit = async () => {
    ...
    if (error === "ValidationError" /* Error */) {
      return import_react_hot_toast10.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react126.default.createElement(Error_default, null) });
    }
    if (error === "ApprovalNeeded" /* ApprovalNeeded */) {
      return approve();
    }
    const { success, message: submitMessage } = await submitTransaction();
    if (!success) return import_react_hot_toast10.toast.error(submitMessage, { icon: /* @__PURE__ */ import_react126.default.createElement(Error_default, null) });
  };
  const onNext = () => {
    ...
    import_react_hot_toast10.toast.error(message, { icon: /* @__PURE__ */ import_react126.default.createElement(Error_default, null) });
