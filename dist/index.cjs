...
var import_react36 = require("@reown/appkit/react");
...
var setupAppKit = (projectId, networkOption) => {
  ...
  appKitModel = (0, import_react36.createAppKit)({
...
var CHAIN_NAMES_TO_APPKIT_NETWORK_TESTNET = {
  ...
  ["BERA" /* BERA */]: import_networks3.berachainTestnetbArtio
};
var CLUSTER2 = "devnet";
...
function useBalance() {
  ...
  const tokenAddress = (0, import_react72.useMemo)(() => {
...
function useIsWalletReady() {
  ...
  const { walletProvider: evmProvider } = (0, import_react76.useAppKitProvider)("eip155");
  ...
  const correctEvmNetwork = (0, import_react75.useMemo)(() => {
...
function useEvmAllowance() {
  ...
  const [approvalsCount, setApprovalsCount] = (0, import_react77.useState)(0);
...
function useDisconnectWallet() {
  const { disconnect } = (0, import_react79.useDisconnect)();
...
var WalletProvider2 = ({
  ...
  return /* @__PURE__ */ import_react81.default.createElement(import_wallet_adapter_react.ConnectionProvider, { endpoint }, /* @__PURE__ */ import_react81.default.createElement(
...
function useTronAllowance() {
  ...
  const [approvalsCount, setApprovalsCount] = (0, import_react87.useState)(0);
...
var InternalKimaProvider = React76.memo(
  ({
    ...
    const WrappedProviders = (0, import_react90.useMemo)(() => {
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ import_react91.default.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ import_react91.default.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ import_react91.default.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ import_react91.default.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ import_react91.default.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ import_react91.default.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react91.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react91.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react91.default.createElement(Check_default, null) : null, /* @__PURE__ */ import_react91.default.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ import_react92.default.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ import_react94.default.createElement(
    ...
    /* @__PURE__ */ import_react94.default.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ import_react94.default.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ import_react96.default.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ import_react96.default.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ import_react96.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react96.default.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ import_react97.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react97.default.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ import_react99.default.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = (0, import_react100.useState)(default_default);
...
var useWidth = () => {
  const [width, setWidth] = (0, import_react101.useState)(0);
...
var import_react105 = require("@reown/appkit/react");

// src/components/reusable/CopyButton.tsx
var import_react102 = __toESM(require("react"), 1);
var CopyButton = ({ text }) => {
  const [copyClicked, setCopyClicked] = (0, import_react102.useState)(false);
  ...
  return /* @__PURE__ */ import_react102.default.createElement(
    ...
    copyClicked ? /* @__PURE__ */ import_react102.default.createElement(Check_default, null) : /* @__PURE__ */ import_react102.default.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  const { open } = (0, import_react105.useAppKit)();
  const { width, updateWidth } = useWidth_default();
  const { open: isModalOpen } = (0, import_react105.useAppKitState)();
  ...
  const errorMessage = (0, import_react104.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react104.default.createElement(
    ...
    /* @__PURE__ */ import_react104.default.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ import_react104.default.createElement(
      "button",
      {
      ...
      !isReady && /* @__PURE__ */ import_react104.default.createElement(Wallet_default, null),
      !isReady && "Connect Wallet"
    ), isReady && /* @__PURE__ */ import_react104.default.createElement(CopyButton_default, { text: walletAddress })),
    isReady && balance !== void 0 ? /* @__PURE__ */ import_react104.default.createElement("p", { className: "balance-info" }, formatUSD(balance), " ", selectedCoin, " available") : null
  );
};
...
function useCurrencyOptions(isSourceChain) {
  ...
  const output = (0, import_react106.useMemo)(() => {
...
function TokenIcon({
  ...
  return /* @__PURE__ */ import_react107.default.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ import_react107.default.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  const [collapsed, setCollapsed] = (0, import_react108.useState)(true);
  ...
  return /* @__PURE__ */ import_react108.default.createElement(
    ...
    /* @__PURE__ */ import_react108.default.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ import_react108.default.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ import_react108.default.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ import_react108.default.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ import_react108.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react108.default.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ import_react108.default.createElement("p", null, token.symbol)
      ))
    ),
    /* @__PURE__ */ import_react108.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react108.default.createElement(Arrow_default, { fill: "none" }))
  );
};
...
function ChainIcon({
  ...
  return /* @__PURE__ */ import_react109.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react109.default.createElement(Icon, null));
}
...
var ConfirmDetails = ({
  ...
  const originNetworkOption = (0, import_react110.useMemo)(
    () => networkOptions3.filter((network) => network.id === originNetwork)[0],
    [networkOptions3, originNetwork]
  );
  const targetNetworkOption = (0, import_react110.useMemo)(
  ...
  const sourceWalletAddress = (0, import_react110.useMemo)(() => {
    return width >= 916 ? walletAddress : getShortenedAddress(walletAddress || "");
  }, [width, walletAddress]);
  const targetWalletAddress = (0, import_react110.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react110.default.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ import_react110.default.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react110.default.createElement("div", null, /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react110.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react110.default.createElement(ChainIcon, { symbol: originNetworkOption?.id }), "FIAT"), /* @__PURE__ */ import_react110.default.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react110.default.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ import_react110.default.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ import_react110.default.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "Source wallet:"), /* @__PURE__ */ import_react110.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react110.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react110.default.createElement(ChainIcon, { symbol: originNetworkOption?.id }), originNetworkOption.label)), /* @__PURE__ */ import_react110.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : walletAddress : dAppOption === "LPDrain" /* LPDrain */ ? targetWalletAddress : sourceWalletAddress))), /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "Transaction", width > 500 && /* @__PURE__ */ import_react110.default.createElement("br", null), "Details:"), /* @__PURE__ */ import_react110.default.createElement("span", { className: "amount-container" }, /* @__PURE__ */ import_react110.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react110.default.createElement("span", null, "Transfer amount"), /* @__PURE__ */ import_react110.default.createElement("div", { className: "coin-details" }, /* @__PURE__ */ import_react110.default.createElement("p", null, formatterFloat2.format(parseFloat(amountToShow) - totalFeeUsd), " ", sourceCurrency)), sourceCurrency !== targetCurrency && /* @__PURE__ */ import_react110.default.createElement("div", { className: "coin-details" }, "\u2192 ", targetCurrency)), /* @__PURE__ */ import_react110.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react110.default.createElement("span", null, "Network costs"), /* @__PURE__ */ import_react110.default.createElement("span", { className: "service-fee" }, formatterFloat2.format(totalFeeUsd), " ", sourceCurrency)), /* @__PURE__ */ import_react110.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react110.default.createElement("span", null, "Total"), /* @__PURE__ */ import_react110.default.createElement("span", { className: "service-fee" }, formatterFloat2.format(parseFloat(amountToShow)), " ", targetCurrency)))), targetNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react110.default.createElement("div", null, /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react110.default.createElement("p", null, bankDetails.iban), /* @__PURE__ */ import_react110.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react110.default.createElement(ChainIcon, { symbol: targetNetworkOption?.id }), "FIAT")), /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react110.default.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ import_react110.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ import_react110.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react110.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react110.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react110.default.createElement(ChainIcon, { symbol: targetNetworkOption?.id }), targetNetworkOption?.label)), /* @__PURE__ */ import_react110.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? walletAddress : targetAddress : dAppOption === "LPDrain" /* LPDrain */ ? sourceWalletAddress : targetWalletAddress))), /* @__PURE__ */ import_react110.default.createElement(
    "div",
    {
      className: `kima-card-footer ${mode === "bridge" /* bridge */ && formStep !== 0 && "confirm"}`
    },
    /* @__PURE__ */ import_react110.default.createElement("div", { className: `button-group` }, formStep !== 0 && /* @__PURE__ */ import_react110.default.createElement(
    ...
    ), allowance > 0 && formStep !== 0 ? /* @__PURE__ */ import_react110.default.createElement(
      SecondaryButton_default,
      {
    ...
    ) : null, /* @__PURE__ */ import_react110.default.createElement(
...
var CustomCheckbox = ({ text, checked, setCheck }) => {
  ...
  return /* @__PURE__ */ import_react112.default.createElement("div", { className: "kima-custom-checkbox" }, /* @__PURE__ */ import_react112.default.createElement(
    "div",
    {
      className: "custom-checkbox-content",
      onClick: () => setCheck(!checked)
    },
    /* @__PURE__ */ import_react112.default.createElement("div", { className: `custom-checkbox-icon-wrapper ${theme.colorMode}` }, checked && /* @__PURE__ */ import_react112.default.createElement(Check_default, null)),
    /* @__PURE__ */ import_react112.default.createElement("span", null, text)
  ));
};
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  return /* @__PURE__ */ import_react113.default.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ import_react113.default.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ import_react113.default.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ import_react113.default.createElement(
    "div",
    {
      className: `info-item
    ...
    step < index && /* @__PURE__ */ import_react113.default.createElement(Lock_default, null),
    step >= index ? index === loadingStep ? /* @__PURE__ */ import_react113.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react113.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react113.default.createElement(Check_default, null) : null,
    /* @__PURE__ */ import_react113.default.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ import_react113.default.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ import_react113.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react113.default.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ import_react113.default.createElement("p", { className: "chain-name" }, "Kima TX ID:"), /* @__PURE__ */ import_react113.default.createElement("p", null, /* @__PURE__ */ import_react113.default.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ import_react113.default.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash ? /* @__PURE__ */ import_react113.default.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ import_react113.default.createElement(ChainIcon, { symbol: originNetworkOption?.id }),
    /* @__PURE__ */ import_react113.default.createElement("p", { className: "chain-name" }, CHAIN_NAMES_TO_STRING[data?.sourceChain || "ETH" /* ETHEREUM */], " ", "TX ID:"),
    /* @__PURE__ */ import_react113.default.createElement("p", null, /* @__PURE__ */ import_react113.default.createElement(
      ExternalLink_default,
      {
    ...
    ), /* @__PURE__ */ import_react113.default.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ import_react113.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react113.default.createElement(ChainIcon, { symbol: targetnNetworkOption?.id }), /* @__PURE__ */ import_react113.default.createElement("p", { className: "chain-name" }, CHAIN_NAMES_TO_STRING[data?.targetChain || "ETH" /* ETHEREUM */], " ", "TX ID:"), /* @__PURE__ */ import_react113.default.createElement("p", null, /* @__PURE__ */ import_react113.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react113.default.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ import_react114.default.createElement("div", { className: "bank-input" }, /* @__PURE__ */ import_react114.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react114.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react114.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react114.default.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ import_react117.default.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ import_react117.default.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ import_react117.default.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ import_react117.default.createElement("h3", null, transactionId), /* @__PURE__ */ import_react117.default.createElement(CopyButton_default, { text: transactionId })));
};
var TransactionStatusMessage_default = TransactionStatusMessage;

// src/components/TransactionWidget.tsx
var TransactionWidget = ({ theme }) => {
  const [step, setStep] = (0, import_react118.useState)(0);
  const [focus, setFocus] = (0, import_react118.useState)(-1);
  const [errorStep, setErrorStep] = (0, import_react118.useState)(-1);
  const [errorMessage, setErrorMessage] = (0, import_react118.useState)("");
  const [loadingStep, setLoadingStep] = (0, import_react118.useState)(-1);
  const [minimized, setMinimized] = (0, import_react118.useState)(false);
  ...
  (0, import_react118.useEffect)(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      import_react_hot_toast2.toast.error("Unavailable", { icon: /* @__PURE__ */ import_react118.default.createElement(Error_default, null) });
      ...
      import_react_hot_toast2.toast.error("Failed to release tokens to target!", {
        icon: /* @__PURE__ */ import_react118.default.createElement(Error_default, null)
      });
      ...
      setLoadingStep(-1);
      console.log(data.failReason);
      import_react_hot_toast2.toast.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ import_react118.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react118.default.createElement(import_react_redux33.Provider, { store }, /* @__PURE__ */ import_react118.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react118.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react118.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react118.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react118.default.createElement("h3", { className: "transaction" }, "Transferring", " ", data?.amount && data.sourceChain && data.sourceSymbol && data.targetChain && data.targetSymbol && /* @__PURE__ */ import_react118.default.createElement("div", null, formatterFloat2.format(
      mode === "status" /* status */ ? data.amount : feeDeduct ? +amount || 0 + totalFeeUsd : +amount || 0 - totalFeeUsd
    ), " ", data?.sourceSymbol, " ", /* @__PURE__ */ import_react118.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react118.default.createElement(ChainIcon, { symbol: data.sourceChain })), " ", "(", data?.sourceChain, ") \u2192", " ", formatterFloat2.format(
      mode === "status" /* status */ ? data.amount : feeDeduct ? +amount - totalFeeUsd || 0 : +amount || 0
    ), " ", data?.targetSymbol, " ", /* @__PURE__ */ import_react118.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react118.default.createElement(ChainIcon, { symbol: data.targetChain })), " ", "(", data?.targetChain, ")"))), !minimized ? /* @__PURE__ */ import_react118.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react118.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react118.default.createElement(Minimize_default, null)
    ), loadingStep < 0 ? /* @__PURE__ */ import_react118.default.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ import_react118.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react118.default.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    /* @__PURE__ */ import_react118.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react118.default.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ import_react118.default.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    /* @__PURE__ */ import_react118.default.createElement("div", { className: "floating-footer status" }, /* @__PURE__ */ import_react118.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react118.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react118.default.createElement(FooterLogo_default, { fill: "black" }), /* @__PURE__ */ import_react118.default.createElement("strong", null, "Network")))
  ));
};
...
var NetworkSelector = ({ type }) => {
  const [collapsed, setCollapsed] = (0, import_react119.useState)(true);
  ...
  const networks = (0, import_react119.useMemo)(() => {
    if (isSourceSelector) {
  ...
  const selectedNetwork = (0, import_react119.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react119.default.createElement(
    ...
    /* @__PURE__ */ import_react119.default.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ import_react119.default.createElement(ChainIcon, { symbol: selectedNetwork.id }), /* @__PURE__ */ import_react119.default.createElement("span", null, selectedNetwork.label)),
    /* @__PURE__ */ import_react119.default.createElement(
      ...
      networks.filter((network) => network.id !== selectedNetwork.id).map((network) => /* @__PURE__ */ import_react119.default.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ import_react119.default.createElement(ChainIcon, { symbol: network.id }),
        /* @__PURE__ */ import_react119.default.createElement("p", null, network.label)
      ))
    ),
    /* @__PURE__ */ import_react119.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react119.default.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = import_react119.default.memo(NetworkSelector);
...
// src/components/reusable/OptionDivider.tsx
var import_react121 = __toESM(require("react"), 1);
var OptionDivider = ({ text }) => {
  return /* @__PURE__ */ import_react121.default.createElement("div", { className: "option-divider" }, /* @__PURE__ */ import_react121.default.createElement("span", { className: "line" }), /* @__PURE__ */ import_react121.default.createElement("span", { className: "text" }, text), /* @__PURE__ */ import_react121.default.createElement("span", { className: "line" }));
};
var OptionDivider_default = OptionDivider;
...
var SingleForm = ({
  ...
  const compliantOption = (0, import_react_redux40.useSelector)(selectCompliantOption);
  const targetCompliant = (0, import_react_redux40.useSelector)(selectTargetCompliant);
  ...
  const [amountValue, setAmountValue] = (0, import_react122.useState)("");
  ...
  const targetCurrency = (0, import_react_redux40.useSelector)(selectTargetCurrency);
  ...
  const errorMessage = (0, import_react122.useMemo)(
  ...
  return /* @__PURE__ */ import_react122.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react122.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react122.default.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ import_react122.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react122.default.createElement(NetworkSelector_default, { type: "source" }), /* @__PURE__ */ import_react122.default.createElement(CoinDropdown_default, null))), /* @__PURE__ */ import_react122.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react122.default.createElement(
      ...
      /* @__PURE__ */ import_react122.default.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ import_react122.default.createElement(WalletButton_default, null)
    ),
    mode === "bridge" /* bridge */ && /* @__PURE__ */ import_react122.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react122.default.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ import_react122.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react122.default.createElement(NetworkSelector_default, { type: "target" }), /* @__PURE__ */ import_react122.default.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork !== "FIAT" /* FIAT */ ? targetNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react122.default.createElement(BankInput_default, null) : /* @__PURE__ */ import_react122.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react122.default.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ import_react122.default.createElement(
    AddressInput_default,
    {
      theme: theme.colorMode,
      placeholder: "Target address"
    }
  )) : null, mode === "bridge" /* bridge */ ? /* @__PURE__ */ import_react122.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react122.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react122.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react122.default.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "text",
    ...
    "Max"
  ))) : /* @__PURE__ */ import_react122.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react122.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react122.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react122.default.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "number",
  ...
  ), /* @__PURE__ */ import_react122.default.createElement("div", { className: `coin-wrapper ${theme.colorMode}` }, /* @__PURE__ */ import_react122.default.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ import_react122.default.createElement(TargetIcon, null)), targetCurrency))), mode === "bridge" /* bridge */ && totalFeeUsd > 0 ? /* @__PURE__ */ import_react122.default.createElement(
    ...
    /* @__PURE__ */ import_react122.default.createElement("div", { className: `button-group` }, formStep !== 0 && /* @__PURE__ */ import_react122.default.createElement(
      SecondaryButton_default,
      {
        clickHandler: onBack,
        theme: theme.colorMode,
      ...
      formStep > 0 ? "Back" : "Cancel"
    ), allowance > 0 && formStep !== 0 ? /* @__PURE__ */ import_react122.default.createElement(
      SecondaryButton_default,
      {
        clickHandler: onCancelApprove,
        isLoading: isCancellingApprove,
  ...
  ), /* @__PURE__ */ import_react122.default.createElement(OptionDivider_default, { text: "or" }), /* @__PURE__ */ import_react122.default.createElement(TransactionSearch_default, null));
};
...
var SolanaWalletSelect = () => {
  ...
  const handleWalletClick = (0, import_react123.useCallback)(
    (walletName) => {
      select(walletName);
    },
    [select]
  ...
  return /* @__PURE__ */ import_react123.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react123.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react123.default.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ import_react123.default.createElement(
    ...
    /* @__PURE__ */ import_react123.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react123.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react123.default.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ import_react123.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react123.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react123.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react123.default.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
...
var SolanaWalletConnectModal = () => {
  ...
  const connectModal = (0, import_react_redux43.useSelector)(selectSolanaConnectModal);
  return /* @__PURE__ */ import_react125.default.createElement("div", null, /* @__PURE__ */ import_react125.default.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ import_react125.default.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ import_react125.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react125.default.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
var AccountDetailsModal2 = () => {
  ...
  const sourcheChain = (0, import_react_redux44.useSelector)(selectSourceChain);
  ...
  const selectedNetwork = (0, import_react_redux44.useSelector)(selectSourceChain);
  const networkDetails = (0, import_react126.useMemo)(
...
var TronWalletSelect = () => {
  ...
  return /* @__PURE__ */ import_react127.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react127.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react127.default.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ import_react127.default.createElement(
    ...
    /* @__PURE__ */ import_react127.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react127.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react127.default.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ import_react127.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react127.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react127.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react127.default.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  const connectModal = (0, import_react_redux46.useSelector)(selectTronConnectModal);
  return /* @__PURE__ */ import_react128.default.createElement("div", null, /* @__PURE__ */ import_react128.default.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ import_react128.default.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ import_react128.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react128.default.createElement(TronWalletSelect_default, null)))
  ));
};
...
var useValidateTransaction = ({
  ...
  const maxValue = (0, import_react129.useMemo)(() => {
    if (!balance) return 0;
    if (feeDeduct || totalFeeUsd < 0) return balance;
    const amountMinusFees = preciseSubtraction(balance, totalFeeUsd);
...
var useSubmitTransaction = ({
  ...
  const [isSubmitting, setSubmitting] = (0, import_react130.useState)(false);
...
var TransferWidget = ({
  ...
  const mainRef = (0, import_react131.useRef)(null);
  const [formStep, setFormStep] = (0, import_react131.useState)(0);
  const dAppOption = (0, import_react_redux48.useSelector)(selectDappOption);
  const mode = (0, import_react_redux48.useSelector)(selectMode);
  const transactionOption = (0, import_react_redux48.useSelector)(selectTransactionOption);
  const backendUrl = (0, import_react_redux48.useSelector)(selectBackendUrl);
  const sourceAddress = (0, import_react_redux48.useSelector)(selectSourceAddress);
  const targetAddress = (0, import_react_redux48.useSelector)(selectTargetAddress);
  const sourceChain = (0, import_react_redux48.useSelector)(selectSourceChain);
  const targetChain = (0, import_react_redux48.useSelector)(selectTargetChain);
  const sourceCurrency = (0, import_react_redux48.useSelector)(selectSourceCurrency);
  const targetCurrency = (0, import_react_redux48.useSelector)(selectTargetCurrency);
  const amount = (0, import_react_redux48.useSelector)(selectAmount);
  const {
    totalFeeUsd,
    totalFee,
    targetNetworkFee,
  ...
  } = (0, import_react_redux48.useSelector)(selectServiceFee);
  const compliantOption = (0, import_react_redux48.useSelector)(selectCompliantOption);
  const networkOptions3 = (0, import_react_redux48.useSelector)(selectNetworkOption);
  const feeDeduct = (0, import_react_redux48.useSelector)(selectFeeDeduct);
  const { keplrHandler, closeHandler } = useKimaContext();
  const [isCancellingApprove, setCancellingApprove] = (0, import_react131.useState)(false);
  const [isApproving, setApproving] = (0, import_react131.useState)(false);
  const [isSigning, setSigning] = (0, import_react131.useState)(false);
  const pendingTxs = (0, import_react_redux48.useSelector)(selectPendingTxs);
  ...
  const handleSubmit = async () => {
    ...
    if (error === "ValidationError" /* Error */) {
      return import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react131.default.createElement(Error_default, null) });
    }
    ...
    if (!success) return import_react_hot_toast5.toast.error(submitMessage, { icon: /* @__PURE__ */ import_react131.default.createElement(Error_default, null) });
  };
  const onNext = () => {
    ...
    import_react_hot_toast5.toast.error(message, { icon: /* @__PURE__ */ import_react131.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react131.default.createElement(
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ import_react131.default.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ import_react131.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react131.default.createElement("h3", null, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ import_react131.default.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ import_react131.default.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ import_react131.default.createElement(
      ExternalLink_default,
      {
        to: helpURL ? helpURL : "https://docs.kima.network/kima-network/try-kima-with-the-demo-app"
      },
      /* @__PURE__ */ import_react131.default.createElement("div", { className: "menu-button" }, "I need help")
    ), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ import_react131.default.createElement(
      "button",
      {
      ...
      "Reset"
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ import_react131.default.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ import_react131.default.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ import_react131.default.createElement(
      SingleForm_default,
      {
        ...{
          allowance,
    ...
    )), /* @__PURE__ */ import_react131.default.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ import_react131.default.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ import_react131.default.createElement(
    ...
    ), /* @__PURE__ */ import_react131.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react131.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react131.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react131.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react131.default.createElement("strong", null, "Network"))))
  );
};

// src/components/KimaTransactionWidget.tsx
var import_react133 = require("@reown/appkit/react");
var KimaTransactionWidget = ({
  ...
  const submitted = (0, import_react_redux49.useSelector)(selectSubmitted);
  const dispatch = (0, import_react_redux49.useDispatch)();
  const { setThemeMode, setThemeVariables } = (0, import_react133.useAppKitTheme)();
  ...
  return submitted ? /* @__PURE__ */ import_react132.default.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ import_react132.default.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
