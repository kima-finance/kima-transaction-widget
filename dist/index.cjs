...
var Bank = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ import_react25.default.createElement(
    ...
    /* @__PURE__ */ import_react25.default.createElement("path", { d: "M6 9.4375V20.4062", stroke: "#86B8CE", "stroke-width": "2" }),
    /* @__PURE__ */ import_react25.default.createElement("path", { d: "M12 9.4375V20.4062", stroke: "#86B8CE", "stroke-width": "2" }),
    /* @__PURE__ */ import_react25.default.createElement("path", { d: "M18 9.4375V20.4062", stroke: "#86B8CE", "stroke-width": "2" }),
    /* @__PURE__ */ import_react25.default.createElement("path", { d: "M24 9.4375V20.4062", stroke: "#86B8CE", "stroke-width": "2" }),
...
var optionSlice = createSlice({
  ...
  reducers: {
    ...
    setCCTransactionRetrying: (state, action) => {
...
// plugins/bank/index.tsx
var import_react62 = __toESM(require("react"), 1);

// plugins/bank/core/hooks/useIsProviderReady.tsx
var import_react_redux19 = require("react-redux");
var import_react61 = require("react");
var useIsProviderReady2 = () => {
  const [isReady, setIsReady] = (0, import_react61.useState)(false);
  ...
  (0, import_react61.useEffect)(() => {
    if (sourceChain.compatibility === "BANK" /* BANK */) {
      logger_default.debug("BANK:useIsProviderReady: dispatching changes from bank...");
      dispatch(setSourceAddress(""));
...
var useIsProviderReady_default2 = useIsProviderReady2;
...
var useNativeBalance2 = () => ({
  balance: BigInt(0),
  decimals: 2
});
var useTokenBalance2 = () => ({
  balance: BigInt(0),
  decimals: 2
});
var useDisconnectWallet5 = () => ({
  disconnectWallet: async () => {
  }
});
var CreditCardPlugin2 = class extends PluginBase {
  constructor(store2) {
    super({
      store: store2,
      id: "BANK",
      compatibility: "BANK" /* BANK */,
      useTokenBalance: useTokenBalance2,
      useNativeBalance: useNativeBalance2,
      useAllowance: useAllowance2,
      useWalletIsReady: useIsProviderReady_default2,
      useDisconnectWallet: useDisconnectWallet5
    });
  }
  isCompatible = (chain) => {
...
var creditCardPlugin2 = new CreditCardPlugin2(store);
var bank_default = creditCardPlugin2;

// plugins/index.ts
initializePlugins([evm_default, solana_default, tron_default, credit_card_default, bank_default]);

// src/KimaProvider.tsx
var import_web310 = require("@solana/web3.js");
var import_ethers5 = require("ethers");
var queryClient = new import_react_query13.QueryClient();
var KimaContext = (0, import_react63.createContext)(void 0);
var useKimaContext = () => {
  const context = (0, import_react63.useContext)(KimaContext);
  if (!context) {
    throw new Error("useKimaContext must be used within a KimaProvider");
  }
  return context;
};
var InternalKimaProvider = React51.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children, logLevel }) => {
    ...
    const plugins = (0, import_react_redux20.useSelector)(selectAllPlugins, (prev, next) => prev === next);
    logger_default.debug("Registered Plugins:", plugins);
    const WrappedProviders = (0, import_react63.useMemo)(() => {
    ...
    return /* @__PURE__ */ React51.createElement(React51.Fragment, null, WrappedProviders);
  }
);
var KimaProvider = ({
  walletConnectProjectId,
  ...
  return /* @__PURE__ */ React51.createElement(import_react_query13.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React51.createElement(import_react_redux20.Provider, { store }, /* @__PURE__ */ React51.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React51.createElement(
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  const theme = (0, import_react_redux21.useSelector)(selectTheme);
  return /* @__PURE__ */ import_react64.default.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ import_react64.default.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ import_react64.default.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ import_react64.default.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ import_react64.default.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ import_react64.default.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react64.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react64.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react64.default.createElement(Check_default, null) : null, /* @__PURE__ */ import_react64.default.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ import_react65.default.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ import_react67.default.createElement(
    ...
    /* @__PURE__ */ import_react67.default.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ import_react67.default.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ import_react69.default.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ import_react69.default.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ import_react69.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react69.default.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ import_react70.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react70.default.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ import_react72.default.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = (0, import_react73.useState)(default_default);
  const isIndexed = (0, import_react_redux25.useSelector)(selectPluginIsIndexed);
  const sourceChain = (0, import_react_redux25.useSelector)(selectSourceChain);
...
var useWidth = () => {
  const [width, setWidth] = (0, import_react74.useState)(0);
...
var import_react78 = require("@reown/appkit/react");

// src/components/reusable/CopyButton.tsx
var import_react75 = __toESM(require("react"), 1);
var CopyButton = ({ text }) => {
  const [copyClicked, setCopyClicked] = (0, import_react75.useState)(false);
  ...
  return /* @__PURE__ */ import_react75.default.createElement(
    ...
    copyClicked ? /* @__PURE__ */ import_react75.default.createElement(Check_default, null) : /* @__PURE__ */ import_react75.default.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({
  ...
  const dispatch = (0, import_react_redux26.useDispatch)();
  const theme = (0, import_react_redux26.useSelector)(selectTheme);
  const mode = (0, import_react_redux26.useSelector)(selectMode);
  const selectedCoin = (0, import_react_redux26.useSelector)(selectSourceCurrency);
  const sourceCompliant = (0, import_react_redux26.useSelector)(selectSourceCompliant);
  const compliantOption = (0, import_react_redux26.useSelector)(selectCompliantOption);
  const selectedNetwork = (0, import_react_redux26.useSelector)(selectSourceChain);
  ...
  const { open } = (0, import_react78.useAppKit)();
  const { open: isModalOpen } = (0, import_react78.useAppKitState)();
  ...
  const errorMessage = (0, import_react77.useMemo)(() => {
  ...
  const isConnected = (0, import_react77.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react77.default.createElement(
    ...
    /* @__PURE__ */ import_react77.default.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ import_react77.default.createElement(
      "button",
      {
      ...
      !isConnected && mode !== "light" /* light */ && !initialSelection && /* @__PURE__ */ import_react77.default.createElement(Wallet_default, null),
      !isConnected && mode !== "light" /* light */ && !initialSelection && "Connect Wallet"
    ), isConnected && !placeholder && /* @__PURE__ */ import_react77.default.createElement(CopyButton_default, { text: connectedAddress })),
    isConnected && !placeholder && balance !== void 0 && decimals !== void 0 ? /* @__PURE__ */ import_react77.default.createElement("p", { className: "balance-info" }, formatUSD(bigIntToNumber({ value: balance, decimals })), " ", selectedCoin, " available") : null
  );
};
...
function useCurrencyOptions(isSourceChain) {
  ...
  const sourceSymbol = (0, import_react_redux27.useSelector)(selectSourceCurrency);
  const targetChain = (0, import_react_redux27.useSelector)(selectTargetChain);
  const transactionOption = (0, import_react_redux27.useSelector)(selectTransactionOption);
  const output = (0, import_react79.useMemo)(() => {
...
function TokenIcon({
  ...
  return /* @__PURE__ */ import_react80.default.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ import_react80.default.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  const [collapsed, setCollapsed] = (0, import_react81.useState)(true);
  const sourceCurrency = (0, import_react_redux29.useSelector)(selectSourceCurrency);
  ...
  const transactionOption = (0, import_react_redux29.useSelector)(selectTransactionOption);
  const targetCurrency = (0, import_react_redux29.useSelector)(selectTargetCurrency);
  ...
  return /* @__PURE__ */ import_react81.default.createElement(
    ...
    /* @__PURE__ */ import_react81.default.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ import_react81.default.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ import_react81.default.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ import_react81.default.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ import_react81.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react81.default.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ import_react81.default.createElement("p", null, token.symbol)
      ))
    ),
    !shouldLockToken && /* @__PURE__ */ import_react81.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react81.default.createElement(Arrow_default, { fill: "none" }))
  );
};
...
function ChainIcon({ symbol }) {
  ...
  if (!Icon) {
    ...
    return /* @__PURE__ */ import_react82.default.createElement("div", null);
  }
  return /* @__PURE__ */ import_react82.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react82.default.createElement(Icon, null));
}
...
var FeeDeductionRadioButtons = ({ disabled }) => {
  ...
  return /* @__PURE__ */ import_react83.default.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ import_react83.default.createElement("div", { className: "fee-options" }, Number(amount) - totalFee > 0 && /* @__PURE__ */ import_react83.default.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ import_react83.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  ), /* @__PURE__ */ import_react83.default.createElement("span", { className: `radio-label ${theme.colorMode}` }, `Pay $${formatterFloat.format(
    Number(amount)
  ...
  )} ${targetCurrency} ${["BANK", "CC"].includes(targetNetwork.shortName) ? "with" : "in"} ${targetNetwork.name}`)), /* @__PURE__ */ import_react83.default.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ import_react83.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({
  ...
  const { transactionValues, sourceFee, targetFee, kimaFee, totalFee } = (0, import_react_redux32.useSelector)(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  ...
  const sourceAddress = (0, import_react_redux32.useSelector)(selectSourceAddress);
  ...
  const signature = (0, import_react_redux32.useSelector)(selectSignature);
  const networkOptions3 = (0, import_react_redux32.useSelector)(selectNetworks);
  const [feeCollapsed, setFeeCollapsed] = (0, import_react84.useState)(true);
  ...
  const targetNetworkOption = (0, import_react84.useMemo)(
  ...
  return /* @__PURE__ */ import_react84.default.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ import_react84.default.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react84.default.createElement("div", null, /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react84.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react84.default.createElement(ChainIcon, { symbol: originNetwork?.shortName }), "FIAT"), /* @__PURE__ */ import_react84.default.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react84.default.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ import_react84.default.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ import_react84.default.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "label" }, "Source", !["BANK", "CC"].includes(originNetwork.shortName) && "wallet", ":"), /* @__PURE__ */ import_react84.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react84.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react84.default.createElement(ChainIcon, { symbol: originNetwork?.shortName }), originNetwork.name)), !["CC", "BANK"].includes(originNetwork.shortName) && /* @__PURE__ */ import_react84.default.createElement("p", { className: theme.colorMode }, dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : connectedAddress))), /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "amount-container" }, dAppOption === "none" /* None */ && /* @__PURE__ */ import_react84.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react84.default.createElement("span", null, "Amount to Transfer "), /* @__PURE__ */ import_react84.default.createElement("div", { className: "coin-details" }, /* @__PURE__ */ import_react84.default.createElement("p", null, formatBigInt(txValues.allowanceAmount), " ", sourceCurrency))), dAppOption === "none" /* None */ && /* @__PURE__ */ import_react84.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react84.default.createElement("span", null, "Total Fees"), /* @__PURE__ */ import_react84.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react84.default.createElement("span", { className: "service-fee" }, formatBigInt(totalFee), " ", sourceCurrency)
  )), /* @__PURE__ */ import_react84.default.createElement("div", { className: `fee-breakdown ${feeCollapsed ? "collapsed" : ""}` }, /* @__PURE__ */ import_react84.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react84.default.createElement("span", null, ["BANK", "CC"].includes(originNetwork.shortName) ? `${originNetwork.name} Processing Fee` : `Source Network Fee (${originNetwork.shortName})`), /* @__PURE__ */ import_react84.default.createElement("span", { className: "service-fee" }, formatBigInt(sourceFee), " ", sourceCurrency)), /* @__PURE__ */ import_react84.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react84.default.createElement("span", null, "Target Network Fee (", targetNetwork.shortName, ")"), /* @__PURE__ */ import_react84.default.createElement("span", { className: "service-fee" }, formatBigInt(targetFee), " ", targetCurrency)), /* @__PURE__ */ import_react84.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react84.default.createElement("span", null, "KIMA Service Fee"), /* @__PURE__ */ import_react84.default.createElement("span", { className: "service-fee" }, formatBigInt(kimaFee), " ", sourceCurrency))), /* @__PURE__ */ import_react84.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react84.default.createElement("span", null, "Target Transfer Amount"), /* @__PURE__ */ import_react84.default.createElement("span", { className: "service-fee" }, formatBigInt(txValues.submitAmount), " ", targetCurrency)))), targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react84.default.createElement("div", null, /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react84.default.createElement("p", null, bankDetails.iban), /* @__PURE__ */ import_react84.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react84.default.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), "FIAT")), /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react84.default.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ import_react84.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ import_react84.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react84.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react84.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react84.default.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), targetNetworkOption?.name)), /* @__PURE__ */ import_react84.default.createElement("p", { className: theme.colorMode }, mode === "light" /* light */ ? targetNetwork.shortName === "SOL" ? lightDemoAccounts.SOL : targetNetwork.shortName === "TRX" ? lightDemoAccounts.TRX : lightDemoAccounts.EVM : dAppOption === "LPDrain" /* LPDrain */ ? connectedAddress : targetAddress))), mode === "bridge" /* bridge */ && BigInt(totalFee.value) > BigInt(0) ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ import_react84.default.createElement(FeeDeductionRadioButtons_default, { disabled: feeOptionDisabled })
  ) : null);
};
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  const sourceChain = (0, import_react87.useMemo)(() => {
    const sourceKey = data?.sourceChain === "FIAT" ? "CC" : data?.sourceChain;
    return networks.find((network) => network.shortName === sourceKey);
  }, [data, networks]);
  const targetChain = (0, import_react87.useMemo)(
    () => networks.find((network) => network.shortName === data?.targetChain),
    [data, networks]
  );
  return /* @__PURE__ */ import_react87.default.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ import_react87.default.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ import_react87.default.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ import_react87.default.createElement(
    "div",
    {
      className: `info-item
    ...
    /* @__PURE__ */ import_react87.default.createElement("div", { className: "info-icon" }, step < index && /* @__PURE__ */ import_react87.default.createElement(Lock_default, { width: 24, height: 24 }), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react87.default.createElement(Loader_default, { width: 24, height: 24, className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react87.default.createElement(Warning_default, { width: 24, height: 24 }) : /* @__PURE__ */ import_react87.default.createElement(Check_default, { width: 24, height: 24 }) : null),
    /* @__PURE__ */ import_react87.default.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ import_react87.default.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ import_react87.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react87.default.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ import_react87.default.createElement("p", { className: "chain-name" }, "Kima TX Hash:"), /* @__PURE__ */ import_react87.default.createElement("p", null, /* @__PURE__ */ import_react87.default.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ import_react87.default.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash && sourceChain?.shortName !== "CC" ? /* @__PURE__ */ import_react87.default.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ import_react87.default.createElement(ChainIcon, { symbol: data.sourceChain }),
    /* @__PURE__ */ import_react87.default.createElement("p", { className: "chain-name" }, windowWidth >= 770 ? sourceChain?.name : sourceChain?.shortName, " ", "TX Hash:"),
    /* @__PURE__ */ import_react87.default.createElement("p", null, /* @__PURE__ */ import_react87.default.createElement(
      ExternalLink_default,
      {
    ...
    ), /* @__PURE__ */ import_react87.default.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ import_react87.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react87.default.createElement(ChainIcon, { symbol: data.sourceChain }), /* @__PURE__ */ import_react87.default.createElement("p", { className: "chain-name" }, windowWidth >= 770 ? sourceChain?.name : sourceChain?.shortName, " ", "TX Hash:"), /* @__PURE__ */ import_react87.default.createElement("p", null, /* @__PURE__ */ import_react87.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react87.default.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ import_react87.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react87.default.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ import_react87.default.createElement("p", { className: "chain-name" }, windowWidth >= 770 ? targetChain?.name : targetChain?.shortName, " ", "TX Hash:"), /* @__PURE__ */ import_react87.default.createElement("p", null, /* @__PURE__ */ import_react87.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react87.default.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  const bankDetails = (0, import_react_redux37.useSelector)(selectBankDetails);
  return /* @__PURE__ */ import_react88.default.createElement("div", { className: "bank-input" }, /* @__PURE__ */ import_react88.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react88.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react88.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react88.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react88.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react88.default.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TxButton = ({ theme }) => {
  ...
  const txCount = (0, import_react_redux39.useSelector)(selectPendingTxs);
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ import_react91.default.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ import_react91.default.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ import_react91.default.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ import_react91.default.createElement("h3", null, transactionId), /* @__PURE__ */ import_react91.default.createElement(CopyButton_default, { text: transactionId })));
};
...
var TransactionSearch = () => {
  ...
  const backendUrl = (0, import_react_redux40.useSelector)(selectBackendUrl);
  const dispatch = (0, import_react_redux41.useDispatch)();
  const [transactionId, setTransactionId] = (0, import_react92.useState)("");
  const refPollForUpdates = (0, import_react92.useRef)(false);
  const handleSearch = async () => {
    if (transactionId.length <= 0)
      return import_react_hot_toast2.default.error("You must provide a valid transaction id", {
        icon: /* @__PURE__ */ import_react92.default.createElement(Error_default, null)
      });
    try {
  ...
  return /* @__PURE__ */ import_react92.default.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ import_react92.default.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ import_react92.default.createElement("span", { className: "label" }, "Search Transaction:"), /* @__PURE__ */ import_react92.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react92.default.createElement(SecondaryButton_default, { clickHandler: handleSearch }, "Search"));
};
var TransactionSearch_default = TransactionSearch;

// src/components/TransactionWidget.tsx
var TransactionWidget = ({ theme }) => {
  const [step, setStep] = (0, import_react93.useState)(0);
  const [focus, setFocus] = (0, import_react93.useState)(-1);
  const [errorStep, setErrorStep] = (0, import_react93.useState)(-1);
  const [errorMessage, setErrorMessage] = (0, import_react93.useState)("");
  const [loadingStep, setLoadingStep] = (0, import_react93.useState)(-1);
  const [minimized, setMinimized] = (0, import_react93.useState)(false);
  const [isComplete, setIsComplete] = (0, import_react93.useState)(false);
  const dispatch = (0, import_react_redux44.useDispatch)();
  const explorerUrl = (0, import_react_redux43.useSelector)(selectKimaExplorer);
  ...
  const txId = (0, import_react_redux43.useSelector)(selectTxId);
  const dAppOption = (0, import_react_redux43.useSelector)(selectDappOption);
  const { transactionValues } = (0, import_react_redux43.useSelector)(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const transactionOption = (0, import_react_redux43.useSelector)(selectTransactionOption);
  const sourceChain = (0, import_react_redux43.useSelector)(selectSourceChain);
  const targetChain = (0, import_react_redux43.useSelector)(selectTargetChain);
  const sourceSymbol = (0, import_react_redux43.useSelector)(selectSourceCurrency);
  const targetSymbol = (0, import_react_redux43.useSelector)(selectTargetCurrency);
  const networks = (0, import_react_redux43.useSelector)(selectNetworks);
  ...
  const transactionSourceChain = (0, import_react93.useMemo)(
    () => networks.find(
  ...
  (0, import_react93.useEffect)(() => {
    if (error)
      import_react_hot_toast3.toast.error(
        ...
        {
          icon: /* @__PURE__ */ import_react93.default.createElement(Error_default, null)
        }
      );
  }, [error]);
  (0, import_react93.useEffect)(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      import_react_hot_toast3.toast.error("Unavailable", { icon: /* @__PURE__ */ import_react93.default.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      logger_default.error("transaction failed:", data.failReason);
      import_react_hot_toast3.toast.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ import_react93.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react93.default.createElement(import_react_redux42.Provider, { store }, /* @__PURE__ */ import_react93.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react93.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react93.default.createElement("div", { className: "topbar" }, !isComplete && /* @__PURE__ */ import_react93.default.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ import_react93.default.createElement("div", { className: "transaction-title" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "Transferred " : "Transfering " : isEmptyStatus ? "Fetching transaction status " : data?.status === "Completed" /* COMPLETED */ ? "Transferred " : "Transfering ", mode !== "status" /* status */ ? Number(amount) !== 0 ? transactionSourceChain?.shortName === "CC" ? bigIntToNumber(txValues.allowanceAmount).toFixed(2) : formatBigInt(txValues.allowanceAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `${sourceSymbol} ` : isEmptyStatus ? "" : `${data?.sourceSymbol}`, mode !== "status" /* status */ ? `\u2192 ` : isEmptyStatus ? "" : `\u2192 `, mode !== "status" /* status */ ? Number(amount) !== 0 ? transactionSourceChain?.shortName === "CC" ? bigIntToNumber(txValues.submitAmount).toFixed(2) : formatBigInt(txValues.submitAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `${targetSymbol}${" "}` : isEmptyStatus ? "" : `${data?.targetSymbol}${" "}`) : /* @__PURE__ */ import_react93.default.createElement("div", null, /* @__PURE__ */ import_react93.default.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ import_react93.default.createElement(
      "div",
      {
        className: `control-buttons ${isComplete ? "complete" : ""}`
      },
      isComplete && /* @__PURE__ */ import_react93.default.createElement(
        "button",
        {
      ...
      /* @__PURE__ */ import_react93.default.createElement(
        ...
        /* @__PURE__ */ import_react93.default.createElement(Minimize_default, null)
      ),
      !isValidTxId || loadingStep < 0 || error && dAppOption !== "none" /* None */ ? /* @__PURE__ */ import_react93.default.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null,
      closeHandler && /* @__PURE__ */ import_react93.default.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ import_react93.default.createElement(Cross_default, null)
      )
    ) : /* @__PURE__ */ import_react93.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react93.default.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View"))), data && !isComplete && /* @__PURE__ */ import_react93.default.createElement("div", { className: "header-network-labels" }, /* @__PURE__ */ import_react93.default.createElement("div", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react93.default.createElement(
      ChainIcon,
      {
        symbol: transactionSourceChain?.shortName
      }
    ), windowWidth > 450 && /* @__PURE__ */ import_react93.default.createElement("h3", null, transactionSourceChain?.name)), /* @__PURE__ */ import_react93.default.createElement(
      "div",
      {
        style: { display: "inline-block", transform: "rotate(-90deg)" }
      },
      /* @__PURE__ */ import_react93.default.createElement(Arrow_default, { width: 25, height: 25 })
    ), /* @__PURE__ */ import_react93.default.createElement("div", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react93.default.createElement(
      ChainIcon,
      {
        symbol: transactionTargetChain?.shortName
      }
    ), windowWidth > 450 && /* @__PURE__ */ import_react93.default.createElement("h3", null, transactionTargetChain?.name)))),
    isValidTxId && !error ? /* @__PURE__ */ import_react93.default.createElement("div", { className: "kima-card-content" }, !isComplete ? /* @__PURE__ */ import_react93.default.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ import_react93.default.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )) : /* @__PURE__ */ import_react93.default.createElement("div", { className: "transaction-content transaction-complete" }, /* @__PURE__ */ import_react93.default.createElement(TransactionComplete_default, null), /* @__PURE__ */ import_react93.default.createElement("h2", null, "Transaction Complete"), /* @__PURE__ */ import_react93.default.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ import_react93.default.createElement(
      "div",
      {
        className: `content-wrapper transaction-complete ${theme.colorMode}`
      },
      /* @__PURE__ */ import_react93.default.createElement("p", null, "You just transferred ", data?.amount, " ", data?.sourceSymbol),
      /* @__PURE__ */ import_react93.default.createElement("div", { className: "header-network-labels" }, /* @__PURE__ */ import_react93.default.createElement(
        "div",
        {
        ...
        windowWidth > 450 && /* @__PURE__ */ import_react93.default.createElement("h3", null, transactionSourceChain?.name)
      ), /* @__PURE__ */ import_react93.default.createElement(
        "div",
        {
          style: {
    ...
    )), /* @__PURE__ */ import_react93.default.createElement("div", { className: "transaction-buttons" }, /* @__PURE__ */ import_react93.default.createElement(
      ...
      /* @__PURE__ */ import_react93.default.createElement(PrimaryButton_default, null, "View Details")
    ))), !error && !isEmptyStatus && !isComplete && /* @__PURE__ */ import_react93.default.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ import_react93.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react93.default.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ import_react93.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react93.default.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ import_react93.default.createElement(
    ...
    /* @__PURE__ */ import_react93.default.createElement(
      ...
      /* @__PURE__ */ import_react93.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react93.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react93.default.createElement(KimaNetwork_default, null))
    )
  ));
};
...
var NetworkSelector = ({
  ...
  const [collapsed, setCollapsed] = (0, import_react94.useState)(true);
  ...
  const networkOptions3 = (0, import_react_redux45.useSelector)(selectNetworks);
  const transactionOption = (0, import_react_redux45.useSelector)(selectTransactionOption);
  ...
  const sourceSymbol = (0, import_react_redux45.useSelector)(selectSourceCurrency);
  ...
  const networks = (0, import_react94.useMemo)(() => {
  ...
  const selectedNetwork = (0, import_react94.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react94.default.createElement(
    ...
    /* @__PURE__ */ import_react94.default.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ import_react94.default.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ import_react94.default.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ import_react94.default.createElement(
      ...
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ import_react94.default.createElement(
        "div",
        {
          key: network.id,
        ...
        network.disabled ? /* @__PURE__ */ import_react94.default.createElement(Warning_default, { width: 25, height: 25 }) : /* @__PURE__ */ import_react94.default.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ import_react94.default.createElement("p", null, network.name),
        network.disabled && /* @__PURE__ */ import_react94.default.createElement("span", { className: "tooltip" }, "Temporarily unavailable")
      ))
    ),
    !shouldLockSourceNetwork && /* @__PURE__ */ import_react94.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react94.default.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = import_react94.default.memo(NetworkSelector);
...
var useGetFees = ({
  ...
  return (0, import_react_query15.useQuery)({
    ...
    enabled: !!backendUrl && !!amount && !!sourceNetwork && !!sourceSymbol && !!targetNetwork && !!targetAddress && !!targetSymbol && (["BANK", "CC"].includes(sourceNetwork) ? sourceAddress === "" || sourceAddress === null : !!sourceAddress),
...
var SingleForm = ({
  ...
  const [amountValue, setAmountValue] = (0, import_react95.useState)("");
  ...
  const { kimaBackendUrl } = useKimaContext();
  const { data: envOptions } = useGetEnvOptions({ kimaBackendUrl });
  const errorMessage = (0, import_react95.useMemo)(
  ...
  const maxValue = (0, import_react95.useMemo)(() => {
    if (mode === "light" /* light */)
      return BigInt(
  ...
  const feeCurrency = (0, import_react95.useMemo)(() => {
    const sourceToken = sourceNetwork.supportedTokens.find(
  ...
  const isConnected = (0, import_react95.useMemo)(() => {
    if (mode === "payment" /* payment */ && dAppOption !== "none" /* None */) {
      return isReady;
    }
    return isReady && !initialSelection.sourceSelection;
  }, [isReady, initialSelection, mode, dAppOption]);
  return /* @__PURE__ */ import_react95.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react95.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react95.default.createElement("span", { className: "label" }, dAppOption === "none" /* None */ && "Source", " Network:"), /* @__PURE__ */ import_react95.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react95.default.createElement(
  ...
  ), /* @__PURE__ */ import_react95.default.createElement(CoinDropdown_default, { isSourceChain: true }))), /* @__PURE__ */ import_react95.default.createElement(
    "div",
    {
    ...
    !["CC" /* CC */, "BANK" /* BANK */].includes(
      ...
      /* @__PURE__ */ import_react95.default.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ import_react95.default.createElement(WalletButton_default, { initialSelection: initialSelection.sourceSelection })
    ),
    mode !== "payment" /* payment */ && /* @__PURE__ */ import_react95.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react95.default.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ import_react95.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react95.default.createElement(
      NetworkSelector_default,
      {
        type: "target",
        ...{
    ...
    ), /* @__PURE__ */ import_react95.default.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react95.default.createElement(BankInput_default, null) : /* @__PURE__ */ import_react95.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react95.default.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ import_react95.default.createElement(
  ...
  )) : null, mode === "light" /* light */ && /* @__PURE__ */ import_react95.default.createElement(
    "div",
    {
      className: `form-item wallet-button-item ${!initialSelection.targetSelection && "connected"}`,
      style: { display: "flex", alignItems: "center" }
    },
    /* @__PURE__ */ import_react95.default.createElement("span", { className: "label" }, "Target Wallet:"),
    /* @__PURE__ */ import_react95.default.createElement(
  ...
  ), /* @__PURE__ */ import_react95.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react95.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react95.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react95.default.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "text",
  ...
  ), /* @__PURE__ */ import_react95.default.createElement("div", { className: "max-disclaimer" }, sourceNetwork.shortName !== "CC" && mode !== "payment" /* payment */ && /* @__PURE__ */ import_react95.default.createElement("span", { className: "max-button", onClick: onMaxClick }, "Max"), +totalFee !== -1 && dAppOption === "none" /* None */ && !initialSelection.sourceSelection && !initialSelection.targetSelection && /* @__PURE__ */ import_react95.default.createElement("p", { className: "fee-amount" }, "Est fees:", " ", /* @__PURE__ */ import_react95.default.createElement("span", { className: `${isLoadingFees ? "loading" : ""}` }, " ", isLoadingFees ? "" : `$ ${formatBigInt(totalFee)} ${feeCurrency}`))))));
};
...
var SolanaWalletSelect = () => {
  ...
  const handleWalletClick = (0, import_react96.useCallback)(
    (walletName) => {
      logger_default.debug(
  ...
  return /* @__PURE__ */ import_react96.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react96.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react96.default.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ import_react96.default.createElement(
    ...
    /* @__PURE__ */ import_react96.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react96.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react96.default.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ import_react96.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react96.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react96.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react96.default.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react98.default.createElement("div", null, /* @__PURE__ */ import_react98.default.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ import_react98.default.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ import_react98.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react98.default.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
var AccountDetailsModal2 = () => {
  ...
  const networkDetails = (0, import_react99.useMemo)(
    () => networkOptions.find(({ id }) => id === selectedNetwork.shortName),
    [selectedNetwork]
  );
  const explorerUrl = (0, import_react99.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react99.default.createElement(
    ...
    )))), /* @__PURE__ */ import_react99.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react99.default.createElement("div", { className: "summary" }, networkDetails && /* @__PURE__ */ import_react99.default.createElement(networkDetails.icon, { width: 60, height: 60 }), /* @__PURE__ */ import_react99.default.createElement("div", { className: "address" }, /* @__PURE__ */ import_react99.default.createElement("h2", null, getShortenedAddress(connectedAddress || "")), /* @__PURE__ */ import_react99.default.createElement(CopyButton_default, { text: connectedAddress })), /* @__PURE__ */ import_react99.default.createElement("h3", null, formatterFloat.format(Number(tronBalance)), " ", selectedNetwork.shortName)), /* @__PURE__ */ import_react99.default.createElement(SecondaryButton_default, { className: "block-explorer" }, /* @__PURE__ */ import_react99.default.createElement(ExternalLink_default, { className: "link", to: explorerUrl }, /* @__PURE__ */ import_react99.default.createElement(Explorer_default, { fill: "#778DA3" }), /* @__PURE__ */ import_react99.default.createElement("p", null, "Block explorer"), /* @__PURE__ */ import_react99.default.createElement(ExternalUrl_default, { fill: "#778DA3" }))), /* @__PURE__ */ import_react99.default.createElement(PrimaryButton_default, { clickHandler: handleDisconnect }, "Disconnect")))
  );
};
...
var TronWalletSelect = () => {
  ...
  const sliderRef = (0, import_react100.useRef)();
  ...
  const [detected, undetected] = (0, import_react100.useMemo)(() => {
    const detected2 = [];
    const undetected2 = [];
  ...
  return /* @__PURE__ */ import_react100.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react100.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react100.default.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ import_react100.default.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ import_react100.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react100.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react100.default.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ import_react100.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react100.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react100.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react100.default.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react101.default.createElement("div", null, /* @__PURE__ */ import_react101.default.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ import_react101.default.createElement(
    "div",
    {
      className: `kima-modal wallet-connect ${theme.colorMode} ${connectModal ? "open" : ""}`
    },
    /* @__PURE__ */ import_react101.default.createElement("div", { className: "modal-overlay" }),
    /* @__PURE__ */ import_react101.default.createElement("div", { className: `modal-content-container ${theme.colorMode}` }, /* @__PURE__ */ import_react101.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react101.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react101.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react101.default.createElement("h3", null, "Connect Wallet")), /* @__PURE__ */ import_react101.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react101.default.createElement(
      "button",
      {
    ...
    )))), /* @__PURE__ */ import_react101.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react101.default.createElement(TronWalletSelect_default, null)))
  ));
};
...
var useValidateTransaction = (inputs) => {
  ...
  const maxValue = (0, import_react102.useMemo)(() => {
  ...
  const validate = (isSubmitting = false) => {
    ...
    if (!sourceAddress && !["BANK", "CC"].includes(sourceChain) && mode !== "light" /* light */) {
      return {
        error: "ValidationError" /* Error */,
...
var WarningModal = ({
  ...
  return /* @__PURE__ */ import_react103.default.createElement("div", { className: "warning-modal-overlay" }, /* @__PURE__ */ import_react103.default.createElement("div", { className: "warning-modal" }, /* @__PURE__ */ import_react103.default.createElement("h3", null, "Warning"), /* @__PURE__ */ import_react103.default.createElement("p", null, message), /* @__PURE__ */ import_react103.default.createElement("div", { className: "warning-modal-buttons" }, /* @__PURE__ */ import_react103.default.createElement(
    SecondaryButton_default,
    {
...
var CCWidget = ({ submitCallback }) => {
  ...
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const allowanceAmount = (0, import_react104.useMemo)(
    () => formatBigInt(txValues.allowanceAmount),
    [txValues]
  );
  ...
  return /* @__PURE__ */ import_react104.default.createElement("div", { className: `cc-widget ${isLoading ? "loading" : ""}` }, (isLoading || isTransactionIdLoading || isEnvLoading || ccTransactionStatus === "success") && /* @__PURE__ */ import_react104.default.createElement("div", { className: "cc-widget-loader" }, /* @__PURE__ */ import_react104.default.createElement(ring_default, { width: 50, height: 50, fill: "#86b8ce" })), /* @__PURE__ */ import_react104.default.createElement(
    "iframe",
    {
...
var TransferWidget = ({
  ...
  const mainRef = (0, import_react105.useRef)(null);
  const [signature, setSignature2] = (0, import_react105.useState)("");
  const [isSubmitting, setIsSubmitting] = (0, import_react105.useState)(false);
  const [formStep, setFormStep] = (0, import_react105.useState)(0);
  const [warningModalOpen, setWarningModalOpen] = (0, import_react105.useState)(null);
  const [resetModalOpen, setResetModalOpen] = (0, import_react105.useState)(false);
  ...
  const [isCancellingApprove, setCancellingApprove] = (0, import_react105.useState)(false);
  const [isApproving, setApproving] = (0, import_react105.useState)(false);
  const [isSigning, setSigning] = (0, import_react105.useState)(false);
  const [feeOptionDisabled, setFeeOptionDisabled] = (0, import_react105.useState)(false);
  const [initialSelection, setInitialSelection] = (0, import_react105.useState)({
  ...
  const { width: windowWidth } = useWidth_default();
  const { disconnectWallet } = useDisconnectWallet6();
  const { submitTransaction } = useSubmitTransaction_default(
    isSubmitting,
    setIsSubmitting
  );
  const { allowance, balance, isApproved, approve, decimals, signMessage } = useAllowance3({
    setApproving,
    setCancellingApprove
  });
  ...
  const isBackButtonEnabled = (0, import_react105.useMemo)(() => {
    if (formStep !== 0) {
  ...
  const isSubmitButtonEnabled = (0, import_react105.useMemo)(() => {
  ...
  const submit = (0, import_react105.useCallback)(async () => {
    try {
      await submitTransaction(signature);
    } catch (err) {
      import_react_hot_toast5.toast.error("Failed to submit transaction", { icon: /* @__PURE__ */ import_react105.default.createElement(Error_default, null) });
      dispatch(setCCTransactionStatus("error-generic"));
    }
  ...
  const handleSubmit = async () => {
    ...
    if (error2 === "ValidationError" /* Error */) {
      return import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react105.default.createElement(Error_default, null) });
    }
    if (["BANK", "CC"].includes(sourceChain.shortName)) {
  ...
  const onNext = () => {
    ...
    import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react105.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react105.default.createElement(
    ...
    resetModalOpen && /* @__PURE__ */ import_react105.default.createElement(
    ...
    warningModalOpen && /* @__PURE__ */ import_react105.default.createElement(
      WarningModal_default,
      {
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ import_react105.default.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ import_react105.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react105.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react105.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react105.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react105.default.createElement("h3", { style: { marginRight: "5px" } }, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ import_react105.default.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ import_react105.default.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ import_react105.default.createElement(
      ExternalLink_default,
      {
      ...
      /* @__PURE__ */ import_react105.default.createElement("div", { className: "menu-button" }, "I need help")
    ), ["BANK", "CC"].includes(sourceChain.shortName) && formStep > 0 && /* @__PURE__ */ import_react105.default.createElement(ExternalLink_default, { to: "https://docs.kima.network/kima-network/supported-fiat#unsupported-countries-credit-cards" }, /* @__PURE__ */ import_react105.default.createElement("div", { className: "menu-button" }, "Unsupported Countries")), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ import_react105.default.createElement(
      "button",
      {
      ...
      "Reset"
    ), closeHandler && /* @__PURE__ */ import_react105.default.createElement(
      "button",
      {
        className: "cross-icon-button",
        onClick: () => {
      ...
      /* @__PURE__ */ import_react105.default.createElement(Cross_default, null)
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ import_react105.default.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ import_react105.default.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ import_react105.default.createElement(
      SingleForm_default,
      {
        ...{
    ...
    ) : ccTransactionStatus !== "idle" ? /* @__PURE__ */ import_react105.default.createElement(CCWidget_default, { submitCallback: submit }) : /* @__PURE__ */ import_react105.default.createElement(
      ...
      /* @__PURE__ */ import_react105.default.createElement("div", { className: `button-group` }, isBackButtonEnabled && /* @__PURE__ */ import_react105.default.createElement(
        SecondaryButton_default,
        {
          clickHandler: onBack,
          theme: theme.colorMode,
      ...
      ), !!allowance && allowance > 0 && formStep !== 0 && ["BANK", "CC"].includes(sourceChain.shortName) && mode !== "light" /* light */ && dAppOption !== "LPDrain" /* LPDrain */ ? /* @__PURE__ */ import_react105.default.createElement(
        SecondaryButton_default,
        {
      ...
      ) : null, isSubmitButtonEnabled && /* @__PURE__ */ import_react105.default.createElement(
        PrimaryButton_default,
        {
          clickHandler: onNext,
    ...
    ), /* @__PURE__ */ import_react105.default.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ import_react105.default.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ import_react105.default.createElement(
    ...
    ), /* @__PURE__ */ import_react105.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react105.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react105.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react105.default.createElement(KimaNetwork_default, null))))
  );
};

// src/components/KimaWidgetWrapper.tsx
var import_react109 = require("@reown/appkit/react");

// src/hooks/useDebugMode.ts
var import_react106 = require("react");
var useDebugCode = (sequence = ["D", "E", "B", "U", "G"]) => {
  const [debugMode, setDebugMode] = (0, import_react106.useState)(false);
  const [, setInputSequence] = (0, import_react106.useState)([]);
...
var ErrorWidget = ({
  ...
  const ccTransactionId = (0, import_react_redux58.useSelector)(selectCCTransactionId);
  const isCreditCardSource = sourceChain.shortName === "CC";
  const isRetrying = (0, import_react_redux58.useSelector)(selectCCTransactionRetrying);
  return /* @__PURE__ */ import_react107.default.createElement(
    ...
    /* @__PURE__ */ import_react107.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react107.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react107.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react107.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react107.default.createElement("h3", null, title))), /* @__PURE__ */ import_react107.default.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ import_react107.default.createElement("div", { className: "kima-card-content error" }, isCreditCardSource && !isRetrying && /* @__PURE__ */ import_react107.default.createElement(Error_default, { width: 40, height: 40 }), message && message !== "" && /* @__PURE__ */ import_react107.default.createElement("h2", null, message), isCreditCardSource && /* @__PURE__ */ import_react107.default.createElement(
      "div",
      {
        style: {
          marginTop: 16,
      ...
      ccTransactionId && /* @__PURE__ */ import_react107.default.createElement(
        ...
        /* @__PURE__ */ import_react107.default.createElement(CopyButton_default, { text: ccTransactionId })
      ),
      isRetrying && /* @__PURE__ */ import_react107.default.createElement(ring_default, { width: 30, height: 30, fill: "#86b8ce" })
    )), backButtonEnabled && /* @__PURE__ */ import_react107.default.createElement(
      "div",
      {
        style: {
          display: "flex",
      ...
      /* @__PURE__ */ import_react107.default.createElement(PrimaryButton_default, { clickHandler: backButtonFunction }, "Back")
    ), /* @__PURE__ */ import_react107.default.createElement("div", { className: "kima-card-footer" }), /* @__PURE__ */ import_react107.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react107.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react107.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react107.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react107.default.createElement("strong", null, "Network"))))
  );
};
...
var KimaWidgetWrapper = ({
  ...
  useDebugCode();
  const { kimaBackendUrl } = useKimaContext();
  const submitted = (0, import_react_redux59.useSelector)(selectSubmitted);
  const dispatch = (0, import_react_redux59.useDispatch)();
  const { setThemeMode, setThemeVariables } = (0, import_react109.useAppKitTheme)();
  const sourceChain = (0, import_react_redux59.useSelector)(selectSourceChain);
  const ccTransactionStatus = (0, import_react_redux59.useSelector)(selectCCTransactionStatus);
  const ccTransactionRetrying = (0, import_react_redux59.useSelector)(selectCCTransactionRetrying);
  ...
  if (sourceChain.shortName === "CC") {
    ...
    if (submitted) {
      ...
      return /* @__PURE__ */ import_react108.default.createElement(TransactionWidget, { theme });
  ...
  return submitted ? /* @__PURE__ */ import_react108.default.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ import_react108.default.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
...
var SkeletonLoader = ({ theme }) => {
  ...
  return /* @__PURE__ */ import_react110.default.createElement(
    ...
    /* @__PURE__ */ import_react110.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react110.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react110.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react110.default.createElement("div", { className: "title skeleton" }, /* @__PURE__ */ import_react110.default.createElement("h3", null)), /* @__PURE__ */ import_react110.default.createElement("div", { className: "control-buttons" }, closeHandler && /* @__PURE__ */ import_react110.default.createElement(
      "button",
      {
        className: "cross-icon-button",
        onClick: () => {
      ...
      /* @__PURE__ */ import_react110.default.createElement(Cross_default, null)
    ))), /* @__PURE__ */ import_react110.default.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ import_react110.default.createElement("div", { className: "kima-card-content skeleton" }, /* @__PURE__ */ import_react110.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react110.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react110.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react110.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react110.default.createElement("div", { className: "skeleton" })), /* @__PURE__ */ import_react110.default.createElement("div", { className: `kima-card-footer` }, /* @__PURE__ */ import_react110.default.createElement("div", { className: `button-group skeleton` }, /* @__PURE__ */ import_react110.default.createElement("div", { className: "skeleton" }))), /* @__PURE__ */ import_react110.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react110.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react110.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react110.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react110.default.createElement("strong", null, "Network"))))
  );
};
...
var KimaTransactionWidget = ({
  ...
  const { kimaBackendUrl } = useKimaContext();
  const [hydrated, setHydrated] = (0, import_react111.useState)(false);
  const {
    data: envOptions,
  ...
  if (!hydrated || !theme?.colorMode)
    return /* @__PURE__ */ import_react111.default.createElement(ring_default, { width: 20, height: 20, fill: "#86b8ce" });
  if (isLoadingEnvs || isLoadingChainData)
    return /* @__PURE__ */ import_react111.default.createElement(SkeletonLoader_default, { theme });
