...
var CHAIN_NAMES_TO_APPKIT_NETWORK_TESTNET = {
  ...
  ["BERA" /* BERA */]: import_networks.berachainTestnetbArtio
};
...
var optionSlice = createSlice({
  ...
  reducers: {
    ...
    setCCWidgetProcessed: (state, action) => {
...
var import_react38 = require("@reown/appkit/react");
...
var appkitTestnetChains = [
  ...
  import_networks2.berachainTestnetbArtio
];
var metadata = {
...
var setupAppKit = (projectId, networkOption) => {
  ...
  appKitModel = (0, import_react38.createAppKit)({
...
var selectCCWidgetProcessed = (state) => state.option.ccWidgetProcessed;
...
var getEvmTokenBalance = async (input) => {
  ...
  return {
    balance: Number((0, import_ethers.formatUnits)(userBalance, decimals)),
...
function useBalance() {
  ...
  const tokenAddress = (0, import_react74.useMemo)(() => {
  ...
  const enabled = !!tokenAddress && !!walletAddress && isEVMChain(sourceChain.shortName) && (!!walletProvider || !!externalProvider);
...
var getEvmBalance = async (input) => {
  ...
  try {
    ...
    return {
      balance: Number((0, import_ethers2.formatEther)(balance)),
...
var useNativeEvmBalance = () => {
  ...
  const { walletProvider } = (0, import_react76.useAppKitProvider)("eip155");
...
var useChainData = (backendURL, chainName) => {
  ...
  const ouput = (0, import_react_query4.useQuery)({
    queryKey: ["chainData"],
    queryFn: async () => {
      try {
...
function useIsWalletReady() {
  ...
  const { walletProvider: appkitProvider } = (0, import_react78.useAppKitProvider)("eip155");
  const appkitAccountInfo = (0, import_react78.useAppKitAccount)();
  const { chainId: walletChainId } = (0, import_react78.useAppKitNetwork)();
  ...
  (0, import_react77.useEffect)(() => {
    async function checkChainId() {
      ...
      if (!externalProvider && sourceChain.compatibility === "EVM" /* EVM */) {
...
var useGetPools = (backendUrl, networkOption) => {
  const { data, error, isLoading } = (0, import_react_query5.useQuery)({
...
var preciseSubtraction = (a, b, decimals = 18) => {
  const numA = (0, import_ethers4.parseUnits)(a.toString(), decimals);
  const numB = (0, import_ethers4.parseUnits)(b.toString(), decimals);
  const result = numA - numB;
  return parseFloat((0, import_ethers4.formatUnits)(result, decimals));
};
var isValidExternalProvider = (externalProvider) => {
  const { type, provider, signer } = externalProvider;
  if (type === "evm") {
    if (!(provider instanceof import_ethers4.BrowserProvider) || !(signer instanceof import_ethers4.JsonRpcSigner))
      return false;
  }
  if (type === "solana") {
...
var getTokenAllowance = async ({
  ...
  try {
    ...
    const erc20Contract = (0, import_viem4.getContract)({
      address: tokenAddress,
...
function useEvmAllowance() {
  const { externalProvider } = useKimaContext();
  const { walletProvider: appkitProvider } = (0, import_react80.useAppKitProvider)("eip155");
  const appkitAccountInfo = (0, import_react80.useAppKitAccount)();
  ...
  const [approvalsCount, setApprovalsCount] = (0, import_react79.useState)(0);
  ...
  logger_default.debug("evm allowance: enabled: ", enabled);
  const {
    data: allowanceData,
    isLoading,
    refetch
    ...
    queryKey,
    queryFn: async () => await getTokenAllowance({
      tokenOptions,
      selectedCoin,
  ...
  const approveErc20TokenTransfer = async (isCancel = false) => {
    ...
    try {
      const viemClient = (0, import_viem5.createPublicClient)({
        chain: sourceChain,
      ...
      const finalAmount = isCancel ? BigInt(0) : feeDeduct ? (0, import_viem5.parseUnits)(amount, allowanceData.decimals) : (0, import_viem5.parseUnits)(
...
function useDisconnectWallet() {
  const { disconnect } = (0, import_react81.useDisconnect)();
...
var WalletProvider2 = ({
  ...
  return /* @__PURE__ */ import_react83.default.createElement(import_wallet_adapter_react.ConnectionProvider, { endpoint }, /* @__PURE__ */ import_react83.default.createElement(
...
function useSolanaAllowance() {
  ...
  const { pools } = useGetPools_default(backendUrl, networkOption);
  const [approvalsCount, setApprovalsCount] = (0, import_react84.useState)(0);
  ...
  const approveSPLTokenTransfer = async (isCancel = false) => {
    ...
    try {
      ...
      const transaction = new import_web38.Transaction().add(approveInstruction);
...
var WalletProvider3 = ({ children, networkOption }) => {
  const adapters = (0, import_react87.useMemo)(
    () => [
...
function useGetTronBalance() {
  ...
  const result = (0, import_react_query9.useQuery)({
...
function useTronAllowance() {
  ...
  const [approvalsCount, setApprovalsCount] = (0, import_react89.useState)(0);
  ...
  const tronWeb = (0, import_react89.useMemo)(() => {
    if (isTronProvider2)
...
function useIsWalletReady3() {
  ...
  return (0, import_react90.useMemo)(() => {
    ...
    if (internalTronAddress)
      return createWalletStatus2(true, void 0, internalTronAddress);
    return createWalletStatus2(false, "Solana wallet not connected", "");
...
var useIsProviderReady = () => {
  const [isReady, setIsReady] = (0, import_react92.useState)(false);
...
var CreditCardPlugin = class extends PluginBase {
  ...
  Provider = ({ children }) => {
    return /* @__PURE__ */ import_react93.default.createElement(import_react93.default.Fragment, null, children);
  };
};
...
var KimaContext = (0, import_react94.createContext)(void 0);
var useKimaContext = () => {
  const context = (0, import_react94.useContext)(KimaContext);
  if (!context) {
    throw new Error("useKimaContext must be used within a KimaProvider");
  }
  return context;
};
var InternalKimaProvider = React79.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children, logLevel }) => {
    ...
    const plugins = (0, import_react_redux15.useSelector)(selectAllPlugins, (prev, next) => prev === next);
    logger_default.debug("Registered Plugins:", plugins);
    const WrappedProviders = (0, import_react94.useMemo)(() => {
    ...
    return /* @__PURE__ */ React79.createElement(React79.Fragment, null, WrappedProviders);
  }
);
var KimaProvider = ({
  walletConnectProjectId,
  children = /* @__PURE__ */ React79.createElement(React79.Fragment, null),
  externalProvider,
  ...
  if (externalProvider && isValidExternalProvider(externalProvider)) {
    ...
    if (externalProvider.type === "evm" && externalProvider.signer instanceof import_ethers10.JsonRpcSigner)
      sourceAddress = externalProvider.signer.address;
    if (externalProvider.type === "solana" && externalProvider.signer instanceof import_web39.PublicKey)
  ...
  return /* @__PURE__ */ React79.createElement(import_react_query11.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React79.createElement(import_react_redux15.Provider, { store }, /* @__PURE__ */ React79.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React79.createElement(
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  const theme = (0, import_react_redux16.useSelector)(selectTheme);
  return /* @__PURE__ */ import_react95.default.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ import_react95.default.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ import_react95.default.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ import_react95.default.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ import_react95.default.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ import_react95.default.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react95.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react95.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react95.default.createElement(Check_default, null) : null, /* @__PURE__ */ import_react95.default.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ import_react96.default.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ import_react98.default.createElement(
    ...
    /* @__PURE__ */ import_react98.default.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ import_react98.default.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ import_react100.default.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ import_react100.default.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ import_react100.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react100.default.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ import_react101.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react101.default.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ import_react103.default.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = (0, import_react104.useState)(default_default);
  const isIndexed = (0, import_react_redux20.useSelector)(selectPluginIsIndexed);
...
var useWidth = () => {
  const [width, setWidth] = (0, import_react105.useState)(0);
...
var CopyButton = ({ text }) => {
  const [copyClicked, setCopyClicked] = (0, import_react106.useState)(false);
  ...
  return /* @__PURE__ */ import_react106.default.createElement(
    ...
    copyClicked ? /* @__PURE__ */ import_react106.default.createElement(Check_default, null) : /* @__PURE__ */ import_react106.default.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  const selectedCoin = (0, import_react_redux21.useSelector)(selectSourceCurrency);
  const sourceCompliant = (0, import_react_redux21.useSelector)(selectSourceCompliant);
  const compliantOption = (0, import_react_redux21.useSelector)(selectCompliantOption);
  const selectedNetwork = (0, import_react_redux21.useSelector)(selectSourceChain);
  const { externalProvider } = useKimaContext();
  ...
  const { open } = (0, import_react109.useAppKit)();
  const { width, updateWidth } = useWidth_default();
  const { open: isModalOpen } = (0, import_react109.useAppKitState)();
  ...
  const errorMessage = (0, import_react108.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react108.default.createElement(
    ...
    /* @__PURE__ */ import_react108.default.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ import_react108.default.createElement(
      "button",
      {
      ...
      !isReady && /* @__PURE__ */ import_react108.default.createElement(Wallet_default, null),
      !isReady && "Connect Wallet"
    ), isReady && /* @__PURE__ */ import_react108.default.createElement(CopyButton_default, { text: walletAddress })),
    isReady && balance !== void 0 ? /* @__PURE__ */ import_react108.default.createElement("p", { className: "balance-info" }, formatUSD(balance), " ", selectedCoin, " available") : null
  );
};
...
function useCurrencyOptions(isSourceChain) {
  ...
  const mode = (0, import_react_redux22.useSelector)(selectMode);
  ...
  const transactionOption = (0, import_react_redux22.useSelector)(selectTransactionOption);
  const networks = (0, import_react_redux22.useSelector)(selectNetworks);
  const output = (0, import_react110.useMemo)(() => {
...
var CoinDropdown = ({
  ...
  const ref = (0, import_react112.useRef)();
  const dispatch = (0, import_react_redux25.useDispatch)();
  const [collapsed, setCollapsed] = (0, import_react112.useState)(true);
  ...
  return /* @__PURE__ */ import_react112.default.createElement(
    ...
    /* @__PURE__ */ import_react112.default.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ import_react112.default.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ import_react112.default.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ import_react112.default.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ import_react112.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react112.default.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ import_react112.default.createElement("p", null, token.symbol)
      ))
    ),
    /* @__PURE__ */ import_react112.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react112.default.createElement(Arrow_default, { fill: "none" }))
  );
};
...
function ChainIcon({ symbol }) {
  ...
  if (!Icon) {
    ...
    return /* @__PURE__ */ import_react113.default.createElement("div", { className: "icon" });
  }
  return /* @__PURE__ */ import_react113.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react113.default.createElement(Icon, null));
}
...
var FeeDeductionRadioButtons = () => {
  ...
  const sourceNetwork = (0, import_react_redux26.useSelector)(selectSourceChain);
  ...
  return /* @__PURE__ */ import_react114.default.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ import_react114.default.createElement("div", { className: "fee-options" }, /* @__PURE__ */ import_react114.default.createElement("label", { className: "fee-option" }, /* @__PURE__ */ import_react114.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  ), /* @__PURE__ */ import_react114.default.createElement("span", { className: `radio-label ${theme.colorMode}` }, `Pay $${formatterFloat2.format(
    Number(amount)
  )} ${sourceCurrency} in ${sourceNetwork.name} to receive $${formatterFloat2.format(
    Number(amount) - totalFeeUsd
  )} ${targetCurrency} in ${targetNetwork.name}`)), /* @__PURE__ */ import_react114.default.createElement("label", { className: "fee-option" }, /* @__PURE__ */ import_react114.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({ isApproved }) => {
  ...
  const feeDeduct = (0, import_react_redux27.useSelector)(selectFeeDeduct);
  ...
  const amount = (0, import_react_redux27.useSelector)(selectAmount);
  const { totalFeeUsd, targetNetworkFee, sourceNetworkFee } = (0, import_react_redux27.useSelector)(selectServiceFee);
  ...
  const targetAddress = (0, import_react_redux27.useSelector)(selectTargetAddress);
  const bankDetails = (0, import_react_redux27.useSelector)(selectBankDetails);
  const signature = (0, import_react_redux27.useSelector)(selectSignature);
  const networkOptions3 = (0, import_react_redux27.useSelector)(selectNetworks);
  const transactionOption = (0, import_react_redux27.useSelector)(selectTransactionOption);
  const { walletAddress } = useIsWalletReady4();
  const sourceChainOption = (0, import_react115.useMemo)(
    () => networkOptions3.filter((network) => network.id === sourceChain.id)[0],
    [networkOptions3, sourceChain]
  );
  const targetChainOption = (0, import_react115.useMemo)(
    () => networkOptions3.filter(
      (network) => network.shortName === (mode === "payment" /* payment */ ? transactionOption?.targetChain : targetChain.shortName)
    )[0],
    [networkOptions3, sourceChain]
  );
  const sourceCurrency = (0, import_react_redux27.useSelector)(selectSourceCurrency);
  const targetCurrency = (0, import_react_redux27.useSelector)(selectTargetCurrency);
  const { width, updateWidth } = useWidth_default();
  (0, import_react115.useEffect)(() => {
    width === 0 && updateWidth(window.innerWidth);
  }, []);
  const sourceWalletAddress = (0, import_react115.useMemo)(() => {
    return width >= 916 ? walletAddress : getShortenedAddress(walletAddress || "");
  }, [width, walletAddress]);
  const targetWalletAddress = (0, import_react115.useMemo)(() => {
  ...
  const amountToShow = (0, import_react115.useMemo)(() => {
    if (sourceChain.shortName === "BTC" /* BTC */ || targetChain.shortName === "BTC" /* BTC */) {
  ...
  return /* @__PURE__ */ import_react115.default.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ import_react115.default.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : sourceChain.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), sourceChain.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react115.default.createElement("div", null, /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react115.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react115.default.createElement(ChainIcon, { symbol: sourceChainOption?.shortName }), "FIAT"), /* @__PURE__ */ import_react115.default.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react115.default.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ import_react115.default.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ import_react115.default.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "Source", sourceChain.shortName !== "CC" && " wallet", ":"), /* @__PURE__ */ import_react115.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react115.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react115.default.createElement(ChainIcon, { symbol: sourceChainOption?.shortName }), sourceChainOption.name)), sourceChain.shortName !== "CC" && /* @__PURE__ */ import_react115.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : walletAddress : dAppOption === "LPDrain" /* LPDrain */ ? targetWalletAddress : sourceWalletAddress))), /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "Transaction", width > 500 && /* @__PURE__ */ import_react115.default.createElement("br", null), "Details:"), /* @__PURE__ */ import_react115.default.createElement("span", { className: "amount-container" }, /* @__PURE__ */ import_react115.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react115.default.createElement("span", null, "Source Transfer amount"), /* @__PURE__ */ import_react115.default.createElement("div", { className: "coin-details" }, /* @__PURE__ */ import_react115.default.createElement("p", null, feeDeduct ? formatterFloat2.format(Number(amount)) : formatterFloat2.format(Number(amount) + totalFeeUsd), " ", sourceCurrency))), /* @__PURE__ */ import_react115.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react115.default.createElement("span", null, "Source Network Fee (", sourceChain.shortName, ")"), /* @__PURE__ */ import_react115.default.createElement("span", { className: "service-fee" }, formatterFloat2.format(sourceNetworkFee?.amount || 0), " ", sourceCurrency)), /* @__PURE__ */ import_react115.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react115.default.createElement("span", null, "Target Network Fee (", targetChain.shortName, ")"), /* @__PURE__ */ import_react115.default.createElement("span", { className: "service-fee" }, formatterFloat2.format(targetNetworkFee?.amount || 0), " ", sourceCurrency)), /* @__PURE__ */ import_react115.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react115.default.createElement("span", null, "Target Transfer Amount"), /* @__PURE__ */ import_react115.default.createElement("span", { className: "service-fee" }, !feeDeduct ? formatterFloat2.format(Number(amount)) : formatterFloat2.format(Number(amount) - totalFeeUsd), " ", targetCurrency)))), targetChain.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react115.default.createElement("div", null, /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react115.default.createElement("p", null, bankDetails.iban), /* @__PURE__ */ import_react115.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react115.default.createElement(ChainIcon, { symbol: targetChainOption?.shortName }), "FIAT")), /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react115.default.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ import_react115.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ import_react115.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react115.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react115.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react115.default.createElement(ChainIcon, { symbol: targetChainOption?.shortName }), targetChainOption?.name)), /* @__PURE__ */ import_react115.default.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? walletAddress : targetAddress : dAppOption === "LPDrain" /* LPDrain */ ? sourceWalletAddress : targetWalletAddress))), mode === "bridge" /* bridge */ && totalFeeUsd > 0 ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ import_react115.default.createElement(FeeDeductionRadioButtons_default, null)
  ) : null);
};
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  const networks = (0, import_react_redux32.useSelector)(selectNetworks);
  const sourceChain = (0, import_react118.useMemo)(
    () => networks.find((network) => network.shortName === data?.sourceChain),
    [data, networks]
  );
  const targetChain = (0, import_react118.useMemo)(
    () => networks.find((network) => network.shortName === data?.targetChain),
    [data, networks]
  );
  return /* @__PURE__ */ import_react118.default.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ import_react118.default.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ import_react118.default.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ import_react118.default.createElement(
    "div",
    {
      className: `info-item
    ...
    step < index && /* @__PURE__ */ import_react118.default.createElement(Lock_default, null),
    step >= index ? index === loadingStep ? /* @__PURE__ */ import_react118.default.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react118.default.createElement(Warning_default, null) : /* @__PURE__ */ import_react118.default.createElement(Check_default, null) : null,
    /* @__PURE__ */ import_react118.default.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ import_react118.default.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ import_react118.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react118.default.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ import_react118.default.createElement("p", { className: "chain-name" }, "Kima TX ID:"), /* @__PURE__ */ import_react118.default.createElement("p", null, /* @__PURE__ */ import_react118.default.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ import_react118.default.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash ? /* @__PURE__ */ import_react118.default.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ import_react118.default.createElement(ChainIcon, { symbol: data.sourceChain }),
    /* @__PURE__ */ import_react118.default.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"),
    /* @__PURE__ */ import_react118.default.createElement("p", null, /* @__PURE__ */ import_react118.default.createElement(
      ExternalLink_default,
      {
    ...
    ), /* @__PURE__ */ import_react118.default.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ import_react118.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react118.default.createElement(ChainIcon, { symbol: data.sourceChain }), /* @__PURE__ */ import_react118.default.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"), /* @__PURE__ */ import_react118.default.createElement("p", null, /* @__PURE__ */ import_react118.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react118.default.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ import_react118.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react118.default.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ import_react118.default.createElement("p", { className: "chain-name" }, targetChain?.name, " TX ID:"), /* @__PURE__ */ import_react118.default.createElement("p", null, /* @__PURE__ */ import_react118.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react118.default.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ import_react119.default.createElement("div", { className: "bank-input" }, /* @__PURE__ */ import_react119.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react119.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react119.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react119.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react119.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react119.default.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ import_react122.default.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ import_react122.default.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ import_react122.default.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ import_react122.default.createElement("h3", null, transactionId), /* @__PURE__ */ import_react122.default.createElement(CopyButton_default, { text: transactionId })));
};
...
var TransactionSearch = () => {
  ...
  const backendUrl = (0, import_react_redux37.useSelector)(selectBackendUrl);
  const dispatch = (0, import_react_redux38.useDispatch)();
  const [transactionId, setTransactionId] = (0, import_react123.useState)("");
  const refPollForUpdates = (0, import_react123.useRef)(false);
  const handleSearch = async () => {
    if (transactionId.length <= 0)
      return import_react_hot_toast2.default.error("You must provide a valid transaction id", {
        icon: /* @__PURE__ */ import_react123.default.createElement(Error_default, null)
      });
    try {
  ...
  return /* @__PURE__ */ import_react123.default.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ import_react123.default.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ import_react123.default.createElement("span", { className: "label" }, "Search Transaction:"), /* @__PURE__ */ import_react123.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react123.default.createElement(SecondaryButton_default, { clickHandler: handleSearch }, "Search"));
};
var TransactionSearch_default = TransactionSearch;

// src/components/TransactionWidget.tsx
var TransactionWidget = ({ theme }) => {
  const [step, setStep] = (0, import_react124.useState)(0);
  const [focus, setFocus] = (0, import_react124.useState)(-1);
  const [errorStep, setErrorStep] = (0, import_react124.useState)(-1);
  const [errorMessage, setErrorMessage] = (0, import_react124.useState)("");
  const [loadingStep, setLoadingStep] = (0, import_react124.useState)(-1);
  const [minimized, setMinimized] = (0, import_react124.useState)(false);
  const dispatch = (0, import_react_redux41.useDispatch)();
  const mode = (0, import_react_redux40.useSelector)(selectMode);
  const feeDeduct = (0, import_react_redux40.useSelector)(selectFeeDeduct);
  const amount = (0, import_react_redux40.useSelector)(selectAmount);
  ...
  const { totalFeeUsd } = (0, import_react_redux40.useSelector)(selectServiceFee);
  const transactionOption = (0, import_react_redux40.useSelector)(selectTransactionOption);
  const sourceChain = (0, import_react_redux40.useSelector)(selectSourceChain);
  const targetChain = (0, import_react_redux40.useSelector)(selectTargetChain);
  const sourceSymbol = (0, import_react_redux40.useSelector)(selectSourceCurrency);
  const targetSymbol = (0, import_react_redux40.useSelector)(selectTargetCurrency);
  const networks = (0, import_react_redux40.useSelector)(selectNetworks);
  ...
  (0, import_react124.useEffect)(() => {
    if (error)
      import_react_hot_toast3.toast.error(
        ...
        {
          icon: /* @__PURE__ */ import_react124.default.createElement(Error_default, null)
        }
      );
  }, [error]);
  (0, import_react124.useEffect)(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      import_react_hot_toast3.toast.error("Unavailable", { icon: /* @__PURE__ */ import_react124.default.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      logger_default.error("transaction failed:", data.failReason);
      import_react_hot_toast3.toast.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ import_react124.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react124.default.createElement(import_react_redux39.Provider, { store }, /* @__PURE__ */ import_react124.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react124.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react124.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react124.default.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ import_react124.default.createElement("h3", { className: "transaction" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING" : isEmptyStatus ? "GETTING TRANSACTION STATUS" : data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING", /* @__PURE__ */ import_react124.default.createElement("div", null, mode !== "status" /* status */ ? Number(amount) !== 0 ? formatterFloat2.format(
      feeDeduct ? Number(amount) : Number(amount) + totalFeeUsd
    ) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `(${sourceSymbol})` : isEmptyStatus ? "" : `(${data?.sourceSymbol})`, /* @__PURE__ */ import_react124.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react124.default.createElement(
      ChainIcon,
      {
    ...
    ) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `(${targetSymbol})${" "}` : isEmptyStatus ? "" : `(${data?.targetSymbol})${" "}`, /* @__PURE__ */ import_react124.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react124.default.createElement(
      ChainIcon,
      {
        symbol: transactionTargetChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `(${transactionTargetChain?.shortName})${" "}` : isEmptyStatus ? "" : `(${data?.targetChain}) ${" "}`)) : /* @__PURE__ */ import_react124.default.createElement("div", null, /* @__PURE__ */ import_react124.default.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ import_react124.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react124.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react124.default.createElement(Minimize_default, null)
    ), !isValidTxId || loadingStep < 0 || error ? /* @__PURE__ */ import_react124.default.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ import_react124.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react124.default.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    isValidTxId && !error ? /* @__PURE__ */ import_react124.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react124.default.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ import_react124.default.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )), !error && !isEmptyStatus && /* @__PURE__ */ import_react124.default.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ import_react124.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react124.default.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ import_react124.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react124.default.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ import_react124.default.createElement(
    ...
    /* @__PURE__ */ import_react124.default.createElement("div", { className: "floating-footer status" }, /* @__PURE__ */ import_react124.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react124.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react124.default.createElement(FooterLogo_default, { fill: "black" }), /* @__PURE__ */ import_react124.default.createElement("strong", null, "Network")))
  ));
};
...
var NetworkSelector = ({ type }) => {
  const [collapsed, setCollapsed] = (0, import_react125.useState)(true);
  ...
  const networkOptions3 = (0, import_react_redux43.useSelector)(selectNetworks);
  ...
  const excludedSourceNetworks = (0, import_react_redux43.useSelector)(selectExcludedSourceNetworks);
  const excludedTargetNetworks = (0, import_react_redux43.useSelector)(selectExcludedTargetNetworks);
  const { switchChainHandler } = useKimaContext();
  const isSourceSelector = type === "source";
  const networks = (0, import_react125.useMemo)(() => {
    if (isSourceSelector) {
    ...
    return networkOptions3.filter(
      (network) => network.shortName !== sourceNetwork.shortName && !excludedTargetNetworks.includes(network.shortName) && network.shortName !== "CC"
    );
  }, [
    networkOptions3,
    sourceNetwork,
  ...
  const selectedNetwork = (0, import_react125.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react125.default.createElement(
    ...
    /* @__PURE__ */ import_react125.default.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ import_react125.default.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ import_react125.default.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ import_react125.default.createElement(
      ...
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ import_react125.default.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ import_react125.default.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ import_react125.default.createElement("p", null, network.name)
      ))
    ),
    /* @__PURE__ */ import_react125.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react125.default.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = import_react125.default.memo(NetworkSelector);
...
var SingleForm = ({
  ...
  const [amountValue, setAmountValue] = (0, import_react126.useState)("");
  ...
  const errorMessage = (0, import_react126.useMemo)(
  ...
  const maxValue = (0, import_react126.useMemo)(() => {
    if (!balance) return 0;
  ...
  return /* @__PURE__ */ import_react126.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react126.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react126.default.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ import_react126.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react126.default.createElement(NetworkSelector_default, { type: "source" }), /* @__PURE__ */ import_react126.default.createElement(CoinDropdown_default, null))), /* @__PURE__ */ import_react126.default.createElement(
    "div",
    {
      className: `dynamic-area ${sourceNetwork.shortName === "FIAT" /* FIAT */ ? "reverse" : "1"}`
    },
    sourceNetwork.compatibility !== "CC" /* CC */ && /* @__PURE__ */ import_react126.default.createElement(
      "div",
      {
        className: `form-item wallet-button-item ${isReady && "connected"}`
      },
      /* @__PURE__ */ import_react126.default.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ import_react126.default.createElement(WalletButton_default, null)
    ),
    mode === "bridge" /* bridge */ && /* @__PURE__ */ import_react126.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react126.default.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ import_react126.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react126.default.createElement(NetworkSelector_default, { type: "target" }), /* @__PURE__ */ import_react126.default.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react126.default.createElement(BankInput_default, null) : /* @__PURE__ */ import_react126.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react126.default.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ import_react126.default.createElement(
    AddressInput_default,
    {
      theme: theme.colorMode,
      placeholder: "Target address"
    }
  )) : null, /* @__PURE__ */ import_react126.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react126.default.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ import_react126.default.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ import_react126.default.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "text",
  ...
  ), /* @__PURE__ */ import_react126.default.createElement("div", { className: "max-disclaimer" }, /* @__PURE__ */ import_react126.default.createElement(
    "span",
    {
    ...
    "Max"
  ), totalFeeUsd !== -1 && /* @__PURE__ */ import_react126.default.createElement("p", null, "Est fees: $ ", totalFeeUsd, " USD")))));
};
...
var SolanaWalletSelect = () => {
  ...
  const sliderRef = (0, import_react127.useRef)();
  const { wallet, wallets, select, connect, connected } = (0, import_wallet_adapter_react7.useWallet)();
  const [detected, undetected] = (0, import_react127.useMemo)(() => {
    const detected2 = [];
    const undetected2 = [];
  ...
  const handleWalletClick = (0, import_react127.useCallback)(
    (walletName) => {
      logger_default.debug(
  ...
  return /* @__PURE__ */ import_react127.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react127.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react127.default.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ import_react127.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react127.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react127.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react127.default.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ import_react127.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react127.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react127.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react127.default.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
...
var AccountDetailsModal = () => {
  ...
  const sourceChain = (0, import_react_redux46.useSelector)(selectSourceChain);
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react129.default.createElement("div", null, /* @__PURE__ */ import_react129.default.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ import_react129.default.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ import_react129.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react129.default.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
var AccountDetailsModal2 = () => {
  ...
  const sourcheChain = (0, import_react_redux48.useSelector)(selectSourceChain);
  ...
  const selectedNetwork = (0, import_react_redux48.useSelector)(selectSourceChain);
  const networkDetails = (0, import_react130.useMemo)(
    () => networkOptions.find(({ id }) => id === selectedNetwork.shortName),
    [selectedNetwork]
  );
  const explorerUrl = (0, import_react130.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react130.default.createElement(
    ...
    )))), /* @__PURE__ */ import_react130.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react130.default.createElement("div", { className: "summary" }, networkDetails && /* @__PURE__ */ import_react130.default.createElement(networkDetails.icon, { width: 60, height: 60 }), /* @__PURE__ */ import_react130.default.createElement("div", { className: "address" }, /* @__PURE__ */ import_react130.default.createElement("h2", null, getShortenedAddress(walletAddress || "")), /* @__PURE__ */ import_react130.default.createElement(CopyButton_default, { text: walletAddress })), /* @__PURE__ */ import_react130.default.createElement("h3", null, tronBalance, " ", selectedNetwork.shortName)), /* @__PURE__ */ import_react130.default.createElement(SecondaryButton_default, { className: "block-explorer" }, /* @__PURE__ */ import_react130.default.createElement(ExternalLink_default, { className: "link", to: explorerUrl }, /* @__PURE__ */ import_react130.default.createElement(Explorer_default, { fill: "#778DA3" }), /* @__PURE__ */ import_react130.default.createElement("p", null, "Block explorer"), /* @__PURE__ */ import_react130.default.createElement(ExternalUrl_default, { fill: "#778DA3" }))), /* @__PURE__ */ import_react130.default.createElement(PrimaryButton_default, { clickHandler: handleDisconnect }, "Disconnect")))
  );
};
...
var TronWalletSelect = () => {
  ...
  const sliderRef = (0, import_react131.useRef)();
  ...
  const [detected, undetected] = (0, import_react131.useMemo)(() => {
    const detected2 = [];
    const undetected2 = [];
  ...
  return /* @__PURE__ */ import_react131.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ import_react131.default.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ import_react131.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react131.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react131.default.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ import_react131.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react131.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react131.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react131.default.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  const connectModal = (0, import_react_redux50.useSelector)(selectTronConnectModal);
  return /* @__PURE__ */ import_react132.default.createElement("div", null, /* @__PURE__ */ import_react132.default.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ import_react132.default.createElement(
    "div",
    {
      className: `kima-modal wallet-connect ${theme.colorMode} ${connectModal ? "open" : ""}`
    },
    /* @__PURE__ */ import_react132.default.createElement("div", { className: "modal-overlay" }),
    /* @__PURE__ */ import_react132.default.createElement("div", { className: `modal-content-container ${theme.colorMode}` }, /* @__PURE__ */ import_react132.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react132.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react132.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react132.default.createElement("h3", null, "Connect Wallet")), /* @__PURE__ */ import_react132.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react132.default.createElement(
      "button",
      {
    ...
    )))), /* @__PURE__ */ import_react132.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react132.default.createElement(TronWalletSelect_default, null)))
  ));
};
...
var useValidateTransaction = ({
  ...
  const maxValue = (0, import_react133.useMemo)(() => {
    if (!balance) return 0;
    if (totalFeeUsd < 0) return balance;
...
var useSubmitTransaction = ({
  ...
  const [isSubmitting, setSubmitting] = (0, import_react134.useState)(false);
...
var WarningModal = ({
  ...
  return /* @__PURE__ */ import_react135.default.createElement("div", { className: "warning-modal-overlay" }, /* @__PURE__ */ import_react135.default.createElement("div", { className: "warning-modal" }, /* @__PURE__ */ import_react135.default.createElement("h3", null, "Warning"), /* @__PURE__ */ import_react135.default.createElement("p", null, message), /* @__PURE__ */ import_react135.default.createElement("div", { className: "warning-modal-buttons" }, /* @__PURE__ */ import_react135.default.createElement(
...
var CCWidget = () => {
  ...
  const ccTransactionId = (0, import_react_redux52.useSelector)(selectCCTransactionId);
  ...
  return /* @__PURE__ */ import_react136.default.createElement("div", { className: "cc-widget" }, /* @__PURE__ */ import_react136.default.createElement(
    "iframe",
    {
      width: 600,
      height: 600,
...
var TransferWidget = ({
  ...
  const mainRef = (0, import_react137.useRef)(null);
  const [signature, setSignature2] = (0, import_react137.useState)("");
  const [formStep, setFormStep] = (0, import_react137.useState)(0);
  const [warningModalOpen, setWarningModalOpen] = (0, import_react137.useState)(null);
  const dAppOption = (0, import_react_redux53.useSelector)(selectDappOption);
  const mode = (0, import_react_redux53.useSelector)(selectMode);
  const transactionOption = (0, import_react_redux53.useSelector)(selectTransactionOption);
  const backendUrl = (0, import_react_redux53.useSelector)(selectBackendUrl);
  const sourceAddress = (0, import_react_redux53.useSelector)(selectSourceAddress);
  const targetAddress = (0, import_react_redux53.useSelector)(selectTargetAddress);
  const sourceChain = (0, import_react_redux53.useSelector)(selectSourceChain);
  const targetChain = (0, import_react_redux53.useSelector)(selectTargetChain);
  const sourceCurrency = (0, import_react_redux53.useSelector)(selectSourceCurrency);
  const targetCurrency = (0, import_react_redux53.useSelector)(selectTargetCurrency);
  const amount = (0, import_react_redux53.useSelector)(selectAmount);
  const {
    totalFeeUsd,
    totalFee,
    targetNetworkFee,
  ...
  } = (0, import_react_redux53.useSelector)(selectServiceFee);
  const compliantOption = (0, import_react_redux53.useSelector)(selectCompliantOption);
  const networkOptions3 = (0, import_react_redux53.useSelector)(selectNetworkOption);
  const feeDeduct = (0, import_react_redux53.useSelector)(selectFeeDeduct);
  const { keplrHandler, closeHandler } = useKimaContext();
  const [isCancellingApprove, setCancellingApprove] = (0, import_react137.useState)(false);
  const [isApproving, setApproving] = (0, import_react137.useState)(false);
  const [isSigning, setSigning] = (0, import_react137.useState)(false);
  const pendingTxs = (0, import_react_redux53.useSelector)(selectPendingTxs);
  const networks = (0, import_react_redux53.useSelector)(selectNetworks);
  const submitted = (0, import_react_redux53.useSelector)(selectSubmitted);
  const ccWidgetProcessed = (0, import_react_redux53.useSelector)(selectCCWidgetProcessed);
  const { width: windowWidth } = useWidth_default();
  const { disconnectWallet } = useDisconnectWallet4();
  const { balance } = useBalance2();
  const { allowance, isApproved, approve, decimals, signMessage } = useAllowance2({
    setApproving,
    setCancellingApprove
  });
  ...
  const handleSubmit = async () => {
    ...
    if (error === "ValidationError" /* Error */) {
      return import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react137.default.createElement(Error_default, null) });
    }
    ...
    if (!success) return import_react_hot_toast5.toast.error(submitMessage, { icon: /* @__PURE__ */ import_react137.default.createElement(Error_default, null) });
  };
  const onNext = () => {
    ...
    import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react137.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react137.default.createElement(
    ...
    warningModalOpen && /* @__PURE__ */ import_react137.default.createElement(
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ import_react137.default.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ import_react137.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react137.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react137.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react137.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react137.default.createElement("h3", null, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ import_react137.default.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ import_react137.default.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ import_react137.default.createElement(
      ExternalLink_default,
      {
        to: helpURL ? helpURL : "https://docs.kima.network/kima-network/try-kima-with-the-demo-app"
      },
      /* @__PURE__ */ import_react137.default.createElement("div", { className: "menu-button" }, "I need help")
    ), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ import_react137.default.createElement(
      "button",
      {
      ...
      "Reset"
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ import_react137.default.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ import_react137.default.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ import_react137.default.createElement(
      SingleForm_default,
      {
        ...{
          allowance,
    ...
    ) : submitted && !ccWidgetProcessed ? /* @__PURE__ */ import_react137.default.createElement(CCWidget_default, null) : /* @__PURE__ */ import_react137.default.createElement(
      ...
      /* @__PURE__ */ import_react137.default.createElement("div", { className: `button-group` }, formStep !== 0 && /* @__PURE__ */ import_react137.default.createElement(
        SecondaryButton_default,
        {
          clickHandler: onBack,
          theme: theme.colorMode,
      ...
      ), allowance > 0 && formStep !== 0 && sourceChain.shortName !== "CC" ? /* @__PURE__ */ import_react137.default.createElement(
        SecondaryButton_default,
        {
      ...
      ) : null, !submitted && /* @__PURE__ */ import_react137.default.createElement(
        PrimaryButton_default,
        {
          clickHandler: onNext,
    ...
    ), /* @__PURE__ */ import_react137.default.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ import_react137.default.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ import_react137.default.createElement(
    ...
    ), /* @__PURE__ */ import_react137.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react137.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react137.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react137.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react137.default.createElement("strong", null, "Network"))))
  );
};

// src/components/KimaWidgetWrapper.tsx
var import_react140 = require("@reown/appkit/react");

// src/hooks/useDebugMode.ts
var import_react138 = require("react");
var useDebugCode = (sequence = ["D", "E", "B", "U", "G"]) => {
  const [debugMode, setDebugMode] = (0, import_react138.useState)(false);
  const [, setInputSequence] = (0, import_react138.useState)([]);
...
var KimaWidgetWrapper = ({
  ...
  const { setThemeMode, setThemeVariables } = (0, import_react140.useAppKitTheme)();
  ...
  if (sourceChain.shortName === "CC") {
    if (submitted && ccWidgetProcessed) {
      return /* @__PURE__ */ import_react139.default.createElement(TransactionWidget, { theme });
    }
  ...
  return submitted ? /* @__PURE__ */ import_react139.default.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ import_react139.default.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
...
var SkeletonLoader = ({ theme }) => {
  return /* @__PURE__ */ import_react141.default.createElement(
    ...
    /* @__PURE__ */ import_react141.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: "title skeleton" }, /* @__PURE__ */ import_react141.default.createElement("h3", null))), /* @__PURE__ */ import_react141.default.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ import_react141.default.createElement("div", { className: "kima-card-content skeleton" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react141.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react141.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react141.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react141.default.createElement("div", { className: "skeleton" })), /* @__PURE__ */ import_react141.default.createElement("div", { className: `kima-card-footer` }, /* @__PURE__ */ import_react141.default.createElement("div", { className: `button-group skeleton` }, /* @__PURE__ */ import_react141.default.createElement("div", { className: "skeleton" }))), /* @__PURE__ */ import_react141.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react141.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react141.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react141.default.createElement("strong", null, "Network"))))
  );
};
...
var ErrorWidget = ({
  ...
  return /* @__PURE__ */ import_react142.default.createElement(
    ...
    /* @__PURE__ */ import_react142.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react142.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react142.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react142.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react142.default.createElement("h3", null, title))), /* @__PURE__ */ import_react142.default.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ import_react142.default.createElement("div", { className: "kima-card-content error" }, /* @__PURE__ */ import_react142.default.createElement(Error_default, { width: 40, height: 40 }), /* @__PURE__ */ import_react142.default.createElement("h2", null, message)), /* @__PURE__ */ import_react142.default.createElement("div", { className: `kima-card-footer` }), /* @__PURE__ */ import_react142.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react142.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react142.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react142.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react142.default.createElement("strong", null, "Network"))))
  );
};
...
var KimaTransactionWidget = ({
  ...
  const { kimaBackendUrl } = useKimaContext();
  const [hydrated, setHydrated] = (0, import_react143.useState)(false);
  const {
    data: envOptions,
  ...
  if (isLoadingEnvs || isLoadingChainData)
    return /* @__PURE__ */ import_react143.default.createElement(SkeletonLoader_default, { theme });
