...
var Warning = ({ width = 14, height = 13, fill = "#86B8CE", ...rest }) => {
...
var Lock = ({ width = 24, height = 27, fill = "none", stroke = "#86B8CE", ...rest }) => {
...
var Loader = ({ width = 50, height = 49, stroke = "#86B8CE", ...rest }) => {
...
var Base = ({ width = 30, height = 30, ...rest }) => {
...
var KEUR2 = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ import_react37.default.createElement(
    ...
    /* @__PURE__ */ import_react37.default.createElement(
      "path",
      {
        d: "M7 0C5.61553 0 4.26216 0.410543 3.11101 1.17971C1.95987 1.94888 1.06266 3.04213 0.532846 4.32122C0.003033 5.6003 -0.13559 7.00777 0.134506 8.36563C0.404603 9.7235 1.07129 10.9708 2.05026 11.9497C3.02922 12.9287 4.2765 13.5954 5.63437 13.8655C6.99224 14.1356 8.3997 13.997 9.67879 13.4672C10.9579 12.9373 12.0511 12.0401 12.8203 10.889C13.5895 9.73785 14 8.38447 14 7C14 5.14348 13.2625 3.36301 11.9498 2.05025C10.637 0.737498 8.85652 0 7 0ZM7 13C5.81332 13 4.65328 12.6481 3.66658 11.9888C2.67989 11.3295 1.91085 10.3925 1.45673 9.2961C1.0026 8.19974 0.88378 6.99334 1.11529 5.82946C1.3468 4.66557 1.91825 3.59647 2.75736 2.75736C3.59648 1.91824 4.66558 1.3468 5.82946 1.11529C6.99335 0.883777 8.19975 1.0026 9.2961 1.45672C10.3925 1.91085 11.3295 2.67988 11.9888 3.66658C12.6481 4.65327 13 5.81331 13 7C13 8.5913 12.3679 10.1174 11.2426 11.2426C10.1174 12.3679 8.5913 13 7 13Z",
        fill: "white",
        "fill-opacity": "0.8"
      }
    ),
    /* @__PURE__ */ import_react37.default.createElement(
      "path",
      {
        d: "M7 11.5C7.41422 11.5 7.75 11.1642 7.75 10.75C7.75 10.3358 7.41422 10 7 10C6.58579 10 6.25 10.3358 6.25 10.75C6.25 11.1642 6.58579 11.5 7 11.5Z",
        fill: "white",
        "fill-opacity": "0.8"
      }
    ),
    /* @__PURE__ */ import_react37.default.createElement(
      "path",
      {
        d: "M7.5 3H6.75C6.45434 2.99934 6.16147 3.05709 5.88819 3.16993C5.61491 3.28277 5.36661 3.44848 5.15754 3.65754C4.94848 3.8666 4.78277 4.1149 4.66993 4.38818C4.55709 4.66146 4.49934 4.95434 4.5 5.25V5.5H5.5V5.25C5.5 4.91848 5.6317 4.60054 5.86612 4.36612C6.10054 4.1317 6.41848 4 6.75 4H7.5C7.83152 4 8.14947 4.1317 8.38389 4.36612C8.61831 4.60054 8.75 4.91848 8.75 5.25C8.75 5.58152 8.61831 5.89946 8.38389 6.13388C8.14947 6.3683 7.83152 6.5 7.5 6.5H6.5V8.75H7.5V7.5C8.09674 7.5 8.66904 7.26295 9.09099 6.84099C9.51295 6.41903 9.75 5.84674 9.75 5.25C9.75 4.65326 9.51295 4.08097 9.09099 3.65901C8.66904 3.23705 8.09674 3 7.5 3Z",
        fill: "white",
        "fill-opacity": "0.8"
      }
    )
...
var useNativeEvmBalance = () => {
  ...
  const { walletProvider } = (0, import_react78.useAppKitProvider)("eip155");
...
function useIsWalletReady() {
  ...
  const { chainId: walletChainId } = (0, import_react80.useAppKitNetwork)();
  ...
  const [isReady, setIsReady] = (0, import_react79.useState)(false);
  const [statusMessage, setStatusMessage] = (0, import_react79.useState)("Wallet not connected");
  const [connectedAddress, setConnectedAddress] = (0, import_react79.useState)("");
  const switchNetwork = (0, import_react79.useCallback)(async () => {
...
var useIsProviderReady = () => {
  const [isReady, setIsReady] = (0, import_react91.useState)(false);
...
var KimaContext = (0, import_react93.createContext)(void 0);
var useKimaContext = () => {
  const context = (0, import_react93.useContext)(KimaContext);
  if (!context) {
    throw new Error("useKimaContext must be used within a KimaProvider");
  }
  return context;
};
var InternalKimaProvider = React82.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children, logLevel }) => {
    ...
    const WrappedProviders = (0, import_react93.useMemo)(() => {
    ...
    return /* @__PURE__ */ React82.createElement(React82.Fragment, null, WrappedProviders);
  }
);
var KimaProvider = ({
  walletConnectProjectId,
  children = /* @__PURE__ */ React82.createElement(React82.Fragment, null),
  externalProvider,
  ...
  return /* @__PURE__ */ React82.createElement(import_react_query13.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React82.createElement(import_react_redux19.Provider, { store }, /* @__PURE__ */ React82.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React82.createElement(
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ import_react94.default.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ import_react94.default.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ import_react94.default.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ import_react94.default.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ import_react94.default.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ import_react94.default.createElement(Lock_default, { stroke: "#353539" }), step >= index ? index === loadingStep ? /* @__PURE__ */ import_react94.default.createElement(Loader_default, { stroke: "white", className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react94.default.createElement(Warning_default, { fill: "white" }) : /* @__PURE__ */ import_react94.default.createElement(Check_default, { fill: "white" }) : null, /* @__PURE__ */ import_react94.default.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ import_react95.default.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ import_react97.default.createElement(
    ...
    /* @__PURE__ */ import_react97.default.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ import_react97.default.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ import_react99.default.createElement(
    ...
    isLoading && /* @__PURE__ */ import_react99.default.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ import_react99.default.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  );
};
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ import_react102.default.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = (0, import_react103.useState)(default_default);
...
var useWidth = () => {
  const [width, setWidth] = (0, import_react104.useState)(0);
...
var import_react108 = require("@reown/appkit/react");

// src/components/reusable/CopyButton.tsx
var import_react105 = __toESM(require("react"), 1);
var CopyButton = ({ text }) => {
  const [copyClicked, setCopyClicked] = (0, import_react105.useState)(false);
  ...
  return /* @__PURE__ */ import_react105.default.createElement(
    ...
    copyClicked ? /* @__PURE__ */ import_react105.default.createElement(Check_default, { fill: "white" }) : /* @__PURE__ */ import_react105.default.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({
  ...
  const { open } = (0, import_react108.useAppKit)();
  const { open: isModalOpen } = (0, import_react108.useAppKitState)();
  ...
  const errorMessage = (0, import_react107.useMemo)(() => {
  ...
  const isConnected = (0, import_react107.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react107.default.createElement(
    ...
    /* @__PURE__ */ import_react107.default.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ import_react107.default.createElement(
      "button",
      {
      ...
      !isConnected && mode !== "light" /* light */ && !initialSelection && /* @__PURE__ */ import_react107.default.createElement(Wallet_default, null),
      !isConnected && mode !== "light" /* light */ && !initialSelection && "CONNECT WALLET"
    ), isConnected && !placeholder && /* @__PURE__ */ import_react107.default.createElement(CopyButton_default, { text: connectedAddress })),
    isConnected && !placeholder && balance !== void 0 && decimals !== void 0 ? /* @__PURE__ */ import_react107.default.createElement("p", { className: "balance-info" }, formatUSD(bigIntToNumber({ value: balance, decimals })), " ", selectedCoin, " available") : null
  );
};
...
function useCurrencyOptions(isSourceChain) {
  ...
  const output = (0, import_react109.useMemo)(() => {
...
function TokenIcon({
  ...
  return /* @__PURE__ */ import_react110.default.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ import_react110.default.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  return /* @__PURE__ */ import_react111.default.createElement(
    ...
    /* @__PURE__ */ import_react111.default.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ import_react111.default.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ import_react111.default.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ import_react111.default.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ import_react111.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react111.default.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ import_react111.default.createElement("p", null, token.symbol)
      ))
    ),
...
function ChainIcon({ symbol }) {
  ...
  if (!Icon) {
    ...
    return /* @__PURE__ */ import_react112.default.createElement("div", null);
  }
  return /* @__PURE__ */ import_react112.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react112.default.createElement(Icon, null));
}
...
var FeeDeductionRadioButtons = ({ disabled }) => {
  ...
  return /* @__PURE__ */ import_react113.default.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ import_react113.default.createElement("div", { className: "fee-options" }, Number(amount) - totalFee > 0 && /* @__PURE__ */ import_react113.default.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ import_react113.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  ), /* @__PURE__ */ import_react113.default.createElement("span", { className: `radio-label ${theme.colorMode}` }, `Pay $${formatterFloat.format(
    Number(amount)
  )} ${sourceCurrency} in ${sourceNetwork.name} to receive $${formatterFloat.format(
    Number(amount) - totalFee
  )} ${targetCurrency} in ${targetNetwork.name}`)), /* @__PURE__ */ import_react113.default.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ import_react113.default.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({
  ...
  const [feeCollapsed, setFeeCollapsed] = (0, import_react114.useState)(true);
  ...
  const originNetworkOption = (0, import_react114.useMemo)(
    () => networkOptions3.filter((network) => network.id === originNetwork.id)[0],
    [networkOptions3, originNetwork]
  );
  const targetNetworkOption = (0, import_react114.useMemo)(
  ...
  return /* @__PURE__ */ import_react114.default.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ import_react114.default.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react114.default.createElement("div", null, /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react114.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react114.default.createElement(ChainIcon, { symbol: originNetworkOption?.shortName }), "FIAT"), /* @__PURE__ */ import_react114.default.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react114.default.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ import_react114.default.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ import_react114.default.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "Source ", originNetwork.shortName !== "CC" && "Wallet"), /* @__PURE__ */ import_react114.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react114.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react114.default.createElement(ChainIcon, { symbol: originNetworkOption?.shortName }), originNetworkOption.shortName)), originNetwork.shortName !== "CC" && /* @__PURE__ */ import_react114.default.createElement("p", { className: theme.colorMode }, dAppOption === "LPDrain" /* LPDrain */ ? getShortenedAddress(targetAddress) : getShortenedAddress(connectedAddress)))), /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "amount-container" }, /* @__PURE__ */ import_react114.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react114.default.createElement("span", null, "Amount to Transfer "), /* @__PURE__ */ import_react114.default.createElement("div", { className: "coin-details" }, /* @__PURE__ */ import_react114.default.createElement("span", null, formatBigInt(txValues.allowanceAmount), " ", sourceCurrency))), /* @__PURE__ */ import_react114.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react114.default.createElement("span", null, "Total Fees"), /* @__PURE__ */ import_react114.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react114.default.createElement("span", { className: "service-fee" }, formatBigInt(totalFee), " ", sourceCurrency)
  )), /* @__PURE__ */ import_react114.default.createElement("div", { className: `fee-breakdown ${feeCollapsed ? "collapsed" : ""}` }, /* @__PURE__ */ import_react114.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react114.default.createElement("span", null, originNetwork.shortName === "CC" ? "Credit Card Processing Fee" : `Source Network Fee (${originNetwork.shortName})`), /* @__PURE__ */ import_react114.default.createElement("span", { className: "service-fee" }, formatBigInt(sourceFee), " ", sourceCurrency)), /* @__PURE__ */ import_react114.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react114.default.createElement("span", null, "Target Network Fee (", targetNetwork.shortName, ")"), /* @__PURE__ */ import_react114.default.createElement("span", { className: "service-fee" }, formatBigInt(targetFee), " ", targetCurrency)), /* @__PURE__ */ import_react114.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react114.default.createElement("span", null, "KIMA Service Fee"), /* @__PURE__ */ import_react114.default.createElement("span", { className: "service-fee" }, formatBigInt(kimaFee), " ", sourceCurrency))), /* @__PURE__ */ import_react114.default.createElement("div", { className: "amount-details" }, /* @__PURE__ */ import_react114.default.createElement("span", null, "Target Transfer Amount"), /* @__PURE__ */ import_react114.default.createElement("span", { className: "service-fee target-amount" }, formatBigInt(txValues.submitAmount), " ", targetCurrency)))), targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react114.default.createElement("div", null, /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react114.default.createElement("p", null, bankDetails.iban), /* @__PURE__ */ import_react114.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react114.default.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), "FIAT")), /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react114.default.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ import_react114.default.createElement("div", { className: "detail-item" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: "label" }, "Target Wallet"), /* @__PURE__ */ import_react114.default.createElement("div", { className: "network-details" }, /* @__PURE__ */ import_react114.default.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ import_react114.default.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ import_react114.default.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), targetNetworkOption?.shortName)), /* @__PURE__ */ import_react114.default.createElement("p", { className: theme.colorMode }, mode === "light" /* light */ ? targetNetwork.shortName === "SOL" ? getShortenedAddress(lightDemoAccounts.SOL) : targetNetwork.shortName === "TRX" ? getShortenedAddress(lightDemoAccounts.TRX) : getShortenedAddress(lightDemoAccounts.EVM) : dAppOption === "LPDrain" /* LPDrain */ ? getShortenedAddress(connectedAddress) : getShortenedAddress(targetAddress)))), mode === "bridge" /* bridge */ && BigInt(totalFee.value) > BigInt(0) ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ import_react114.default.createElement(FeeDeductionRadioButtons_default, { disabled: feeOptionDisabled })
  ) : null);
};
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  const sourceChain = (0, import_react117.useMemo)(() => {
    const sourceKey = data?.originChain === "FIAT" ? "CC" : data?.originChain;
    return networks.find((network) => network.shortName === sourceKey);
  }, [data, networks]);
  const targetChain = (0, import_react117.useMemo)(
    () => networks.find((network) => network.shortName === data?.targetChain),
    [data, networks]
  );
  return /* @__PURE__ */ import_react117.default.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ import_react117.default.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ import_react117.default.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ import_react117.default.createElement(
    "div",
    {
      className: `info-item
    ...
    step < index && /* @__PURE__ */ import_react117.default.createElement(Lock_default, { stroke: "#353539" }),
    step >= index ? index === loadingStep ? /* @__PURE__ */ import_react117.default.createElement(Loader_default, { stroke: "white", className: "loader" }) : index === errorStep ? /* @__PURE__ */ import_react117.default.createElement(Warning_default, { fill: "white" }) : /* @__PURE__ */ import_react117.default.createElement(Check_default, { fill: "white" }) : null,
    /* @__PURE__ */ import_react117.default.createElement("p", { className: "label" }, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ import_react117.default.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ import_react117.default.createElement("div", { className: "icon" }, /* @__PURE__ */ import_react117.default.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ import_react117.default.createElement("p", { className: "chain-name" }, "Kima TX Hash:"), /* @__PURE__ */ import_react117.default.createElement("p", null, /* @__PURE__ */ import_react117.default.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ import_react117.default.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash && sourceChain?.shortName !== "CC" ? /* @__PURE__ */ import_react117.default.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ import_react117.default.createElement(ChainIcon, { symbol: sourceChain?.shortName }),
    /* @__PURE__ */ import_react117.default.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX Hash:"),
    /* @__PURE__ */ import_react117.default.createElement("p", null, /* @__PURE__ */ import_react117.default.createElement(
      ExternalLink_default,
      {
        to: `${sourceChain?.blockExplorers?.default.url}/${data?.originChain === "TRX" /* TRON */ ? "#/transaction" : "tx"}/${data?.tssPullHash}${data?.originChain === "SOL" /* SOLANA */ && networkOption === "testnet" /* testnet */ ? "?cluster=devnet" : ""}`
      },
      getShortenedAddress(data?.tssPullHash || "")
    ), /* @__PURE__ */ import_react117.default.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ import_react117.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react117.default.createElement(ChainIcon, { symbol: data.originChain }), /* @__PURE__ */ import_react117.default.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX Hash:"), /* @__PURE__ */ import_react117.default.createElement("p", null, /* @__PURE__ */ import_react117.default.createElement(
    ExternalLink_default,
    {
      to: `${sourceChain?.blockExplorers?.default.url}/${data?.originChain === "TRX" /* TRON */ ? "#/transaction" : "tx"}/${data?.tssRefundHash}${data?.originChain === "SOL" /* SOLANA */ && networkOption === "testnet" /* testnet */ ? "?cluster=devnet" : ""}`
    },
    getShortenedAddress(data?.tssRefundHash || "")
  ), /* @__PURE__ */ import_react117.default.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ import_react117.default.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ import_react117.default.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ import_react117.default.createElement("p", { className: "chain-name" }, targetChain?.name, " TX Hash:"), /* @__PURE__ */ import_react117.default.createElement("p", null, /* @__PURE__ */ import_react117.default.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ import_react117.default.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ import_react118.default.createElement("div", { className: "bank-input" }, /* @__PURE__ */ import_react118.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react118.default.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ import_react118.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react118.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react118.default.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ import_react118.default.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var useGetTxData = (txId, dAppOption, backendUrl) => {
  ...
  const result = (0, import_react_query14.useQuery)({
    ...
    queryFn: async () => {
      const result2 = await getTxData({ txId, isLP, backendUrl, refPollForUpdates });
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ import_react121.default.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ import_react121.default.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ import_react121.default.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ import_react121.default.createElement("h3", null, transactionId), /* @__PURE__ */ import_react121.default.createElement(CopyButton_default, { text: transactionId })));
};
...
var TransactionSearch = () => {
  ...
  const [transactionId, setTransactionId] = (0, import_react122.useState)("");
  const refPollForUpdates = (0, import_react122.useRef)(false);
  ...
  return /* @__PURE__ */ import_react122.default.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ import_react122.default.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ import_react122.default.createElement("span", { className: "label" }, "Search Transaction"), /* @__PURE__ */ import_react122.default.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ import_react122.default.createElement(PrimaryButton_default, { clickHandler: handleSearch }, "SEARCH"));
};
var TransactionSearch_default = TransactionSearch;

// src/components/TransactionWidget.tsx
var TransactionWidget = ({ theme }) => {
  const [step, setStep] = (0, import_react123.useState)(0);
  const [focus, setFocus] = (0, import_react123.useState)(-1);
  const [errorStep, setErrorStep] = (0, import_react123.useState)(-1);
  const [errorMessage, setErrorMessage] = (0, import_react123.useState)("");
  const [loadingStep, setLoadingStep] = (0, import_react123.useState)(-1);
  const [minimized, setMinimized] = (0, import_react123.useState)(false);
  ...
  const transactionSourceChain = (0, import_react123.useMemo)(
    () => networks.find(
  ...
  (0, import_react123.useEffect)(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      import_react_hot_toast3.toast.error("Unavailable", { icon: /* @__PURE__ */ import_react123.default.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      logger_default.error("transaction failed:", data.failReason);
      import_react_hot_toast3.toast.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ import_react123.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react123.default.createElement(import_react_redux41.Provider, { store }, /* @__PURE__ */ import_react123.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react123.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react123.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react123.default.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ import_react123.default.createElement("div", { className: "transaction-title" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "Transferred " : "Transfering " : isEmptyStatus ? "Fetching transaction status " : data?.status === "Completed" /* COMPLETED */ ? "Transfered " : "Transfering ", mode !== "status" /* status */ ? Number(amount) !== 0 ? transactionSourceChain?.shortName === "CC" ? bigIntToNumber(txValues.allowanceAmount).toFixed(2) : formatBigInt(txValues.allowanceAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `${sourceSymbol} ` : isEmptyStatus ? "" : `(${data?.sourceSymbol})`, /* @__PURE__ */ import_react123.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react123.default.createElement(
      ChainIcon,
      {
        symbol: transactionSourceChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `${transactionSourceChain?.name}` : isEmptyStatus ? "" : `${data?.originChain === "FIAT" ? "CC" : data?.originChain}`, " ", mode !== "status" /* status */ ? `\u2192 ` : isEmptyStatus ? "" : `\u2192 `, mode !== "status" /* status */ ? Number(amount) !== 0 ? transactionSourceChain?.shortName === "CC" ? bigIntToNumber(txValues.submitAmount).toFixed(2) : formatBigInt(txValues.submitAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `${targetSymbol}${" "}` : isEmptyStatus ? "" : `${data?.targetSymbol}${" "}`, /* @__PURE__ */ import_react123.default.createElement("div", { className: "title-icon" }, /* @__PURE__ */ import_react123.default.createElement(
      ChainIcon,
      {
        symbol: transactionTargetChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `${transactionTargetChain?.name}${" "}` : isEmptyStatus ? "" : `${data?.targetChain} ${" "}`) : /* @__PURE__ */ import_react123.default.createElement("div", null, /* @__PURE__ */ import_react123.default.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ import_react123.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react123.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react123.default.createElement(Minimize_default, { fill: "white" })
    ), !isValidTxId || loadingStep < 0 || error ? /* @__PURE__ */ import_react123.default.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ import_react123.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react123.default.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    isValidTxId && !error ? /* @__PURE__ */ import_react123.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react123.default.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ import_react123.default.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )), !error && !isEmptyStatus && /* @__PURE__ */ import_react123.default.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ import_react123.default.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ import_react123.default.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ import_react123.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react123.default.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ import_react123.default.createElement(
    ...
    /* @__PURE__ */ import_react123.default.createElement("div", { className: `kima-card-footer transaction` }, /* @__PURE__ */ import_react123.default.createElement("div", { className: "kima-powered" }, /* @__PURE__ */ import_react123.default.createElement("span", null, "POWERED BY"), /* @__PURE__ */ import_react123.default.createElement("span", { className: "kima-logo" }, /* @__PURE__ */ import_react123.default.createElement(FooterLogo_default, { fill: "#666666" }), /* @__PURE__ */ import_react123.default.createElement("span", null, "Network"))))
  ));
};
...
var NetworkSelector = ({
  ...
  const [collapsed, setCollapsed] = (0, import_react124.useState)(true);
  ...
  const networks = (0, import_react124.useMemo)(() => {
  ...
  const selectedNetwork = (0, import_react124.useMemo)(() => {
    if (initialSelection) {
      return {
        shortName: "",
  ...
  return /* @__PURE__ */ import_react124.default.createElement(
    ...
    /* @__PURE__ */ import_react124.default.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ import_react124.default.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ import_react124.default.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ import_react124.default.createElement(
      ...
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ import_react124.default.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ import_react124.default.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ import_react124.default.createElement("p", null, network.name)
      ))
    ),
    /* @__PURE__ */ import_react124.default.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ import_react124.default.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = import_react124.default.memo(NetworkSelector);
...
var SingleForm = ({
  ...
  const [amountValue, setAmountValue] = (0, import_react125.useState)("");
  ...
  const { kimaBackendUrl } = useKimaContext();
  const { data: envOptions } = useGetEnvOptions({ kimaBackendUrl });
  const errorMessage = (0, import_react125.useMemo)(
  ...
  const maxValue = (0, import_react125.useMemo)(() => {
    if (mode === "light" /* light */)
      return BigInt(
  ...
  const isConnected = (0, import_react125.useMemo)(() => {
    return isReady && !initialSelection.sourceSelection;
  }, [isReady, initialSelection]);
  return /* @__PURE__ */ import_react125.default.createElement("div", { className: "single-form" }, /* @__PURE__ */ import_react125.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react125.default.createElement("span", { className: "label" }, "Source Network"), /* @__PURE__ */ import_react125.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react125.default.createElement(
  ...
  ), /* @__PURE__ */ import_react125.default.createElement(CoinDropdown_default, null))), /* @__PURE__ */ import_react125.default.createElement(
    "div",
    {
      className: `dynamic-area ${sourceNetwork.shortName === "FIAT" /* FIAT */ ? "reverse" : "1"}`
    },
    sourceNetwork.compatibility !== "CC" /* CC */ && /* @__PURE__ */ import_react125.default.createElement(
      "div",
      {
        className: `form-item wallet-button-item ${isConnected && "connected"}`
      },
      /* @__PURE__ */ import_react125.default.createElement("span", { className: "label" }, "Wallet"),
      /* @__PURE__ */ import_react125.default.createElement(WalletButton_default, { initialSelection: initialSelection.sourceSelection })
    ),
    mode !== "payment" /* payment */ && /* @__PURE__ */ import_react125.default.createElement("div", { className: "form-item" }, /* @__PURE__ */ import_react125.default.createElement("span", { className: "label" }, "Target Network"), /* @__PURE__ */ import_react125.default.createElement("div", { className: "items" }, /* @__PURE__ */ import_react125.default.createElement(
      NetworkSelector_default,
      {
        type: "target",
        ...{
    ...
    ), /* @__PURE__ */ import_react125.default.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ import_react125.default.createElement(BankInput_default, null) : /* @__PURE__ */ import_react125.default.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ import_react125.default.createElement("span", { className: "label" }, "Target Address"), /* @__PURE__ */ import_react125.default.createElement(
  ...
  )) : null, mode === "light" /* light */ && /* @__PURE__ */ import_react125.default.createElement(
    "div",
    {
      className: `form-item wallet-button-item ${!initialSelection.targetSelection && "connected"}`,
      style: { display: "flex", alignItems: "center" }
    },
    /* @__PURE__ */ import_react125.default.createElement("span", { className: "label" }, "Target Wallet:"),
  ...
  ), /* @__PURE__ */ import_react125.default.createElement("div", { className: "max-disclaimer" }, /* @__PURE__ */ import_react125.default.createElement(
    ...
    "MAX"
  ), +totalFee !== -1 && /* @__PURE__ */ import_react125.default.createElement("p", { className: "fee-amount" }, "Est fees:", " ", /* @__PURE__ */ import_react125.default.createElement("span", { className: `${isLoadingFees ? "loading" : ""}` }, " ", isLoadingFees ? "" : `$ ${formatBigInt(totalFee)} USD`))))));
};
...
var SolanaWalletSelect = () => {
  ...
  const sliderRef = (0, import_react126.useRef)();
  const { wallet, wallets, select, connect, connected } = (0, import_wallet_adapter_react7.useWallet)();
  const [detected, undetected] = (0, import_react126.useMemo)(() => {
    const detected2 = [];
    const undetected2 = [];
  ...
  const handleWalletClick = (0, import_react126.useCallback)(
    (walletName) => {
      logger_default.debug(
  ...
  return /* @__PURE__ */ import_react126.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react126.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react126.default.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ import_react126.default.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ import_react126.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react126.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react126.default.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ import_react126.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react126.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react126.default.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ import_react126.default.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react128.default.createElement("div", null, /* @__PURE__ */ import_react128.default.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ import_react128.default.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ import_react128.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react128.default.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
var AccountDetailsModal2 = () => {
  ...
  const networkDetails = (0, import_react129.useMemo)(
    () => networkOptions.find(({ id }) => id === selectedNetwork.shortName),
    [selectedNetwork]
  );
  const explorerUrl = (0, import_react129.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react129.default.createElement(
    ...
    )))), /* @__PURE__ */ import_react129.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react129.default.createElement("div", { className: "summary" }, networkDetails && /* @__PURE__ */ import_react129.default.createElement(networkDetails.icon, { width: 60, height: 60 }), /* @__PURE__ */ import_react129.default.createElement("div", { className: "address" }, /* @__PURE__ */ import_react129.default.createElement("h2", null, getShortenedAddress(connectedAddress || "")), /* @__PURE__ */ import_react129.default.createElement(CopyButton_default, { text: connectedAddress })), /* @__PURE__ */ import_react129.default.createElement("h3", null, formatterFloat.format(Number(tronBalance)), " ", selectedNetwork.shortName)), /* @__PURE__ */ import_react129.default.createElement(SecondaryButton_default, { className: "block-explorer" }, /* @__PURE__ */ import_react129.default.createElement(ExternalLink_default, { className: "link", to: explorerUrl }, /* @__PURE__ */ import_react129.default.createElement(Explorer_default, { fill: "#778DA3" }), /* @__PURE__ */ import_react129.default.createElement("p", null, "Block explorer"), /* @__PURE__ */ import_react129.default.createElement(ExternalUrl_default, { fill: "#778DA3" }))), /* @__PURE__ */ import_react129.default.createElement(PrimaryButton_default, { clickHandler: handleDisconnect }, "Disconnect")))
  );
};
...
var TronWalletSelect = () => {
  ...
  const sliderRef = (0, import_react130.useRef)();
  ...
  const [detected, undetected] = (0, import_react130.useMemo)(() => {
    const detected2 = [];
    const undetected2 = [];
  ...
  return /* @__PURE__ */ import_react130.default.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ import_react130.default.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ import_react130.default.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ import_react130.default.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ import_react130.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react130.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react130.default.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ import_react130.default.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ import_react130.default.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ import_react130.default.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ import_react130.default.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ import_react131.default.createElement("div", null, /* @__PURE__ */ import_react131.default.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ import_react131.default.createElement(
    "div",
    {
      className: `kima-modal wallet-connect ${theme.colorMode} ${connectModal ? "open" : ""}`
    },
    /* @__PURE__ */ import_react131.default.createElement("div", { className: "modal-overlay" }),
    /* @__PURE__ */ import_react131.default.createElement("div", { className: `modal-content-container ${theme.colorMode}` }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react131.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react131.default.createElement("h3", null, "Connect Wallet")), /* @__PURE__ */ import_react131.default.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ import_react131.default.createElement(
      "button",
      {
    ...
    )))), /* @__PURE__ */ import_react131.default.createElement("div", { className: "modal-content" }, /* @__PURE__ */ import_react131.default.createElement(TronWalletSelect_default, null)))
  ));
};
...
var useValidateTransaction = (inputs) => {
  ...
  const maxValue = (0, import_react132.useMemo)(() => {
...
var useSubmitTransaction = () => {
  ...
  const [isSubmitting, setSubmitting] = (0, import_react133.useState)(false);
...
var WarningModal = ({
  ...
  return /* @__PURE__ */ import_react134.default.createElement("div", { className: "warning-modal-overlay" }, /* @__PURE__ */ import_react134.default.createElement("div", { className: "warning-modal" }, /* @__PURE__ */ import_react134.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react134.default.createElement("h3", null, "Warning"), /* @__PURE__ */ import_react134.default.createElement("button", { onClick: onCancel }, /* @__PURE__ */ import_react134.default.createElement(Cross_default, { width: 15, height: 15, fill: "white" }))), /* @__PURE__ */ import_react134.default.createElement("p", null, message), /* @__PURE__ */ import_react134.default.createElement("div", { className: "warning-modal-buttons" }, /* @__PURE__ */ import_react134.default.createElement(
    SecondaryButton_default,
    {
...
var CCWidget = () => {
  ...
  const randomUserIdRef = (0, import_react135.useRef)((0, import_uuid.v4)());
  const ccTransactionIdSeedRef = (0, import_react135.useRef)((0, import_uuid.v4)());
  ...
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const allowanceAmount = (0, import_react135.useMemo)(
    () => formatBigInt(txValues.allowanceAmount),
    [txValues]
  );
  const [isLoading, setIsLoading] = (0, import_react135.useState)(true);
  const baseUrl = (0, import_react135.useMemo)(
  ...
  return /* @__PURE__ */ import_react135.default.createElement("div", { className: `cc-widget ${isLoading ? "loading" : ""}` }, (isLoading || isTransactionIdLoading || isEnvLoading || ccTransactionStatus === "success") && /* @__PURE__ */ import_react135.default.createElement("div", { className: "cc-widget-loader" }, /* @__PURE__ */ import_react135.default.createElement(ring_default, { width: 50, height: 50, fill: "white" })), /* @__PURE__ */ import_react135.default.createElement(
    "iframe",
    {
...
var TransferWidget = ({
  ...
  const mainRef = (0, import_react136.useRef)(null);
  const [signature, setSignature2] = (0, import_react136.useState)("");
  const [formStep, setFormStep] = (0, import_react136.useState)(0);
  const [warningModalOpen, setWarningModalOpen] = (0, import_react136.useState)(null);
  const [resetModalOpen, setResetModalOpen] = (0, import_react136.useState)(false);
  ...
  const [isCancellingApprove, setCancellingApprove] = (0, import_react136.useState)(false);
  const [isApproving, setApproving] = (0, import_react136.useState)(false);
  const [isSigning, setSigning] = (0, import_react136.useState)(false);
  const [feeOptionDisabled, setFeeOptionDisabled] = (0, import_react136.useState)(false);
  const [initialSelection, setInitialSelection] = (0, import_react136.useState)({
  ...
  const isBackButtonEnabled = (0, import_react136.useMemo)(() => {
    if (formStep !== 0) {
  ...
  const isSubmitButtonEnabled = (0, import_react136.useMemo)(() => {
  ...
  (0, import_react136.useEffect)(() => {
    const submit = async () => {
      if (ccTransactionStatus === "success") {
        ...
        if (!success) {
          import_react_hot_toast5.toast.error(submitMessage, { icon: /* @__PURE__ */ import_react136.default.createElement(Error_default, null) });
  ...
  const handleSubmit = async () => {
    ...
    if (error2 === "ValidationError" /* Error */) {
      return import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react136.default.createElement(Error_default, null) });
    }
    if (sourceChain.shortName === "CC") {
    ...
    if (!success) return import_react_hot_toast5.toast.error(submitMessage, { icon: /* @__PURE__ */ import_react136.default.createElement(Error_default, null) });
  };
  const onNext = () => {
    ...
    import_react_hot_toast5.toast.error(validationMessage, { icon: /* @__PURE__ */ import_react136.default.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ import_react136.default.createElement(
    ...
    resetModalOpen && /* @__PURE__ */ import_react136.default.createElement(
    ...
    warningModalOpen && /* @__PURE__ */ import_react136.default.createElement(
      WarningModal_default,
      {
        message: warningModalOpen.message,
        cancelButtonText: "CANCEL",
        acknowledgeButtonText: "CONTINUE",
        onAcknowledge: () => {
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ import_react136.default.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ import_react136.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react136.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react136.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react136.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react136.default.createElement("h3", { style: { marginRight: "5px" } }, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ import_react136.default.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ import_react136.default.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ import_react136.default.createElement(
      ExternalLink_default,
      {
      ...
      /* @__PURE__ */ import_react136.default.createElement("div", { className: "menu-button" }, /* @__PURE__ */ import_react136.default.createElement(Help_default, { width: 20, height: 20 }), "I need help")
    ), sourceChain.shortName === "CC" && formStep > 0 && /* @__PURE__ */ import_react136.default.createElement(ExternalLink_default, { to: "https://docs.kima.network/kima-network/supported-fiat#unsupported-countries-credit-cards" }, /* @__PURE__ */ import_react136.default.createElement("div", { className: "menu-button" }, "Unsupported Countries")), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ import_react136.default.createElement(
      "button",
      {
      ...
      "Reset"
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ import_react136.default.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ import_react136.default.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ import_react136.default.createElement(
      SingleForm_default,
      {
        ...{
    ...
    ) : ccTransactionStatus !== "idle" ? /* @__PURE__ */ import_react136.default.createElement(CCWidget_default, null) : /* @__PURE__ */ import_react136.default.createElement(
      ...
      /* @__PURE__ */ import_react136.default.createElement("div", { className: "kima-powered" }, /* @__PURE__ */ import_react136.default.createElement("span", null, "POWERED BY"), /* @__PURE__ */ import_react136.default.createElement("span", { className: "kima-logo" }, /* @__PURE__ */ import_react136.default.createElement(FooterLogo_default, { fill: "#666666" }), /* @__PURE__ */ import_react136.default.createElement("span", null, "Network"))),
      /* @__PURE__ */ import_react136.default.createElement("div", { className: `button-group` }, isBackButtonEnabled && /* @__PURE__ */ import_react136.default.createElement(
        SecondaryButton_default,
        {
          clickHandler: onBack,
          theme: theme.colorMode,
      ...
      ), !!allowance && allowance > 0 && formStep !== 0 && sourceChain.shortName !== "CC" && mode !== "light" /* light */ ? /* @__PURE__ */ import_react136.default.createElement(
        SecondaryButton_default,
        {
      ...
      ) : null, isSubmitButtonEnabled && /* @__PURE__ */ import_react136.default.createElement(
        PrimaryButton_default,
        {
          clickHandler: onNext,
    ...
    ), /* @__PURE__ */ import_react136.default.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ import_react136.default.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ import_react136.default.createElement(
...
// src/components/KimaWidgetWrapper.tsx
var import_react139 = require("@reown/appkit/react");

// src/hooks/useDebugMode.ts
var import_react137 = require("react");
var useDebugCode = (sequence = ["D", "E", "B", "U", "G"]) => {
  const [debugMode, setDebugMode] = (0, import_react137.useState)(false);
  const [, setInputSequence] = (0, import_react137.useState)([]);
...
var KimaWidgetWrapper = ({
  ...
  const { setThemeMode, setThemeVariables } = (0, import_react139.useAppKitTheme)();
  ...
  return submitted ? /* @__PURE__ */ import_react138.default.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ import_react138.default.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
...
var SkeletonLoader = ({ theme }) => {
  return /* @__PURE__ */ import_react140.default.createElement(
    ...
    /* @__PURE__ */ import_react140.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react140.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react140.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react140.default.createElement("div", { className: "title skeleton" }, /* @__PURE__ */ import_react140.default.createElement("h3", null))), /* @__PURE__ */ import_react140.default.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ import_react140.default.createElement("div", { className: "kima-card-content skeleton" }, /* @__PURE__ */ import_react140.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react140.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react140.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react140.default.createElement("div", { className: "skeleton" }), /* @__PURE__ */ import_react140.default.createElement("div", { className: "skeleton" })), /* @__PURE__ */ import_react140.default.createElement("div", { className: `kima-card-footer` }, /* @__PURE__ */ import_react140.default.createElement("div", { className: `button-group skeleton` }, /* @__PURE__ */ import_react140.default.createElement("div", { className: "skeleton" }))))
  );
};
...
var ErrorWidget = ({
  ...
  return /* @__PURE__ */ import_react141.default.createElement(
    ...
    /* @__PURE__ */ import_react141.default.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: "topbar" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: "title" }, /* @__PURE__ */ import_react141.default.createElement("h3", null, title))), /* @__PURE__ */ import_react141.default.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ import_react141.default.createElement("div", { className: "kima-card-content error" }, /* @__PURE__ */ import_react141.default.createElement(Error_default, { width: 40, height: 40 }), /* @__PURE__ */ import_react141.default.createElement("h2", null, message)), backButtonEnabled && /* @__PURE__ */ import_react141.default.createElement("div", { style: { display: "flex", justifyContent: "flex-end" } }, /* @__PURE__ */ import_react141.default.createElement(PrimaryButton_default, { clickHandler: backButtonFunction }, "Back")), /* @__PURE__ */ import_react141.default.createElement("div", { className: `kima-card-footer` }), /* @__PURE__ */ import_react141.default.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ import_react141.default.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ import_react141.default.createElement("span", null, "Powered by"), /* @__PURE__ */ import_react141.default.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ import_react141.default.createElement("strong", null, "Network"))))
  );
};
...
var KimaTransactionWidget = ({
  ...
  const { kimaBackendUrl } = useKimaContext();
  const [hydrated, setHydrated] = (0, import_react142.useState)(false);
  ...
  if (!hydrated || !theme?.colorMode) return /* @__PURE__ */ import_react142.default.createElement(ring_default, { width: 20, height: 20, fill: "#86b8ce" });
  if (isLoadingEnvs || isLoadingChainData)
    return /* @__PURE__ */ import_react142.default.createElement(SkeletonLoader_default, { theme });
