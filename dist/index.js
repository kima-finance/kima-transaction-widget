  ...
  return /* @__PURE__ */ React18.createElement(
    ...
    /* @__PURE__ */ React18.createElement(
      ...
      /* @__PURE__ */ React18.createElement(
        ...
        /* @__PURE__ */ React18.createElement('use', {
          href: '#image0_214_308',
  ...
  return /* @__PURE__ */ React19.createElement(
    ...
    /* @__PURE__ */ React19.createElement(
      ...
      /* @__PURE__ */ React19.createElement(
        ...
        /* @__PURE__ */ React19.createElement('use', {
          href: '#image0_214_312',
...
var ExternalUrl = ({ width = 40, height = 40, fill = 'black', ...rest }) => {
  return /* @__PURE__ */ React32.createElement(
    ...
    /* @__PURE__ */ React32.createElement(
      'mask',
      { id: 'path-2-inside-1_883_418', fill: 'white' },
      /* @__PURE__ */ React32.createElement('path', {
        'fill-rule': 'evenodd',
        'clip-rule': 'evenodd',
...
var SupportedChainIdTestnet = /* @__PURE__ */ ((SupportedChainIdTestnet2) => {
  SupportedChainIdTestnet2[(SupportedChainIdTestnet2['ETHEREUM'] = 11155111)] =
    'ETHEREUM'
  SupportedChainIdTestnet2[(SupportedChainIdTestnet2['POLYGON'] = 80002)] =
    'POLYGON'
  SupportedChainIdTestnet2[(SupportedChainIdTestnet2['AVALANCHE'] = 43113)] =
    'AVALANCHE'
  SupportedChainIdTestnet2[(SupportedChainIdTestnet2['BSC'] = 97)] = 'BSC'
  SupportedChainIdTestnet2[(SupportedChainIdTestnet2['ARBITRUM'] = 421614)] =
    'ARBITRUM'
  SupportedChainIdTestnet2[(SupportedChainIdTestnet2['OPTIMISM'] = 11155420)] =
    'OPTIMISM'
  SupportedChainIdTestnet2[(SupportedChainIdTestnet2['POLYGON_ZKEM'] = 2442)] =
    'POLYGON_ZKEM'
...
var SupportedChainIdMainnet = /* @__PURE__ */ ((SupportedChainIdMainnet2) => {
  SupportedChainIdMainnet2[(SupportedChainIdMainnet2['ETHEREUM'] = 1)] =
    'ETHEREUM'
  SupportedChainIdMainnet2[(SupportedChainIdMainnet2['POLYGON'] = 137)] =
    'POLYGON'
  SupportedChainIdMainnet2[(SupportedChainIdMainnet2['AVALANCHE'] = 43114)] =
    'AVALANCHE'
  SupportedChainIdMainnet2[(SupportedChainIdMainnet2['BSC'] = 56)] = 'BSC'
  SupportedChainIdMainnet2[(SupportedChainIdMainnet2['ARBITRUM'] = 42161)] =
    'ARBITRUM'
  SupportedChainIdMainnet2[(SupportedChainIdMainnet2['OPTIMISM'] = 10)] =
    'OPTIMISM'
  SupportedChainIdMainnet2[(SupportedChainIdMainnet2['POLYGON_ZKEM'] = 1101)] =
    'POLYGON_ZKEM'
...
var isEVMChain = (chainId) =>
  chainId === 'ETH' /* ETHEREUM */ ||
  chainId === 'POL' /* POLYGON */ ||
  chainId === 'AVX' /* AVALANCHE */ ||
  chainId === 'BSC' /* BSC */ ||
  chainId === 'OPT' /* OPTIMISM */ ||
  chainId === 'ARB' /* ARBITRUM */ ||
  chainId === 'ZKE' /* POLYGON_ZKEVM */
var COIN_LIST = {
  USDK: {
    symbol: 'USDK',
    icon: USDK_default
...
var setupAppKit = (projectId, networkOption) => {
  const networks =
    networkOption === 'mainnet' ? appkitMainnetChains : appkitTestnetChains
  return createAppKit({
...
// plugins/evm/features/walletConnect/WalletProvider.tsx
var WalletProvider = ({ children, networkOption, walletConnectProjectId }) => {
...
function useBalance() {
  ...
  const tokenAddress = useMemo(() => {
    if (isEmptyObject(tokenOptions) || sourceChain === 'FIAT' /* FIAT */)
      return ''
...
function useIsWalletReady() {
  ...
  const correctEvmNetwork = useMemo2(() => {
    return networkOption === 'mainnet' /* mainnet */
      ? CHAIN_NAMES_TO_APPKIT_NETWORK_MAINNET2[sourceChain]
      : CHAIN_NAMES_TO_APPKIT_NETWORK_TESTNET2[sourceChain]
...
var EvmPlugin = class extends PluginBase {
  ...
  Provider = ({ children, networkOption, walletConnectProjectId }) => {
...
var KimaProvider = ({ walletConnectProjectId, children }) => {
...
import {
  useDispatch as useDispatch30,
  useSelector as useSelector42
} from 'react-redux'
      ...
      stepInfo.map((item, index) =>
        /* @__PURE__ */ React72.createElement(
          ...
          /* @__PURE__ */ React72.createElement(
            ...
            { className: 'step-info' },
            step < index &&
              /* @__PURE__ */ React72.createElement(Lock_default, null),
            step >= index
              ? index === loadingStep
                ? /* @__PURE__ */ React72.createElement(Loader_default, {
                    className: 'loader'
                  })
                : index === errorStep
                  ? /* @__PURE__ */ React72.createElement(Warning_default, null)
                  : /* @__PURE__ */ React72.createElement(Check_default, null)
              : null,
            /* @__PURE__ */ React72.createElement('span', null, item.title)
          )
        )
      )
    )
...
var ExternalLink = ({ to, children, className, rest }) =>
    ...
    SourceInfo?.label &&
      /* @__PURE__ */ React74.createElement(
        ...
        /* @__PURE__ */ React74.createElement(
          'div',
          { className: 'icon' },
          /* @__PURE__ */ React74.createElement(SourceInfo.icon, null)
        ),
        /* @__PURE__ */ React74.createElement('p', null, SourceInfo.label)
      ),
    SourceInfo?.label &&
      TargetInfo?.label &&
      /* @__PURE__ */ React74.createElement(
        'div',
        { className: 'arrow' },
        /* @__PURE__ */ React74.createElement(Arrow_default, null)
      ),
    TargetInfo?.label &&
      /* @__PURE__ */ React74.createElement(
        'span',
        ...
        /* @__PURE__ */ React74.createElement(
          'div',
          { className: 'icon' },
          /* @__PURE__ */ React74.createElement(TargetInfo.icon, null)
        ),
        /* @__PURE__ */ React74.createElement('p', null, TargetInfo.label)
      )
  )
}
...
var Loading180Ring = ({ width = 24, height = 24, fill = 'white' }) => {
  return /* @__PURE__ */ React75.createElement(
    ...
    /* @__PURE__ */ React75.createElement(
      ...
      /* @__PURE__ */ React75.createElement('animateTransform', {
    ...
    /* @__PURE__ */ React77.createElement(
      ...
      isLoading &&
        /* @__PURE__ */ React77.createElement(
          ...
          /* @__PURE__ */ React77.createElement(ring_default, {
            width: 24,
            height: 24,
            fill: 'white'
          })
...
import {
  useSelector as useSelector10,
  useDispatch as useDispatch4
} from 'react-redux'
...
function ChainIcon({ symbol, width = 30, height = 30 }) {
  ...
  return /* @__PURE__ */ React79.createElement(
    'div',
    { className: 'icon' },
    /* @__PURE__ */ React79.createElement(Icon, { width, height })
  )
}
...
var Network = ({ isOriginChain = true }) => {
  ...
  return /* @__PURE__ */ React80.createElement(
    ...
    /* @__PURE__ */ React80.createElement(
      ...
      /* @__PURE__ */ React80.createElement(Arrow_default, {
    ...
    /* @__PURE__ */ React80.createElement(
      'div',
      { className: 'slide-area hide-scrollbar', ref: sliderRef },
      /* @__PURE__ */ React80.createElement(
        'div',
        ...
        networks.map((network) =>
          /* @__PURE__ */ React80.createElement(
            ...
            /* @__PURE__ */ React80.createElement(ChainIcon, {
              symbol: network.id
            }),
...
import {
  useDispatch as useDispatch7,
  useSelector as useSelector14
} from 'react-redux'
...
function useIsWalletReady4() {
  ...
  const correctEvmNetwork = useMemo9(() => {
    return networkOption === 'mainnet' /* mainnet */
      ? CHAIN_NAMES_TO_APPKIT_NETWORK_MAINNET[correctChain] || mainnet4
      : CHAIN_NAMES_TO_APPKIT_NETWORK_TESTNET[correctChain] || sepolia4
...
async function getAssociatedTokenAddress(
  ...
  associatedTokenProgramId = ASSOCIATED_TOKEN_PROGRAM_ID2
) {
...
async function getOrCreateAssociatedTokenAccount(
  ...
  associatedTokenProgramId = ASSOCIATED_TOKEN_PROGRAM_ID3
) {
...
function useBalance2() {
  ...
  const sourceChain = useMemo10(() => {
    if (
      ...
      selectedNetwork === 'TRX' /* TRON */ ||
      selectedNetwork === 'BTC' /* BTC */
    )
  ...
  const tokenAddress = useMemo10(() => {
    if (isEmptyObject2(tokenOptions) || sourceChain === 'FIAT' /* FIAT */)
      return ''
    ...
    ;(async () => {
      ...
      try {
        ...
        if (walletProvider) {
          ...
          const erc20Contract = new Contract2(
            tokenAddress,
            erc20ABI_default2.abi,
            signer
          )
...
var CopyButton = ({ text }) => {
  ...
  return /* @__PURE__ */ React82.createElement(
    ...
    copyClicked
      ? /* @__PURE__ */ React82.createElement(Check_default, null)
      : /* @__PURE__ */ React82.createElement(Copy_default, null)
  )
}
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  return /* @__PURE__ */ React83.createElement(
    ...
    /* @__PURE__ */ React83.createElement(
      ...
      isReady &&
        /* @__PURE__ */ React83.createElement(CopyButton_default, {
          text: walletAddress
        })
    ),
    isReady
...
import {
  useSelector as useSelector17,
  useDispatch as useDispatch10
} from 'react-redux'
import toast7 from 'react-hot-toast'
var NetworkDropdown = React85.memo(({ isSourceChain = true }) => {
  ...
  useEffect13(() => {
    ...
    ;(async function () {
      try {
        if (
          dAppOption === 'LPAdd' /* LPAdd */ ||
          dAppOption === 'LPDrain' /* LPDrain */
        ) {
  ...
  return /* @__PURE__ */ React85.createElement(
    ...
    /* @__PURE__ */ React85.createElement(
      ...
      /* @__PURE__ */ React85.createElement(ChainIcon, {
        symbol: selectedNetwork.id
      }),
      /* @__PURE__ */ React85.createElement('span', null, selectedNetwork.label)
    ),
    /* @__PURE__ */ React85.createElement(
      'div',
      {
    ...
    /* @__PURE__ */ React85.createElement(
      ...
      /* @__PURE__ */ React85.createElement(Arrow_default, { fill: 'none' })
    )
  )
})
...
var ConfirmDetails = ({ isApproved }) => {
  ...
  const amountToShow = useMemo15(() => {
    if (
      originNetwork === 'BTC' /* BTC */ ||
      targetNetwork === 'BTC' /* BTC */
    ) {
    ...
    originNetwork === 'FIAT' /* FIAT */
      ? /* @__PURE__ */ React86.createElement(
          ...
          /* @__PURE__ */ React86.createElement(
            ...
            /* @__PURE__ */ React86.createElement('p', null, 'Kima Sandbox')
          ),
          /* @__PURE__ */ React86.createElement(
            'div',
            { className: 'detail-item' },
            ...
            /* @__PURE__ */ React86.createElement('p', null, 'CAIXESBBXXX')
          ),
          /* @__PURE__ */ React86.createElement(
            'div',
            { className: 'detail-item' },
    ...
    /* @__PURE__ */ React86.createElement(
      ...
      /* @__PURE__ */ React86.createElement(
        ...
        /* @__PURE__ */ React86.createElement(
          ...
          /* @__PURE__ */ React86.createElement(SourceCoinIcon, null),
          /* @__PURE__ */ React86.createElement(
            'p',
            null,
            amountToShow,
        ...
        sourceCurrency !== targetCurrency &&
          /* @__PURE__ */ React86.createElement(
            ...
            { className: 'coin-details' },
            '\u2192 ',
            /* @__PURE__ */ React86.createElement(TargetCoinIcon, null),
            ' ',
            targetCurrency
          ),
        /* @__PURE__ */ React86.createElement(
          ...
          /* @__PURE__ */ React86.createElement(
            ...
            formatterFloat2.format(totalFeeUsd),
            ' ',
            sourceCurrency
          )
        ),
        /* @__PURE__ */ React86.createElement(
          'div',
          { className: 'amount-details' },
          /* @__PURE__ */ React86.createElement('span', null, 'Total'),
          /* @__PURE__ */ React86.createElement(
            'span',
            { className: 'service-fee' },
            formatterFloat2.format(parseFloat(amountToShow) - totalFeeUsd),
            ' ',
            targetCurrency
          )
        )
    ...
    targetNetwork === 'FIAT' /* FIAT */
      ? /* @__PURE__ */ React86.createElement(
          ...
          /* @__PURE__ */ React86.createElement(
            ...
            /* @__PURE__ */ React86.createElement('p', null, bankDetails.iban),
            /* @__PURE__ */ React86.createElement(
              'span',
              { className: `kima-card-network-label ${theme.colorMode}` },
              /* @__PURE__ */ React86.createElement(
...
var AddressInput = ({ theme, placeholder }) => {
  ...
  return /* @__PURE__ */ React88.createElement(
    ...
    /* @__PURE__ */ React88.createElement(
      ...
      /* @__PURE__ */ React88.createElement(
        ...
        checked && /* @__PURE__ */ React88.createElement(Check_default, null)
      ),
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  return /* @__PURE__ */ React89.createElement(
    ...
    /* @__PURE__ */ React89.createElement(
      ...
      stepInfo2.map((item, index) =>
        /* @__PURE__ */ React89.createElement(
          'div',
          { key: item.title, className: 'step-item' },
          /* @__PURE__ */ React89.createElement(
            'div',
            {
              className: `info-item
            ...
            step < index &&
              /* @__PURE__ */ React89.createElement(Lock_default, null),
            step >= index
              ? index === loadingStep
                ? /* @__PURE__ */ React89.createElement(Loader_default, {
                    className: 'loader'
                  })
                : index === errorStep
                  ? /* @__PURE__ */ React89.createElement(Warning_default, null)
                  : /* @__PURE__ */ React89.createElement(Check_default, null)
              : null,
          ...
          index === 0 && data?.kimaTxHash
            ? /* @__PURE__ */ React89.createElement(
                ...
                /* @__PURE__ */ React89.createElement(
                  'div',
                  { className: 'icon' },
                  /* @__PURE__ */ React89.createElement(USDK_default, null)
                ),
                /* @__PURE__ */ React89.createElement(
                  'p',
                ...
                /* @__PURE__ */ React89.createElement(
                  ...
                  /* @__PURE__ */ React89.createElement(CopyButton_default, {
                    text: data?.kimaTxHash
                  })
                )
              )
            : null,
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ React90.createElement(
    ...
    /* @__PURE__ */ React90.createElement(
      ...
      /* @__PURE__ */ React90.createElement('input', {
...
var TxButton = ({ theme }) => {
  ...
  return /* @__PURE__ */ React91.createElement(
    ...
    txCount,
    /* @__PURE__ */ React91.createElement(ring_default, {
      height: 16,
      width: 16,
      fill: theme.colorMode === 'light' ? 'black' : 'white'
    })
...
var useGetTxData = (txId, dAppOption, backendUrl) => {
  ...
  const isLP =
    dAppOption === 'LPAdd' /* LPAdd */ || dAppOption === 'LPDrain' /* LPDrain */
  const result = useQuery4({
    ...
    queryFn: async () => {
      try {
        ...
        const data = selectStatus(response)
...
var TransactionWidget = ({ theme }) => {
  ...
  useEffect17(() => {
    ...
    if (
      ...
      setLoadingStep(-1)
      console.log(data.failReason)
      toast8.error('Failed to pull tokens from source!', {
        icon: /* @__PURE__ */ React92.createElement(Error_default, null)
      })
    ...
    /* @__PURE__ */ React155.createElement(
      ...
      /* @__PURE__ */ React92.createElement(
        ...
        /* @__PURE__ */ React92.createElement(
          ...
          /* @__PURE__ */ React92.createElement(
            ...
            /* @__PURE__ */ React92.createElement(
              ...
              null,
              'Transferring ',
              formatterFloat2.format(data?.amount || 0),
              ' ',
          ...
          !minimized
            ? /* @__PURE__ */ React92.createElement(
                ...
                loadingStep < 0
                  ? /* @__PURE__ */ React155.createElement(
                      'button',
                      { className: 'reset-button', onClick: resetForm },
                      'Reset'
                    )
                  : null
              )
            : /* @__PURE__ */ React155.createElement(
                ...
                /* @__PURE__ */ React155.createElement(
                  'div',
                  { className: 'maximize', onClick: () => setMinimized(false) },
                  'View'
                )
              )
        ),
        !minimized &&
          data?.sourceChain &&
          data?.targetChain &&
          /* @__PURE__ */ React155.createElement(NetworkLabel_default, {
      ...
      /* @__PURE__ */ React92.createElement(
        ...
        /* @__PURE__ */ React92.createElement(Progressbar_default, {
          step,
          focus,
          errorStep,
          setFocus,
        ...
        /* @__PURE__ */ React92.createElement(StepBox_default, {
          step,
          errorStep,
          loadingStep,
          data
      ...
      /* @__PURE__ */ React92.createElement(Toaster, {
        position: 'top-right',
        reverseOrder: false,
        containerStyle: {
          position: 'absolute'
        ...
        toastOptions: {
          ...
          style: {
            ...
            background:
              theme.colorMode === 'light' /* light */ ? '#F7F8F9' : '#242732'
          }
        }
      }),
      /* @__PURE__ */ React92.createElement(
        ...
        /* @__PURE__ */ React92.createElement(
          ...
          /* @__PURE__ */ React92.createElement('span', null, 'Powered by'),
          /* @__PURE__ */ React92.createElement(FooterLogo_default, {
            fill: 'black'
          }),
          /* @__PURE__ */ React92.createElement('strong', null, 'Network')
        )
      )
    )
  )
...
import {
  useDispatch as useDispatch29,
  useSelector as useSelector41
} from 'react-redux'
...
import {
  useDispatch as useDispatch20,
  useSelector as useSelector31
} from 'react-redux'
...
import {
  useSelector as useSelector27,
  useDispatch as useDispatch16
} from 'react-redux'
...
import {
  useSelector as useSelector25,
  useDispatch as useDispatch15
} from 'react-redux'
var SourceNetworkSelectorComponent = () => {
    ...
    const data =
      chainData
        ...
        .map((network) => ({
          ...
          label: network.name,
          icon: network.icon
            ? /* @__PURE__ */ React156.createElement(network.icon, null)
            : /* @__PURE__ */ React156.createElement('div', null)
  ...
  const selectedNetwork = useMemo16(() => {
    return (
      ...
      networks[0] || { id: '', label: 'Loading...' }
    )
  }, [originNetwork, networks])
  useEffect19(() => {}, [chainData])
  ...
  return /* @__PURE__ */ React93.createElement(
    ...
    /* @__PURE__ */ React93.createElement(
      'div',
      { className: 'network-wrapper' },
      /* @__PURE__ */ React93.createElement(ChainIcon, {
        symbol: selectedNetwork.id
      }),
      /* @__PURE__ */ React93.createElement('span', null, selectedNetwork.label)
    ),
    /* @__PURE__ */ React93.createElement(
      'div',
      {
      ...
      networks
        ...
        .map((filteredNetwork) =>
          /* @__PURE__ */ React93.createElement(
            ...
            /* @__PURE__ */ React93.createElement(ChainIcon, {
              symbol: filteredNetwork.id
            }),
            /* @__PURE__ */ React93.createElement(
              'p',
              null,
              filteredNetwork.label
            )
          )
        )
    ),
    /* @__PURE__ */ React93.createElement(
      'div',
      { className: `dropdown-icon ${collapsed ? 'toggled' : 'collapsed'}` },
      /* @__PURE__ */ React93.createElement(Arrow_default, { fill: 'none' })
    )
  )
}
...
import {
  useSelector as useSelector28,
  useDispatch as useDispatch17
} from 'react-redux'
...
function TokenIcon({ symbol, width = 30, height = 30 }) {
  if (!symbol) return null
  ...
  return /* @__PURE__ */ React94.createElement(
    ...
    /* @__PURE__ */ React94.createElement(Icon, { width, height })
  )
}
...
var TokenBadgeComponent = ({ symbol }) => {
  ...
  return /* @__PURE__ */ React95.createElement(
    'div',
    { className: `coin-dropdown single-coin ${theme.colorMode}` },
    /* @__PURE__ */ React95.createElement(
      'div',
      { className: `coin-wrapper ${theme.colorMode}` },
      /* @__PURE__ */ React95.createElement(TokenIcon, { symbol }),
      symbol
    )
  )
}
...
var SourceTokenSelectorComponent = () => {
  ...
  const selectedToken = useMemo17(() => {
    return (
      ...
      tokens[0] || { id: '', label: 'Select Token' }
    )
  ...
  if (tokens.length <= 1) {
    return /* @__PURE__ */ React96.createElement(TokenBadge_default, {
  ...
  return /* @__PURE__ */ React96.createElement(
    ...
    /* @__PURE__ */ React96.createElement(
      ...
      /* @__PURE__ */ React96.createElement(TokenIcon, {
        symbol: selectedToken.id
      }),
      /* @__PURE__ */ React96.createElement('span', null, selectedToken.label)
    ),
    /* @__PURE__ */ React96.createElement(
      'div',
      {
    ...
    /* @__PURE__ */ React96.createElement(
      'div',
      { className: `dropdown-icon ${collapsed ? 'toggled' : 'collapsed'}` },
      /* @__PURE__ */ React96.createElement(Arrow_default, { fill: 'none' })
    )
  )
}
...
import {
  useSelector as useSelector29,
  useDispatch as useDispatch18
} from 'react-redux'
var TargetNetworkSelectorComponent = () => {
  ...
  return /* @__PURE__ */ React97.createElement(
    ...
    /* @__PURE__ */ React97.createElement(
      'div',
      { className: 'network-wrapper' },
      /* @__PURE__ */ React97.createElement(ChainIcon, {
        symbol: selectedNetwork.id
      }),
      /* @__PURE__ */ React97.createElement('span', null, selectedNetwork.label)
    ),
    /* @__PURE__ */ React97.createElement(
      'div',
      {
    ...
    /* @__PURE__ */ React156.createElement(
      'div',
      { className: `dropdown-icon ${collapsed ? 'toggled' : 'collapsed'}` },
      /* @__PURE__ */ React156.createElement(Arrow_default, { fill: 'none' })
    )
  )
}
...
var SourceTokenSelectorComponent = () => {
  ...
  const tokens = useMemo18(() => {
    ...
    if (network && network.tokens) {
      return network.tokens.map((token) => ({
        ...
        label: token.symbol,
        icon: token.icon
          ? /* @__PURE__ */ React157.createElement(token.icon, null)
          : /* @__PURE__ */ React157.createElement('div', null)
        // Render the icon as JSX
      }))
    }
    return []
  ...
  const selectedToken = useMemo18(() => {
    return (
      tokens.find((token) => token.id === sourceCurrency) ||
      tokens[0] || { label: 'Select Token', icon: null }
    )
  }, [tokens, sourceCurrency])
  const handleTokenChange = (tokenId) => {
    if (tokenId === sourceCurrency) return
  ...
  return /* @__PURE__ */ React157.createElement(
    ...
    /* @__PURE__ */ React157.createElement(
      ...
      /* @__PURE__ */ React157.createElement('span', null, selectedToken.label)
    ),
    /* @__PURE__ */ React157.createElement(
      'div',
      {
    ...
    /* @__PURE__ */ React157.createElement(
      'div',
      { className: `dropdown-icon ${collapsed ? 'toggled' : 'collapsed'}` },
      /* @__PURE__ */ React157.createElement(Arrow_default, { fill: 'none' })
    )
  )
}
...
var TargetNetworkSelectorComponent = () => {
  ...
  const networks = useMemo19(() => {
    const data =
      chainData.map((network) => ({
        ...
        label: network.name,
        icon: network.icon
          ? /* @__PURE__ */ React158.createElement(network.icon, null)
          : /* @__PURE__ */ React158.createElement('div', null)
        // Render the icon as JSX
      })) || []
  ...
  return /* @__PURE__ */ React158.createElement(
    ...
    /* @__PURE__ */ React97.createElement(
      'div',
      { className: `dropdown-icon ${collapsed ? 'toggled' : 'collapsed'}` },
      /* @__PURE__ */ React97.createElement(Arrow_default, { fill: 'none' })
    )
  )
}
...
import {
  useSelector as useSelector30,
  useDispatch as useDispatch19
} from 'react-redux'
var TargetTokenSelectorComponent = () => {
  ...
  const tokens = useMemo20(() => {
    ...
    if (network && network.tokens) {
      return network.tokens.map((token) => ({
        ...
        label: token.symbol,
        icon: token.icon
          ? /* @__PURE__ */ React159.createElement(token.icon, null)
          : /* @__PURE__ */ React159.createElement('div', null)
        // Render the icon as JSX
      }))
    }
    return []
  ...
  return /* @__PURE__ */ React159.createElement(
    ...
    /* @__PURE__ */ React159.createElement(
      ...
      /* @__PURE__ */ React159.createElement('span', null, selectedToken.label)
    ),
    /* @__PURE__ */ React159.createElement(
      'div',
      {
    ...
    /* @__PURE__ */ React159.createElement(
      'div',
      { className: `dropdown-icon ${collapsed ? 'toggled' : 'collapsed'}` },
      /* @__PURE__ */ React159.createElement(Arrow_default, { fill: 'none' })
    )
  )
}
  ...
  return /* @__PURE__ */ React98.createElement(
    ...
    /* @__PURE__ */ React98.createElement(
      ...
      /* @__PURE__ */ React98.createElement(
        ...
        { className: 'items' },
        /* @__PURE__ */ React98.createElement(
          SourceNetworkSelector_default,
          null
        ),
        /* @__PURE__ */ React98.createElement(SourceTokenSelector_default, null)
      )
    ),
    /* @__PURE__ */ React98.createElement(
      'div',
      ...
      mode === 'bridge' /* bridge */ &&
        /* @__PURE__ */ React160.createElement(
          ...
          /* @__PURE__ */ React160.createElement(
            ...
            { className: 'items' },
            /* @__PURE__ */ React160.createElement(
              TargetNetworkSelector_default,
              null
            ),
            networkOpion === 'mainnet' /* mainnet */
              ? /* @__PURE__ */ React160.createElement(
                  TargetTokenSelector_default,
                  null
                )
              : /* @__PURE__ */ React160.createElement(
                  'div',
                  ...
                  /* @__PURE__ */ React160.createElement(
                    ...
                    /* @__PURE__ */ React160.createElement(
                      'div',
                      { className: 'icon-wrapper' },
                      /* @__PURE__ */ React160.createElement(TargetIcon, null)
                    ),
                    targetCurrency
                  )
                )
    ...
    mode === 'bridge' /* bridge */ && sourceNetwork !== 'FIAT' /* FIAT */
      ? targetNetwork === 'FIAT' /* FIAT */
        ? /* @__PURE__ */ React160.createElement(BankInput_default, null)
        : /* @__PURE__ */ React160.createElement(
            'div',
            { className: `form-item ${theme.colorMode}` },
            /* @__PURE__ */ React160.createElement(
            ...
            /* @__PURE__ */ React160.createElement(AddressInput_default, {
    ...
    mode === 'bridge' /* bridge */
      ? /* @__PURE__ */ React160.createElement(
          ...
          /* @__PURE__ */ React160.createElement(
            'div',
            { className: `amount-label-container items ${theme.colorMode}` },
            /* @__PURE__ */ React160.createElement('input', {
              className: `${theme.colorMode}`,
              type: 'number',
              placeholder: 'Amount',
              value: amountValue || '',
      ...
      : /* @__PURE__ */ React98.createElement(
          ...
          /* @__PURE__ */ React98.createElement(
            'div',
            { className: `amount-label-container items ${theme.colorMode}` },
            /* @__PURE__ */ React98.createElement('input', {
              className: `${theme.colorMode}`,
              type: 'number',
              placeholder: 'Amount',
    ...
    mode === 'bridge' /* bridge */ && totalFeeUsd > 0
      ? /* @__PURE__ */ React160.createElement(CustomCheckbox_default, {
          text:
            sourceNetwork === 'BTC' /* BTC */
              ? `Deduct ${formatterFloat2.format(totalFeeUsd)} BTC fee`
              : `Deduct $${formatterFloat2.format(totalFeeUsd)} fee`,
          checked: feeDeduct,
...
var CoinSelect = () => {
  ...
  return /* @__PURE__ */ React99.createElement(
    ...
    /* @__PURE__ */ React99.createElement(
      'p',
      null,
      'Select Amount of Token for Funding'
    ),
    /* @__PURE__ */ React99.createElement(
      'div',
      { className: `amount-input ${theme.colorMode}` },
      /* @__PURE__ */ React99.createElement('span', null, 'Amount:'),
      /* @__PURE__ */ React99.createElement(
        'div',
        { className: 'input-wrapper' },
        /* @__PURE__ */ React99.createElement('input', {
          type: 'number',
          value: amountValue || '',
        ...
        /* @__PURE__ */ React99.createElement(
          ...
          /* @__PURE__ */ React99.createElement(Icon, null),
          /* @__PURE__ */ React99.createElement('span', null, selectedCoin)
        )
      )
    )
  )
...
function createApproveTransferInstruction(
  source,
  destination,
  owner,
  amount,
...
function useAllowance({ setApproving, setCancellingApprove }) {
      ...
      try {
        ...
        if (!isEVMChain(sourceChain)) {
          if (solanaAddress && tokenAddress && connection) {
            ...
            const userAllowance2 = await trc20Contract
        ...
        const provider = new ethers3.providers.Web3Provider(walletProvider)
        const signer = provider?.getSigner()
        if (!tokenAddress || !targetAddress || !signer || !signerAddress) return
        const erc20Contract = new Contract3(
          tokenAddress,
          erc20ABI_default2.abi,
          signer
        )
...
var AddressInputWizard = () => {
  ...
  return /* @__PURE__ */ React100.createElement(
    ...
    /* @__PURE__ */ React100.createElement(
      'p',
      null,
      'Select Target Address for Funding'
    ),
    /* @__PURE__ */ React100.createElement(
      'div',
      { className: `address-input ${theme.colorMode}` },
      /* @__PURE__ */ React100.createElement('span', null, 'Target Address:'),
      /* @__PURE__ */ React100.createElement(AddressInput_default, {
        theme: theme.colorMode,
        placeholder: 'Target address'
      })
    )
...
import {
  useDispatch as useDispatch23,
  useSelector as useSelector36
} from 'react-redux'
...
import {
  useDispatch as useDispatch22,
  useSelector as useSelector35
} from 'react-redux'
    ...
    /* @__PURE__ */ React102.createElement(
        ...
        /* @__PURE__ */ React102.createElement(
          ...
          /* @__PURE__ */ React102.createElement(
            ...
            /* @__PURE__ */ React102.createElement(
              ...
              /* @__PURE__ */ React102.createElement(Cross_default, {
                fill: theme.colorMode === 'light' ? 'black' : 'white'
              })
            )
          )
      ...
      /* @__PURE__ */ React102.createElement(
        ...
        /* @__PURE__ */ React102.createElement(
          ...
          { className: 'summary' },
          networkDetails &&
            /* @__PURE__ */ React102.createElement(networkDetails.icon, {
              width: 60,
              height: 60
            }),
          /* @__PURE__ */ React102.createElement(
            ...
            /* @__PURE__ */ React102.createElement(CopyButton_default, {
              text: walletAddress
            })
          ),
          /* @__PURE__ */ React102.createElement(
        ...
        /* @__PURE__ */ React102.createElement(
          ...
          /* @__PURE__ */ React102.createElement(
            ExternalLink_default,
            { className: 'link', to: explorerUrl },
            /* @__PURE__ */ React102.createElement(Explorer_default, {
              fill: '#778DA3'
            }),
            /* @__PURE__ */ React102.createElement('p', null, 'Block explorer'),
            /* @__PURE__ */ React102.createElement(ExternalUrl_default, {
              fill: '#778DA3'
            })
          )
        ),
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ React103.createElement(
    'div',
    null,
    /* @__PURE__ */ React103.createElement(AccountDetailsModal_default, null),
          ...
          /* @__PURE__ */ React103.createElement(
            ...
            /* @__PURE__ */ React103.createElement(
              ...
              /* @__PURE__ */ React103.createElement(
                ...
                /* @__PURE__ */ React103.createElement(Cross_default, {
                  width: 30,
                  height: 30,
                  fill: theme.colorMode === 'light' ? 'black' : 'white'
                })
...
import {
  useDispatch as useDispatch26,
  useSelector as useSelector39
} from 'react-redux'

// plugins/tron/components/AccountDetailsModal.tsx
import React104, { useMemo as useMemo23 } from 'react'
import {
  useDispatch as useDispatch24,
  useSelector as useSelector37
} from 'react-redux'
    ...
    /* @__PURE__ */ React104.createElement(
        ...
        /* @__PURE__ */ React104.createElement(
          ...
          /* @__PURE__ */ React104.createElement(
            ...
            /* @__PURE__ */ React104.createElement(
              ...
              /* @__PURE__ */ React104.createElement(Cross_default, {
                fill: theme.colorMode === 'light' ? 'black' : 'white'
              })
            )
          )
      ...
      /* @__PURE__ */ React104.createElement(
        ...
        /* @__PURE__ */ React104.createElement(
          ...
          { className: 'summary' },
          networkDetails &&
            /* @__PURE__ */ React104.createElement(networkDetails.icon, {
              width: 60,
              height: 60
            }),
          /* @__PURE__ */ React104.createElement(
            ...
            /* @__PURE__ */ React104.createElement(CopyButton_default, {
              text: walletAddress
            })
          ),
          /* @__PURE__ */ React104.createElement(
        ...
        /* @__PURE__ */ React104.createElement(
          ...
          /* @__PURE__ */ React104.createElement(
            ExternalLink_default,
            { className: 'link', to: explorerUrl },
            /* @__PURE__ */ React104.createElement(Explorer_default, {
              fill: '#778DA3'
            }),
            /* @__PURE__ */ React104.createElement('p', null, 'Block explorer'),
            /* @__PURE__ */ React104.createElement(ExternalUrl_default, {
              fill: '#778DA3'
            })
          )
        ),
        ...
        detected.map((wallet, index) =>
          /* @__PURE__ */ React105.createElement(
            ...
            /* @__PURE__ */ React105.createElement(
              'div',
              { className: 'wallet-item' },
              /* @__PURE__ */ React105.createElement('img', {
                src: wallet.adapter.icon,
                alt: wallet.adapter.name
              }),
              /* @__PURE__ */ React105.createElement(
...
var TronWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ React106.createElement(
    'div',
    null,
    /* @__PURE__ */ React106.createElement(AccountDetailsModal_default2, null),
    /* @__PURE__ */ React106.createElement(
      ...
      /* @__PURE__ */ React106.createElement(
          ...
          /* @__PURE__ */ React106.createElement(
            ...
            /* @__PURE__ */ React106.createElement(
              ...
              /* @__PURE__ */ React106.createElement(
                ...
                /* @__PURE__ */ React106.createElement(Cross_default, {
                  fill: theme.colorMode === 'light' ? 'black' : 'white'
                })
              )
            )
        ...
        /* @__PURE__ */ React106.createElement(
          'div',
          { className: 'modal-content' },
          /* @__PURE__ */ React106.createElement(TronWalletSelect_default, null)
        )
      )
    )
  )
...
var TransferWidget = ({
  ...
  const handleSubmit = async () => {
    ...
    if (error === 'ValidationError' /* Error */) {
      return toast12.error(validationMessage, {
    ...
    if (!success)
      return toast12.error(submitMessage, {
        icon: /* @__PURE__ */ React169.createElement(Error_default, null)
      })
  }
  const onNext = () => {
  ...
  return /* @__PURE__ */ React107.createElement(
    ...
    mode === 'payment' /* payment */ &&
      ...
      /* @__PURE__ */ React169.createElement(
        'h2',
        { className: 'invalid-option-banner' },
        "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."
      ),
    /* @__PURE__ */ React169.createElement(
      'div',
      ...
      /* @__PURE__ */ React169.createElement(
        ...
        /* @__PURE__ */ React169.createElement(
          ...
          /* @__PURE__ */ React169.createElement(
            ...
            { className: 'control-buttons' },
            pendingTxs > 0
              ? /* @__PURE__ */ React169.createElement(TxButton_default, {
                  theme
                })
              : null,
            /* @__PURE__ */ React169.createElement(
        ...
        /* @__PURE__ */ React169.createElement(
          'h4',
          { className: 'subtitle' },
          mode === 'payment' /* payment */ && paymentTitleOption?.title
        )
      ),
      /* @__PURE__ */ React169.createElement(
        'div',
        { className: 'kima-card-content', ref: mainRef },
        isWizard
          ? wizardStep === 0
            ? /* @__PURE__ */ React169.createElement(
                NetworkSelect_default,
                null
              )
            : wizardStep === 1
              ? /* @__PURE__ */ React169.createElement(
                  ...
                  /* @__PURE__ */ React169.createElement(WalletButton_default, {
                    errorBelow: true
                  })
                )
              : wizardStep === 2
          ...
          : formStep === 0
            ? /* @__PURE__ */ React169.createElement(SingleForm_default, null)
            : /* @__PURE__ */ React169.createElement(ConfirmDetails_default, {
                isApproved
              })
      ),
      /* @__PURE__ */ React169.createElement(
          ...
          /* @__PURE__ */ React107.createElement(
            PrimaryButton_default,
            {
              ...
              disabled:
                ...
                isSubmitting ||
                isSigning ||
                (mode === 'payment' /* payment */ && !transactionOption)
            },
            getButtonLabel()
          )
        )
      ...
      /* @__PURE__ */ React169.createElement(
        SolanaWalletConnectModal_default,
        null
      ),
      /* @__PURE__ */ React169.createElement(
        TronWalletConnectModal_default,
        null
      ),
      /* @__PURE__ */ React169.createElement(Toaster2, {
        position: 'top-right',
        reverseOrder: false,
        containerStyle: {
          position: 'absolute'
      ...
      /* @__PURE__ */ React169.createElement(
        ...
        /* @__PURE__ */ React169.createElement(
          'div',
          { className: `items ${theme.colorMode}` },
          /* @__PURE__ */ React169.createElement('span', null, 'Powered by'),
          /* @__PURE__ */ React169.createElement(FooterLogo_default, {
            width: 50,
            fill: 'black'
          }),
          /* @__PURE__ */ React169.createElement('strong', null, 'Network')
        )
      )
    )
  )
...
var KimaTransactionWidget = ({
  ...
  return submitted
    ? /* @__PURE__ */ React108.createElement(TransactionWidget, { theme })
    : /* @__PURE__ */ React108.createElement(TransferWidget, {
        theme,
        feeURL,
        helpURL,
        titleOption,
