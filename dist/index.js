...
import { Provider, useSelector as useSelector15 } from "react-redux";
...
var WalletProvider = ({
  ...
  return /* @__PURE__ */ React37.createElement(React37.Fragment, null, children);
};
...
import React75, { useMemo as useMemo3 } from "react";
...
import { useEffect as useEffect3, useMemo as useMemo6 } from "react";
...
var InternalKimaProvider = React77.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children }) => {
    ...
    const plugins = useSelector15(selectAllPlugins, (prev, next) => prev === next);
...
import { useDispatch as useDispatch25, useSelector as useSelector43 } from "react-redux";

// src/components/TransactionWidget.tsx
import React101, { useEffect as useEffect13, useMemo as useMemo12, useState as useState7 } from "react";
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ React78.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ React78.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ React78.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ React78.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ React78.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ React78.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ React78.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ React78.createElement(Warning_default, null) : /* @__PURE__ */ React78.createElement(Check_default, null) : null, /* @__PURE__ */ React78.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ React79.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ React81.createElement(
    ...
    /* @__PURE__ */ React81.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ React81.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ React83.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ React83.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ React83.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React83.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ React84.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React84.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
import React88, { useEffect as useEffect8, useMemo as useMemo8 } from "react";
import { useDispatch as useDispatch6, useSelector as useSelector20 } from "react-redux";
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ React86.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = useState2(default_default);
  const isIndexed = useSelector19(selectPluginIsIndexed);
...
import React87, { useEffect as useEffect6, useState as useState4 } from "react";
var CopyButton = ({ text }) => {
  ...
  return /* @__PURE__ */ React87.createElement(
    ...
    copyClicked ? /* @__PURE__ */ React87.createElement(Check_default, null) : /* @__PURE__ */ React87.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  const sourceCompliant = useSelector20(selectSourceCompliant);
  const compliantOption = useSelector20(selectCompliantOption);
  const selectedNetwork = useSelector20(selectSourceChain);
  const { externalProvider } = useKimaContext();
  ...
  return /* @__PURE__ */ React88.createElement(
    ...
    /* @__PURE__ */ React88.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ React88.createElement(
      "button",
      {
      ...
      !isReady && /* @__PURE__ */ React88.createElement(Wallet_default, null),
      !isReady && "Connect Wallet"
    ), isReady && /* @__PURE__ */ React88.createElement(CopyButton_default, { text: walletAddress })),
    isReady && balance !== void 0 && decimals !== void 0 ? /* @__PURE__ */ React88.createElement("p", { className: "balance-info" }, formatUSD(bigIntToNumber({ value: balance, decimals })), " ", selectedCoin, " available") : null
  );
};
var WalletButton_default = WalletButton;

// src/components/reusable/CoinDropdown.tsx
import React90, { useEffect as useEffect10, useRef, useState as useState5 } from "react";
...
function useCurrencyOptions(isSourceChain) {
  ...
  const networks = useSelector21(selectNetworks);
...
function TokenIcon({
  ...
  return /* @__PURE__ */ React89.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ React89.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  return /* @__PURE__ */ React90.createElement(
    ...
    /* @__PURE__ */ React90.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ React90.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ React90.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ React90.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ React90.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React90.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ React90.createElement("p", null, token.symbol)
      ))
    ),
    /* @__PURE__ */ React90.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ React90.createElement(Arrow_default, { fill: "none" }))
  );
};
var CoinDropdown_default = CoinDropdown;

// src/components/reusable/ConfirmDetails.tsx
import React93, { useEffect as useEffect11, useMemo as useMemo10 } from "react";
...
function ChainIcon({
  ...
  return /* @__PURE__ */ React91.createElement("div", { className: "icon" }, /* @__PURE__ */ React91.createElement(Icon, null));
}

// src/components/reusable/FeeDeductionRadioButtons.tsx
import React92 from "react";
import { useDispatch as useDispatch9, useSelector as useSelector23 } from "react-redux";
var FeeDeductionRadioButtons = ({ disabled }) => {
  const dispatch = useDispatch9();
  const feeDeduct = useSelector23(selectFeeDeduct);
  const amount = useSelector23(selectAmount);
  const sourceNetwork = useSelector23(selectSourceChain);
  const targetNetwork = useSelector23(selectTargetChain);
  const { totalFee: feeTotalBigInt } = useSelector23(selectServiceFee);
  ...
  return /* @__PURE__ */ React92.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ React92.createElement("div", { className: "fee-options" }, /* @__PURE__ */ React92.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ React92.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  ), /* @__PURE__ */ React92.createElement("span", { className: `radio-label ${theme.colorMode}` }, `Pay $${formatterFloat.format(
    Number(amount)
  )} ${sourceCurrency} in ${sourceNetwork.name} to receive $${formatterFloat.format(
    Number(amount) - totalFee
  )} ${targetCurrency} in ${targetNetwork.name}`)), /* @__PURE__ */ React92.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ React92.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({
  ...
  const { transactionValues, sourceFee, targetFee, kimaFee, totalFee } = useSelector24(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const originNetwork = useSelector24(selectSourceChain);
  const targetNetwork = useSelector24(selectTargetChain);
  const targetAddress = useSelector24(selectTargetAddress);
  const bankDetails = useSelector24(selectBankDetails);
  const signature = useSelector24(selectSignature);
  const networkOptions3 = useSelector24(selectNetworks);
  ...
  return /* @__PURE__ */ React93.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ React93.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React93.createElement("div", null, /* @__PURE__ */ React93.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React93.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React93.createElement(ChainIcon, { symbol: originNetworkOption?.shortName }), "FIAT"), /* @__PURE__ */ React93.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ React93.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React93.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ React93.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ React93.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ React93.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ React93.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ React93.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "Source wallet:"), /* @__PURE__ */ React93.createElement("div", { className: "network-details" }, /* @__PURE__ */ React93.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React93.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React93.createElement(ChainIcon, { symbol: originNetworkOption?.shortName }), originNetworkOption.name)), /* @__PURE__ */ React93.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : walletAddress : dAppOption === "LPDrain" /* LPDrain */ ? targetWalletAddress : sourceWalletAddress))), /* @__PURE__ */ React93.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "Transaction", width > 500 && /* @__PURE__ */ React93.createElement("br", null), "Details:"), /* @__PURE__ */ React93.createElement("span", { className: "amount-container" }, /* @__PURE__ */ React93.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React93.createElement("span", null, "Source Transfer amount"), /* @__PURE__ */ React93.createElement("div", { className: "coin-details" }, /* @__PURE__ */ React93.createElement("p", null, formatBigInt(txValues.allowanceAmount), sourceCurrency))), /* @__PURE__ */ React93.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React93.createElement("span", null, "Source Network Fee (", originNetwork.shortName, ")"), /* @__PURE__ */ React93.createElement("span", { className: "service-fee" }, formatBigInt(sourceFee), " ", sourceCurrency)), /* @__PURE__ */ React93.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React93.createElement("span", null, "Kima Service Fee"), /* @__PURE__ */ React93.createElement("span", { className: "service-fee" }, formatBigInt(kimaFee), " USD")), /* @__PURE__ */ React93.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React93.createElement("span", null, "Target Network Fee (", targetNetwork.shortName, ")"), /* @__PURE__ */ React93.createElement("span", { className: "service-fee" }, formatBigInt(targetFee), " ", sourceCurrency)), /* @__PURE__ */ React93.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React93.createElement("span", null, "Target Transfer Amount"), /* @__PURE__ */ React93.createElement("span", { className: "service-fee" }, formatBigInt(totalFee), " ", targetCurrency)))), targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React93.createElement("div", null, /* @__PURE__ */ React93.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React93.createElement("p", null, bankDetails.iban), /* @__PURE__ */ React93.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React93.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), "FIAT")), /* @__PURE__ */ React93.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React93.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ React93.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React93.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ React93.createElement("div", { className: "network-details" }, /* @__PURE__ */ React93.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React93.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React93.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), targetNetworkOption?.name)), /* @__PURE__ */ React93.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? walletAddress : targetAddress : dAppOption === "LPDrain" /* LPDrain */ ? sourceWalletAddress : targetWalletAddress))), mode === "bridge" /* bridge */ && BigInt(totalFee.value) > BigInt(0) ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ React93.createElement(FeeDeductionRadioButtons_default, { disabled: feeOptionDisabled })
  ) : null);
};
var ConfirmDetails_default = ConfirmDetails;

// src/components/reusable/AddressInput.tsx
import React94, { useEffect as useEffect12 } from "react";
...
var AddressInput = ({
  ...
  const sourceChain = useSelector25(selectSourceChain);
...
import React96, { useMemo as useMemo11 } from "react";
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  const explorerUrl = useSelector27(selectKimaExplorer);
  const networkOption = useSelector27(selectNetworkOption);
  ...
  return /* @__PURE__ */ React96.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ React96.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ React96.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ React96.createElement(
    "div",
    {
      className: `info-item
    ...
    step < index && /* @__PURE__ */ React96.createElement(Lock_default, null),
    step >= index ? index === loadingStep ? /* @__PURE__ */ React96.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ React96.createElement(Warning_default, null) : /* @__PURE__ */ React96.createElement(Check_default, null) : null,
    /* @__PURE__ */ React96.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ React96.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ React96.createElement("div", { className: "icon" }, /* @__PURE__ */ React96.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ React96.createElement("p", { className: "chain-name" }, "Kima TX ID:"), /* @__PURE__ */ React96.createElement("p", null, /* @__PURE__ */ React96.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ React96.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash ? /* @__PURE__ */ React96.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ React96.createElement(ChainIcon, { symbol: data.sourceChain }),
    /* @__PURE__ */ React96.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"),
    /* @__PURE__ */ React96.createElement("p", null, /* @__PURE__ */ React96.createElement(
      ExternalLink_default,
      {
    ...
    ), /* @__PURE__ */ React96.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ React96.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React96.createElement(ChainIcon, { symbol: data.sourceChain }), /* @__PURE__ */ React96.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"), /* @__PURE__ */ React96.createElement("p", null, /* @__PURE__ */ React96.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React96.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ React96.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React96.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ React96.createElement("p", { className: "chain-name" }, targetChain?.name, " TX ID:"), /* @__PURE__ */ React96.createElement("p", null, /* @__PURE__ */ React96.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React96.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  const bankDetails = useSelector28(selectBankDetails);
  return /* @__PURE__ */ React97.createElement("div", { className: "bank-input" }, /* @__PURE__ */ React97.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React97.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React97.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React97.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React97.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React97.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TxButton = ({ theme }) => {
  ...
  const txCount = useSelector29(selectPendingTxs);
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ React99.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ React99.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ React99.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ React99.createElement("h3", null, transactionId), /* @__PURE__ */ React99.createElement(CopyButton_default, { text: transactionId })));
};
var TransactionStatusMessage_default = TransactionStatusMessage;

// src/components/reusable/TransactionSearch.tsx
import React100, { useRef as useRef3, useState as useState6 } from "react";
...
var TransactionSearch = () => {
  ...
  const [transactionId, setTransactionId] = useState6("");
...
var TransactionWidget = ({ theme }) => {
  ...
  const [focus, setFocus] = useState7(-1);
  const [errorStep, setErrorStep] = useState7(-1);
  const [errorMessage, setErrorMessage] = useState7("");
  const [loadingStep, setLoadingStep] = useState7(-1);
  ...
  const txId = useSelector31(selectTxId);
  const dAppOption = useSelector31(selectDappOption);
  const { transactionValues } = useSelector31(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const transactionOption = useSelector31(selectTransactionOption);
  const sourceChain = useSelector31(selectSourceChain);
  const targetChain = useSelector31(selectTargetChain);
  const sourceSymbol = useSelector31(selectSourceCurrency);
  const targetSymbol = useSelector31(selectTargetCurrency);
  const networks = useSelector31(selectNetworks);
  ...
  useEffect13(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      toast3.error("Unavailable", { icon: /* @__PURE__ */ React101.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      console.log(data.failReason);
      toast3.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ React101.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ React101.createElement(Provider2, { store }, /* @__PURE__ */ React101.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React101.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React101.createElement("div", { className: "topbar" }, /* @__PURE__ */ React101.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ React101.createElement("h3", { className: "transaction" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING" : isEmptyStatus ? "GETTING TRANSACTION STATUS" : data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING", /* @__PURE__ */ React101.createElement("div", null, mode !== "status" /* status */ ? Number(amount) !== 0 ? formatBigInt(txValues.allowanceAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `(${sourceSymbol})` : isEmptyStatus ? "" : `(${data?.sourceSymbol})`, /* @__PURE__ */ React101.createElement("div", { className: "title-icon" }, /* @__PURE__ */ React101.createElement(
      ChainIcon,
      {
        symbol: transactionSourceChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `(${transactionSourceChain?.shortName})` : isEmptyStatus ? "" : `(${data?.sourceChain})`, " ", mode !== "status" /* status */ ? `\u2192 ` : isEmptyStatus ? "" : `\u2192 `, mode !== "status" /* status */ ? Number(amount) !== 0 ? bigIntToNumber(txValues.allowanceAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `(${targetSymbol})${" "}` : isEmptyStatus ? "" : `(${data?.targetSymbol})${" "}`, /* @__PURE__ */ React101.createElement("div", { className: "title-icon" }, /* @__PURE__ */ React101.createElement(
      ChainIcon,
      {
        symbol: transactionTargetChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `(${transactionTargetChain?.shortName})${" "}` : isEmptyStatus ? "" : `(${data?.targetChain}) ${" "}`)) : /* @__PURE__ */ React101.createElement("div", null, /* @__PURE__ */ React101.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ React101.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React101.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React101.createElement(Minimize_default, null)
    ), !isValidTxId || loadingStep < 0 || error ? /* @__PURE__ */ React101.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ React101.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React101.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    isValidTxId && !error ? /* @__PURE__ */ React101.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ React101.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ React101.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )), !error && !isEmptyStatus && /* @__PURE__ */ React101.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ React101.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ React101.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ React101.createElement("div", { className: "single-form" }, /* @__PURE__ */ React101.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ React101.createElement(
      Toaster,
      {
        position: "top-right",
    ...
    /* @__PURE__ */ React101.createElement("div", { className: "floating-footer status" }, /* @__PURE__ */ React101.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ React101.createElement("span", null, "Powered by"), /* @__PURE__ */ React101.createElement(FooterLogo_default, { fill: "black" }), /* @__PURE__ */ React101.createElement("strong", null, "Network")))
  ));
};

// src/components/TransferWidget.tsx
import React111, { useEffect as useEffect18, useState as useState11, useRef as useRef7 } from "react";
import { useDispatch as useDispatch24, useSelector as useSelector42 } from "react-redux";

// src/components/reusable/SingleForm.tsx
import React103, { useEffect as useEffect15, useMemo as useMemo14, useState as useState9 } from "react";
import { toast as toast4 } from "react-hot-toast";
import { useDispatch as useDispatch16, useSelector as useSelector34 } from "react-redux";
...
import React102, { useState as useState8, useMemo as useMemo13, useRef as useRef4, useEffect as useEffect14 } from "react";
import { useSelector as useSelector33, useDispatch as useDispatch15 } from "react-redux";
var NetworkSelector = ({ type }) => {
  ...
  return /* @__PURE__ */ React102.createElement(
    ...
    /* @__PURE__ */ React102.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ React102.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ React102.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ React102.createElement(
      "div",
      {
        className: `network-menu custom-scrollbar ${theme?.colorMode ?? ""} ${collapsed ? "collapsed" : "toggled"}`
      },
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ React102.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ React102.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ React102.createElement("p", null, network.name)
      ))
    ),
    /* @__PURE__ */ React102.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ React102.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = React102.memo(NetworkSelector);
...
var SingleForm = ({
  ...
  const [amountValue, setAmountValue] = useState9("");
  ...
  return /* @__PURE__ */ React103.createElement("div", { className: "single-form" }, /* @__PURE__ */ React103.createElement("div", { className: "form-item" }, /* @__PURE__ */ React103.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ React103.createElement("div", { className: "items" }, /* @__PURE__ */ React103.createElement(NetworkSelector_default, { type: "source" }), /* @__PURE__ */ React103.createElement(CoinDropdown_default, null))), /* @__PURE__ */ React103.createElement(
    ...
    /* @__PURE__ */ React103.createElement(
      ...
      /* @__PURE__ */ React103.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ React103.createElement(WalletButton_default, null)
    ),
    mode === "bridge" /* bridge */ && /* @__PURE__ */ React103.createElement("div", { className: "form-item" }, /* @__PURE__ */ React103.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ React103.createElement("div", { className: "items" }, /* @__PURE__ */ React103.createElement(NetworkSelector_default, { type: "target" }), /* @__PURE__ */ React103.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React103.createElement(BankInput_default, null) : /* @__PURE__ */ React103.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React103.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ React103.createElement(
    ...
    "Max"
  ), +totalFee !== -1 && /* @__PURE__ */ React103.createElement("p", null, "Est fees: $ ", formatBigInt(totalFee), " USD")))));
};
...
import React104, { useCallback as useCallback2, useEffect as useEffect16, useMemo as useMemo15, useRef as useRef5 } from "react";
...
var SolanaWalletSelect = () => {
  ...
  return /* @__PURE__ */ React104.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React104.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React104.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ React104.createElement(
    ...
    /* @__PURE__ */ React104.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React104.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React104.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ React104.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React104.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React104.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React104.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
var SolanaWalletSelect_default = SolanaWalletSelect;

// plugins/solana/components/AccountDetailsModal.tsx
import React105, { useMemo as useMemo16 } from "react";
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ React106.createElement("div", null, /* @__PURE__ */ React106.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ React106.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ React106.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React106.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
import React108, { useEffect as useEffect17, useMemo as useMemo18, useRef as useRef6 } from "react";
...
var TronWalletSelect = () => {
  ...
  return /* @__PURE__ */ React108.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React108.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React108.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ React108.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ React108.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React108.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React108.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ React108.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React108.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React108.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React108.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ React109.createElement("div", null, /* @__PURE__ */ React109.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ React109.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ React109.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React109.createElement(TronWalletSelect_default, null)))
  ));
};
...
var useSubmitTransaction = () => {
  ...
  const [isSubmitting, setSubmitting] = useState10(false);
...
var TransferWidget = ({
  ...
  const [signature, setSignature2] = useState11("");
  const [formStep, setFormStep] = useState11(0);
  const [warningModalOpen, setWarningModalOpen] = useState11(null);
  ...
  const { totalFee, transactionValues } = useSelector42(selectServiceFee);
  const compliantOption = useSelector42(selectCompliantOption);
  const networkOptions3 = useSelector42(selectNetworkOption);
  const feeDeduct = useSelector42(selectFeeDeduct);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const { keplrHandler, closeHandler } = useKimaContext();
  const [isCancellingApprove, setCancellingApprove] = useState11(false);
  const [isApproving, setApproving] = useState11(false);
  const [isSigning, setSigning] = useState11(false);
  const [feeOptionDisabled, setFeeOptionDisabled] = useState11(false);
  const pendingTxs = useSelector42(selectPendingTxs);
  const networks = useSelector42(selectNetworks);
  ...
  return /* @__PURE__ */ React111.createElement(
    ...
    /* @__PURE__ */ React111.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React111.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React111.createElement("div", { className: "topbar" }, /* @__PURE__ */ React111.createElement("div", { className: "title" }, /* @__PURE__ */ React111.createElement("h3", null, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ React111.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ React111.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ React111.createElement(
      ...
      ), !!allowance && allowance > 0 && formStep !== 0 ? /* @__PURE__ */ React111.createElement(
        SecondaryButton_default,
        {
