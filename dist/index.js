...
import { Provider, useSelector as useSelector25 } from "react-redux";
...
var LoadingErrorTitle = /* @__PURE__ */ ((LoadingErrorTitle2) => {
  LoadingErrorTitle2["EnvLoadingError"] = "Fatal ENV Initialization Error";
  LoadingErrorTitle2["ChainLoadingError"] = "Fatal Chains Initialization Error";
  return LoadingErrorTitle2;
})(LoadingErrorTitle || {});
var LoadingErrorMessage = /* @__PURE__ */ ((LoadingErrorMessage2) => {
  LoadingErrorMessage2["EnvLoadingError"] = "There was an error loading the required environment variables from the backend. Please check that the backend is running properly and the widget points to the corresponding url.";
  LoadingErrorMessage2["ChainLoadingError"] = "There was an error loading the chain data from the backend. Please check that the backend is running properly and the widget points to the corresponding url.";
  return LoadingErrorMessage2;
})(LoadingErrorMessage || {});
...
var Minimize = ({ width = 16, height = 1, fill = "#86B8CE", ...rest }) => {
  return /* @__PURE__ */ jsx2(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      ...rest,
      children: /* @__PURE__ */ jsx2("rect", { width: "11", height: "1", fill })
    }
  );
};
...
var Arrow2 = ({ width = 22, height = 25, fill = "none", ...rest }) => {
  return /* @__PURE__ */ jsxs3(
    "svg",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx7("path", { d: "M10.9974 0L10.9974 16.625", stroke: "#778DA3", strokeWidth: "2" }),
        /* @__PURE__ */ jsx7(
          "path",
          {
...
var Ethereum = ({ width = 30, height = 30, ...rest }) => {
  return /* @__PURE__ */ jsxs5(
    "svg",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx9("path", { d: "M10.9966 13.3093V0L0 18.3307L10.9966 13.3093Z", fill: "#8A92B2" }),
        /* @__PURE__ */ jsx9(
          "path",
          {
        ...
        /* @__PURE__ */ jsx9("path", { d: "M10.9966 26.9561L0 20.4297L10.9966 36V26.9561Z", fill: "#8A92B2" }),
        /* @__PURE__ */ jsx9("path", { d: "M22 20.4297L10.9966 26.9561V36L22 20.4297Z", fill: "#62688F" })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxs6(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx10("defs", { children: /* @__PURE__ */ jsxs6(
          "linearGradient",
          {
            ...
            children: [
              /* @__PURE__ */ jsx10("stop", { stopColor: "#CF41E8" }),
              /* @__PURE__ */ jsx10("stop", { offset: "1", stopColor: "#10F2B0" })
            ]
          }
        ) })
      ]
...
var Error2 = ({ width = 21, height = 20, ...rest }) => {
  return /* @__PURE__ */ jsxs8(
    "svg",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx14("circle", { cx: "10.9331", cy: "10", r: "10", fill: "#B90000" }),
        /* @__PURE__ */ jsx14("rect", { x: "8.93311", y: "3", width: "4", height: "9", rx: "2", fill: "white" }),
        /* @__PURE__ */ jsx14("rect", { x: "8.93311", y: "13", width: "4", height: "4", rx: "2", fill: "white" })
      ]
    }
  );
};
...
var USDC = ({ width = 37, height = 37, ...rest }) => {
  return /* @__PURE__ */ jsxs11(
    "svg",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx18("rect", { width: "37", height: "37", fill: "url(#pattern4)" }),
        /* @__PURE__ */ jsxs11("defs", { children: [
          /* @__PURE__ */ jsx18(
            "pattern",
            {
              ...
              width: "1",
              height: "1",
              children: /* @__PURE__ */ jsx18("use", { href: "#image0_214_308", transform: "scale(0.00552486)" })
            }
          ),
          /* @__PURE__ */ jsx18(
            "image",
...
var USDT = ({ width = 37, height = 37, ...rest }) => {
  return /* @__PURE__ */ jsxs12(
    "svg",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx19("rect", { width: "37", height: "37", fill: "url(#pattern5)" }),
        /* @__PURE__ */ jsxs12("defs", { children: [
          /* @__PURE__ */ jsx19(
            "pattern",
            {
              ...
              width: "1",
              height: "1",
              children: /* @__PURE__ */ jsx19("use", { href: "#image0_214_312", transform: "scale(0.00390625)" })
            }
          ),
          /* @__PURE__ */ jsx19(
            "image",
...
var Bank = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ jsxs17(
    "svg",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx25("path", { d: "M6 9.4375V20.4062", stroke: "#86B8CE", strokeWidth: "2" }),
        /* @__PURE__ */ jsx25("path", { d: "M12 9.4375V20.4062", stroke: "#86B8CE", strokeWidth: "2" }),
        /* @__PURE__ */ jsx25("path", { d: "M18 9.4375V20.4062", stroke: "#86B8CE", strokeWidth: "2" }),
        /* @__PURE__ */ jsx25("path", { d: "M24 9.4375V20.4062", stroke: "#86B8CE", strokeWidth: "2" }),
        /* @__PURE__ */ jsx25(
          "path",
          {
            d: "M26 20L3 20",
...
var KEUR = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ jsx27(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      ...rest,
      children: /* @__PURE__ */ jsxs19("g", { fill: "none", fillRule: "evenodd", children: [
        /* @__PURE__ */ jsx27("circle", { cx: "16", cy: "16", fill: "#0f8ff8", r: "16" }),
        /* @__PURE__ */ jsx27(
          "path",
          {
  ...
  return /* @__PURE__ */ jsxs21(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx32("mask", { id: "path-2-inside-1_883_418", fill: "white", children: /* @__PURE__ */ jsx32(
          "path",
          {
            fillRule: "evenodd",
            clipRule: "evenodd",
...
var Bera = ({ width = 31, height = 30, ...rest }) => {
  return /* @__PURE__ */ jsx35(
    "svg",
    {
      ...
      viewBox: "0, 0, 400,408",
      ...rest,
      children: /* @__PURE__ */ jsxs23("g", { id: "svgg", children: [
        /* @__PURE__ */ jsx35(
          "path",
          {
            id: "path0",
  ...
  return /* @__PURE__ */ jsxs24(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx36("g", { filter: "url(#filter0_dd_6594_45)", children: /* @__PURE__ */ jsx36(
          "path",
          {
        ...
        /* @__PURE__ */ jsxs24("defs", { children: [
          /* @__PURE__ */ jsxs24(
            "filter",
            {
              ...
              children: [
                /* @__PURE__ */ jsx36("feFlood", { "flood-opacity": "0", result: "BackgroundImageFix" }),
                /* @__PURE__ */ jsx36(
                  "feColorMatrix",
                  {
                    in: "SourceAlpha",
                ...
                /* @__PURE__ */ jsx36("feOffset", { dy: "0.5" }),
                /* @__PURE__ */ jsx36("feGaussianBlur", { stdDeviation: "0.5" }),
                /* @__PURE__ */ jsx36("feComposite", { in2: "hardAlpha", operator: "out" }),
                /* @__PURE__ */ jsx36(
                  "feColorMatrix",
                  {
                    type: "matrix",
          ...
          /* @__PURE__ */ jsxs24(
            "radialGradient",
            {
              ...
              children: [
                /* @__PURE__ */ jsx36("stop", { "stop-color": "#E9D0B4" }),
                /* @__PURE__ */ jsx36("stop", { offset: "1", "stop-color": "#DA9713" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs24(
            "radialGradient",
            {
              ...
              children: [
                /* @__PURE__ */ jsx36("stop", { "stop-color": "#E9D0B4" }),
                /* @__PURE__ */ jsx36("stop", { offset: "1", "stop-color": "#EC8A19" })
              ]
            }
          )
        ] })
...
var CFX = ({ width = 30, height = 30, ...rest }) => {
  return /* @__PURE__ */ jsx40(
    "svg",
    {
      ...
      fill: "none",
      ...rest,
      children: /* @__PURE__ */ jsx40("g", { children: /* @__PURE__ */ jsxs26("g", { children: [
        /* @__PURE__ */ jsx40(
          "polygon",
          {
            fill: "#181818",
  ...
  return /* @__PURE__ */ jsxs27(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx41("rect", { width: "100", height: "100", fill: "url(#pattern0_1506_393)" }),
        /* @__PURE__ */ jsxs27("defs", { children: [
          /* @__PURE__ */ jsx41(
            "pattern",
            {
              ...
              width: "1",
              height: "1",
              children: /* @__PURE__ */ jsx41("use", { xlinkHref: "#image0_1506_393", transform: "scale(0.005)" })
            }
          ),
          /* @__PURE__ */ jsx41(
            "image",
  ...
  return /* @__PURE__ */ jsxs28(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs28("g", { filter: "url(#filter0_d_1838_5769)", children: [
          /* @__PURE__ */ jsx42("circle", { cx: "70.3622", cy: "57.9308", r: "37.9308", fill: "white" }),
          /* @__PURE__ */ jsx42(
            "circle",
            {
              cx: "70.3622",
        ...
        /* @__PURE__ */ jsxs28("defs", { children: [
          /* @__PURE__ */ jsxs28(
            "filter",
            {
              ...
              children: [
                /* @__PURE__ */ jsx42("feFlood", { floodOpacity: "0", result: "BackgroundImageFix" }),
                /* @__PURE__ */ jsx42(
                  "feColorMatrix",
                  {
                    in: "SourceAlpha",
                ...
                /* @__PURE__ */ jsx42("feOffset", {}),
                /* @__PURE__ */ jsx42("feGaussianBlur", { stdDeviation: "9.64341" }),
                /* @__PURE__ */ jsx42("feComposite", { in2: "hardAlpha", operator: "out" }),
                /* @__PURE__ */ jsx42(
                  "feColorMatrix",
                  {
                    type: "matrix",
          ...
          /* @__PURE__ */ jsxs28(
            "linearGradient",
            {
              ...
              gradientUnits: "userSpaceOnUse",
              children: [
                /* @__PURE__ */ jsx42("stop", { stopColor: "#ADF4A6" }),
                /* @__PURE__ */ jsx42("stop", { offset: "0.315", stopColor: "#80D7F5" }),
                /* @__PURE__ */ jsx42("stop", { offset: "0.775", stopColor: "#9990D5" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs28(
...
var CHAIN_NAMES_TO_EXPLORER_TESTNET = {
  ...
  ["CFX" /* CFX */]: "evmtestnet.confluxscan.org"
};
...
var TransactionStatus = /* @__PURE__ */ ((TransactionStatus2) => {
  TransactionStatus2["AVAILABLE"] = "Available";
  TransactionStatus2["CONFIRMED"] = "Pull_Confirmed";
  TransactionStatus2["PULLED"] = "Pulled";
  TransactionStatus2["PAID"] = "Paid";
  TransactionStatus2["COMPLETED"] = "Completed";
  TransactionStatus2["FAILEDTOPAY"] = "FailedToPay";
  TransactionStatus2["FAILEDTOPULL"] = "FailedToPull";
  TransactionStatus2["UNAVAILABLE"] = "UnAvailable";
  TransactionStatus2["REFUNDSTART"] = "RefundStart";
  TransactionStatus2["REFUNDFAILED"] = "RefundFailed";
  TransactionStatus2["REFUNDCOMPLETED"] = "RefundCompleted";
  TransactionStatus2["DECLINEDINVALID"] = "DeclinedInvalid";
...
var ChainCompatibility = /* @__PURE__ */ ((ChainCompatibility2) => {
  ...
  ChainCompatibility2["FIAT"] = "FIAT";
  ChainCompatibility2["COSMOS"] = "COSMOS";
  ChainCompatibility2["SELF"] = "SELF";
  ChainCompatibility2["CC"] = "CC";
  ChainCompatibility2["BANK"] = "BANK";
  return ChainCompatibility2;
})(ChainCompatibility || {});
...
// src/shared/store/pluginSlice.tsx
...
if (log.getLevel() !== DEFAULT_LOG_LEVEL) {
...
// src/shared/store/optionSlice.tsx
import * as toolkitRaw from "@reduxjs/toolkit";
var { createSlice: createSlice2 } = toolkitRaw;
var ZERO = { value: BigInt(0), decimals: 0 };
...
var toMutableChain = (c) => {
  const defaultHttp = c.rpcUrls?.default?.http ?? [];
  const publicHttp = c.rpcUrls?.public?.http ?? [];
  return {
    ...c,
    // ensure arrays are mutable
    supportedTokens: Array.isArray(c.supportedTokens) ? [...c.supportedTokens] : [],
    rpcUrls: {
      ...c.rpcUrls ?? {
        default: { http: [] },
        public: { http: [] }
...
var optionSlice = createSlice2({
  name: "option",
  initialState: initialState2,
  reducers: {
    initialize: (state) => {
      Object.assign(state, initialState2);
    },
...
var INITIAL_SOURCE_CHAIN = SOURCE_PLACEHOLDER;
var INITIAL_TARGET_CHAIN = TARGET_PLACEHOLDER;
...
var indexPluginsByChain = (chains) => {
  ...
  const sameSize = Object.keys(next).length === Object.keys(pluginsByChain).length;
  const sameContent = sameSize && Object.keys(next).every((k) => pluginsByChain[k] === next[k]);
  if (!sameContent) {
    pluginsByChain = next;
    logger_default.debug("[registry] pluginsByChain result:", Object.keys(pluginsByChain));
  }
...
// src/shared/plugins/PluginBase.ts
...
// src/shared/store/selectors.tsx
...
var getTokenAddress = (tokenOptions, selectedCoin, chain) => {
  ...
  logger_default.debug("[addresses.getTokenAddress]", { selectedCoin, chain, addr });
  return addr;
};
var getPoolAddress = (pools, chain) => {
  if (!pools?.length) {
    logger_default.debug("[addresses.getPoolAddress] pools empty", { chain });
    return void 0;
  }
  const pool = pools.find((p) => p.chainName === chain);
  const addr = pool?.poolAddress?.trim();
  logger_default.debug("[addresses.getPoolAddress] resolved", {
    chain,
    addr,
    hasBalances: !!pool?.balance?.length
  });
  return addr ? addr : void 0;
};
...
var useEvmAddress = (mode) => {
  ...
  return useMemo(() => {
    ...
    const ext = externalProvider?.signer?.address;
    return ext || appkitAddress || "";
  }, [mode, externalProvider, appkitAddress]);
};

// src/features/allowances/evm/useApproveErc20.ts
import { useAppKitAccount as useAppKitAccount2, useAppKitProvider } from "@reown/appkit/react";
var useApproveErc20 = () => {
    ...
    async (isCancel = false) => {
      try {
        if (!tokenAddress || !poolAddress || !sourceChain) {
          logger_default.warn("[useApproveErc20] missing data", {
            tokenAddress,
            poolAddress,
            sourceChain
          });
        ...
        if (!eip1193?.request) {
          logger_default.error("[useApproveErc20] No EIP-1193 provider available");
          return;
        }
        ...
        await qc.invalidateQueries({
          predicate: (q) => Array.isArray(q.queryKey) && q.queryKey[0] === "evmAllowance"
        });
      } catch (err) {
...
// src/features/allowances/evm/useErc20Allowance.ts
...
var useErc20Allowance = () => {
  const mode = useSelector2(selectMode);
  const sourceChain = useSelector2(selectSourceChain);
  const selectedCoin = useSelector2(selectSourceCurrency);
  const tokenOptions = useSelector2(selectTokenOptions);
  const owner = useEvmAddress(mode);
  const { pools } = useGetPools_default(
    useSelector2(selectBackendUrl),
    useSelector2(selectNetworkOption)
  );
  const tokenAddress = useMemo3(() => {
    const a = getTokenAddress(tokenOptions, selectedCoin, sourceChain.shortName);
    return a && /^0x[0-9a-fA-F]{40}$/.test(a) ? a : void 0;
  }, [tokenOptions, selectedCoin, sourceChain.shortName]);
  const spender = useMemo3(() => {
    const p = getPoolAddress(pools, sourceChain.shortName);
    return p && /^0x[0-9a-fA-F]{40}$/.test(p) ? p : void 0;
  }, [pools, sourceChain.shortName]);
  ...
  return useQuery3({
    ...
    queryFn: async () => {
      try {
        ...
        logger_default.debug("[useErc20Allowance.viem] result", {
        ...
        logger_default.error("[useErc20Allowance.viem] queryFn error", err);
...
// src/features/allowances/evm/useEvmSignMessage.ts
import { useCallback as useCallback2 } from "react";
import { useSelector as useSelector3 } from "react-redux";
import { useAppKitAccount as useAppKitAccount3, useAppKitProvider as useAppKitProvider2 } from "@reown/appkit/react";
...
var useEvmSignMessage = () => {
  ...
  const { transactionValues } = useSelector3(selectServiceFee);
  const feeDeduct = useSelector3(selectFeeDeduct);
  const { address: appkitAddress } = useAppKitAccount3() || {};
  const { walletProvider: appkitProvider } = useAppKitProvider2("eip155");
  const userAddress = useEvmAddress(mode);
  const { message } = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const signMessage = useCallback2(async () => {
    try {
      const eip1193 = appkitProvider?.provider ?? globalThis.ethereum;
      if (!eip1193?.request) {
        logger_default.error("[useEvmSignMessage] No EIP-1193 provider available");
        return void 0;
      }
      const account = userAddress ?? appkitAddress;
      if (!account) {
        logger_default.warn("[useEvmSignMessage] Missing account");
        return void 0;
      }
      ...
      logger_default.debug("[useEvmSignMessage] signing via viem walletClient");
      const sig = await walletClient.signMessage({ account, message });
      return sig;
    } catch (err) {
      logger_default.error("[useEvmSignMessage] failed to sign", err);
      throw err;
    }
...
// src/features/allowances/evm/useAllowance.ts
...
var useAllowance = () => {
  ...
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const allowanceNeeded = useMemo4(
...
// src/app/providers/EvmWalletProvider.tsx
import { Fragment, jsx as jsx43 } from "react/jsx-runtime";
var EvmWalletProvider = ({
  ...
  return /* @__PURE__ */ jsx43(Fragment, { children });
};
...
var SolanaWalletProvider = ({
  ...
  const endpoint = networkOption === "testnet" /* testnet */ ? clusterApiUrl2("testnet") : clusterApiUrl2("mainnet-beta");
...
var TronWalletProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx45(WalletProvider2, { adapters, autoConnect: false, children });
};
...
import { useCallback as useCallback3, useEffect as useEffect2, useMemo as useMemo6, useState } from "react";
import { useDispatch as useDispatch2, useSelector as useSelector5 } from "react-redux";
import {
...
var switchNetworkSmart = async ({
  ...
  const findChain = (id) => chains.find((c) => c.id === id);
  const addChain = async (id) => {
    ...
    const rpcUrls = Object.values(net.rpcUrls || {}).flatMap(
      (cfg) => Array.isArray(cfg?.http) ? cfg.http : []
    );
    ...
    logger_default.debug("[switchNetworkSmart] wallet_addEthereumChain payload", payload);
    await request("wallet_addEthereumChain", [payload]);
  };
  try {
    await request("wallet_switchEthereumChain", [{ chainId: hexId }]);
    logger_default.debug("[switchNetworkSmart] switched via wallet_switchEthereumChain");
    return true;
  } catch (err) {
    if (err?.code === 4902) {
      logger_default.warn("[switchNetworkSmart] chain not added, attempting add\u2026", err);
      try {
        ...
        logger_default.error("[switchNetworkSmart] add chain failed", addErr);
      }
    } else if (err?.code === -32603) {
      logger_default.debug("[switchNetworkSmart] node says already switched / busy", err);
      return true;
    } else {
      logger_default.warn(
  ...
  if (appKitSwitch) {
    ...
    if (net) {
      try {
        ...
        logger_default.debug("[switchNetworkSmart] switched via AppKit modal fallback");
        return true;
      } catch (e) {
        logger_default.error("[switchNetworkSmart] AppKit modal fallback failed", e);
      }
    } else {
      logger_default.warn("[switchNetworkSmart] no chain data for AppKit fallback");
    }
  }
  logger_default.error("[switchNetworkSmart] failed to switch network");
  return false;
};
...
var useIsWalletReady = () => {
  ...
  const mode = useSelector5(selectMode);
  ...
  const trySwitch = useCallback3(async () => {
    if (!sourceChain || sourceChain.compatibility !== "EVM" /* EVM */)
      return;
    const eip1193 = externalProvider?.provider?.provider || appkitProvider?.provider || appkitProvider || null;
    const browserProvider = externalProvider?.provider || appkitProvider || null;
  ...
  const resolveConnection = useCallback3(async () => {
    if (mode === "light" /* light */) {
  ...
  const query = useQuery5({
    ...
    queryFn: async () => {
      try {
        ...
        logger_default.debug("[useErc20Balance.viem] result", {
          chain: sourceChain.shortName,
          tokenAddress,
          owner,
          ...res
        ...
        logger_default.error("[useErc20Balance.viem] queryFn error", err);
...
var EvmPlugin = class extends PluginBase {
  ...
  Provider = ({ children, networkOption, projectId, isLoading }) => /* @__PURE__ */ jsx46(EvmWalletProvider, { networkOption, projectId, isLoading, children });
};
...
import { Connection as Connection2, clusterApiUrl as clusterApiUrl3 } from "@solana/web3.js";
...
var useSolProvider = () => {
  ...
  return useMemo9(() => {
    ...
    const endpoint = net === "testnet" /* testnet */ ? clusterApiUrl3("devnet") : clusterApiUrl3("mainnet-beta");
    const connection = new Connection2(endpoint, "confirmed");
    const pk = wallet.publicKey?.toBase58();
    const signTransaction = wallet.signTransaction;
    const signMessage = wallet.signMessage;
    logger_default.debug("[useSolProvider] using WalletAdapter / direct RPC", {
      endpoint,
      hasWallet: !!wallet,
...
import { useEffect as useEffect3, useMemo as useMemo11 } from "react";
import { useDispatch as useDispatch3, useSelector as useSelector10 } from "react-redux";
import { useWallet as useWallet2 } from "@solana/wallet-adapter-react";
var createStatus = (isReady, statusMessage = "", connectedAddress) => ({
  isReady,
  statusMessage,
  connectedAddress
});
var useIsWalletReady2 = () => {
  const dispatch = useDispatch3();
  const mode = useSelector10(selectMode);
  const sourceChain = useSelector10(selectSourceChain);
  const { publicKey } = useSolProvider();
  const { connected, connecting } = useWallet2();
  useEffect3(() => {
...
var useSPLAllowance = () => {
  ...
  const backendUrl = useSelector11(selectBackendUrl);
  const networkOption = useSelector11(selectNetworkOption);
  const selectedCoin = useSelector11(selectSourceCurrency);
  const tokenOptions = useSelector11(selectTokenOptions);
  const { pools } = useGetPools_default(backendUrl, networkOption);
  const ownerPk = mode === "light" /* light */ ? new PublicKey3(lightDemoAccounts.SOL) : publicKey ? new PublicKey3(publicKey) : void 0;
  ...
  const { data } = useQuery7({
    ...
    queryFn: async () => {
      try {
        ...
        if (selectedCoin === "SOL") {
          logger_default.debug("[useSPLAllowance] SOL selected \u2192 allowance 0n");
        ...
        if (!mintAddr || !poolAddr) {
          logger_default.warn("[useSPLAllowance] missing mint or pool", {
            mintAddr,
            poolAddr
          });
          return { allowance: 0n, decimals: 0 };
        }
        const mint = new PublicKey3(mintAddr);
        ...
        if (!parsed) {
          logger_default.warn("[useSPLAllowance] no ATA", {
            owner: ownerPk?.toBase58(),
            ata: ata.toBase58(),
            mint: mint.toBase58()
          });
        ...
        logger_default.error("[useSPLAllowance] error", e);
        return { allowance: 0n, decimals: 0 };
      }
    }
  });
  logger_default.debug("[useSPLAllowance] enabled?", { enabled });
  return data ?? { allowance: 0n, decimals: 0 };
};

// src/features/allowances/solana/useApproveSPL.ts
import { useCallback as useCallback5 } from "react";
import { useQueryClient as useQueryClient2 } from "@tanstack/react-query";
import { useSelector as useSelector12 } from "react-redux";
import { PublicKey as PublicKey4, Transaction as Transaction2 } from "@solana/web3.js";
import {
  TOKEN_PROGRAM_ID,
...
var useApproveSPL = () => {
  ...
  const networkOption = useSelector12(selectNetworkOption);
  const selectedCoin = useSelector12(selectSourceCurrency);
  const tokenOptions = useSelector12(selectTokenOptions);
  const { transactionValues } = useSelector12(selectServiceFee);
  const feeDeduct = useSelector12(selectFeeDeduct);
  ...
  const ownerPk = mode === "light" /* light */ ? new PublicKey4(lightDemoAccounts.SOL) : publicKey ? new PublicKey4(publicKey) : void 0;
  const { pools } = useGetPools_default(backendUrl, networkOption);
  const approve = useCallback5(
    async (isCancel = false) => {
      if (!connection || !signTransaction || !ownerPk) {
        log2.warn("useApproveSPL: missing provider or owner");
        return;
      }
      try {
        ...
        const mint = new PublicKey4(tokenAddress);
        const ata = await getAssociatedTokenAddress2(mint, ownerPk);
        const ix = isCancel ? createRevokeInstruction(ata, ownerPk, [], TOKEN_PROGRAM_ID) : createApproveInstruction(
          ata,
        ...
        const tx = new Transaction2().add(ix);
        tx.feePayer = ownerPk;
        ...
        log2.debug("useApproveSPL: sent", sig);
        const conf = await connection.confirmTransaction(
          { signature: sig, ...recent },
          "finalized"
        );
        if (conf.value.err) {
          log2.error("useApproveSPL: confirmation error", conf.value.err);
          return;
        }
        await qc.invalidateQueries({
          queryKey: [
        ...
        log2.error("useApproveSPL: tx error", err);
        throw err;
      }
    },
    [
...
// src/features/allowances/solana/useSolSignMessage.ts
import { useCallback as useCallback6 } from "react";
import { useSelector as useSelector13 } from "react-redux";
var useSolSignMessage = () => {
  ...
  const sign = useCallback6(async () => {
    ...
    try {
      ...
      logger_default.error("useSolSignMessage: failed", err);
      throw err;
    }
  }, [message, signMessage]);
  return { sign };
...
// src/features/allowances/solana/useAllowance.ts
...
var useAllowance2 = () => {
  ...
  const { transactionValues } = useSelector14(selectServiceFee);
  const feeDeduct = useSelector14(selectFeeDeduct);
  const needed = BigInt(
  ...
  logger_default.debug("[useAllowance.solana]", {
  ...
  const query = useQuery8({
    ...
    queryFn: async () => {
      try {
        ...
        const lamports = await connection.getBalance(new PublicKey5(owner));
        const res = { balance: BigInt(lamports), decimals: 9 };
        logger_default.debug("[useSolNativeBalance] result", res);
        return res;
      } catch (e) {
        logger_default.error("[useSolNativeBalance] error", e);
        return { balance: 0n, decimals: 9 };
      }
    }
  });
  logger_default.debug("[useSolNativeBalance] enabled?", { enabled, owner });
  return { balance: query.data?.balance, decimals: query.data?.decimals };
};
...
import { getAssociatedTokenAddress as getAssociatedTokenAddress3, getMint } from "@solana/spl-token";
var getMintAddressForSymbol = (tokenOptions, symbol) => tokenOptions?.[symbol]?.SOL || "";
var useSolTokenBalance = () => {
  const symbol = useSelector16(selectSourceCurrency);
  const sourceChain = useSelector16(selectSourceChain);
  if (symbol === "SOL") return useSolNativeBalance();
  const tokenOptions = useSelector16(selectTokenOptions);
  const owner = useSolAddress();
  const { connection } = useSolProvider();
  ...
  const query = useQuery9({
    ...
    queryFn: async () => {
      try {
        ...
        if (!mintAddr) {
          logger_default.warn("[useSolTokenBalance] missing mint for symbol", { symbol });
          return { amount: 0n, decimals: 0 };
        }
        const mint = new PublicKey6(mintAddr);
        const ownerPk = new PublicKey6(owner);
        const ata = await getAssociatedTokenAddress3(mint, ownerPk, false);
        ...
        const parsed = accInfo?.value?.data;
        if (!parsed) {
          logger_default.warn("[useSolTokenBalance] ATA not found (parsed)", {
            owner,
            mint: mint.toBase58()
          });
        ...
        logger_default.error("[useSolTokenBalance] error", e);
        return { amount: 0n, decimals: 0 };
      }
    }
  });
...
// src/features/connect-wallet/solana/useDisconnectWallet.ts
...
var useDisconnectWallet2 = () => {
  ...
  const { externalProvider } = useKimaContext();
  const disconnectWallet = useCallback7(async () => {
...
var SolanaPlugin = class extends PluginBase {
  constructor(store2) {
    super({
      ...
      useIsWalletReady: useIsWalletReady2,
      useDisconnectWallet: useDisconnectWallet2
    });
  }
  isCompatible = (chain) => chain.shortName === "SOL";
  Provider = ({ children, networkOption }) => /* @__PURE__ */ jsx47(SolanaWalletProvider, { networkOption, children });
};
var solanaPlugin = new SolanaPlugin(store_default);
var adapter_default2 = solanaPlugin;

// src/features/allowances/tron/useApproveTrc20.ts
import { useCallback as useCallback8, useMemo as useMemo16 } from "react";
import { useQueryClient as useQueryClient3 } from "@tanstack/react-query";
import { useSelector as useSelector20 } from "react-redux";

// src/features/connect-wallet/tron/useTronProvider.ts
...
var useTronProvider = () => {
  const net = useSelector17(selectNetworkOption);
  const { externalProvider } = useKimaContext();
  const {
...
import { useEffect as useEffect5, useMemo as useMemo15 } from "react";
import { useQuery as useQuery10 } from "@tanstack/react-query";
import { useSelector as useSelector19 } from "react-redux";

// src/shared/crypto/evm/erc20ABI.json
...
// src/features/connect-wallet/tron/useIsWalletReady.ts
import { useEffect as useEffect4, useMemo as useMemo14 } from "react";
import { useDispatch as useDispatch4, useSelector as useSelector18 } from "react-redux";
var createStatus2 = (isReady, statusMessage = "", connectedAddress) => ({ isReady, statusMessage, connectedAddress });
var useIsWalletReady3 = () => {
  const dispatch = useDispatch4();
  const mode = useSelector18(selectMode);
  const sourceChain = useSelector18(selectSourceChain);
  ...
  return useMemo14(() => {
    if (sourceChain.shortName !== "TRX") {
      return createStatus2(false, "Not a Tron source chain", "");
    }
    if (mode === "light" /* light */) {
    ...
    if (addr) return createStatus2(true, "Connected Tron wallet", addr);
    return createStatus2(false, "Tron wallet not connected", "");
  }, [mode, addr, sourceChain.shortName]);
};

// src/features/allowances/tron/useTrc20Allowance.ts
var useTrc20Allowance = () => {
  const { tronWeb } = useTronProvider();
  const { transactionValues } = useSelector19(selectServiceFee);
  const mode = useSelector19(selectMode);
  const sourceChain = useSelector19(selectSourceChain);
  const selectedCoin = useSelector19(selectSourceCurrency);
  const tokenOptions = useSelector19(selectTokenOptions);
  const address = useTronAddress(mode);
  const tokenAddress = useMemo15(
    () => getTokenAddress(tokenOptions, selectedCoin, "TRX"),
    [tokenOptions, selectedCoin]
  );
  const { pools } = useGetPools_default(
    useSelector19(selectBackendUrl),
    useSelector19(selectNetworkOption)
  );
  const poolAddress = useMemo15(() => getPoolAddress(pools, "TRX"), [pools]);
      ...
      try {
        ...
        try {
          ...
          if (!cur || cur !== ownerBase58) {
            logger_default.debug("[useTrc20Allowance] setAddress()", {
              from: cur,
              to: ownerBase58
            });
        ...
        logger_default.debug("[useTrc20Allowance] hex", { tokenHex, ownerHex, poolHex });
        const contract = await tronWeb.contract(erc20ABI_default.abi, tokenHex);
        logger_default.debug("[useTrc20Allowance] contract ready", { at: tokenHex });
        const [allowanceRaw, decimalsRaw] = await Promise.all([
          contract.allowance(ownerHex, poolHex).call(),
          contract.decimals().call()
        ]);
        logger_default.debug("[useTrc20Allowance] raw", {
          allowanceRaw,
          decimalsRaw
        });
        ...
        logger_default.info("[useTrc20Allowance] result", {
          allowance: allowance.toString(),
          decimals
        });
        return { allowance, decimals };
      } catch (e) {
        logger_default.error("[useTrc20Allowance] error", e);
        throw e;
      }
    }
  });
  useEffect5(() => {
    if (!enabled) return;
    if (q.isSuccess) logger_default.debug("[useTrc20Allowance] success", q.data);
    if (q.isError) logger_default.error("[useTrc20Allowance] error", q.error);
...
var useApproveTrc20 = () => {
  ...
  const selectedCoin = useSelector20(selectSourceCurrency);
  const tokenOptions = useSelector20(selectTokenOptions);
  const { transactionValues } = useSelector20(selectServiceFee);
  const feeDeduct = useSelector20(selectFeeDeduct);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const allowanceNeeded = BigInt(txValues.allowanceAmount.value);
  const { tronWeb, signTransaction } = useTronProvider();
  const address = useTronAddress(mode);
  const tokenAddress = useMemo16(
    () => getTokenAddress(tokenOptions, selectedCoin, "TRX"),
    [tokenOptions, selectedCoin]
  );
  const { pools } = useGetPools_default(
    useSelector20(selectBackendUrl),
    useSelector20(selectNetworkOption)
  );
  const poolAddress = useMemo16(() => getPoolAddress(pools, "TRX"), [pools]);
  const { data } = useTrc20Allowance();
  const approve = useCallback8(
    async (isCancel = false) => {
      logger_default.debug("[useApproveTrc20] start", {
        isCancel,
        address,
        tokenAddress,
        poolAddress,
      ...
      try {
        ...
        logger_default.debug("[useApproveTrc20] triggerSmartContract resp", {
          result: txResp?.result,
          txHasRaw: !!txResp?.transaction
        });
        const signer = signTransaction ?? tronWeb.trx?.sign ?? void 0;
        if (!signer) {
          const msg = "No Tron transaction signer available";
          logger_default.error("[useApproveTrc20] " + msg);
          throw new Error(msg);
        }
        logger_default.debug("[useApproveTrc20] signing...");
        const signed = await signer(txResp.transaction);
        logger_default.debug("[useApproveTrc20] sending...");
        const sent = await tronWeb.trx.sendRawTransaction(signed);
        logger_default.info("[useApproveTrc20] sent", { txid: sent?.txid, raw: sent });
        await qc.invalidateQueries({
          predicate: (q) => Array.isArray(q.queryKey) && q.queryKey[0] === "tronAllowance"
        });
        await qc.invalidateQueries({
          predicate: (q) => Array.isArray(q.queryKey) && q.queryKey[0] === "tronTrc20Balance"
        });
        logger_default.debug("[useApproveTrc20] caches invalidated");
      } catch (err) {
        const m = String(err?.message || err);
        if (err?.code === 4001 || /UserRejected|denied|canceled|cancelled/i.test(m)) {
          err._kimaUserRejected = true;
          logger_default.warn("[useApproveTrc20] user rejected", m);
        } else {
          logger_default.error("[useApproveTrc20] error", err);
        }
        throw err;
      }
    },
...
// src/features/allowances/tron/useTronSignMessage.ts
import { useCallback as useCallback9 } from "react";
import { useSelector as useSelector21 } from "react-redux";
var useTronSignMessage = () => {
  const { signMessage } = useTronProvider();
  const sourceChain = useSelector21(selectSourceChain);
  const { transactionValues } = useSelector21(selectServiceFee);
  const msg = transactionValues?.feeFromOrigin?.message || transactionValues?.feeFromTarget?.message || "";
  const sign = useCallback9(async () => {
    try {
      if (sourceChain.shortName !== "TRX") {
        logger_default.debug("[useTronSignMessage] not TRX, skip");
        return void 0;
      }
      if (!signMessage) {
        const err = new Error("No Tron signer available");
        err._kimaNoSigner = true;
        throw err;
      }
      if (!msg) {
        logger_default.warn("[useTronSignMessage] empty message");
        return void 0;
      }
      logger_default.debug("[useTronSignMessage] requesting signature");
      const sig = await signMessage(msg);
      logger_default.debug("[useTronSignMessage] got signature");
      return sig;
    } catch (e) {
      const m = String(e?.message || e);
      if (e?.code === 4001 || /UserRejected|denied|canceled|cancelled/i.test(m)) {
        e._kimaUserRejected = true;
      }
      logger_default.error("[useTronSignMessage] failed", e);
      throw e;
    }
...
// src/features/allowances/tron/useAllowance.ts
...
var useAllowance3 = () => {
  ...
  const { transactionValues } = useSelector22(selectServiceFee);
  const feeDeduct = useSelector22(selectFeeDeduct);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const allowanceNeeded = useMemo17(
    () => BigInt(txValues.allowanceAmount.value),
    [txValues.allowanceAmount.value]
  );
  const allowancePart = {
...
// src/features/balances/tron/useTrc20Balance.ts
import { useEffect as useEffect6, useMemo as useMemo18 } from "react";
...
var useTrc20Balance = () => {
  ...
  const address = useTronAddress(mode);
  const selectedCoin = useSelector23(selectSourceCurrency);
  const tokenOptions = useSelector23(selectTokenOptions);
  const tokenAddress = useMemo18(
    () => getTokenAddress(tokenOptions, selectedCoin, "TRX"),
    [tokenOptions, selectedCoin]
  );
  const enabled = !!tronWeb && !!address && tronWeb.isAddress(address) && !!tokenAddress && sourceChain.shortName === "TRX";
  const q = useQuery11({
    ...
    queryFn: async () => {
      try {
        logger_default.debug("[useTrc20Balance] fetch", { address, tokenAddress });
        const ownerBase58 = address;
        try {
          const cur = tronWeb.defaultAddress?.base58;
          if (!cur || cur !== ownerBase58) {
        ...
        const [rawBalance, rawDecimals] = await Promise.all([
          contract.balanceOf(ownerHex).call(),
          // default owner now set
          contract.decimals().call()
        ]);
        ...
        logger_default.error("[useTrc20Balance] error", e);
        throw e;
      }
    }
  });
  useEffect6(() => {
    logger_default.debug("[useTrc20Balance] enabled?", {
      enabled,
      address,
      tokenAddress,
    ...
    if (!enabled) return;
    if (q.isSuccess) logger_default.debug("[useTrc20Balance] success", q.data);
    if (q.isError) logger_default.error("[useTrc20Balance] error", q.error);
  }, [
    enabled,
    q.isSuccess,
    q.isError,
...
// src/features/balances/tron/useTronNativeBalance.ts
import { useEffect as useEffect7 } from "react";
import { useQuery as useQuery12 } from "@tanstack/react-query";
import { useSelector as useSelector24 } from "react-redux";
var useTronNativeBalance = () => {
  const mode = useSelector24(selectMode);
  const sourceChain = useSelector24(selectSourceChain);
  const { tronWeb } = useTronProvider();
  const address = useTronAddress(mode);
  const enabled = !!tronWeb && !!address && tronWeb.isAddress(address) && sourceChain.shortName === "TRX";
  const q = useQuery12({
    ...
    queryFn: async () => {
      try {
        logger_default.debug("[useTronNativeBalance] fetch", { address });
        const sun = await tronWeb.trx.getBalance(address);
        return { balance: BigInt(sun), decimals: 6 };
      } catch (e) {
        logger_default.error("[useTronNativeBalance] error", e);
        throw e;
      }
    }
  });
  useEffect7(() => {
    logger_default.debug("[useTronNativeBalance] enabled?", { enabled, address });
    if (!enabled) return;
    if (q.isSuccess) logger_default.debug("[useTronNativeBalance] success", q.data);
    if (q.isError) logger_default.error("[useTronNativeBalance] error", q.error);
  }, [enabled, q.isSuccess, q.isError, q.data, q.error, address]);
  return { balance: q.data?.balance, decimals: q.data?.decimals };
};

// src/features/connect-wallet/tron/useDisconnectWallet.ts
...
var useDisconnectWallet3 = () => {
  ...
  const { externalProvider } = useKimaContext();
  const disconnectWallet = useCallback10(async () => {
    const maybeExt = externalProvider;
    const extDisconnect = maybeExt?.disconnect ?? maybeExt?.provider?.disconnect;
    if (typeof extDisconnect === "function") {
      await extDisconnect();
...
var TronPlugin = class extends PluginBase {
  constructor(store2) {
    super({
      ...
      id: "TRX",
      compatibility: "SELF" /* SELF */,
      useAllowance: useAllowance3,
      useNativeBalance: useTronNativeBalance,
      useTokenBalance: useTrc20Balance,
      useIsWalletReady: useIsWalletReady3,
      useDisconnectWallet: useDisconnectWallet3
    });
  }
  isCompatible = (chain) => chain.shortName === "TRX";
  Provider = ({ children, networkOption }) => /* @__PURE__ */ jsx48(TronWalletProvider, { networkOption, children });
};
var tronPlugin = new TronPlugin(store_default);
var adapter_default3 = tronPlugin;

// src/features/allowances/credit-card/useAllowance.ts
var useAllowance4 = () => ({
  isApproved: true,
  approve: async () => {
  }
...
// src/features/balances/credit-card/useCcNativeBalance.ts
var useCcNativeBalance = () => ({
  balance: 0n,
  decimals: 2
  // fiat-like placeholder
});

// src/features/balances/credit-card/useCcTokenBalance.ts
var useCcTokenBalance = () => ({
  balance: 0n,
  decimals: 2
});

// src/features/connect-wallet/credit-card/useIsWalletReady.ts
import { useMemo as useMemo19 } from "react";
var useIsWalletReady4 = () => useMemo19(
  () => ({
    isReady: true,
    statusMessage: "Credit Card flow ready",
    connectedAddress: ""
  }),
  []
);

// src/features/connect-wallet/credit-card/useDisconnectWallet.ts
...
import { Fragment as Fragment2, jsx as jsx49 } from "react/jsx-runtime";
var CreditCardPlugin = class extends PluginBase {
  constructor(storeArg) {
    super({
      ...
      id: "CC",
      compatibility: "CC" /* CC */,
      useAllowance: useAllowance4,
      useNativeBalance: useCcNativeBalance,
      useTokenBalance: useCcTokenBalance,
      useIsWalletReady: useIsWalletReady4,
      useDisconnectWallet: useDisconnectWallet4
    });
  }
  isCompatible = (chain) => chain.compatibility === "CC";
  Provider = ({ children }) => /* @__PURE__ */ jsx49(Fragment2, { children });
};
var creditCardPlugin = new CreditCardPlugin(store_default);
var adapter_default4 = creditCardPlugin;

// src/features/allowances/bank/useAllowance.ts
var useAllowance5 = () => ({
  isApproved: true,
  approve: async () => {
  }
...
// src/features/balances/bank/useBankNativeBalance.ts
var useBankNativeBalance = () => ({
  balance: 0n,
  decimals: 2
  // EUR-style placeholder
});

// src/features/balances/bank/useBankTokenBalance.ts
var useBankTokenBalance = () => ({
  balance: 0n,
  decimals: 2
});

// src/features/connect-wallet/bank/useIsWalletReady.ts
import { useMemo as useMemo20 } from "react";
var useIsWalletReady5 = () => useMemo20(
  () => ({
    isReady: true,
...
// src/features/connect-wallet/bank/useDisconnectWallet.ts
...
import { Fragment as Fragment3, jsx as jsx50 } from "react/jsx-runtime";
var BankPlugin = class extends PluginBase {
  constructor(storeArg) {
    super({
      ...
      useAllowance: useAllowance5,
      useNativeBalance: useBankNativeBalance,
      useTokenBalance: useBankTokenBalance,
      useIsWalletReady: useIsWalletReady5,
      useDisconnectWallet: useDisconnectWallet5
    });
  }
  isCompatible = (chain) => chain.compatibility === "BANK";
  Provider = ({ children }) => /* @__PURE__ */ jsx50(Fragment3, { children });
};
...
var InternalKimaProvider = React3.memo(({ kimaBackendUrl, projectId, children }) => {
  ...
  logger_default.debug("InternalKimaProvider: networkOption:", networkOption);
  logger_default.debug("InternalKimaProvider: isLoadingEnv:", isLoadingEnv);
  const [appKitReady, setAppKitReady] = useState2(false);
  useEffect8(() => {
    if (!envOptions) return;
    try {
      setupAppKit(projectId, networkOption);
      setAppKitReady(true);
      logger_default.debug("AppKit ready");
    } catch (e) {
      logger_default.error("Failed to setup AppKit:", e);
    }
  }, [envOptions, projectId, networkOption]);
  const plugins = useSelector25(selectAllPlugins, (prev, next) => prev === next);
  logger_default.debug("Registered Plugins:", plugins);
  const WrappedProviders = useMemo21(() => {
  ...
  return /* @__PURE__ */ jsx51(Fragment4, { children: WrappedProviders });
});
var KimaProvider = ({
  projectId,
  ...
  return /* @__PURE__ */ jsx51(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsx51(Provider, { store: store_default, children: /* @__PURE__ */ jsx51(KimaContext.Provider, { value: kimaContext, children: /* @__PURE__ */ jsx51(
...
import { useEffect as useEffect26, useState as useState14 } from "react";
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ jsx52(
    "svg",
    {
      ...
      viewBox: "0 0 24 24",
      xmlns: "http://www.w3.org/2000/svg",
      children: /* @__PURE__ */ jsx52("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z", children: /* @__PURE__ */ jsx52(
        "animateTransform",
        {
...
var SkeletonLoader = ({ theme }) => {
  ...
  return /* @__PURE__ */ jsx54(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs30("div", { className: "transfer-card", children: [
        /* @__PURE__ */ jsxs30("div", { className: "kima-card-header", children: [
          /* @__PURE__ */ jsxs30("div", { className: "topbar", children: [
            /* @__PURE__ */ jsx54("div", { className: "title skeleton", children: /* @__PURE__ */ jsx54("h3", {}) }),
            /* @__PURE__ */ jsx54("div", { className: "control-buttons", children: closeHandler && /* @__PURE__ */ jsx54(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx54(Cross_default, {})
              }
            ) })
          ] }),
          /* @__PURE__ */ jsx54("h4", { className: "subtitle" })
        ] }),
        /* @__PURE__ */ jsxs30("div", { className: "kima-card-content skeleton", children: [
          /* @__PURE__ */ jsx54("div", { className: "skeleton" }),
          /* @__PURE__ */ jsx54("div", { className: "skeleton" }),
          /* @__PURE__ */ jsx54("div", { className: "skeleton" }),
          /* @__PURE__ */ jsx54("div", { className: "skeleton" }),
          /* @__PURE__ */ jsx54("div", { className: "skeleton" })
        ] }),
        /* @__PURE__ */ jsx54("div", { className: `kima-card-footer`, children: /* @__PURE__ */ jsx54("div", { className: `button-group skeleton`, children: /* @__PURE__ */ jsx54("div", { className: "skeleton" }) }) }),
        /* @__PURE__ */ jsx54("div", { className: "floating-footer", children: /* @__PURE__ */ jsxs30("div", { className: `items ${theme.colorMode}`, children: [
          /* @__PURE__ */ jsx54("span", { children: "Powered by" }),
          /* @__PURE__ */ jsx54(FooterLogo_default, { width: 50, fill: "black" }),
          /* @__PURE__ */ jsx54("strong", { children: "Network" })
        ] }) })
      ] })
    }
  );
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ jsx55(
  "a",
  {
    className,
    href: to,
...
import { useDispatch as useDispatch5, useSelector as useSelector28 } from "react-redux";
...
var useGetCurrentPlugin = () => {
  const isIndexed = useSelector27(selectPluginIsIndexed);
  ...
  const currentPlugin = useMemo22(() => {
    ...
    if (plugin) {
      logger_default.debug("[useGetCurrentPlugin] resolved plugin id:", plugin.id);
    }
    logger_default.debug("[useGetCurrentPlugin]", {
      isIndexed,
      chain: sourceChain.shortName,
      resolved: !!plugin
    });
...
var DefaultPlugin = class extends PluginBase {
  constructor(storeArg) {
    super({
      ...
      useDisconnectWallet: () => ({
        disconnectWallet: useCallback11(async () => {
        }, [])
      })
    });
  }
...
// src/widgets/transfer/hooks/useIsWalletReady.tsx
var EMPTY = {
  isReady: false,
  statusMessage: "",
  connectedAddress: ""
...
var useIsWalletReady6 = () => {
  ...
  logger_default.debug("[useIsWalletReady] pluginId", currentPlugin?.id);
  const hook = currentPlugin?.useIsWalletReady ?? default_default.useIsWalletReady ?? (() => EMPTY);
  logger_default.debug("[useIsWalletReady] plugin", !!currentPlugin);
  return hook();
};
var useIsWalletReady_default = useIsWalletReady6;

// src/widgets/transfer/hooks/useBalance.tsx
var EMPTY2 = { balance: BigInt(0), decimals: 0 };
var useBalance = () => {
  const { currentPlugin } = useGetCurrentPlugin_default();
  logger_default.debug("[useBalance] pluginId", currentPlugin?.id);
  const hook = currentPlugin?.useTokenBalance ?? default_default.useTokenBalance ?? (() => EMPTY2);
  const res = hook();
  return res ?? EMPTY2;
};
var useBalance_default = useBalance;

// src/shared/lib/hooks/useWidth.tsx
...
var isSamePeggedToken = (sourceChain, sourceTokenId, targetChain, targetTokenId) => {
...
var WalletButton = ({
  ...
  const selectedCoin = useSelector28(selectSourceCurrency);
  const sourceCompliant = useSelector28(selectSourceCompliant);
  const compliantOption = useSelector28(selectCompliantOption);
  const sourceNetwork = useSelector28(selectSourceChain);
  const targetNetwork = useSelector28(selectTargetChain);
  const targetAddress = useSelector28(selectTargetAddress);
  ...
  useEffect12(() => {
    ...
    logger_default.debug(`${TAG} targetAddress=`, targetAddress);
    logger_default.debug(`${TAG} envOption=`, networkOption);
  }, [
    mode,
    placeholder,
    initialSelection,
  ...
  const demoSourceAddress = useMemo24(() => {
    if (mode !== "light" /* light */) return "";
    const short = sourceNetwork?.shortName;
    if (!short) return "";
    if (short === "SOL" /* SOLANA */) return lightDemoAccounts.SOL;
    if (short === "TRX" /* TRON */) return lightDemoAccounts.TRX;
  ...
  const isWalletApplicable = ![
    "CC" /* CC */,
    "BANK" /* BANK */
  ].includes(sourceNetwork?.compatibility);
  const isEvmSwitching = useMemo24(() => {
  ...
  const handleClick = async () => {
    ...
    if (isEvmSwitching) return;
    if (sourceNetwork?.shortName === "SOL" /* SOLANA */) {
      return isSolanaConnected ? dispatch(setAccountDetailsModal(true)) : dispatch(setSolanaConnectModal(true));
    }
    if (sourceNetwork?.shortName === "TRX" /* TRON */) {
      return isTronConnected ? dispatch(setAccountDetailsModal(true)) : dispatch(setTronConnectModal(true));
    }
    try {
      await open();
    } catch (error) {
      logger_default.error(`${TAG} Failed to open AppKitModal`, error);
    }
  };
  const displayedAddress = useMemo24(() => {
    if (mode === "light" /* light */) {
  ...
  useEffect12(() => {
    if (mode === "light" /* light */) return;
    const to = isReady ? connectedAddress : "";
    dispatch(setSourceAddress(to));
    logger_default.debug(`${TAG} setSourceAddress(${to}) [advanced mode sync]`);
  }, [mode, isReady, connectedAddress, dispatch]);
  useEffect12(() => {
    if (mode !== "light" /* light */ && !isReady && statusMessage) {
      logger_default.debug(`${TAG} statusMessage (advanced):`, statusMessage);
    }
  ...
  const renderConnectedLabel = () => {
    ...
    return width >= 640 ? displayedAddress : getShortenedAddress(displayedAddress);
  };
  const btnClasses = [
...
import { useDispatch as useDispatch7, useSelector as useSelector30 } from "react-redux";

// src/widgets/transfer/hooks/useCurrencyOptions.tsx
import { useEffect as useEffect13, useMemo as useMemo25 } from "react";
import { useSelector as useSelector29, useDispatch as useDispatch6 } from "react-redux";
...
function useCurrencyOptions(isSourceChain) {
  ...
  const sourceSymbol = useSelector29(selectSourceCurrency);
  const targetChain = useSelector29(selectTargetChain);
  const targetSymbol = useSelector29(selectTargetCurrency);
  ...
  useEffect13(() => {
    ...
    const stillValid = current ? tokenList.some((t) => t.symbol === current) : false;
...
var CoinDropdown = ({
  ...
  const appliedLockRef = useRef(null);
  useEffect14(() => {
...
import { useDispatch as useDispatch8, useSelector as useSelector31 } from "react-redux";
...
var FeeDeductionRadioButtons = ({ disabled }) => {
  ...
  const { totalFee: feeTotalBigInt } = useSelector31(selectServiceFee);
  ...
  const isSubmitted = useSelector31(selectSubmitted);
...
var ConfirmDetails = ({
  ...
  const {
    ...
    swapFee,
    swapInfo
  } = useSelector32(selectServiceFee);
  const originNetwork = useSelector32(selectSourceChain);
  const targetNetwork = useSelector32(selectTargetChain);
  const targetAddress = useSelector32(selectTargetAddress);
  const networkOptions = useSelector32(selectNetworks);
  ...
  const sourceCurrency = useSelector32(selectSourceCurrency);
  const targetCurrency = useSelector32(selectTargetCurrency);
  const { width, updateWidth } = useWidth_default();
  ...
  const targetDisplayAmount = useMemo26(() => {
  ...
  const combinedSwapFees = useMemo26(
  ...
  useEffect15(() => {
    logger_default.debug("[ConfirmDetails] render", {
      isSwap,
      sourceCurrency,
      targetCurrency,
      totalFee,
...
import { useDispatch as useDispatch9, useSelector as useSelector33 } from "react-redux";
...
var AddressInput = ({
  ...
  const targetAddress = useSelector33(selectTargetAddress);
  const didAutofill = useRef2(null);
  useEffect16(() => {
  ...
  useEffect16(() => {
    ...
    if (bothEvm && isReady && sourceAddress && !targetAddress && didAutofill.current !== targetChain.shortName) {
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  const explorerUrl = useSelector35(selectKimaExplorer);
  const networkOption = useSelector35(selectNetworkOption);
  const networks = useSelector35(selectNetworks);
...
var ErrorWidget = ({
  ...
  const ccTransactionId = useSelector36(selectCCTransactionId);
  const isCreditCardSource = sourceChain.shortName === "CC";
  const isRetrying = useSelector36(selectCCTransactionRetrying);
...
import { useEffect as useEffect17, useState as useState7 } from "react";
var useDebugCode = (sequence = ["D", "E", "B", "U", "G"]) => {
  const [debugMode, setDebugMode] = useState7(false);
  const [, setInputSequence] = useState7([]);
  useEffect17(() => {
    const onKeyDown = (e) => {
...
import { useEffect as useEffect25, useMemo as useMemo40, useRef as useRef10 } from "react";
import { useDispatch as useDispatch23, useSelector as useSelector54 } from "react-redux";
...
var parseTxData = (raw) => {
  ...
  return {
    ...
    amount: raw.amount,
    // keep same shape as your rollback
    sourceSymbol: raw.originsymbol,
    targetSymbol: raw.targetsymbol,
    kimaTxHash: raw.kimahash
  };
};
var parseSwapTxData = (raw) => {
  if (!raw) return emptyStatus;
  const amountOut = typeof raw.amountOut === "number" ? raw.amountOut : raw.amount ?? 0;
  return {
    status: raw.txstatus,
    sourceChain: raw.originchain,
    targetChain: raw.targetchain,
...
var getTxData = async ({
  ...
  try {
    const path = isLP ? `tx/lp/${txId}/status` : isSwap ? `swap_tx/${txId}/status` : `tx/${txId}/status`;
...
var useTxData = (txId, dAppOption, backendUrl, isSwap) => {
  ...
  return useQuery13({
    ...
    queryFn: async () => await getTxData({ txId, isLP, isSwap, backendUrl, refPollForUpdates }),
    ...
    enabled: validTxId && typeof backendUrl === "string" && backendUrl.length > 0
  });
};
...
var TransactionWidget = ({ theme }) => {
  ...
  const explorerUrl = useSelector39(selectKimaExplorer);
  ...
  const dAppOption = useSelector39(selectDappOption);
  const { transactionValues } = useSelector39(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const transactionOption = useSelector39(selectTransactionOption);
  const sourceChain = useSelector39(selectSourceChain);
  const targetChain = useSelector39(selectTargetChain);
  const sourceSymbol = useSelector39(selectSourceCurrency);
  const targetSymbol = useSelector39(selectTargetCurrency);
  const networks = useSelector39(selectNetworks);
  const { successHandler, closeHandler } = useKimaContext();
  const backendUrl = useSelector39(selectBackendUrl);
  ...
  const transactionTargetChain = useMemo28(
    () => networks.find(
  ...
  const { leftAmt, rightAmt, leftSym, rightSym } = useMemo28(() => {
    if (mode === "status" /* status */) {
      if (widgetIsSwap) {
...
var getFees = async (amount, originChain, originAddress, originSymbol, targetChain, targetAddress, targetSymbol, backendUrl) => {
  ...
  try {
    logger_default.debug("[getFees] request", {
      amount,
      originChain,
      originSymbol,
      originAddrParam,
    ...
    const tv = result.transactionValues ?? {};
    const fromOrigin = tv.feeFromOrigin;
    const fromTarget = tv.feeFromTarget;
    if (!fromOrigin) {
    ...
    const swapFee = result.feeSwapBigInt ? toBigintAmount(result.feeSwapBigInt) : { value: 0n, decimals: 0 };
    const swapInfo = result.swapInfo ? {
      amountOutFiat: result.swapInfo.amountOutFiat,
      amountOutBigInt: toBigintAmount(
        result.swapInfo.amountOutBigInt
      ),
    ...
    logger_default.error("[getFees] failed", e);
...
import { useDispatch as useDispatch12, useSelector as useSelector41 } from "react-redux";
...
var useSubmitTransaction = (isSubmitting, setIsSubmitting) => {
  ...
  const {
    ...
    options: feeOptions,
    swapInfo
  } = useSelector41(selectServiceFee);
  const originChainData = useSelector41(selectSourceChain);
  const targetChainData = useSelector41(selectTargetChain);
  const feeDeduct = useSelector41(selectFeeDeduct);
  const ccTransactionIdSeed = useSelector41(selectCCTransactionIdSeed);
  ...
  const txValues = doSwap ? transactionValues.feeFromOrigin : feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const mutation = useMutation({
    mutationFn: async (signature) => {
      ...
      if (doSwap) {
        ...
        return getTransactionId(response2.events);
      }
      ...
      logger_default.debug("submitTransaction (TRANSFER): params:", params);
    ...
    onSuccess: (transactionId) => {
      logger_default.debug("submit success", transactionId);
...
var useValidateTransaction = (inputs) => {
  ...
  const validate = (isSubmitting = false) => {
    ...
    if (mode !== "payment" /* payment */ && !targetChain) {
      return {
        error: "ValidationError" /* Error */,
    ...
    if (amount > parseUnits2(envOptions?.transferLimitMaxUSDT || "100", decimals) && networkOption === "testnet" /* testnet */) {
      return {
        error: "ValidationError" /* Error */,
...
import { useEffect as useEffect24, useState as useState13, useRef as useRef9, useMemo as useMemo39, useCallback as useCallback15 } from "react";
import toast4, { Toaster as Toaster2 } from "react-hot-toast";
import { useDispatch as useDispatch22, useSelector as useSelector53 } from "react-redux";
    ...
    /* @__PURE__ */ jsxs45("div", { className: "warning-modal-buttons", children: [
      ...
      /* @__PURE__ */ jsx75(
        PrimaryButton_default,
        {
          ...
          children: acknowledgeButtonText
        }
      )
    ] })
  ] }) });
...
import { useDispatch as useDispatch14, useSelector as useSelector44 } from "react-redux";

// src/components/primary/NetworkSelector.tsx
import React11, { useState as useState10, useMemo as useMemo30, useRef as useRef5, useEffect as useEffect19 } from "react";
import { useSelector as useSelector43, useDispatch as useDispatch13 } from "react-redux";
...
var NetworkSelector = ({
  ...
  const networkOptions = useSelector43(selectNetworks);
  const transactionOption = useSelector43(selectTransactionOption);
  ...
  const sourceSymbol = useSelector43(selectSourceCurrency);
  const targetNetwork = useSelector43(selectTargetChain);
  const currentSourceAddr = useSelector43(selectSourceAddress);
  const currentTargetAddr = useSelector43(selectTargetAddress);
  ...
  const networks = useMemo30(() => {
    ...
    logger_default.debug("[NetworkSelector] networks (filtered)", {
      type,
      count: result.length,
      mode,
      dAppOption
  ...
  const selectedNetwork = useMemo30(() => {
    if (shouldLockSourceNetwork) {
      const forced = networks.find(
        (n) => n.shortName === transactionOption.targetChain
      );
      const value2 = forced ?? { shortName: "", name: "Invalid Source Network" };
      logger_default.debug("[NetworkSelector] selected (locked to dApp target)", {
        type,
        value: value2
      });
      return value2;
    ...
    if (initialSelection && !selected?.shortName) {
      ...
      logger_default.debug("[NetworkSelector] selected (initial placeholder)", {
        type,
        value: value2
      });
      return value2;
    }
    const value = networks.find((n) => n.shortName === selected?.shortName) ?? {
      shortName: "",
      name: isOriginSelector ? "Select Source Network" : "Select Target Network"
    };
    logger_default.debug("[NetworkSelector] selected", { type, value });
    return value;
  }, [
    networks,
    sourceNetwork,
  ...
  useEffect19(() => {
    ...
    logger_default.info("[NetworkSelector] FORCING origin to dApp targetChain", {
      forced: forcedNetwork.shortName
    });
    dispatch(setSourceChain(forcedNetwork));
    setInitialSelection((prev) => {
      const next = { ...prev, sourceSelection: false };
      logger_default.info("[NetworkSelector] setInitialSelection (forced origin)", {
        prev,
        next
      });
      return next;
  ...
  const handleNetworkChange = (chain) => {
    logger_default.info("[NetworkSelector] change", {
      type,
    ...
    if (isOriginSelector) {
      if (chain.shortName !== sourceNetwork.shortName) {
        ...
        if (mode === "light" /* light */) {
          ...
          if (currentSourceAddr !== demoAddr) {
            logger_default.debug("[NetworkSelector] set demo SOURCE address", {
      ...
      setInitialSelection((prev) => {
        const next = prev.sourceSelection === false ? prev : { ...prev, sourceSelection: false };
        logger_default.info("[NetworkSelector] setInitialSelection(origin)", {
          prev,
          next
        });
        return next;
      ...
      if (chain.shortName !== targetNetwork.shortName) {
        logger_default.debug("[NetworkSelector] set targetChain", {
          chain: chain.shortName
        });
        ...
        if (mode === "light" /* light */) {
          ...
          if (currentTargetAddr !== demoAddr) {
            logger_default.debug("[NetworkSelector] set demo TARGET address", {
      ...
      setInitialSelection((prev) => {
        const next = prev.targetSelection === false ? prev : { ...prev, targetSelection: false };
        logger_default.info("[NetworkSelector] setInitialSelection(target)", {
          prev,
          next
        });
        return next;
  ...
  useEffect19(() => {
    ...
    if (srcDemo && currentSourceAddr !== srcDemo) {
      logger_default.debug("[NetworkSelector] sync demo SOURCE address", {
        was: currentSourceAddr,
        now: srcDemo
      });
    ...
    if (tgtDemo && currentTargetAddr !== tgtDemo) {
      logger_default.debug("[NetworkSelector] sync demo TARGET address", {
        was: currentTargetAddr,
        now: tgtDemo
      });
...
var SingleForm = ({
  ...
  const theme = useSelector44(selectTheme);
  const feeDeduct = useSelector44(selectFeeDeduct);
  const { totalFee } = useSelector44(selectServiceFee);
  const dAppOption = useSelector44(selectDappOption);
  const compliantOption = useSelector44(selectCompliantOption);
  const targetCompliant = useSelector44(selectTargetCompliant);
  const sourceAddress = useSelector44(selectSourceAddress);
  const sourceNetwork = useSelector44(selectSourceChain);
  const targetNetwork = useSelector44(selectTargetChain);
  const targetAddress = useSelector44(selectTargetAddress);
  ...
  const targetCurrency = useSelector44(selectTargetCurrency);
  ...
  const onAmountChange = (value) => {
    try {
      ...
      let masked = value.replace(/[^0-9.]/g, "").replace(/(\..*?)\..*/g, "$1").replace(new RegExp(`(\\.\\d{${safeDecimals}})\\d+`), "$1");
      ...
      logger_default.error("[SingleForm] onAmountChange failed", e);
      toast3.error(
  ...
  const onMaxClick = () => {
    try {
      ...
      const envCap = envOptions?.transferLimitMaxUSDT != null ? parseFloat(envOptions.transferLimitMaxUSDT) : Number.POSITIVE_INFINITY;
      ...
      logger_default.error("[SingleForm] onMaxClick failed", e);
      toast3.error(
        "Unable to calculate the maximum amount. Please contact support for assistance."
      );
    }
  };
  const demoSourceAddress = useMemo31(() => {
    if (mode !== "light" /* light */) return "";
    const short = sourceNetwork?.shortName;
    if (!short) return "";
    if (short === "SOL" /* SOLANA */) return lightDemoAccounts.SOL;
  ...
  const isConnectedSourceWrapper = useMemo31(() => {
    if (mode === "light" /* light */) {
    ...
    if (mode === "payment" /* payment */ && dAppOption !== "none" /* None */) {
      const on2 = isReady;
      logger_default.debug("[SingleForm] source wrapper connected (PAYMENT dApp)?", {
        on: on2,
        isReady
      });
      return on2;
    ...
    const on = isReady;
    logger_default.debug("[SingleForm] source wrapper connected (ADVANCED)?", {
      on,
      isReady,
  ...
  const isConnectedTargetWrapper = useMemo31(() => {
    if (mode !== "light" /* light */) return false;
...
import { useEffect as useEffect21, useMemo as useMemo32, useRef as useRef6, useState as useState12 } from "react";
import { useSelector as useSelector45, useDispatch as useDispatch15 } from "react-redux";
...
var FiatWidget = ({ submitCallback }) => {
  ...
  const ccTransactionIdSeedRef = useRef6(uuidv4());
  const ccTransactionSubmittedRef = useRef6(false);
...
var FiatWidget_default = FiatWidget;

// src/widgets/transfer/hooks/useAllowance.tsx
var EMPTY3 = {
  isApproved: false,
  approve: async () => {
  },
...
var useAllowance6 = (args) => {
  const { currentPlugin } = useGetCurrentPlugin_default();
  logger_default.debug("[useAllowance] pluginId", currentPlugin?.id);
  const hook = currentPlugin?.useAllowance ?? default_default.useAllowance ?? (() => EMPTY3);
  logger_default.debug("[useAllowance] plugin", !!currentPlugin);
  return hook(args);
};
var useAllowance_default = useAllowance6;
...
// src/widgets/transfer/hooks/useComplianceCheck.tsx
...
// src/widgets/transfer/hooks/useDisconnectWallet.tsx
var EMPTY4 = {
  disconnectWallet: async () => {
  }
};
var useDisconnectWallet6 = () => {
  const { currentPlugin } = useGetCurrentPlugin_default();
  logger_default.debug("[useDisconnectWallet] pluginId", currentPlugin?.id);
  const hook = currentPlugin?.useDisconnectWallet ?? default_default.useDisconnectWallet ?? (() => EMPTY4);
  logger_default.debug("[useDisconnectWallet] plugin", !!currentPlugin);
  return hook();
};
...
import { useDispatch as useDispatch18, useSelector as useSelector49 } from "react-redux";
...
import { useCallback as useCallback12, useEffect as useEffect22, useMemo as useMemo33, useRef as useRef7 } from "react";
import { useDispatch as useDispatch16, useSelector as useSelector46 } from "react-redux";
...
import { useDispatch as useDispatch17, useSelector as useSelector48 } from "react-redux";
...
var AccountDetailsModal = () => {
  ...
  const sourceAddress = useSelector48(selectSourceAddress);
  const networkOption = useSelector48(selectNetworkOption);
  const sourceChain = useSelector48(selectSourceChain);
  const isOpen = useSelector48(selectAccountDetailsModal);
  ...
  const handleDisconnect = async () => {
    if (mode === "light" /* light */) {
      logger_default.debug("[Solana AccountDetailsModal] disconnect noop in LIGHT mode");
      close();
      return;
    }
    try {
...
var SolanaWalletConnectModal = () => {
  ...
  const isOpen = useSelector49(selectSolanaConnectModal);
  ...
  const onConnect = useCallback13(async () => {
    if (!isSol) return;
    if (mode === "light" /* light */) {
...
import { useDispatch as useDispatch21, useSelector as useSelector52 } from "react-redux";
...
import { useDispatch as useDispatch19, useSelector as useSelector50 } from "react-redux";
...
var AccountDetailsModal2 = () => {
  ...
  const mode = useSelector50(selectMode);
  const networkOption = useSelector50(selectNetworkOption);
  const sourceChain = useSelector50(selectSourceChain);
  const sourceAddress = useSelector50(selectSourceAddress);
  const isOpen = useSelector50(selectAccountDetailsModal);
  ...
  const handleDisconnect = async () => {
    if (mode === "light" /* light */) {
      logger_default.debug("[Tron AccountDetailsModal] disconnect noop in LIGHT mode");
      close();
      return;
    }
    try {
...
import { useEffect as useEffect23, useMemo as useMemo37, useRef as useRef8 } from "react";
import { useDispatch as useDispatch20, useSelector as useSelector51 } from "react-redux";
...
var TronWalletSelect = () => {
  ...
  const [detected, undetected] = useMemo37(() => {
    const detected2 = [];
    const undetected2 = [];
...
var TronWalletConnectModal = () => {
  ...
  const isOpen = useSelector52(selectTronConnectModal);
  ...
  const onConnect = useCallback14(async () => {
    if (!isTrx) return;
    if (mode === "light" /* light */) {
...
var TransferWidget = ({
  ...
  const [warningModalOpen, setWarningModalOpen] = useState13(null);
  const [resetModalOpen, setResetModalOpen] = useState13(false);
  ...
  const networkOption = useSelector53(selectNetworkOption);
  const dAppOption = useSelector53(selectDappOption);
  const mode = useSelector53(selectMode);
  const transactionOption = useSelector53(selectTransactionOption);
  const backendUrl = useSelector53(selectBackendUrl);
  const sourceAddress = useSelector53(selectSourceAddress);
  const targetAddress = useSelector53(selectTargetAddress);
  const sourceChain = useSelector53(selectSourceChain);
  const targetChain = useSelector53(selectTargetChain);
  const sourceCurrency = useSelector53(selectSourceCurrency);
  const targetCurrency = useSelector53(selectTargetCurrency);
  const amount = useSelector53(selectAmount);
  const { totalFee, transactionValues } = useSelector53(selectServiceFee);
  const compliantOption = useSelector53(selectCompliantOption);
  const networkOptions = useSelector53(selectNetworkOption);
  const feeDeduct = useSelector53(selectFeeDeduct);
  const pendingTxs = useSelector53(selectPendingTxs);
  const networks = useSelector53(selectNetworks);
  ...
  const { width: windowWidth } = useWidth_default();
  const { disconnectWallet } = useDisconnectWallet_default();
  const { allowance, isApproved, approve, signMessage } = useAllowance_default();
  const { balance, decimals } = useBalance_default();
  ...
  const { pools } = useGetPools_default(backendUrl, networkOptions);
  const { data: fees, isLoading: isLoadingFees } = useGetFees_default({
  ...
  const isBackButtonEnabled = useMemo39(() => {
    if (formStep !== 0) {
  ...
  const isSubmitButtonEnabled = useMemo39(() => {
  ...
  const [initialSelection, setInitialSelection] = useState13({
    ...
    if (error === "ApprovalNeeded" /* ApprovalNeeded */ && mode !== "light" /* light */ && dAppOption === "none" /* None */) {
      try {
        if (!signature) {
          ...
          setSigning(false);
          if (!sig) {
            toast4("Signature request was cancelled.", { icon: "\u2139\uFE0F" });
            return;
          }
          setSignature2(sig);
          return;
        ...
        setApproving(false);
        if (err?.code === 4001) {
          toast4("Approval request was cancelled.", { icon: "\u2139\uFE0F" });
          return;
        }
  ...
  const onNext = () => {
    ...
    if (error === "Warning" /* Warning */ && formStep === 0) {
      logger_default.info("validationWarning:", validationMessage);
  ...
  const onCancelApprove = async () => {
    ...
    try {
      ...
      await approve(true);
      toast4("Approval successfully cancelled.", { icon: "\u2139\uFE0F" });
    } catch (err) {
      if (err?.code === 4001) {
        toast4("Cancel-approval request was cancelled.", { icon: "\u2139\uFE0F" });
      } else {
...
var KimaWidgetWrapper = ({
  ...
  const submitted = useSelector54(selectSubmitted);
  const sourceChain = useSelector54(selectSourceChain);
  const ccTransactionStatus = useSelector54(selectCCTransactionStatus);
  const ccTransactionRetrying = useSelector54(selectCCTransactionRetrying);
  const networkOption = envOptions?.env;
  const kimaExplorer = envOptions?.kimaExplorer || "https://explorer.sardis.kima.network";
  const { currentPlugin } = useGetCurrentPlugin_default();
  const prevColorMode = useRef10(void 0);
  useEffect25(() => {
    if (prevColorMode.current !== theme?.colorMode) {
      dispatch(setTheme(theme));
      setThemeMode(
        theme?.colorMode === "light" /* light */ ? "light" : "dark"
      );
      setThemeVariables({
  ...
  useEffect25(() => {
    ...
    if (networkOption && prevConfigRef.current.networkOption !== networkOption) {
  ...
  const prevTxOptJson = useRef10(null);
  useEffect25(() => {
    ...
    if (transactionOption) {
      ...
      if (transactionOption.amount !== void 0 && transactionOption.amount !== null) {
        dispatch(setAmount(String(transactionOption.amount)));
      }
    }
    prevTxOptJson.current = nextJson;
  }, [transactionOption, chainData, dispatch]);
  const prevModeRef = useRef10(void 0);
  const prevTxIdRef = useRef10(void 0);
  useEffect25(() => {
...
var KimaTransactionWidget = ({
  ...
  const { kimaBackendUrl } = useKimaContext();
  const [hydrated, setHydrated] = useState14(false);
  const {
    data: envOptions,
