...
var tronwalletAdapterBitkeep = require('@tronweb3/tronwallet-adapter-bitkeep');
...
var EthereumProvider = function EthereumProvider(_ref) {
  ...
  var autoConnect = reactRedux.useSelector(selectWalletAutoConnect);
  ...
  var connect = React.useCallback(function () {
    ...
    var handleProvider = function handleProvider(web3Provider, detectedProvider) {
    ...
    if (ethereumProvider) {
      ...
      detectEthereumProvider().then(function (detectedProvider) {
        if (detectedProvider) {
          ...
          handleProvider(_provider, detectedProvider);
        } else {
          ...
          var _temp = _catch(function () {
            return Promise.resolve(fetchWrapper.get(nodeProviderQuery + "/kima-finance/kima-blockchain/chains/get_chains")).then(function (networks) {
              setOptions(networkOptions.filter(function (network) {
                ...
                }) >= 0 || network.id === exports.SupportNetworks.FIAT && useFIAT || network.id === exports.SupportNetworks.TRON;
              }));
            });
          }, function (e) {
...
function useIsWalletReady(enableNetworkAutoswitch) {
  ...
  var _useEthereumProvider = useEthereumProvider(),
    ...
    signerAddress = _useEthereumProvider.signerAddress,
    evmChainId = _useEthereumProvider.chainId;
    ...
    try {
      return Promise.resolve(function () {
        if (provider && correctEvmNetwork) {
          ...
          var _temp = _catch(function () {
            return Promise.resolve(provider.send('wallet_switchEthereumChain', [{
...
function useBalance() {
  ...
  var _useEthereumProvider = useEthereumProvider(),
    signerAddress = _useEthereumProvider.signerAddress,
    signer = _useEthereumProvider.signer,
    evmChainId = _useEthereumProvider.chainId;
          ...
          var _temp = function () {
            if (originNetwork === exports.SupportNetworks.FIAT) {
              ...
              return Promise.resolve(fetchWrapper.get(nodeProviderQuery + "/kima-finance/kima-blockchain/chains/get_available_chains/" + originNetwork)).then(function (networks) {
                ...
                if (originNetwork === exports.SupportNetworks.TRON) chains = [exports.SupportNetworks.ETHEREUM, exports.SupportNetworks.POLYGON];
              });
            }
          }();
          return _temp && _temp.then ? _temp.then(_temp2) : _temp2(_temp);
...
var KimaProvider = function KimaProvider(_ref) {
  ...
  var adapters = React.useMemo(function () {
    ...
    var bitKeepAdapter = new tronwalletAdapterBitkeep.BitKeepAdapter();
    ...
    return [tronLinkAdapter, bitKeepAdapter, tokenPocketAdapter, okxwalletAdapter, ledger];
  }, []);
  function onError(e) {
