...
var TransferWidget = ({
  ...
  const handleSubmit = async () => {
    ...
    if (error === "ValidationError" /* Error */) {
      return toast12.error(validationMessage, { icon: /* @__PURE__ */ React107.createElement(Error_default, null) });
    }
    if (error === "ApprovalNeeded" /* ApprovalNeeded */) {
      return approve();
    }
    const { success, message: submitMessage } = await submitTransaction();
    if (!success) return toast12.error(submitMessage, { icon: /* @__PURE__ */ React107.createElement(Error_default, null) });
  };
  const onNext = () => {
    ...
    toast12.error(message, { icon: /* @__PURE__ */ React107.createElement(Error_default, null) });
