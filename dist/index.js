...
import { Provider, useSelector as useSelector17 } from "react-redux";
...
var Solana = ({ width = 30, height = 30, ...rest }) => {
  return /* @__PURE__ */ React10.createElement(
    ...
    /* @__PURE__ */ React10.createElement("defs", null, /* @__PURE__ */ React10.createElement(
      ...
      /* @__PURE__ */ React10.createElement("stop", { stopColor: "#CF41E8" }),
      /* @__PURE__ */ React10.createElement("stop", { offset: "1", stopColor: "#10F2B0" })
    ))
  );
};
...
var Bank = ({ width = 32, height = 32, ...rest }) => {
  return /* @__PURE__ */ React25.createElement(
    ...
    /* @__PURE__ */ React25.createElement("path", { d: "M6 9.4375V20.4062", stroke: "#86B8CE", "stroke-width": "2" }),
    /* @__PURE__ */ React25.createElement("path", { d: "M12 9.4375V20.4062", stroke: "#86B8CE", "stroke-width": "2" }),
    /* @__PURE__ */ React25.createElement("path", { d: "M18 9.4375V20.4062", stroke: "#86B8CE", "stroke-width": "2" }),
    /* @__PURE__ */ React25.createElement("path", { d: "M24 9.4375V20.4062", stroke: "#86B8CE", "stroke-width": "2" }),
...
var Bera = ({ width = 31, height = 30, ...rest }) => {
  return /* @__PURE__ */ React35.createElement(
    ...
    /* @__PURE__ */ React35.createElement("g", { id: "svgg" }, /* @__PURE__ */ React35.createElement(
      "path",
      {
        id: "path0",
...
var HONEY = ({ width = 30, height = 30, ...rest }) => {
  return /* @__PURE__ */ React36.createElement(
    ...
    /* @__PURE__ */ React36.createElement("g", { filter: "url(#filter0_dd_6594_45)" }, /* @__PURE__ */ React36.createElement(
      "path",
      {
    ...
    /* @__PURE__ */ React36.createElement("defs", null, /* @__PURE__ */ React36.createElement(
      ...
      /* @__PURE__ */ React36.createElement("feFlood", { "flood-opacity": "0", result: "BackgroundImageFix" }),
      /* @__PURE__ */ React36.createElement(
        "feColorMatrix",
        {
          in: "SourceAlpha",
      ...
      /* @__PURE__ */ React36.createElement("feOffset", { dy: "0.5" }),
      /* @__PURE__ */ React36.createElement("feGaussianBlur", { stdDeviation: "0.5" }),
      /* @__PURE__ */ React36.createElement("feComposite", { in2: "hardAlpha", operator: "out" }),
      /* @__PURE__ */ React36.createElement(
        "feColorMatrix",
        {
          type: "matrix",
      ...
      /* @__PURE__ */ React36.createElement("stop", { "stop-color": "#E9D0B4" }),
      /* @__PURE__ */ React36.createElement("stop", { offset: "1", "stop-color": "#DA9713" })
    ), /* @__PURE__ */ React36.createElement(
      "radialGradient",
      {
      ...
      /* @__PURE__ */ React36.createElement("stop", { "stop-color": "#E9D0B4" }),
      /* @__PURE__ */ React36.createElement("stop", { offset: "1", "stop-color": "#EC8A19" })
    ))
  );
};
...
import {
  ...
  berachainBepolia as berachainBepolia2,
  bsc as bsc2,
...
var useEvmProvider = () => {
  ...
  const walletAddress = externalProvider?.signer instanceof JsonRpcSigner && externalProvider.signer.address || appkitAccountInfo?.address;
  const walletProvider = externalProvider?.provider instanceof BrowserProvider ? externalProvider.provider : appkitProvider;
  return {
    walletProvider,
    walletAddress
  };
...
import { BrowserProvider as BrowserProvider2, formatUnits, JsonRpcSigner as JsonRpcSigner2, parseUnits } from "ethers";
...
var isValidExternalProvider = (externalProvider) => {
  ...
  if (type === "evm") {
    if (!(provider instanceof BrowserProvider2) || !(signer instanceof JsonRpcSigner2))
      return false;
  }
  if (type === "solana") {
    if (!isSolProvider(provider) || !(signer instanceof PublicKey))
      return false;
  }
  if (type === "tron") {
...
var getEvmBalance = async (input) => {
  ...
  try {
    const viemClient = createPublicClient2({
      chain: network,
      transport: http2()
    });
...
async function switchNetworkEthers(provider, chainId, chains) {
  try {
    ...
    logger_default.debug("chainId: ", chainId, toHex(chainId));
...
function useIsWalletReady() {
  ...
  const { walletProvider: appkitProvider } = useAppKitProvider3("eip155");
...
function useEvmAllowance() {
  ...
  const approveErc20TokenTransfer = async (isCancel = false) => {
    ...
    try {
      const viemClient = createPublicClient3({
        chain: sourceChain,
        transport: http3()
      });
      const walletClient = createWalletClient({
...
function useGetSolBalance() {
  ...
  const isSolanaPublicKey = (key) => {
    return key instanceof PublicKey3;
  };
...
var getTokenAllowance2 = async ({
  ...
  try {
    ...
    const mintPublicKey = new PublicKey4(tokenAddress);
...
var useSolanaProvider = () => {
  ...
  const userPublicKey = isSolanaProvider && externalProvider && externalProvider.signer instanceof PublicKey5 ? externalProvider?.signer : sourceChain.shortName === "SOL" ? internalPublicKey : null;
...
function useBalance2() {
  ...
  const publicKey = resolvedAddress ? new PublicKey6(resolvedAddress) : void 0;
  const { data: allowanceData } = useQuery7({
    queryKey: [
      "solanaAllowance",
      publicKey?.toBase58(),
...
import { PublicKey as PublicKey7, Transaction } from "@solana/web3.js";
import { useQueryClient as useQueryClient2 } from "@tanstack/react-query";
function useSolanaAllowance() {
  const queryClient2 = useQueryClient2();
  const { transactionValues } = useSelector8(selectServiceFee);
  const mode = useSelector8(selectMode);
  const feeDeduct = useSelector8(selectFeeDeduct);
  ...
  const publicKey = mode === "light" /* light */ ? new PublicKey7(lightDemoAccounts.SOL) : userPublicKey;
...
function useIsWalletReady2() {
  ...
  const mode = useSelector9(selectMode);
  const { externalProvider } = useKimaContext();
...
var tronWebTestnet = new TronWeb2({
  fullHost: "https://api.nileex.io"
});
var tronWebMainnet = new TronWeb2({
...
function useGetTronBalance() {
  const networkOption = useSelector10(selectNetworkOption);
  const { wallet } = useWallet4();
  const sourceNetwork = useSelector10(selectSourceChain);
  const tronWeb = useMemo4(
    () => networkOption === "testnet" /* testnet */ ? tronWebTestnet : tronWebMainnet,
    [networkOption]
  );
  const result = useQuery8({
...
import { useWallet as useWallet5 } from "@tronweb3/tronwallet-adapter-react-hooks";
import { useMemo as useMemo5 } from "react";
var useTronProvider = () => {
  const { externalProvider } = useKimaContext();
  const networkOption = useSelector11(selectNetworkOption);
  const sourceChain = useSelector11(selectSourceChain);
  const {
...
function useBalance3() {
  ...
  const sourceChain = useSelector12(selectSourceChain);
  const networkOptions3 = useSelector12(selectNetworkOption);
  const tokenOptions = useSelector12(selectTokenOptions);
  const backendUrl = useSelector12(selectBackendUrl);
...
function useTronAllowance() {
  ...
  const mode = useSelector13(selectMode);
  const networkOption = useSelector13(selectNetworkOption);
  const backendUrl = useSelector13(selectBackendUrl);
  const { transactionValues } = useSelector13(selectServiceFee);
  const selectedCoin = useSelector13(selectSourceCurrency);
  const tokenOptions = useSelector13(selectTokenOptions);
...
function useIsWalletReady3() {
  ...
  const sourceChain = useSelector14(selectSourceChain);
  const { externalProvider } = useKimaContext();
...
import { useDispatch as useDispatch6, useSelector as useSelector16 } from "react-redux";
import { useEffect as useEffect6, useState as useState5 } from "react";
var useIsProviderReady2 = () => {
  const [isReady, setIsReady] = useState5(false);
  const dispatch = useDispatch6();
  const sourceChain = useSelector16(selectSourceChain);
  useEffect6(() => {
...
var InternalKimaProvider = React51.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children, logLevel }) => {
    ...
    const plugins = useSelector17(selectAllPlugins, (prev, next) => prev === next);
...
var KimaProvider = ({
  ...
  if (externalProvider && isValidExternalProvider(externalProvider)) {
    ...
    if (externalProvider.type === "solana" && externalProvider.signer instanceof PublicKey8)
  ...
  return /* @__PURE__ */ React51.createElement(QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React51.createElement(Provider, { store }, /* @__PURE__ */ React51.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React51.createElement(
...
import React90, { useEffect as useEffect25, useState as useState18 } from "react";

// src/components/KimaWidgetWrapper.tsx
import React88, { useEffect as useEffect24 } from "react";
import { useDispatch as useDispatch28, useSelector as useSelector48 } from "react-redux";

// src/components/TransactionWidget.tsx
import React75, { useEffect as useEffect16, useMemo as useMemo12, useState as useState12 } from "react";
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ React52.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ React52.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ React52.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ React52.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ React52.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ React52.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ React52.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ React52.createElement(Warning_default, null) : /* @__PURE__ */ React52.createElement(Check_default, null) : null, /* @__PURE__ */ React52.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ React53.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ React55.createElement(
    ...
    /* @__PURE__ */ React55.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ React55.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ React57.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ React57.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ React57.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React57.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ React58.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React58.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
import React62, { useEffect as useEffect11, useMemo as useMemo8 } from "react";
import { useDispatch as useDispatch8, useSelector as useSelector22 } from "react-redux";
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ React60.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = useState6(default_default);
  const isIndexed = useSelector21(selectPluginIsIndexed);
  const sourceChain = useSelector21(selectSourceChain);
  useEffect7(() => {
    if (!isIndexed) return;
...
import React61, { useEffect as useEffect9, useState as useState8 } from "react";
var CopyButton = ({ text }) => {
  ...
  return /* @__PURE__ */ React61.createElement(
    ...
    copyClicked ? /* @__PURE__ */ React61.createElement(Check_default, null) : /* @__PURE__ */ React61.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({
  ...
  const selectedCoin = useSelector22(selectSourceCurrency);
  const sourceCompliant = useSelector22(selectSourceCompliant);
  const compliantOption = useSelector22(selectCompliantOption);
  const selectedNetwork = useSelector22(selectSourceChain);
  const targetAddress = useSelector22(selectTargetAddress);
  const dAppOption = useSelector22(selectDappOption);
  const { externalProvider } = useKimaContext();
  ...
  return /* @__PURE__ */ React62.createElement(
    ...
    /* @__PURE__ */ React62.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ React62.createElement(
      "button",
      {
      ...
      !isConnected && mode !== "light" /* light */ && !initialSelection && /* @__PURE__ */ React62.createElement(Wallet_default, null),
      !isConnected && mode !== "light" /* light */ && !initialSelection && "Connect Wallet"
    ), isConnected && !placeholder && /* @__PURE__ */ React62.createElement(CopyButton_default, { text: connectedAddress })),
    isConnected && !placeholder && balance !== void 0 && decimals !== void 0 ? /* @__PURE__ */ React62.createElement("p", { className: "balance-info" }, formatUSD(bigIntToNumber({ value: balance, decimals })), " ", selectedCoin, " available") : null
  );
};
var WalletButton_default = WalletButton;

// src/components/reusable/CoinDropdown.tsx
import React64, { useEffect as useEffect13, useRef, useState as useState9 } from "react";
...
function useCurrencyOptions(isSourceChain) {
  ...
  const sourceChain = useSelector23(selectSourceChain);
  const sourceSymbol = useSelector23(selectSourceCurrency);
  const targetChain = useSelector23(selectTargetChain);
...
function TokenIcon({
  ...
  return /* @__PURE__ */ React63.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ React63.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  const sourceCurrency = useSelector24(selectSourceCurrency);
  ...
  const targetCurrency = useSelector24(selectTargetCurrency);
  const { tokenList } = useCurrencyOptions(isSourceChain);
  const theme = useSelector24(selectTheme);
  ...
  return /* @__PURE__ */ React64.createElement(
    ...
    /* @__PURE__ */ React64.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ React64.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ React64.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ React64.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ React64.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React64.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ React64.createElement("p", null, token.symbol)
      ))
    ),
    !shouldLockToken && /* @__PURE__ */ React64.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ React64.createElement(Arrow_default, { fill: "none" }))
  );
};
var CoinDropdown_default = CoinDropdown;

// src/components/reusable/ConfirmDetails.tsx
import React67, { useEffect as useEffect14, useMemo as useMemo10, useState as useState10 } from "react";
...
function ChainIcon({ symbol }) {
  ...
  if (!Icon) {
    ...
    return /* @__PURE__ */ React65.createElement("div", null);
  }
  return /* @__PURE__ */ React65.createElement("div", { className: "icon" }, /* @__PURE__ */ React65.createElement(Icon, null));
}

// src/components/reusable/FeeDeductionRadioButtons.tsx
import React66 from "react";
import { useDispatch as useDispatch11, useSelector as useSelector25 } from "react-redux";
var FeeDeductionRadioButtons = ({ disabled }) => {
  const dispatch = useDispatch11();
  const feeDeduct = useSelector25(selectFeeDeduct);
  const amount = useSelector25(selectAmount);
  const sourceNetwork = useSelector25(selectSourceChain);
  const targetNetwork = useSelector25(selectTargetChain);
  const { totalFee: feeTotalBigInt } = useSelector25(selectServiceFee);
  const totalFee = bigIntToNumber(feeTotalBigInt);
  const sourceCurrency = useSelector25(selectSourceCurrency);
  const targetCurrency = useSelector25(selectTargetCurrency);
  const theme = useSelector25(selectTheme);
  const isSubmitted = useSelector25(selectSubmitted);
  const handleChange = (value) => {
    dispatch(setFeeDeduct(value));
  };
  return /* @__PURE__ */ React66.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ React66.createElement("div", { className: "fee-options" }, Number(amount) - totalFee > 0 && /* @__PURE__ */ React66.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ React66.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  ), /* @__PURE__ */ React66.createElement("span", { className: `radio-label ${theme.colorMode}` }, `Pay $${formatterFloat.format(
    Number(amount)
  ...
  )} ${targetCurrency} ${["BANK", "CC"].includes(targetNetwork.shortName) ? "with" : "in"} ${targetNetwork.name}`)), /* @__PURE__ */ React66.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ React66.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({
  ...
  const feeDeduct = useSelector26(selectFeeDeduct);
  const mode = useSelector26(selectMode);
  const dAppOption = useSelector26(selectDappOption);
  const theme = useSelector26(selectTheme);
  const { transactionValues, sourceFee, targetFee, kimaFee, totalFee } = useSelector26(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const originNetwork = useSelector26(selectSourceChain);
  const targetNetwork = useSelector26(selectTargetChain);
  const sourceAddress = useSelector26(selectSourceAddress);
  const targetAddress = useSelector26(selectTargetAddress);
  const bankDetails = useSelector26(selectBankDetails);
  const signature = useSelector26(selectSignature);
  const networkOptions3 = useSelector26(selectNetworks);
  const [feeCollapsed, setFeeCollapsed] = useState10(true);
  const transactionOption = useSelector26(selectTransactionOption);
  ...
  const sourceCurrency = useSelector26(selectSourceCurrency);
  const targetCurrency = useSelector26(selectTargetCurrency);
  const { width, updateWidth } = useWidth_default();
  useEffect14(() => {
    width === 0 && updateWidth(window.innerWidth);
  }, []);
  return /* @__PURE__ */ React67.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ React67.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React67.createElement("div", null, /* @__PURE__ */ React67.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React67.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React67.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React67.createElement(ChainIcon, { symbol: originNetwork?.shortName }), "FIAT"), /* @__PURE__ */ React67.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ React67.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React67.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React67.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ React67.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React67.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ React67.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ React67.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React67.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ React67.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ React67.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React67.createElement("span", { className: "label" }, "Source", !["BANK", "CC"].includes(originNetwork.shortName) && "wallet", ":"), /* @__PURE__ */ React67.createElement("div", { className: "network-details" }, /* @__PURE__ */ React67.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React67.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React67.createElement(ChainIcon, { symbol: originNetwork?.shortName }), originNetwork.name)), !["CC", "BANK"].includes(originNetwork.shortName) && /* @__PURE__ */ React67.createElement("p", { className: theme.colorMode }, dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : connectedAddress))), /* @__PURE__ */ React67.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ React67.createElement("span", { className: "amount-container" }, dAppOption === "none" /* None */ && /* @__PURE__ */ React67.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React67.createElement("span", null, "Amount to Transfer "), /* @__PURE__ */ React67.createElement("div", { className: "coin-details" }, /* @__PURE__ */ React67.createElement("p", null, formatBigInt(txValues.allowanceAmount), " ", sourceCurrency))), dAppOption === "none" /* None */ && /* @__PURE__ */ React67.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React67.createElement("span", null, "Total Fees"), /* @__PURE__ */ React67.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React67.createElement("span", { className: "service-fee" }, formatBigInt(totalFee), " ", sourceCurrency)
  )), /* @__PURE__ */ React67.createElement("div", { className: `fee-breakdown ${feeCollapsed ? "collapsed" : ""}` }, /* @__PURE__ */ React67.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React67.createElement("span", null, ["BANK", "CC"].includes(originNetwork.shortName) ? `${originNetwork.name} Processing Fee` : `Source Network Fee (${originNetwork.shortName})`), /* @__PURE__ */ React67.createElement("span", { className: "service-fee" }, formatBigInt(sourceFee), " ", sourceCurrency)), /* @__PURE__ */ React67.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React67.createElement("span", null, "Target Network Fee (", targetNetwork.shortName, ")"), /* @__PURE__ */ React67.createElement("span", { className: "service-fee" }, formatBigInt(targetFee), " ", targetCurrency)), /* @__PURE__ */ React67.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React67.createElement("span", null, "KIMA Service Fee"), /* @__PURE__ */ React67.createElement("span", { className: "service-fee" }, formatBigInt(kimaFee), " ", sourceCurrency))), /* @__PURE__ */ React67.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React67.createElement("span", null, "Target Transfer Amount"), /* @__PURE__ */ React67.createElement("span", { className: "service-fee" }, formatBigInt(txValues.submitAmount), " ", targetCurrency)))), targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React67.createElement("div", null, /* @__PURE__ */ React67.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React67.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React67.createElement("p", null, bankDetails.iban), /* @__PURE__ */ React67.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React67.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), "FIAT")), /* @__PURE__ */ React67.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React67.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React67.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ React67.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React67.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ React67.createElement("div", { className: "network-details" }, /* @__PURE__ */ React67.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React67.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React67.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), targetNetworkOption?.name)), /* @__PURE__ */ React67.createElement("p", { className: theme.colorMode }, mode === "light" /* light */ ? targetNetwork.shortName === "SOL" ? lightDemoAccounts.SOL : targetNetwork.shortName === "TRX" ? lightDemoAccounts.TRX : lightDemoAccounts.EVM : dAppOption === "LPDrain" /* LPDrain */ ? connectedAddress : targetAddress))), mode === "bridge" /* bridge */ && BigInt(totalFee.value) > BigInt(0) ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ React67.createElement(FeeDeductionRadioButtons_default, { disabled: feeOptionDisabled })
  ) : null);
};
var ConfirmDetails_default = ConfirmDetails;

// src/components/reusable/AddressInput.tsx
import React68, { useEffect as useEffect15 } from "react";
import { useDispatch as useDispatch12, useSelector as useSelector27 } from "react-redux";
var AddressInput = ({
  theme,
  placeholder,
  initialSelection
  ...
  const sourceChain = useSelector27(selectSourceChain);
...
import React70, { useMemo as useMemo11 } from "react";
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  const explorerUrl = useSelector29(selectKimaExplorer);
  const networkOption = useSelector29(selectNetworkOption);
  const networks = useSelector29(selectNetworks);
  ...
  const targetChain = useMemo11(
    () => networks.find((network) => network.shortName === data?.targetChain),
    [data, networks]
  );
  return /* @__PURE__ */ React70.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ React70.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ React70.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ React70.createElement(
    "div",
    {
      className: `info-item
    ...
    /* @__PURE__ */ React70.createElement("div", { className: "info-icon" }, step < index && /* @__PURE__ */ React70.createElement(Lock_default, { width: 24, height: 24 }), step >= index ? index === loadingStep ? /* @__PURE__ */ React70.createElement(Loader_default, { width: 24, height: 24, className: "loader" }) : index === errorStep ? /* @__PURE__ */ React70.createElement(Warning_default, { width: 24, height: 24 }) : /* @__PURE__ */ React70.createElement(Check_default, { width: 24, height: 24 }) : null),
    /* @__PURE__ */ React70.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ React70.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ React70.createElement("div", { className: "icon" }, /* @__PURE__ */ React70.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ React70.createElement("p", { className: "chain-name" }, "Kima TX Hash:"), /* @__PURE__ */ React70.createElement("p", null, /* @__PURE__ */ React70.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ React70.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash && sourceChain?.shortName !== "CC" ? /* @__PURE__ */ React70.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ React70.createElement(ChainIcon, { symbol: data.sourceChain }),
    /* @__PURE__ */ React70.createElement("p", { className: "chain-name" }, windowWidth >= 770 ? sourceChain?.name : sourceChain?.shortName, " ", "TX Hash:"),
    /* @__PURE__ */ React70.createElement("p", null, /* @__PURE__ */ React70.createElement(
      ExternalLink_default,
      {
    ...
    ), /* @__PURE__ */ React70.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ React70.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React70.createElement(ChainIcon, { symbol: data.sourceChain }), /* @__PURE__ */ React70.createElement("p", { className: "chain-name" }, windowWidth >= 770 ? sourceChain?.name : sourceChain?.shortName, " ", "TX Hash:"), /* @__PURE__ */ React70.createElement("p", null, /* @__PURE__ */ React70.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React70.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ React70.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React70.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ React70.createElement("p", { className: "chain-name" }, windowWidth >= 770 ? targetChain?.name : targetChain?.shortName, " ", "TX Hash:"), /* @__PURE__ */ React70.createElement("p", null, /* @__PURE__ */ React70.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React70.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  const bankDetails = useSelector30(selectBankDetails);
  return /* @__PURE__ */ React71.createElement("div", { className: "bank-input" }, /* @__PURE__ */ React71.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React71.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React71.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React71.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React71.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React71.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TxButton = ({ theme }) => {
  ...
  const txCount = useSelector31(selectPendingTxs);
...
import { toast as toast3, Toaster } from "react-hot-toast";
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ React73.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ React73.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ React73.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ React73.createElement("h3", null, transactionId), /* @__PURE__ */ React73.createElement(CopyButton_default, { text: transactionId })));
};
var TransactionStatusMessage_default = TransactionStatusMessage;

// src/components/reusable/TransactionSearch.tsx
import React74, { useRef as useRef3, useState as useState11 } from "react";
...
var TransactionSearch = () => {
  ...
  const [transactionId, setTransactionId] = useState11("");
  const refPollForUpdates = useRef3(false);
  ...
  return /* @__PURE__ */ React74.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ React74.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ React74.createElement("span", { className: "label" }, "Search Transaction:"), /* @__PURE__ */ React74.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React74.createElement(SecondaryButton_default, { clickHandler: handleSearch }, "Search"));
};
var TransactionSearch_default = TransactionSearch;

// src/components/TransactionWidget.tsx
var TransactionWidget = ({ theme }) => {
  const [step, setStep] = useState12(0);
  const [focus, setFocus] = useState12(-1);
  const [errorStep, setErrorStep] = useState12(-1);
  const [errorMessage, setErrorMessage] = useState12("");
  const [loadingStep, setLoadingStep] = useState12(-1);
  const [minimized, setMinimized] = useState12(false);
  const [isComplete, setIsComplete] = useState12(false);
  const dispatch = useDispatch16();
  const explorerUrl = useSelector33(selectKimaExplorer);
  const mode = useSelector33(selectMode);
  const feeDeduct = useSelector33(selectFeeDeduct);
  const amount = useSelector33(selectAmount);
  const txId = useSelector33(selectTxId);
  const dAppOption = useSelector33(selectDappOption);
  const { transactionValues } = useSelector33(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const transactionOption = useSelector33(selectTransactionOption);
  const sourceChain = useSelector33(selectSourceChain);
  const targetChain = useSelector33(selectTargetChain);
  const sourceSymbol = useSelector33(selectSourceCurrency);
  const targetSymbol = useSelector33(selectTargetCurrency);
  const networks = useSelector33(selectNetworks);
  const { successHandler, closeHandler } = useKimaContext();
  const backendUrl = useSelector33(selectBackendUrl);
  ...
  useEffect16(() => {
    if (error)
      toast3.error(
        ...
        {
          icon: /* @__PURE__ */ React75.createElement(Error_default, null)
        }
      );
  }, [error]);
  useEffect16(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      toast3.error("Unavailable", { icon: /* @__PURE__ */ React75.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      logger_default.error("transaction failed:", data.failReason);
      toast3.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ React75.createElement(Error_default, null) });
      ...
      setErrorStep(0);
      setLoadingStep(-1);
      toast3.error("Invalid signature!");
    }
  }, [data?.status]);
  const resetForm = () => {
    setIsComplete(false);
  ...
  return /* @__PURE__ */ React75.createElement(Provider2, { store }, /* @__PURE__ */ React75.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React75.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React75.createElement("div", { className: "topbar" }, !isComplete && /* @__PURE__ */ React75.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ React75.createElement("div", { className: "transaction-title" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "Transferred " : "Transfering " : isEmptyStatus ? "Fetching transaction status " : data?.status === "Completed" /* COMPLETED */ ? "Transferred " : "Transfering ", mode !== "status" /* status */ ? Number(amount) !== 0 ? transactionSourceChain?.shortName === "CC" ? bigIntToNumber(txValues.allowanceAmount).toFixed(2) : formatBigInt(txValues.allowanceAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `${sourceSymbol} ` : isEmptyStatus ? "" : `${data?.sourceSymbol}`, mode !== "status" /* status */ ? `\u2192 ` : isEmptyStatus ? "" : `\u2192 `, mode !== "status" /* status */ ? Number(amount) !== 0 ? transactionSourceChain?.shortName === "CC" ? bigIntToNumber(txValues.submitAmount).toFixed(2) : formatBigInt(txValues.submitAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `${targetSymbol}${" "}` : isEmptyStatus ? "" : `${data?.targetSymbol}${" "}`) : /* @__PURE__ */ React75.createElement("div", null, /* @__PURE__ */ React75.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ React75.createElement(
      "div",
      {
        className: `control-buttons ${isComplete ? "complete" : ""}`
      },
      isComplete && /* @__PURE__ */ React75.createElement(
        "button",
        {
      ...
      /* @__PURE__ */ React75.createElement(
        ...
        /* @__PURE__ */ React75.createElement(Minimize_default, null)
      ),
      !isValidTxId || loadingStep < 0 || error && dAppOption !== "none" /* None */ ? /* @__PURE__ */ React75.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null,
      closeHandler && /* @__PURE__ */ React75.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ React75.createElement(Cross_default, null)
      )
    ) : /* @__PURE__ */ React75.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React75.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View"))), data && !isComplete && /* @__PURE__ */ React75.createElement("div", { className: "header-network-labels" }, /* @__PURE__ */ React75.createElement("div", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React75.createElement(
      ChainIcon,
      {
        symbol: transactionSourceChain?.shortName
      }
    ), windowWidth > 450 && /* @__PURE__ */ React75.createElement("h3", null, transactionSourceChain?.name)), /* @__PURE__ */ React75.createElement(
      "div",
      {
        style: { display: "inline-block", transform: "rotate(-90deg)" }
      },
      /* @__PURE__ */ React75.createElement(Arrow_default, { width: 25, height: 25 })
    ), /* @__PURE__ */ React75.createElement("div", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React75.createElement(
      ChainIcon,
      {
        symbol: transactionTargetChain?.shortName
      }
    ), windowWidth > 450 && /* @__PURE__ */ React75.createElement("h3", null, transactionTargetChain?.name)))),
    isValidTxId && !error ? /* @__PURE__ */ React75.createElement("div", { className: "kima-card-content" }, !isComplete ? /* @__PURE__ */ React75.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ React75.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )) : /* @__PURE__ */ React75.createElement("div", { className: "transaction-content transaction-complete" }, /* @__PURE__ */ React75.createElement(TransactionComplete_default, null), /* @__PURE__ */ React75.createElement("h2", null, "Transaction Complete"), /* @__PURE__ */ React75.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ React75.createElement(
      "div",
      {
        className: `content-wrapper transaction-complete ${theme.colorMode}`
      },
      /* @__PURE__ */ React75.createElement("p", null, "You just transferred ", data?.amount, " ", data?.sourceSymbol),
      /* @__PURE__ */ React75.createElement("div", { className: "header-network-labels" }, /* @__PURE__ */ React75.createElement(
        "div",
        {
        ...
        windowWidth > 450 && /* @__PURE__ */ React75.createElement("h3", null, transactionSourceChain?.name)
      ), /* @__PURE__ */ React75.createElement(
        "div",
        {
          style: {
    ...
    )), /* @__PURE__ */ React75.createElement("div", { className: "transaction-buttons" }, /* @__PURE__ */ React75.createElement(
      ...
      /* @__PURE__ */ React75.createElement(PrimaryButton_default, null, "View Details")
    ))), !error && !isEmptyStatus && !isComplete && /* @__PURE__ */ React75.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ React75.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ React75.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ React75.createElement("div", { className: "single-form" }, /* @__PURE__ */ React75.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ React75.createElement(
      Toaster,
      {
        position: "top-right",
    ...
    /* @__PURE__ */ React75.createElement(
      ...
      /* @__PURE__ */ React75.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ React75.createElement("span", null, "Powered by"), /* @__PURE__ */ React75.createElement(KimaNetwork_default, null))
    )
  ));
};

// src/components/TransferWidget.tsx
import React86, { useEffect as useEffect22, useState as useState16, useRef as useRef8, useMemo as useMemo21, useCallback as useCallback3 } from "react";
import { useDispatch as useDispatch27, useSelector as useSelector46 } from "react-redux";

// src/components/reusable/SingleForm.tsx
import React77, { useEffect as useEffect18, useMemo as useMemo14, useState as useState14 } from "react";
...
import React76, { useState as useState13, useMemo as useMemo13, useRef as useRef4, useEffect as useEffect17 } from "react";
import { useSelector as useSelector34, useDispatch as useDispatch17 } from "react-redux";
var NetworkSelector = ({
  type,
  initialSelection,
  setInitialSelection
  ...
  const dAppOption = useSelector34(selectDappOption);
  const mode = useSelector34(selectMode);
  const sourceNetwork = useSelector34(selectSourceChain);
  const sourceSymbol = useSelector34(selectSourceCurrency);
  ...
  return /* @__PURE__ */ React76.createElement(
    ...
    /* @__PURE__ */ React76.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ React76.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ React76.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ React76.createElement(
      "div",
      {
        className: `network-menu custom-scrollbar ${theme?.colorMode ?? ""} ${collapsed ? "collapsed" : "toggled"}`
      },
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ React76.createElement(
        "div",
        {
          key: network.id,
        ...
        network.disabled ? /* @__PURE__ */ React76.createElement(Warning_default, { width: 25, height: 25 }) : /* @__PURE__ */ React76.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ React76.createElement("p", null, network.name),
        network.disabled && /* @__PURE__ */ React76.createElement("span", { className: "tooltip" }, "Temporarily unavailable")
      ))
    ),
    !shouldLockSourceNetwork && /* @__PURE__ */ React76.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ React76.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = React76.memo(NetworkSelector);
...
var SingleForm = ({
  ...
  const mode = useSelector36(selectMode);
  const theme = useSelector36(selectTheme);
  const feeDeduct = useSelector36(selectFeeDeduct);
  const { totalFee } = useSelector36(selectServiceFee);
  const dAppOption = useSelector36(selectDappOption);
  const compliantOption = useSelector36(selectCompliantOption);
  const targetCompliant = useSelector36(selectTargetCompliant);
  const sourceAddress = useSelector36(selectSourceAddress);
  const sourceNetwork = useSelector36(selectSourceChain);
  const targetNetwork = useSelector36(selectTargetChain);
  const targetAddress = useSelector36(selectTargetAddress);
  const { isReady } = useIsWalletReady4();
  const [amountValue, setAmountValue] = useState14("");
  const amount = useSelector36(selectAmount);
  const sourceCurrency = useSelector36(selectSourceCurrency);
  const targetCurrency = useSelector36(selectTargetCurrency);
  const backendUrl = useSelector36(selectBackendUrl);
  const { balance, decimals } = useBalance4();
  const {
    data: fees,
    isLoading,
  ...
  return /* @__PURE__ */ React77.createElement("div", { className: "single-form" }, /* @__PURE__ */ React77.createElement("div", { className: "form-item" }, /* @__PURE__ */ React77.createElement("span", { className: "label" }, dAppOption === "none" /* None */ && "Source", " Network:"), /* @__PURE__ */ React77.createElement("div", { className: "items" }, /* @__PURE__ */ React77.createElement(
  ...
  ), /* @__PURE__ */ React77.createElement(CoinDropdown_default, { isSourceChain: true }))), /* @__PURE__ */ React77.createElement(
    "div",
    {
    ...
    !["CC" /* CC */, "BANK" /* BANK */].includes(
      ...
      /* @__PURE__ */ React77.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ React77.createElement(WalletButton_default, { initialSelection: initialSelection.sourceSelection })
    ),
    mode !== "payment" /* payment */ && /* @__PURE__ */ React77.createElement("div", { className: "form-item" }, /* @__PURE__ */ React77.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ React77.createElement("div", { className: "items" }, /* @__PURE__ */ React77.createElement(
      NetworkSelector_default,
      {
        type: "target",
        ...{
    ...
    ), /* @__PURE__ */ React77.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React77.createElement(BankInput_default, null) : /* @__PURE__ */ React77.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React77.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ React77.createElement(
  ...
  )) : null, mode === "light" /* light */ && /* @__PURE__ */ React77.createElement(
    "div",
    {
      className: `form-item wallet-button-item ${!initialSelection.targetSelection && "connected"}`,
      style: { display: "flex", alignItems: "center" }
    },
    /* @__PURE__ */ React77.createElement("span", { className: "label" }, "Target Wallet:"),
    /* @__PURE__ */ React77.createElement(
  ...
  ), /* @__PURE__ */ React77.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React77.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ React77.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ React77.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "text",
  ...
  ), /* @__PURE__ */ React77.createElement("div", { className: "max-disclaimer" }, sourceNetwork.shortName !== "CC" && mode !== "payment" /* payment */ && /* @__PURE__ */ React77.createElement("span", { className: "max-button", onClick: onMaxClick }, "Max"), +totalFee !== -1 && dAppOption === "none" /* None */ && !initialSelection.sourceSelection && !initialSelection.targetSelection && /* @__PURE__ */ React77.createElement("p", { className: "fee-amount" }, "Est fees:", " ", /* @__PURE__ */ React77.createElement("span", { className: `${isLoadingFees ? "loading" : ""}` }, " ", isLoadingFees ? "" : `$ ${formatBigInt(totalFee)} ${feeCurrency}`))))));
};
...
import React78, { useCallback as useCallback2, useEffect as useEffect19, useMemo as useMemo15, useRef as useRef5 } from "react";
...
var SolanaWalletSelect = () => {
  ...
  const [detected, undetected] = useMemo15(() => {
    const detected2 = [];
    const undetected2 = [];
    for (const wallet2 of wallets) {
      if (wallet2.readyState === WalletReadyState.Installed || wallet2.readyState === WalletReadyState.Loadable) {
        detected2.push(wallet2);
      } else if (wallet2.readyState === WalletReadyState.NotDetected) {
  ...
  return /* @__PURE__ */ React78.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React78.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React78.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ React78.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React78.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React78.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React78.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ React78.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React78.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React78.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React78.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
...
var SolanaWalletConnectModal = () => {
  ...
  const connectModal = useSelector39(selectSolanaConnectModal);
  return /* @__PURE__ */ React80.createElement("div", null, /* @__PURE__ */ React80.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ React80.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ React80.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React80.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
import { useDispatch as useDispatch24, useSelector as useSelector42 } from "react-redux";
...
var AccountDetailsModal2 = () => {
  ...
  const networkOption = useSelector40(selectNetworkOption);
  const accountDetailsModal = useSelector40(selectAccountDetailsModal);
  const sourcheChain = useSelector40(selectSourceChain);
  ...
  return /* @__PURE__ */ React81.createElement(
    ...
    )))), /* @__PURE__ */ React81.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React81.createElement("div", { className: "summary" }, networkDetails && /* @__PURE__ */ React81.createElement(networkDetails.icon, { width: 60, height: 60 }), /* @__PURE__ */ React81.createElement("div", { className: "address" }, /* @__PURE__ */ React81.createElement("h2", null, getShortenedAddress(connectedAddress || "")), /* @__PURE__ */ React81.createElement(CopyButton_default, { text: connectedAddress })), /* @__PURE__ */ React81.createElement("h3", null, formatterFloat.format(Number(tronBalance)), " ", selectedNetwork.shortName)), /* @__PURE__ */ React81.createElement(SecondaryButton_default, { className: "block-explorer" }, /* @__PURE__ */ React81.createElement(ExternalLink_default, { className: "link", to: explorerUrl }, /* @__PURE__ */ React81.createElement(Explorer_default, { fill: "#778DA3" }), /* @__PURE__ */ React81.createElement("p", null, "Block explorer"), /* @__PURE__ */ React81.createElement(ExternalUrl_default, { fill: "#778DA3" }))), /* @__PURE__ */ React81.createElement(PrimaryButton_default, { clickHandler: handleDisconnect }, "Disconnect")))
  );
};
var AccountDetailsModal_default2 = AccountDetailsModal2;

// plugins/tron/components/TronWalletSelect.tsx
import React82, { useEffect as useEffect20, useMemo as useMemo18, useRef as useRef6 } from "react";
...
var TronWalletSelect = () => {
  ...
  const [detected, undetected] = useMemo18(() => {
    const detected2 = [];
    const undetected2 = [];
  ...
  return /* @__PURE__ */ React82.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React82.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React82.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ React82.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ React82.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React82.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React82.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ React82.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React82.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React82.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React82.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  const connectModal = useSelector42(selectTronConnectModal);
  return /* @__PURE__ */ React83.createElement("div", null, /* @__PURE__ */ React83.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ React83.createElement(
    "div",
    {
      className: `kima-modal wallet-connect ${theme.colorMode} ${connectModal ? "open" : ""}`
    },
    /* @__PURE__ */ React83.createElement("div", { className: "modal-overlay" }),
    /* @__PURE__ */ React83.createElement("div", { className: `modal-content-container ${theme.colorMode}` }, /* @__PURE__ */ React83.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React83.createElement("div", { className: "topbar" }, /* @__PURE__ */ React83.createElement("div", { className: "title" }, /* @__PURE__ */ React83.createElement("h3", null, "Connect Wallet")), /* @__PURE__ */ React83.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React83.createElement(
      "button",
      {
    ...
    )))), /* @__PURE__ */ React83.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React83.createElement(TronWalletSelect_default, null)))
  ));
};
...
var useValidateTransaction = (inputs) => {
  ...
  const maxValue = useMemo19(() => {
    ...
    log2.debug("maxValue: ", { maxVal, amountMinusFees });
    return maxVal;
  }, [balance, totalFee, feeDeduct]);
  const validate = (isSubmitting = false) => {
    ...
    if (amount > parseUnits3(envOptions?.transferLimitMaxUSDT || "100", decimals) && networkOption === "testnet" /* testnet */) {
      return {
        error: "ValidationError" /* Error */,
    ...
    const { isPoolAvailable, error } = checkPoolBalance({
      ...
      targetChain,
      targetCurrency,
      amount: formatUnits3(amount, decimals)
    });
    if (!isPoolAvailable) {
      return {
        error: "ValidationError" /* Error */,
...
import { useDispatch as useDispatch25, useSelector as useSelector44 } from "react-redux";
...
var WarningModal = ({
  ...
  return /* @__PURE__ */ React84.createElement("div", { className: "warning-modal-overlay" }, /* @__PURE__ */ React84.createElement("div", { className: "warning-modal" }, /* @__PURE__ */ React84.createElement("h3", null, "Warning"), /* @__PURE__ */ React84.createElement("p", null, message), /* @__PURE__ */ React84.createElement("div", { className: "warning-modal-buttons" }, /* @__PURE__ */ React84.createElement(
    SecondaryButton_default,
    {
...
import React85, { useEffect as useEffect21, useMemo as useMemo20, useRef as useRef7, useState as useState15 } from "react";
import { useSelector as useSelector45, useDispatch as useDispatch26 } from "react-redux";
...
var CCWidget = ({ submitCallback }) => {
  ...
  const backendUrl = useSelector45(selectBackendUrl);
  ...
  return /* @__PURE__ */ React85.createElement("div", { className: `cc-widget ${isLoading ? "loading" : ""}` }, (isLoading || isTransactionIdLoading || isEnvLoading || ccTransactionStatus === "success") && /* @__PURE__ */ React85.createElement("div", { className: "cc-widget-loader" }, /* @__PURE__ */ React85.createElement(ring_default, { width: 50, height: 50, fill: "#86b8ce" })), /* @__PURE__ */ React85.createElement(
    "iframe",
    {
...
var TransferWidget = ({
  ...
  const networkOption = useSelector46(selectNetworkOption);
  const dAppOption = useSelector46(selectDappOption);
  const mode = useSelector46(selectMode);
  const transactionOption = useSelector46(selectTransactionOption);
  const backendUrl = useSelector46(selectBackendUrl);
  const sourceAddress = useSelector46(selectSourceAddress);
  const targetAddress = useSelector46(selectTargetAddress);
  const sourceChain = useSelector46(selectSourceChain);
  const targetChain = useSelector46(selectTargetChain);
  ...
  const { totalFee, transactionValues } = useSelector46(selectServiceFee);
  const compliantOption = useSelector46(selectCompliantOption);
  const networkOptions3 = useSelector46(selectNetworkOption);
  const feeDeduct = useSelector46(selectFeeDeduct);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  ...
  const pendingTxs = useSelector46(selectPendingTxs);
  const networks = useSelector46(selectNetworks);
  ...
  const isSubmitButtonEnabled = useMemo21(() => {
  ...
  const submit = useCallback3(async () => {
    try {
      ...
      toast5.error("Failed to submit transaction", { icon: /* @__PURE__ */ React86.createElement(Error_default, null) });
      dispatch(setCCTransactionStatus("error-generic"));
    }
  ...
  const handleSubmit = async () => {
    ...
    if (error2 === "ValidationError" /* Error */) {
      return toast5.error(validationMessage, { icon: /* @__PURE__ */ React86.createElement(Error_default, null) });
    }
    if (["BANK", "CC"].includes(sourceChain.shortName)) {
  ...
  const onNext = () => {
    ...
    toast5.error(validationMessage, { icon: /* @__PURE__ */ React86.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ React86.createElement(
    ...
    resetModalOpen && /* @__PURE__ */ React86.createElement(
    ...
    warningModalOpen && /* @__PURE__ */ React86.createElement(
      WarningModal_default,
      {
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ React86.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ React86.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React86.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React86.createElement("div", { className: "topbar" }, /* @__PURE__ */ React86.createElement("div", { className: "title" }, /* @__PURE__ */ React86.createElement("h3", { style: { marginRight: "5px" } }, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ React86.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ React86.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ React86.createElement(
      ExternalLink_default,
      {
      ...
      /* @__PURE__ */ React86.createElement("div", { className: "menu-button" }, "I need help")
    ), ["BANK", "CC"].includes(sourceChain.shortName) && formStep > 0 && /* @__PURE__ */ React86.createElement(ExternalLink_default, { to: "https://docs.kima.network/kima-network/supported-fiat#unsupported-countries-credit-cards" }, /* @__PURE__ */ React86.createElement("div", { className: "menu-button" }, "Unsupported Countries")), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ React86.createElement(
      "button",
      {
      ...
      "Reset"
    ), closeHandler && /* @__PURE__ */ React86.createElement(
      "button",
      {
        className: "cross-icon-button",
        onClick: () => {
      ...
      /* @__PURE__ */ React86.createElement(Cross_default, null)
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ React86.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ React86.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ React86.createElement(
      SingleForm_default,
      {
        ...{
    ...
    ) : ccTransactionStatus !== "idle" ? /* @__PURE__ */ React86.createElement(CCWidget_default, { submitCallback: submit }) : /* @__PURE__ */ React86.createElement(
      ...
      /* @__PURE__ */ React86.createElement("div", { className: `button-group` }, isBackButtonEnabled && /* @__PURE__ */ React86.createElement(
        SecondaryButton_default,
        {
          clickHandler: onBack,
          theme: theme.colorMode,
      ...
      ), !!allowance && allowance > 0 && formStep !== 0 && ["BANK", "CC"].includes(sourceChain.shortName) && mode !== "light" /* light */ && dAppOption !== "LPDrain" /* LPDrain */ ? /* @__PURE__ */ React86.createElement(
        SecondaryButton_default,
        {
      ...
      ) : null, isSubmitButtonEnabled && /* @__PURE__ */ React86.createElement(
        PrimaryButton_default,
        {
          clickHandler: onNext,
    ...
    ), /* @__PURE__ */ React86.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ React86.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ React86.createElement(
      Toaster2,
      {
        position: "top-right",
        reverseOrder: false,
    ...
    ), /* @__PURE__ */ React86.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ React86.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ React86.createElement("span", null, "Powered by"), /* @__PURE__ */ React86.createElement(KimaNetwork_default, null))))
  );
};
...
var ErrorWidget = ({
  ...
  return /* @__PURE__ */ React87.createElement(
    ...
    /* @__PURE__ */ React87.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React87.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React87.createElement("div", { className: "topbar" }, /* @__PURE__ */ React87.createElement("div", { className: "title" }, /* @__PURE__ */ React87.createElement("h3", null, title))), /* @__PURE__ */ React87.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ React87.createElement("div", { className: "kima-card-content error" }, isCreditCardSource && !isRetrying && /* @__PURE__ */ React87.createElement(Error_default, { width: 40, height: 40 }), message && message !== "" && /* @__PURE__ */ React87.createElement("h2", null, message), isCreditCardSource && /* @__PURE__ */ React87.createElement(
      "div",
      {
        style: {
          marginTop: 16,
      ...
      ccTransactionId && /* @__PURE__ */ React87.createElement(
        ...
        /* @__PURE__ */ React87.createElement(CopyButton_default, { text: ccTransactionId })
      ),
      isRetrying && /* @__PURE__ */ React87.createElement(ring_default, { width: 30, height: 30, fill: "#86b8ce" })
    )), backButtonEnabled && /* @__PURE__ */ React87.createElement(
      "div",
      {
        style: {
          display: "flex",
      ...
      /* @__PURE__ */ React87.createElement(PrimaryButton_default, { clickHandler: backButtonFunction }, "Back")
...
var KimaWidgetWrapper = ({
  ...
  useDebugCode();
  const { kimaBackendUrl } = useKimaContext();
  const submitted = useSelector48(selectSubmitted);
  ...
  if (sourceChain.shortName === "CC") {
    ...
    if (submitted) {
      ...
      return /* @__PURE__ */ React88.createElement(TransactionWidget, { theme });
  ...
  return submitted ? /* @__PURE__ */ React88.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ React88.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
...
// src/components/KimaTransactionWidget.tsx
import { useDispatch as useDispatch29 } from "react-redux";
...
var SkeletonLoader = ({ theme }) => {
  ...
  return /* @__PURE__ */ React89.createElement(
    ...
    /* @__PURE__ */ React89.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React89.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React89.createElement("div", { className: "topbar" }, /* @__PURE__ */ React89.createElement("div", { className: "title skeleton" }, /* @__PURE__ */ React89.createElement("h3", null)), /* @__PURE__ */ React89.createElement("div", { className: "control-buttons" }, closeHandler && /* @__PURE__ */ React89.createElement(
      "button",
      {
        className: "cross-icon-button",
        onClick: () => {
      ...
      /* @__PURE__ */ React89.createElement(Cross_default, null)
    ))), /* @__PURE__ */ React89.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ React89.createElement("div", { className: "kima-card-content skeleton" }, /* @__PURE__ */ React89.createElement("div", { className: "skeleton" }), /* @__PURE__ */ React89.createElement("div", { className: "skeleton" }), /* @__PURE__ */ React89.createElement("div", { className: "skeleton" }), /* @__PURE__ */ React89.createElement("div", { className: "skeleton" }), /* @__PURE__ */ React89.createElement("div", { className: "skeleton" })), /* @__PURE__ */ React89.createElement("div", { className: `kima-card-footer` }, /* @__PURE__ */ React89.createElement("div", { className: `button-group skeleton` }, /* @__PURE__ */ React89.createElement("div", { className: "skeleton" }))), /* @__PURE__ */ React89.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ React89.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ React89.createElement("span", null, "Powered by"), /* @__PURE__ */ React89.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ React89.createElement("strong", null, "Network"))))
  );
};
...
var KimaTransactionWidget = ({
  ...
  if (!hydrated || !theme?.colorMode)
    return /* @__PURE__ */ React90.createElement(ring_default, { width: 20, height: 20, fill: "#86b8ce" });
  if (isLoadingEnvs || isLoadingChainData)
    return /* @__PURE__ */ React90.createElement(SkeletonLoader_default, { theme });
