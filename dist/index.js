...
var WalletProvider2 = ({
  ...
  return /* @__PURE__ */ React77.createElement(ConnectionProvider, { endpoint }, /* @__PURE__ */ React77.createElement(
...
import React79, { useMemo as useMemo3 } from "react";
...
var CreditCardPlugin = class extends PluginBase {
  ...
  Provider = ({ children }) => {
    return /* @__PURE__ */ React81.createElement(React81.Fragment, null, children);
  };
};
...
var InternalKimaProvider = React82.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children, logLevel }) => {
    ...
    const plugins = useSelector16(selectAllPlugins, (prev, next) => prev === next);
...
var KimaProvider = ({
  ...
  return /* @__PURE__ */ React82.createElement(QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React82.createElement(Provider, { store }, /* @__PURE__ */ React82.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React82.createElement(
...
import React121, { useEffect as useEffect24, useState as useState18 } from "react";

// src/components/KimaWidgetWrapper.tsx
import React119, { useEffect as useEffect23 } from "react";
import { useDispatch as useDispatch27, useSelector as useSelector47 } from "react-redux";

// src/components/TransactionWidget.tsx
import React106, { useEffect as useEffect15, useMemo as useMemo12, useState as useState11 } from "react";
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ React83.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ React83.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ React83.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ React83.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ React83.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ React83.createElement(Lock_default, { stroke: "#353539" }), step >= index ? index === loadingStep ? /* @__PURE__ */ React83.createElement(Loader_default, { stroke: "white", className: "loader" }) : index === errorStep ? /* @__PURE__ */ React83.createElement(Warning_default, { fill: "white" }) : /* @__PURE__ */ React83.createElement(Check_default, { fill: "white" }) : null, /* @__PURE__ */ React83.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ React84.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ React86.createElement(
    ...
    /* @__PURE__ */ React86.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ React86.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ React88.createElement(
    ...
    isLoading && /* @__PURE__ */ React88.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React88.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  );
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ React89.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React89.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
  children
);
...
import React93, { useEffect as useEffect10, useMemo as useMemo8 } from "react";
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ React91.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  ...
  const isIndexed = useSelector20(selectPluginIsIndexed);
...
import React92, { useEffect as useEffect8, useState as useState7 } from "react";
var CopyButton = ({ text }) => {
  ...
  return /* @__PURE__ */ React92.createElement(
    ...
    copyClicked ? /* @__PURE__ */ React92.createElement(Check_default, { fill: "white" }) : /* @__PURE__ */ React92.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({
  ...
  const mode = useSelector21(selectMode);
  const selectedCoin = useSelector21(selectSourceCurrency);
  const sourceCompliant = useSelector21(selectSourceCompliant);
  ...
  return /* @__PURE__ */ React93.createElement(
    ...
    /* @__PURE__ */ React93.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ React93.createElement(
      "button",
      {
      ...
      !isConnected && mode !== "light" /* light */ && !initialSelection && /* @__PURE__ */ React93.createElement(Wallet_default, null),
      !isConnected && mode !== "light" /* light */ && !initialSelection && "CONNECT WALLET"
    ), isConnected && !placeholder && /* @__PURE__ */ React93.createElement(CopyButton_default, { text: connectedAddress })),
    isConnected && !placeholder && balance !== void 0 && decimals !== void 0 ? /* @__PURE__ */ React93.createElement("p", { className: "balance-info" }, formatUSD(bigIntToNumber({ value: balance, decimals })), " ", selectedCoin, " available") : null
  );
};
var WalletButton_default = WalletButton;

// src/components/reusable/CoinDropdown.tsx
import React95, { useEffect as useEffect12, useRef, useState as useState8 } from "react";
...
function TokenIcon({
  ...
  return /* @__PURE__ */ React94.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ React94.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  return /* @__PURE__ */ React95.createElement(
    ...
    /* @__PURE__ */ React95.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ React95.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ React95.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ React95.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ React95.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React95.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ React95.createElement("p", null, token.symbol)
      ))
    ),
...
import React98, { useEffect as useEffect13, useMemo as useMemo10, useState as useState9 } from "react";
...
function ChainIcon({ symbol }) {
  ...
  if (!Icon) {
    ...
    return /* @__PURE__ */ React96.createElement("div", null);
  }
  return /* @__PURE__ */ React96.createElement("div", { className: "icon" }, /* @__PURE__ */ React96.createElement(Icon, null));
}
...
var FeeDeductionRadioButtons = ({ disabled }) => {
  ...
  const sourceNetwork = useSelector24(selectSourceChain);
  const targetNetwork = useSelector24(selectTargetChain);
  const { totalFee: feeTotalBigInt } = useSelector24(selectServiceFee);
  ...
  const isSubmitted = useSelector24(selectSubmitted);
  const handleChange = (value) => {
    dispatch(setFeeDeduct(value));
  };
  return /* @__PURE__ */ React97.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ React97.createElement("div", { className: "fee-options" }, Number(amount) - totalFee > 0 && /* @__PURE__ */ React97.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ React97.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  ), /* @__PURE__ */ React97.createElement("span", { className: `radio-label ${theme.colorMode}` }, `Pay $${formatterFloat.format(
    Number(amount)
  )} ${sourceCurrency} in ${sourceNetwork.name} to receive $${formatterFloat.format(
    Number(amount) - totalFee
  )} ${targetCurrency} in ${targetNetwork.name}`)), /* @__PURE__ */ React97.createElement("label", { className: `fee-option ${disabled ? "disabled" : ""}` }, /* @__PURE__ */ React97.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({
  ...
  const { transactionValues, sourceFee, targetFee, kimaFee, totalFee } = useSelector25(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const originNetwork = useSelector25(selectSourceChain);
  const targetNetwork = useSelector25(selectTargetChain);
  const sourceAddress = useSelector25(selectSourceAddress);
  const targetAddress = useSelector25(selectTargetAddress);
  const bankDetails = useSelector25(selectBankDetails);
  const signature = useSelector25(selectSignature);
  ...
  return /* @__PURE__ */ React98.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ React98.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React98.createElement("div", null, /* @__PURE__ */ React98.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React98.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React98.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React98.createElement(ChainIcon, { symbol: originNetworkOption?.shortName }), "FIAT"), /* @__PURE__ */ React98.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ React98.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React98.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React98.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ React98.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React98.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ React98.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ React98.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React98.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ React98.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ React98.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React98.createElement("span", { className: "label" }, "Source ", originNetwork.shortName !== "CC" && "Wallet"), /* @__PURE__ */ React98.createElement("div", { className: "network-details" }, /* @__PURE__ */ React98.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React98.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React98.createElement(ChainIcon, { symbol: originNetworkOption?.shortName }), originNetworkOption.shortName)), originNetwork.shortName !== "CC" && /* @__PURE__ */ React98.createElement("p", { className: theme.colorMode }, dAppOption === "LPDrain" /* LPDrain */ ? getShortenedAddress(targetAddress) : getShortenedAddress(connectedAddress)))), /* @__PURE__ */ React98.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ React98.createElement("span", { className: "amount-container" }, /* @__PURE__ */ React98.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React98.createElement("span", null, "Amount to Transfer "), /* @__PURE__ */ React98.createElement("div", { className: "coin-details" }, /* @__PURE__ */ React98.createElement("span", null, formatBigInt(txValues.allowanceAmount), " ", sourceCurrency))), /* @__PURE__ */ React98.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React98.createElement("span", null, "Total Fees"), /* @__PURE__ */ React98.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React98.createElement("span", { className: "service-fee" }, formatBigInt(totalFee), " ", sourceCurrency)
  )), /* @__PURE__ */ React98.createElement("div", { className: `fee-breakdown ${feeCollapsed ? "collapsed" : ""}` }, /* @__PURE__ */ React98.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React98.createElement("span", null, originNetwork.shortName === "CC" ? "Credit Card Processing Fee" : `Source Network Fee (${originNetwork.shortName})`), /* @__PURE__ */ React98.createElement("span", { className: "service-fee" }, formatBigInt(sourceFee), " ", sourceCurrency)), /* @__PURE__ */ React98.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React98.createElement("span", null, "Target Network Fee (", targetNetwork.shortName, ")"), /* @__PURE__ */ React98.createElement("span", { className: "service-fee" }, formatBigInt(targetFee), " ", targetCurrency)), /* @__PURE__ */ React98.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React98.createElement("span", null, "KIMA Service Fee"), /* @__PURE__ */ React98.createElement("span", { className: "service-fee" }, formatBigInt(kimaFee), " ", sourceCurrency))), /* @__PURE__ */ React98.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React98.createElement("span", null, "Target Transfer Amount"), /* @__PURE__ */ React98.createElement("span", { className: "service-fee target-amount" }, formatBigInt(txValues.submitAmount), " ", targetCurrency)))), targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React98.createElement("div", null, /* @__PURE__ */ React98.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React98.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React98.createElement("p", null, bankDetails.iban), /* @__PURE__ */ React98.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React98.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), "FIAT")), /* @__PURE__ */ React98.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React98.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React98.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ React98.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React98.createElement("span", { className: "label" }, "Target Wallet"), /* @__PURE__ */ React98.createElement("div", { className: "network-details" }, /* @__PURE__ */ React98.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React98.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React98.createElement(ChainIcon, { symbol: targetNetworkOption?.shortName }), targetNetworkOption?.shortName)), /* @__PURE__ */ React98.createElement("p", { className: theme.colorMode }, mode === "light" /* light */ ? targetNetwork.shortName === "SOL" ? getShortenedAddress(lightDemoAccounts.SOL) : targetNetwork.shortName === "TRX" ? getShortenedAddress(lightDemoAccounts.TRX) : getShortenedAddress(lightDemoAccounts.EVM) : dAppOption === "LPDrain" /* LPDrain */ ? getShortenedAddress(connectedAddress) : getShortenedAddress(targetAddress)))), mode === "bridge" /* bridge */ && BigInt(totalFee.value) > BigInt(0) ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ React98.createElement(FeeDeductionRadioButtons_default, { disabled: feeOptionDisabled })
  ) : null);
};
var ConfirmDetails_default = ConfirmDetails;

// src/components/reusable/AddressInput.tsx
import React99, { useEffect as useEffect14 } from "react";
...
var AddressInput = ({
  ...
  const targetChain = useSelector26(selectTargetChain);
...
import React101, { useMemo as useMemo11 } from "react";
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  return /* @__PURE__ */ React101.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ React101.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ React101.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ React101.createElement(
    "div",
    {
      className: `info-item
    ...
    step < index && /* @__PURE__ */ React101.createElement(Lock_default, { stroke: "#353539" }),
    step >= index ? index === loadingStep ? /* @__PURE__ */ React101.createElement(Loader_default, { stroke: "white", className: "loader" }) : index === errorStep ? /* @__PURE__ */ React101.createElement(Warning_default, { fill: "white" }) : /* @__PURE__ */ React101.createElement(Check_default, { fill: "white" }) : null,
    /* @__PURE__ */ React101.createElement("p", { className: "label" }, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ React101.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ React101.createElement("div", { className: "icon" }, /* @__PURE__ */ React101.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ React101.createElement("p", { className: "chain-name" }, "Kima TX Hash:"), /* @__PURE__ */ React101.createElement("p", null, /* @__PURE__ */ React101.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ React101.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash && sourceChain?.shortName !== "CC" ? /* @__PURE__ */ React101.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ React101.createElement(ChainIcon, { symbol: sourceChain?.shortName }),
    /* @__PURE__ */ React101.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX Hash:"),
    /* @__PURE__ */ React101.createElement("p", null, /* @__PURE__ */ React101.createElement(
      ExternalLink_default,
      {
    ...
    ), /* @__PURE__ */ React101.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ React101.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React101.createElement(ChainIcon, { symbol: data.originChain }), /* @__PURE__ */ React101.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX Hash:"), /* @__PURE__ */ React101.createElement("p", null, /* @__PURE__ */ React101.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React101.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ React101.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React101.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ React101.createElement("p", { className: "chain-name" }, targetChain?.name, " TX Hash:"), /* @__PURE__ */ React101.createElement("p", null, /* @__PURE__ */ React101.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React101.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ React102.createElement("div", { className: "bank-input" }, /* @__PURE__ */ React102.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React102.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React102.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React102.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React102.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React102.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ React104.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ React104.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ React104.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ React104.createElement("h3", null, transactionId), /* @__PURE__ */ React104.createElement(CopyButton_default, { text: transactionId })));
};
var TransactionStatusMessage_default = TransactionStatusMessage;

// src/components/reusable/TransactionSearch.tsx
import React105, { useRef as useRef3, useState as useState10 } from "react";
...
var TransactionSearch = () => {
  ...
  return /* @__PURE__ */ React105.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ React105.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ React105.createElement("span", { className: "label" }, "Search Transaction"), /* @__PURE__ */ React105.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React105.createElement(PrimaryButton_default, { clickHandler: handleSearch }, "SEARCH"));
};
...
var TransactionWidget = ({ theme }) => {
  ...
  const txId = useSelector32(selectTxId);
  const dAppOption = useSelector32(selectDappOption);
  const { transactionValues } = useSelector32(selectServiceFee);
  const txValues = feeDeduct ? transactionValues.feeFromTarget : transactionValues.feeFromOrigin;
  const transactionOption = useSelector32(selectTransactionOption);
  const sourceChain = useSelector32(selectSourceChain);
  const targetChain = useSelector32(selectTargetChain);
  const sourceSymbol = useSelector32(selectSourceCurrency);
  const targetSymbol = useSelector32(selectTargetCurrency);
  const networks = useSelector32(selectNetworks);
  ...
  useEffect15(() => {
    if (error)
      toast3.error(
        ...
        {
          icon: /* @__PURE__ */ React106.createElement(Error_default, null)
        }
      );
  }, [error]);
  useEffect15(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      toast3.error("Unavailable", { icon: /* @__PURE__ */ React106.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      logger_default.error("transaction failed:", data.failReason);
      toast3.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ React106.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ React106.createElement(Provider2, { store }, /* @__PURE__ */ React106.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React106.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React106.createElement("div", { className: "topbar" }, /* @__PURE__ */ React106.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ React106.createElement("div", { className: "transaction-title" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "Transferred " : "Transfering " : isEmptyStatus ? "Fetching transaction status " : data?.status === "Completed" /* COMPLETED */ ? "Transfered " : "Transfering ", mode !== "status" /* status */ ? Number(amount) !== 0 ? transactionSourceChain?.shortName === "CC" ? bigIntToNumber(txValues.allowanceAmount).toFixed(2) : formatBigInt(txValues.allowanceAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `${sourceSymbol} ` : isEmptyStatus ? "" : `(${data?.sourceSymbol})`, /* @__PURE__ */ React106.createElement("div", { className: "title-icon" }, /* @__PURE__ */ React106.createElement(
      ChainIcon,
      {
        symbol: transactionSourceChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `${transactionSourceChain?.name}` : isEmptyStatus ? "" : `${data?.originChain === "FIAT" ? "CC" : data?.originChain}`, " ", mode !== "status" /* status */ ? `\u2192 ` : isEmptyStatus ? "" : `\u2192 `, mode !== "status" /* status */ ? Number(amount) !== 0 ? transactionSourceChain?.shortName === "CC" ? bigIntToNumber(txValues.submitAmount).toFixed(2) : formatBigInt(txValues.submitAmount) : "" : data?.amount || "", " ", mode !== "status" /* status */ ? `${targetSymbol}${" "}` : isEmptyStatus ? "" : `${data?.targetSymbol}${" "}`, /* @__PURE__ */ React106.createElement("div", { className: "title-icon" }, /* @__PURE__ */ React106.createElement(
      ChainIcon,
      {
        symbol: transactionTargetChain?.shortName
      }
    )), " ", mode !== "status" /* status */ ? `${transactionTargetChain?.name}${" "}` : isEmptyStatus ? "" : `${data?.targetChain} ${" "}`) : /* @__PURE__ */ React106.createElement("div", null, /* @__PURE__ */ React106.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ React106.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React106.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React106.createElement(Minimize_default, { fill: "white" })
    ), !isValidTxId || loadingStep < 0 || error ? /* @__PURE__ */ React106.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ React106.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React106.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    isValidTxId && !error ? /* @__PURE__ */ React106.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ React106.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ React106.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )), !error && !isEmptyStatus && /* @__PURE__ */ React106.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ React106.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ React106.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ React106.createElement("div", { className: "single-form" }, /* @__PURE__ */ React106.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ React106.createElement(
      Toaster,
      {
        position: "top-right",
    ...
    /* @__PURE__ */ React106.createElement("div", { className: `kima-card-footer transaction` }, /* @__PURE__ */ React106.createElement("div", { className: "kima-powered" }, /* @__PURE__ */ React106.createElement("span", null, "POWERED BY"), /* @__PURE__ */ React106.createElement("span", { className: "kima-logo" }, /* @__PURE__ */ React106.createElement(FooterLogo_default, { fill: "#666666" }), /* @__PURE__ */ React106.createElement("span", null, "Network"))))
  ));
};

// src/components/TransferWidget.tsx
import React117, { useEffect as useEffect21, useState as useState16, useRef as useRef8, useMemo as useMemo21, useCallback as useCallback3 } from "react";
import { useDispatch as useDispatch26, useSelector as useSelector45 } from "react-redux";

// src/components/reusable/SingleForm.tsx
import React108, { useEffect as useEffect17, useMemo as useMemo14, useState as useState13 } from "react";
...
import React107, { useState as useState12, useMemo as useMemo13, useRef as useRef4, useEffect as useEffect16 } from "react";
...
var NetworkSelector = ({
  ...
  return /* @__PURE__ */ React107.createElement(
    ...
    /* @__PURE__ */ React107.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ React107.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ React107.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ React107.createElement(
      "div",
      {
        className: `network-menu custom-scrollbar ${theme?.colorMode ?? ""} ${collapsed ? "collapsed" : "toggled"}`
      },
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ React107.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ React107.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ React107.createElement("p", null, network.name)
      ))
    ),
    /* @__PURE__ */ React107.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ React107.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = React107.memo(NetworkSelector);
...
var SingleForm = ({
  ...
  return /* @__PURE__ */ React108.createElement("div", { className: "single-form" }, /* @__PURE__ */ React108.createElement("div", { className: "form-item" }, /* @__PURE__ */ React108.createElement("span", { className: "label" }, "Source Network"), /* @__PURE__ */ React108.createElement("div", { className: "items" }, /* @__PURE__ */ React108.createElement(
  ...
  ), /* @__PURE__ */ React108.createElement(CoinDropdown_default, null))), /* @__PURE__ */ React108.createElement(
    "div",
    {
      className: `dynamic-area ${sourceNetwork.shortName === "FIAT" /* FIAT */ ? "reverse" : "1"}`
    },
    sourceNetwork.compatibility !== "CC" /* CC */ && /* @__PURE__ */ React108.createElement(
      "div",
      {
        className: `form-item wallet-button-item ${isConnected && "connected"}`
      },
      /* @__PURE__ */ React108.createElement("span", { className: "label" }, "Wallet"),
      /* @__PURE__ */ React108.createElement(WalletButton_default, { initialSelection: initialSelection.sourceSelection })
    ),
    mode !== "payment" /* payment */ && /* @__PURE__ */ React108.createElement("div", { className: "form-item" }, /* @__PURE__ */ React108.createElement("span", { className: "label" }, "Target Network"), /* @__PURE__ */ React108.createElement("div", { className: "items" }, /* @__PURE__ */ React108.createElement(
      NetworkSelector_default,
      {
        type: "target",
        ...{
    ...
    ), /* @__PURE__ */ React108.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React108.createElement(BankInput_default, null) : /* @__PURE__ */ React108.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React108.createElement("span", { className: "label" }, "Target Address"), /* @__PURE__ */ React108.createElement(
  ...
  )) : null, mode === "light" /* light */ && /* @__PURE__ */ React108.createElement(
    "div",
    {
      className: `form-item wallet-button-item ${!initialSelection.targetSelection && "connected"}`,
      style: { display: "flex", alignItems: "center" }
    },
    /* @__PURE__ */ React108.createElement("span", { className: "label" }, "Target Wallet:"),
  ...
  ), /* @__PURE__ */ React108.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React108.createElement("span", { className: "label" }, "Amount"), /* @__PURE__ */ React108.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ React108.createElement(
    "input",
    {
  ...
  ), /* @__PURE__ */ React108.createElement("div", { className: "max-disclaimer" }, /* @__PURE__ */ React108.createElement(
    ...
    "MAX"
  ), +totalFee !== -1 && /* @__PURE__ */ React108.createElement("p", { className: "fee-amount" }, "Est fees:", " ", /* @__PURE__ */ React108.createElement("span", { className: `${isLoadingFees ? "loading" : ""}` }, " ", isLoadingFees ? "" : `$ ${formatBigInt(totalFee)} USD`))))));
};
...
import React109, { useCallback as useCallback2, useEffect as useEffect18, useMemo as useMemo15, useRef as useRef5 } from "react";
...
var SolanaWalletSelect = () => {
  ...
  return /* @__PURE__ */ React109.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React109.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React109.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ React109.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React109.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React109.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React109.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ React109.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React109.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React109.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React109.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
var SolanaWalletSelect_default = SolanaWalletSelect;

// plugins/solana/components/AccountDetailsModal.tsx
import React110, { useMemo as useMemo16 } from "react";
...
var AccountDetailsModal = () => {
  ...
  return /* @__PURE__ */ React110.createElement(
    ...
    )))), /* @__PURE__ */ React110.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React110.createElement("div", { className: "summary" }, networkDetails && /* @__PURE__ */ React110.createElement(networkDetails.icon, { width: 60, height: 60 }), /* @__PURE__ */ React110.createElement("div", { className: "address" }, /* @__PURE__ */ React110.createElement("h2", null, getShortenedAddress(walletAddress || "")), /* @__PURE__ */ React110.createElement(CopyButton_default, { text: walletAddress })), /* @__PURE__ */ React110.createElement("h3", null, formatterFloat.format(Number(solBalance)), " $SOL")), /* @__PURE__ */ React110.createElement(SecondaryButton_default, { className: "block-explorer" }, /* @__PURE__ */ React110.createElement(ExternalLink_default, { className: "link", to: explorerUrl }, /* @__PURE__ */ React110.createElement(Explorer_default, { fill: "#778DA3" }), /* @__PURE__ */ React110.createElement("p", null, "Block explorer"), /* @__PURE__ */ React110.createElement(ExternalUrl_default, { fill: "#778DA3" }))), /* @__PURE__ */ React110.createElement(PrimaryButton_default, { clickHandler: handleDisconnect }, "Discconect")))
  );
};
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ React111.createElement("div", null, /* @__PURE__ */ React111.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ React111.createElement(
    ...
    )))), /* @__PURE__ */ React111.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React111.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
import React112, { useMemo as useMemo17 } from "react";
...
var AccountDetailsModal2 = () => {
  ...
  return /* @__PURE__ */ React112.createElement(
    ...
    /* @__PURE__ */ React112.createElement("div", { className: "modal-overlay" }),
    /* @__PURE__ */ React112.createElement("div", { className: `modal-content-container ${theme.colorMode}` }, /* @__PURE__ */ React112.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React112.createElement("div", { className: "topbar" }, /* @__PURE__ */ React112.createElement("div", { className: "title" }, /* @__PURE__ */ React112.createElement("h3", null, "Account Details")), /* @__PURE__ */ React112.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React112.createElement(
      "button",
      {
        className: "cross-icon-button",
        onClick: () => dispatch(setAccountDetailsModal(false))
    ...
    )))), /* @__PURE__ */ React112.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React112.createElement("div", { className: "summary" }, networkDetails && /* @__PURE__ */ React112.createElement(networkDetails.icon, { width: 60, height: 60 }), /* @__PURE__ */ React112.createElement("div", { className: "address" }, /* @__PURE__ */ React112.createElement("h2", null, getShortenedAddress(connectedAddress || "")), /* @__PURE__ */ React112.createElement(CopyButton_default, { text: connectedAddress })), /* @__PURE__ */ React112.createElement("h3", null, formatterFloat.format(Number(tronBalance)), " ", selectedNetwork.shortName)), /* @__PURE__ */ React112.createElement(SecondaryButton_default, { className: "block-explorer" }, /* @__PURE__ */ React112.createElement(ExternalLink_default, { className: "link", to: explorerUrl }, /* @__PURE__ */ React112.createElement(Explorer_default, { fill: "#778DA3" }), /* @__PURE__ */ React112.createElement("p", null, "Block explorer"), /* @__PURE__ */ React112.createElement(ExternalUrl_default, { fill: "#778DA3" }))), /* @__PURE__ */ React112.createElement(PrimaryButton_default, { clickHandler: handleDisconnect }, "Disconnect")))
  );
};
var AccountDetailsModal_default2 = AccountDetailsModal2;

// plugins/tron/components/TronWalletSelect.tsx
import React113, { useEffect as useEffect19, useMemo as useMemo18, useRef as useRef6 } from "react";
...
var TronWalletSelect = () => {
  ...
  return /* @__PURE__ */ React113.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React113.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React113.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ React113.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ React113.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React113.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React113.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ React113.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React113.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React113.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React113.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ React114.createElement("div", null, /* @__PURE__ */ React114.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ React114.createElement(
    "div",
    {
      className: `kima-modal wallet-connect ${theme.colorMode} ${connectModal ? "open" : ""}`
    },
    /* @__PURE__ */ React114.createElement("div", { className: "modal-overlay" }),
    /* @__PURE__ */ React114.createElement("div", { className: `modal-content-container ${theme.colorMode}` }, /* @__PURE__ */ React114.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React114.createElement("div", { className: "topbar" }, /* @__PURE__ */ React114.createElement("div", { className: "title" }, /* @__PURE__ */ React114.createElement("h3", null, "Connect Wallet")), /* @__PURE__ */ React114.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React114.createElement(
      "button",
      {
    ...
    )))), /* @__PURE__ */ React114.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React114.createElement(TronWalletSelect_default, null)))
  ));
};
...
var WarningModal = ({
  ...
  return /* @__PURE__ */ React115.createElement("div", { className: "warning-modal-overlay" }, /* @__PURE__ */ React115.createElement("div", { className: "warning-modal" }, /* @__PURE__ */ React115.createElement("div", { className: "title" }, /* @__PURE__ */ React115.createElement("h3", null, "Warning"), /* @__PURE__ */ React115.createElement("button", { onClick: onCancel }, /* @__PURE__ */ React115.createElement(Cross_default, { width: 15, height: 15, fill: "white" }))), /* @__PURE__ */ React115.createElement("p", null, message), /* @__PURE__ */ React115.createElement("div", { className: "warning-modal-buttons" }, /* @__PURE__ */ React115.createElement(
    SecondaryButton_default,
    {
...
import React116, { useEffect as useEffect20, useMemo as useMemo20, useRef as useRef7, useState as useState15 } from "react";
...
var CCWidget = ({ submitCallback }) => {
  ...
  return /* @__PURE__ */ React116.createElement("div", { className: `cc-widget ${isLoading ? "loading" : ""}` }, (isLoading || isTransactionIdLoading || isEnvLoading || ccTransactionStatus === "success") && /* @__PURE__ */ React116.createElement("div", { className: "cc-widget-loader" }, /* @__PURE__ */ React116.createElement(ring_default, { width: 50, height: 50, fill: "white" })), /* @__PURE__ */ React116.createElement(
    "iframe",
    {
...
var TransferWidget = ({
  ...
  const sourceAddress = useSelector45(selectSourceAddress);
  const targetAddress = useSelector45(selectTargetAddress);
  const sourceChain = useSelector45(selectSourceChain);
  const targetChain = useSelector45(selectTargetChain);
  const sourceCurrency = useSelector45(selectSourceCurrency);
  const targetCurrency = useSelector45(selectTargetCurrency);
  const { isReady } = useIsWalletReady4();
  const amount = useSelector45(selectAmount);
  const { totalFee, transactionValues } = useSelector45(selectServiceFee);
  const compliantOption = useSelector45(selectCompliantOption);
  const networkOptions3 = useSelector45(selectNetworkOption);
  ...
  const pendingTxs = useSelector45(selectPendingTxs);
  const networks = useSelector45(selectNetworks);
  ...
  const submit = useCallback3(async () => {
    try {
      ...
      toast5.error("Failed to submit transaction", { icon: /* @__PURE__ */ React117.createElement(Error_default, null) });
      dispatch(setCCTransactionStatus("error-generic"));
    }
  ...
  const handleSubmit = async () => {
    ...
    if (error2 === "ValidationError" /* Error */) {
      return toast5.error(validationMessage, { icon: /* @__PURE__ */ React117.createElement(Error_default, null) });
    }
    if (sourceChain.shortName === "CC") {
  ...
  const onNext = () => {
    ...
    toast5.error(validationMessage, { icon: /* @__PURE__ */ React117.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ React117.createElement(
    ...
    resetModalOpen && /* @__PURE__ */ React117.createElement(
    ...
    warningModalOpen && /* @__PURE__ */ React117.createElement(
      WarningModal_default,
      {
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ React117.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ React117.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React117.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React117.createElement("div", { className: "topbar" }, /* @__PURE__ */ React117.createElement("div", { className: "title" }, /* @__PURE__ */ React117.createElement("h3", { style: { marginRight: "5px" } }, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ React117.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ React117.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ React117.createElement(
      ExternalLink_default,
      {
      ...
      /* @__PURE__ */ React117.createElement("div", { className: "menu-button" }, /* @__PURE__ */ React117.createElement(Help_default, { width: 20, height: 20 }), "I need help")
    ), sourceChain.shortName === "CC" && formStep > 0 && /* @__PURE__ */ React117.createElement(ExternalLink_default, { to: "https://docs.kima.network/kima-network/supported-fiat#unsupported-countries-credit-cards" }, /* @__PURE__ */ React117.createElement("div", { className: "menu-button" }, "Unsupported Countries")), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ React117.createElement(
      "button",
      {
      ...
      "Reset"
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ React117.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ React117.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ React117.createElement(
      SingleForm_default,
      {
        ...{
    ...
    ) : ccTransactionStatus !== "idle" ? /* @__PURE__ */ React117.createElement(CCWidget_default, { submitCallback: submit }) : /* @__PURE__ */ React117.createElement(
      ...
      /* @__PURE__ */ React117.createElement("div", { className: "kima-powered" }, /* @__PURE__ */ React117.createElement("span", null, "POWERED BY"), /* @__PURE__ */ React117.createElement("span", { className: "kima-logo" }, /* @__PURE__ */ React117.createElement(FooterLogo_default, { fill: "#666666" }), /* @__PURE__ */ React117.createElement("span", null, "Network"))),
      /* @__PURE__ */ React117.createElement("div", { className: `button-group` }, isBackButtonEnabled && /* @__PURE__ */ React117.createElement(
        SecondaryButton_default,
        {
          clickHandler: onBack,
          theme: theme.colorMode,
      ...
      ), !!allowance && allowance > 0 && formStep !== 0 && sourceChain.shortName !== "CC" && mode !== "light" /* light */ ? /* @__PURE__ */ React117.createElement(
        SecondaryButton_default,
        {
      ...
      ) : null, isSubmitButtonEnabled && /* @__PURE__ */ React117.createElement(
        PrimaryButton_default,
        {
          clickHandler: onNext,
    ...
    ), /* @__PURE__ */ React117.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ React117.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ React117.createElement(
      Toaster2,
      {
        position: "top-right",
        reverseOrder: false,
...
var ErrorWidget = ({
  ...
  return /* @__PURE__ */ React118.createElement(
    ...
    /* @__PURE__ */ React118.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React118.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React118.createElement("div", { className: "topbar" }, /* @__PURE__ */ React118.createElement("div", { className: "title" }, /* @__PURE__ */ React118.createElement("h3", null, title))), /* @__PURE__ */ React118.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ React118.createElement("div", { className: "kima-card-content error" }, /* @__PURE__ */ React118.createElement(Error_default, { width: 40, height: 40 }), /* @__PURE__ */ React118.createElement("h2", null, message), isCreditCardSource && /* @__PURE__ */ React118.createElement(
      "div",
      {
        style: {
          marginTop: 16,
      ...
      ccTransactionId && /* @__PURE__ */ React118.createElement(
        ...
        /* @__PURE__ */ React118.createElement(CopyButton_default, { text: ccTransactionId })
      ),
      isRetrying && /* @__PURE__ */ React118.createElement(ring_default, { width: 30, height: 30, fill: "#86b8ce" })
    ), backButtonEnabled && /* @__PURE__ */ React118.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React118.createElement(PrimaryButton_default, { clickHandler: backButtonFunction }, "BACK")
    )), /* @__PURE__ */ React118.createElement("div", { className: "kima-card-footer" }, /* @__PURE__ */ React118.createElement("div", { className: "kima-powered" }, /* @__PURE__ */ React118.createElement("span", null, "POWERED BY"), /* @__PURE__ */ React118.createElement("span", { className: "kima-logo" }, /* @__PURE__ */ React118.createElement(FooterLogo_default, { fill: "#666666" }), /* @__PURE__ */ React118.createElement("span", null, "Network")))))
  );
};
...
var KimaWidgetWrapper = ({
  ...
  if (sourceChain.shortName === "CC") {
    ...
    if (submitted) {
      ...
      return /* @__PURE__ */ React119.createElement(TransactionWidget, { theme });
  ...
  return submitted ? /* @__PURE__ */ React119.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ React119.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
...
var SkeletonLoader = ({ theme }) => {
  return /* @__PURE__ */ React120.createElement(
    ...
    /* @__PURE__ */ React120.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React120.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React120.createElement("div", { className: "topbar" }, /* @__PURE__ */ React120.createElement("div", { className: "title skeleton" }, /* @__PURE__ */ React120.createElement("h3", null))), /* @__PURE__ */ React120.createElement("h4", { className: "subtitle" })), /* @__PURE__ */ React120.createElement("div", { className: "kima-card-content skeleton" }, /* @__PURE__ */ React120.createElement("div", { className: "skeleton" }), /* @__PURE__ */ React120.createElement("div", { className: "skeleton" }), /* @__PURE__ */ React120.createElement("div", { className: "skeleton" }), /* @__PURE__ */ React120.createElement("div", { className: "skeleton" }), /* @__PURE__ */ React120.createElement("div", { className: "skeleton" })), /* @__PURE__ */ React120.createElement("div", { className: `kima-card-footer` }, /* @__PURE__ */ React120.createElement("div", { className: `button-group skeleton` }, /* @__PURE__ */ React120.createElement("div", { className: "skeleton" }))))
  );
};
...
var KimaTransactionWidget = ({
  ...
  if (!hydrated || !theme?.colorMode)
    return /* @__PURE__ */ React121.createElement(ring_default, { width: 20, height: 20, fill: "#86b8ce" });
  if (isLoadingEnvs || isLoadingChainData)
    return /* @__PURE__ */ React121.createElement(SkeletonLoader_default, { theme });
