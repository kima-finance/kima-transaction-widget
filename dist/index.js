...
import { Provider, useSelector as useSelector12 } from "react-redux";
...
import React39, { useEffect, useState } from "react";
...
// plugins/evm/core/hooks/useEvmAllowance.tsx
import { BrowserProvider as BrowserProvider4 } from "ethers";
import {
...
function useEvmAllowance() {
  ...
  const approveErc20TokenTransfer = async (isCancel = false) => {
    ...
    try {
      ...
      const finalAmount = isCancel ? BigInt(0) : feeDeduct ? parseUnits2(amount, allowanceData.decimals) : parseUnits2((+amount + totalFee).toString(), allowanceData.decimals);
...
var WalletProvider2 = ({
  ...
  return /* @__PURE__ */ React75.createElement(ConnectionProvider, { endpoint }, /* @__PURE__ */ React75.createElement(
...
import React77, { useMemo as useMemo4 } from "react";
...
import { useDispatch as useDispatch5, useSelector as useSelector11 } from "react-redux";
...
var CreditCardPlugin = class extends PluginBase {
  ...
  Provider = ({ children }) => {
    return /* @__PURE__ */ React79.createElement(React79.Fragment, null, children);
  };
};
...
var InternalKimaProvider = React80.memo(
  ({ kimaBackendUrl, walletConnectProjectId, children, logLevel }) => {
    ...
    const plugins = useSelector12(selectAllPlugins, (prev, next) => prev === next);
...
var KimaProvider = ({
  ...
  return /* @__PURE__ */ React80.createElement(QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React80.createElement(Provider, { store }, /* @__PURE__ */ React80.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React80.createElement(
...
import React119, { useEffect as useEffect24, useState as useState20 } from "react";

// src/components/KimaWidgetWrapper.tsx
import React116, { useEffect as useEffect23 } from "react";
import { useDispatch as useDispatch28, useSelector as useSelector41 } from "react-redux";

// src/components/TransactionWidget.tsx
import React104, { useEffect as useEffect15, useMemo as useMemo13, useState as useState13 } from "react";
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  const theme = useSelector13(selectTheme);
  return /* @__PURE__ */ React81.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ React81.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ React81.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ React81.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ React81.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ React81.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ React81.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ React81.createElement(Warning_default, null) : /* @__PURE__ */ React81.createElement(Check_default, null) : null, /* @__PURE__ */ React81.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ React82.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ React84.createElement(
    ...
    /* @__PURE__ */ React84.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ React84.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ React86.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ React86.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ React86.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React86.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ React87.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React87.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
import React91, { useEffect as useEffect10, useMemo as useMemo9 } from "react";
import { useDispatch as useDispatch7, useSelector as useSelector17 } from "react-redux";
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ React89.createElement("div", null, children);
  };
};
...
var useGetCurrentPlugin = () => {
  const [currentPlugin, setCurrentPlugin] = useState7(default_default);
  const isIndexed = useSelector16(selectPluginIsIndexed);
...
import React90, { useEffect as useEffect8, useState as useState9 } from "react";
var CopyButton = ({ text }) => {
  ...
  return /* @__PURE__ */ React90.createElement(
    ...
    copyClicked ? /* @__PURE__ */ React90.createElement(Check_default, null) : /* @__PURE__ */ React90.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  const selectedCoin = useSelector17(selectSourceCurrency);
  const sourceCompliant = useSelector17(selectSourceCompliant);
  const compliantOption = useSelector17(selectCompliantOption);
  const selectedNetwork = useSelector17(selectSourceChain);
  const { externalProvider } = useKimaContext();
  ...
  return /* @__PURE__ */ React91.createElement(
    ...
    /* @__PURE__ */ React91.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ React91.createElement(
      "button",
      {
      ...
      !isReady && /* @__PURE__ */ React91.createElement(Wallet_default, null),
      !isReady && "Connect Wallet"
    ), isReady && /* @__PURE__ */ React91.createElement(CopyButton_default, { text: connectedAddress })),
    isReady && balance !== void 0 ? /* @__PURE__ */ React91.createElement("p", { className: "balance-info" }, formatUSD(balance), " ", selectedCoin, " available") : null
  );
};
var WalletButton_default = WalletButton;

// src/components/reusable/CoinDropdown.tsx
import React93, { useEffect as useEffect12, useRef, useState as useState10 } from "react";
...
function TokenIcon({
  ...
  return /* @__PURE__ */ React92.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ React92.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  return /* @__PURE__ */ React93.createElement(
    ...
    /* @__PURE__ */ React93.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ React93.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ React93.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ React93.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ React93.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React93.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ React93.createElement("p", null, token.symbol)
      ))
    ),
    /* @__PURE__ */ React93.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ React93.createElement(Arrow_default, { fill: "none" }))
  );
};
var CoinDropdown_default = CoinDropdown;

// src/components/reusable/ConfirmDetails.tsx
import React96, { useEffect as useEffect13, useMemo as useMemo11, useState as useState11 } from "react";
...
function ChainIcon({ symbol }) {
  ...
  return /* @__PURE__ */ React94.createElement("div", { className: "icon" }, /* @__PURE__ */ React94.createElement(Icon, null));
}
...
import { useDispatch as useDispatch10, useSelector as useSelector20 } from "react-redux";
var FeeDeductionRadioButtons = ({ isSigned }) => {
  ...
  const sourceNetwork = useSelector20(selectSourceChain);
  const targetNetwork = useSelector20(selectTargetChain);
  const { totalFee } = useSelector20(selectServiceFee);
  ...
  return /* @__PURE__ */ React95.createElement("div", { className: `fee-deduction-radio-container ${theme.colorMode}` }, /* @__PURE__ */ React95.createElement("div", { className: "fee-options" }, /* @__PURE__ */ React95.createElement("label", { className: "fee-option" }, /* @__PURE__ */ React95.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
  ...
  )} ${targetCurrency} in ${targetNetwork.name}`)), /* @__PURE__ */ React95.createElement("label", { className: "fee-option" }, /* @__PURE__ */ React95.createElement(
    "input",
    {
      type: "radio",
      name: "feeDeduction",
...
var ConfirmDetails = ({
  ...
  const {
    ...
    allowanceAmount,
    submitAmount
  } = useSelector21(selectServiceFee);
  ...
  const bankDetails = useSelector21(selectBankDetails);
  const signature = useSelector21(selectSignature);
  const networkOptions3 = useSelector21(selectNetworks);
  const transactionOption = useSelector21(selectTransactionOption);
  const { connectedAddress } = useIsWalletReady4();
  const sourceChainOption = useMemo11(
    () => networkOptions3.filter((network) => network.id === sourceChain.id)[0],
    [networkOptions3, sourceChain]
  );
  const targetChainOption = useMemo11(
    () => networkOptions3.filter(
      (network) => network.shortName === (mode === "payment" /* payment */ ? transactionOption?.targetChain : targetChain.shortName)
    )[0],
    [networkOptions3, sourceChain]
  );
  const sourceCurrency = useSelector21(selectSourceCurrency);
  const targetCurrency = useSelector21(selectTargetCurrency);
  const { width, updateWidth } = useWidth_default();
  const [feeCollapsed, setFeeCollapsed] = useState11(true);
  useEffect13(() => {
    width === 0 && updateWidth(window.innerWidth);
  }, []);
  const sourceconnectedAddress = useMemo11(() => {
    return width >= 916 ? connectedAddress : getShortenedAddress(connectedAddress || "");
  }, [width, connectedAddress]);
  const targetconnectedAddress = useMemo11(() => {
  ...
  return /* @__PURE__ */ React96.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ React96.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : sourceChain.shortName === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), sourceChain.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React96.createElement("div", null, /* @__PURE__ */ React96.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React96.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React96.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React96.createElement(ChainIcon, { symbol: sourceChainOption?.shortName }), "FIAT"), /* @__PURE__ */ React96.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ React96.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React96.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React96.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ React96.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React96.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ React96.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ React96.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React96.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ React96.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ React96.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React96.createElement("span", { className: "label" }, "Source", sourceChain.shortName !== "CC" && " wallet", ":"), /* @__PURE__ */ React96.createElement("div", { className: "network-details" }, /* @__PURE__ */ React96.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React96.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React96.createElement(ChainIcon, { symbol: sourceChainOption?.shortName }), sourceChainOption.name)), sourceChain.shortName !== "CC" && /* @__PURE__ */ React96.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : connectedAddress : dAppOption === "LPDrain" /* LPDrain */ ? targetconnectedAddress : sourceconnectedAddress))), /* @__PURE__ */ React96.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ React96.createElement("span", { className: "amount-container" }, /* @__PURE__ */ React96.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React96.createElement("span", null, "Amount to Transfer"), /* @__PURE__ */ React96.createElement("div", { className: "coin-details" }, /* @__PURE__ */ React96.createElement("p", null, feeDeduct ? submitAmount : allowanceAmount, " ", sourceCurrency))), /* @__PURE__ */ React96.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React96.createElement("span", null, "Total Network Fees"), /* @__PURE__ */ React96.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React96.createElement("span", { className: "service-fee" }, formatterFloat2.format(totalFee || 0), " ", sourceCurrency)
  )), /* @__PURE__ */ React96.createElement("div", { className: `fee-breakdown ${feeCollapsed ? "collapsed" : ""}` }, /* @__PURE__ */ React96.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React96.createElement("span", null, sourceChain.shortName === "CC" ? "Credit Card Processing Fee" : `Source Network Fee (${sourceChain.shortName})`), /* @__PURE__ */ React96.createElement("span", { className: "service-fee" }, sourceFee || 0, " ", sourceCurrency)), /* @__PURE__ */ React96.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React96.createElement("span", null, "Target Network Fee (", targetChain.shortName, ")"), /* @__PURE__ */ React96.createElement("span", { className: "service-fee" }, targetFee || 0, " ", targetCurrency)), /* @__PURE__ */ React96.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React96.createElement("span", null, "KIMA Service Fee"), /* @__PURE__ */ React96.createElement("span", { className: "service-fee" }, kimaFee, " ", sourceCurrency))), /* @__PURE__ */ React96.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React96.createElement("span", null, "Target Amount"), /* @__PURE__ */ React96.createElement("div", { className: "coin-details" }, /* @__PURE__ */ React96.createElement("p", null, feeDeduct ? +submitAmount - totalFee : +submitAmount, " ", sourceCurrency))))), targetChain.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React96.createElement("div", null, /* @__PURE__ */ React96.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React96.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React96.createElement("p", null, bankDetails.iban), /* @__PURE__ */ React96.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React96.createElement(ChainIcon, { symbol: targetChainOption?.shortName }), "FIAT")), /* @__PURE__ */ React96.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React96.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React96.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ React96.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React96.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ React96.createElement("div", { className: "network-details" }, /* @__PURE__ */ React96.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React96.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React96.createElement(ChainIcon, { symbol: targetChainOption?.shortName }), targetChainOption?.name)), /* @__PURE__ */ React96.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? connectedAddress : targetAddress : dAppOption === "LPDrain" /* LPDrain */ ? sourceconnectedAddress : targetconnectedAddress))), mode === "bridge" /* bridge */ && totalFee > 0 ? (
    // <FeeDeductionSlider />
    /* @__PURE__ */ React96.createElement(FeeDeductionRadioButtons_default, { isSigned })
  ) : null);
};
var ConfirmDetails_default = ConfirmDetails;

// src/components/reusable/AddressInput.tsx
import React97, { useEffect as useEffect14 } from "react";
...
import React99, { useMemo as useMemo12 } from "react";
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  return /* @__PURE__ */ React99.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ React99.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ React99.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ React99.createElement(
    ...
    step < index && /* @__PURE__ */ React99.createElement(Lock_default, null),
    step >= index ? index === loadingStep ? /* @__PURE__ */ React99.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ React99.createElement(Warning_default, null) : /* @__PURE__ */ React99.createElement(Check_default, null) : null,
    /* @__PURE__ */ React99.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ React99.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ React99.createElement("div", { className: "icon" }, /* @__PURE__ */ React99.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ React99.createElement("p", { className: "chain-name" }, "Kima TX ID:"), /* @__PURE__ */ React99.createElement("p", null, /* @__PURE__ */ React99.createElement(
    ...
    ), /* @__PURE__ */ React99.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssRefundHash ? /* @__PURE__ */ React99.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React99.createElement(ChainIcon, { symbol: data.sourceChain }), /* @__PURE__ */ React99.createElement("p", { className: "chain-name" }, sourceChain?.name, " TX ID:"), /* @__PURE__ */ React99.createElement("p", null, /* @__PURE__ */ React99.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React99.createElement(CopyButton_default, { text: data?.tssRefundHash || "" }))) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ React99.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React99.createElement(ChainIcon, { symbol: data.targetChain }), /* @__PURE__ */ React99.createElement("p", { className: "chain-name" }, targetChain?.name, " TX ID:"), /* @__PURE__ */ React99.createElement("p", null, /* @__PURE__ */ React99.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React99.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ React100.createElement("div", { className: "bank-input" }, /* @__PURE__ */ React100.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React100.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React100.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React100.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React100.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React100.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TxButton = ({ theme }) => {
  ...
  const txCount = useSelector26(selectPendingTxs);
...
var TransactionSearch = () => {
  ...
  return /* @__PURE__ */ React103.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ React103.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ React103.createElement("span", { className: "label" }, "Search Transaction:"), /* @__PURE__ */ React103.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React103.createElement(SecondaryButton_default, { clickHandler: handleSearch }, "Search"));
};
...
var TransactionWidget = ({ theme }) => {
  ...
  const feeDeduct = useSelector28(selectFeeDeduct);
  ...
  const backendUrl = useSelector28(selectBackendUrl);
  ...
  useEffect15(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      toast3.error("Unavailable", { icon: /* @__PURE__ */ React104.createElement(Error_default, null) });
      ...
      setLoadingStep(-1);
      logger_default.error("transaction failed:", data.failReason);
      toast3.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ React104.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ React104.createElement(Provider2, { store }, /* @__PURE__ */ React104.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React104.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React104.createElement("div", { className: "topbar" }, /* @__PURE__ */ React104.createElement("div", { className: "title" }, isValidTxId && !error ? /* @__PURE__ */ React104.createElement("h3", { className: "transaction" }, mode !== "status" /* status */ ? data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING" : isEmptyStatus ? "GETTING TRANSACTION STATUS" : data?.status === "Completed" /* COMPLETED */ ? "TRANSFERRED" : "TRANSFERING", /* @__PURE__ */ React104.createElement("div", null, mode !== "status" /* status */ ? Number(amount) !== 0 ? formatterFloat2.format(
    ...
    )), " ", mode !== "status" /* status */ ? `(${transactionTargetChain?.shortName})${" "}` : isEmptyStatus ? "" : `(${data?.targetChain}) ${" "}`)) : /* @__PURE__ */ React104.createElement("div", null, /* @__PURE__ */ React104.createElement("h3", { className: "transaction" }, "Transaction Status"))), !minimized ? /* @__PURE__ */ React104.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React104.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React104.createElement(Minimize_default, null)
    ), !isValidTxId || loadingStep < 0 || error ? /* @__PURE__ */ React104.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ React104.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React104.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    isValidTxId && !error ? /* @__PURE__ */ React104.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ React104.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ React104.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    )), !error && !isEmptyStatus && /* @__PURE__ */ React104.createElement(
      TransactionStatusMessage_default,
      {
        isCompleted: data?.status,
        transactionId: txId.toString()
      }
    )) : /* @__PURE__ */ React104.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ React104.createElement("h4", { className: "subtitle" }, "You can follow the status of a previous submitted transaction by entering the provided transaction id"), /* @__PURE__ */ React104.createElement("div", { className: "single-form" }, /* @__PURE__ */ React104.createElement(TransactionSearch_default, null))),
    /* @__PURE__ */ React104.createElement(
      Toaster,
      {
        position: "top-right",
    ...
    /* @__PURE__ */ React104.createElement("div", { className: "floating-footer status" }, /* @__PURE__ */ React104.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ React104.createElement("span", null, "Powered by"), /* @__PURE__ */ React104.createElement(FooterLogo_default, { fill: "black" }), /* @__PURE__ */ React104.createElement("strong", null, "Network")))
  ));
};

// src/components/TransferWidget.tsx
import React115, { useEffect as useEffect21, useState as useState18, useRef as useRef7 } from "react";
import { useDispatch as useDispatch27, useSelector as useSelector40 } from "react-redux";

// src/components/reusable/SingleForm.tsx
import React106, { useEffect as useEffect17, useMemo as useMemo15, useState as useState15 } from "react";
...
import React105, { useState as useState14, useMemo as useMemo14, useRef as useRef4, useEffect as useEffect16 } from "react";
import { useSelector as useSelector30, useDispatch as useDispatch17 } from "react-redux";
var NetworkSelector = ({ type }) => {
  ...
  const networkOptions3 = useSelector30(selectNetworks);
  const sourceNetwork = useSelector30(selectSourceChain);
  const targetNetwork = useSelector30(selectTargetChain);
  const excludedSourceNetworks = useSelector30(selectExcludedSourceNetworks);
  const excludedTargetNetworks = useSelector30(selectExcludedTargetNetworks);
  ...
  return /* @__PURE__ */ React105.createElement(
    ...
    /* @__PURE__ */ React105.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ React105.createElement(ChainIcon, { symbol: selectedNetwork.shortName }), /* @__PURE__ */ React105.createElement("span", null, selectedNetwork.name)),
    /* @__PURE__ */ React105.createElement(
      "div",
      {
        className: `network-menu custom-scrollbar ${theme?.colorMode ?? ""} ${collapsed ? "collapsed" : "toggled"}`
      },
      networks.filter((network) => network.shortName !== selectedNetwork.shortName).map((network) => /* @__PURE__ */ React105.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ React105.createElement(ChainIcon, { symbol: network.shortName }),
        /* @__PURE__ */ React105.createElement("p", null, network.name)
      ))
    ),
    /* @__PURE__ */ React105.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ React105.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = React105.memo(NetworkSelector);
...
var SingleForm = ({
  ...
  const { totalFee } = useSelector31(selectServiceFee);
  ...
  const [amountValue, setAmountValue] = useState15("");
  ...
  return /* @__PURE__ */ React106.createElement("div", { className: "single-form" }, /* @__PURE__ */ React106.createElement("div", { className: "form-item" }, /* @__PURE__ */ React106.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ React106.createElement("div", { className: "items" }, /* @__PURE__ */ React106.createElement(NetworkSelector_default, { type: "source" }), /* @__PURE__ */ React106.createElement(CoinDropdown_default, null))), /* @__PURE__ */ React106.createElement(
    "div",
    {
      className: `dynamic-area ${sourceNetwork.shortName === "FIAT" /* FIAT */ ? "reverse" : "1"}`
    },
    sourceNetwork.compatibility !== "CC" /* CC */ && /* @__PURE__ */ React106.createElement(
      "div",
      {
        className: `form-item wallet-button-item ${isReady && "connected"}`
      },
      /* @__PURE__ */ React106.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ React106.createElement(WalletButton_default, null)
    ),
    mode === "bridge" /* bridge */ && /* @__PURE__ */ React106.createElement("div", { className: "form-item" }, /* @__PURE__ */ React106.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ React106.createElement("div", { className: "items" }, /* @__PURE__ */ React106.createElement(NetworkSelector_default, { type: "target" }), /* @__PURE__ */ React106.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork.shortName !== "FIAT" /* FIAT */ ? targetNetwork.shortName === "FIAT" /* FIAT */ ? /* @__PURE__ */ React106.createElement(BankInput_default, null) : /* @__PURE__ */ React106.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React106.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ React106.createElement(
    AddressInput_default,
    {
      theme: theme.colorMode,
      placeholder: "Target address"
    }
  )) : null, /* @__PURE__ */ React106.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React106.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ React106.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ React106.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "text",
  ...
  ), /* @__PURE__ */ React106.createElement("div", { className: "max-disclaimer" }, /* @__PURE__ */ React106.createElement(
    "span",
    {
    ...
    "Max"
  ), totalFee !== -1 && /* @__PURE__ */ React106.createElement("p", null, "Est fees: $ ", totalFee, " USD")))));
};
...
import React107, { useCallback as useCallback2, useEffect as useEffect18, useMemo as useMemo16, useRef as useRef5 } from "react";
...
var SolanaWalletSelect = () => {
  ...
  return /* @__PURE__ */ React107.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React107.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React107.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ React107.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React107.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React107.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React107.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ React107.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React107.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React107.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React107.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
var SolanaWalletSelect_default = SolanaWalletSelect;

// plugins/solana/components/AccountDetailsModal.tsx
import React108, { useMemo as useMemo17 } from "react";
...
var AccountDetailsModal = () => {
  ...
  const accountDetailsModal = useSelector33(selectAccountDetailsModal);
...
var SolanaWalletConnectModal = () => {
  ...
  const connectModal = useSelector34(selectSolanaConnectModal);
  return /* @__PURE__ */ React109.createElement("div", null, /* @__PURE__ */ React109.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ React109.createElement(
    ...
    )))), /* @__PURE__ */ React109.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React109.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
import React110, { useMemo as useMemo18 } from "react";
...
var AccountDetailsModal2 = () => {
  ...
  const accountDetailsModal = useSelector35(selectAccountDetailsModal);
  const sourcheChain = useSelector35(selectSourceChain);
...
var TronWalletSelect = () => {
  ...
  return /* @__PURE__ */ React111.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React111.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React111.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ React111.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ React111.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React111.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React111.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ React111.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React111.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React111.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React111.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  const connectModal = useSelector37(selectTronConnectModal);
  return /* @__PURE__ */ React112.createElement("div", null, /* @__PURE__ */ React112.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ React112.createElement(
    ...
    )))), /* @__PURE__ */ React112.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React112.createElement(TronWalletSelect_default, null)))
  ));
};
...
import { useDispatch as useDispatch25 } from "react-redux";
...
var WarningModal = ({
  ...
  return /* @__PURE__ */ React113.createElement("div", { className: "warning-modal-overlay" }, /* @__PURE__ */ React113.createElement("div", { className: "warning-modal" }, /* @__PURE__ */ React113.createElement("h3", null, "Warning"), /* @__PURE__ */ React113.createElement("p", null, message), /* @__PURE__ */ React113.createElement("div", { className: "warning-modal-buttons" }, /* @__PURE__ */ React113.createElement(
...
import React114, { useEffect as useEffect20, useState as useState17 } from "react";
import { useSelector as useSelector39, useDispatch as useDispatch26 } from "react-redux";
...
var CCWidget = () => {
  ...
  return /* @__PURE__ */ React114.createElement("div", { className: `cc-widget ${isLoading ? "loading" : ""}` }, isLoading && /* @__PURE__ */ React114.createElement("div", { className: "cc-widget-loader" }, /* @__PURE__ */ React114.createElement(ring_default, { width: 50, height: 50, fill: "#86b8ce" })), /* @__PURE__ */ React114.createElement(
    "iframe",
    {
...
var TransferWidget = ({
  ...
  const [signature, setSignature2] = useState18("");
  const [formStep, setFormStep] = useState18(0);
  const [warningModalOpen, setWarningModalOpen] = useState18(null);
  const dAppOption = useSelector40(selectDappOption);
  const mode = useSelector40(selectMode);
  const transactionOption = useSelector40(selectTransactionOption);
  const backendUrl = useSelector40(selectBackendUrl);
  const sourceAddress = useSelector40(selectSourceAddress);
  const targetAddress = useSelector40(selectTargetAddress);
  const sourceChain = useSelector40(selectSourceChain);
  const targetChain = useSelector40(selectTargetChain);
  const sourceCurrency = useSelector40(selectSourceCurrency);
  const targetCurrency = useSelector40(selectTargetCurrency);
  const amount = useSelector40(selectAmount);
  const {
    totalFee,
    targetFee,
    submitAmount,
  ...
  const compliantOption = useSelector40(selectCompliantOption);
  const networkOptions3 = useSelector40(selectNetworkOption);
  const feeDeduct = useSelector40(selectFeeDeduct);
  const { keplrHandler, closeHandler } = useKimaContext();
  const [isCancellingApprove, setCancellingApprove] = useState18(false);
  const [isApproving, setApproving] = useState18(false);
  const [isSigning, setSigning] = useState18(false);
  const pendingTxs = useSelector40(selectPendingTxs);
  const networks = useSelector40(selectNetworks);
  const submitted = useSelector40(selectSubmitted);
  const ccWidgetProcessed = useSelector40(selectCCWidgetProcessed);
  ...
  const { submitTransaction, isSubmitting } = useSubmitTransaction_default({
    amount: parseUnits3(submitAmount ?? "0", feeDecimals),
    totalFee: parseUnits3(totalFee.toString() ?? "0", feeDecimals),
  ...
  return /* @__PURE__ */ React115.createElement(
    ...
    warningModalOpen && /* @__PURE__ */ React115.createElement(
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ React115.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ React115.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React115.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React115.createElement("div", { className: "topbar" }, /* @__PURE__ */ React115.createElement("div", { className: "title" }, /* @__PURE__ */ React115.createElement("h3", null, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ React115.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ React115.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ React115.createElement(
      ExternalLink_default,
      {
        to: helpURL ? helpURL : "https://docs.kima.network/kima-network/try-kima-with-the-demo-app"
      },
      /* @__PURE__ */ React115.createElement("div", { className: "menu-button" }, "I need help")
    ), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ React115.createElement(
      "button",
      {
      ...
      "Reset"
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ React115.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ React115.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ React115.createElement(
      SingleForm_default,
      {
        ...{
          allowance,
    ...
    ) : submitted && !ccWidgetProcessed ? /* @__PURE__ */ React115.createElement(CCWidget_default, null) : /* @__PURE__ */ React115.createElement(
      ...
      /* @__PURE__ */ React115.createElement("div", { className: `button-group` }, formStep !== 0 && /* @__PURE__ */ React115.createElement(
        SecondaryButton_default,
        {
          clickHandler: onBack,
          theme: theme.colorMode,
      ...
      ), allowance > 0 && formStep !== 0 && sourceChain.shortName !== "CC" ? /* @__PURE__ */ React115.createElement(
        SecondaryButton_default,
        {
      ...
      ) : null, !submitted && /* @__PURE__ */ React115.createElement(
        PrimaryButton_default,
        {
          clickHandler: onNext,
    ...
    ), /* @__PURE__ */ React115.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ React115.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ React115.createElement(
      Toaster2,
      {
        position: "top-right",
        reverseOrder: false,
...
var useDebugCode = (sequence = ["D", "E", "B", "U", "G"]) => {
  const [debugMode, setDebugMode] = useState19(false);
  const [, setInputSequence] = useState19([]);
  useEffect22(() => {
    const onKeyDown = (e) => {
...
var KimaWidgetWrapper = ({
  ...
  const ccWidgetProcessed = useSelector41(selectCCWidgetProcessed);
  ...
  if (sourceChain.shortName === "CC") {
    if (submitted && ccWidgetProcessed) {
      return /* @__PURE__ */ React116.createElement(TransactionWidget, { theme });
    }
  ...
  return submitted ? /* @__PURE__ */ React116.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ React116.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
...
var KimaTransactionWidget = ({
  ...
  const { kimaBackendUrl } = useKimaContext();
  const [hydrated, setHydrated] = useState20(false);
  const {
    data: envOptions,
  ...
  if (!hydrated || !theme?.colorMode) return /* @__PURE__ */ React119.createElement(ring_default, { width: 20, height: 20, fill: "#86b8ce" });
  if (isLoadingEnvs || isLoadingChainData)
    return /* @__PURE__ */ React119.createElement(SkeletonLoader_default, { theme });
