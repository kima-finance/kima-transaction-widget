...
var CHAIN_NAMES_TO_APPKIT_NETWORK_TESTNET = {
  ...
  ["BERA" /* BERA */]: berachainTestnetbArtio3
};
var CLUSTER2 = "devnet";
...
var getEvmTokenBalance = async (input) => {
  ...
  const provider = walletProvider instanceof Web3Provider ? walletProvider : new ethers.providers.Web3Provider(walletProvider);
...
async function switchNetworkEthers(provider, chainId, chains) {
  try {
    ...
    await provider.send("wallet_switchEthereumChain", [
      { chainId: ethers3.utils.hexValue(chainId) }
    ]);
    ...
    if (error.code === 4902) {
      ...
      try {
        ...
        const chainConfig = {
          chainId: ethers3.utils.hexValue(network?.id),
...
function useIsWalletReady() {
  ...
  const { externalProvider } = useKimaContext();
  const backendUrl = useSelector2(selectBackendUrl);
...
import { Contract as Contract3, ethers as ethers6 } from "ethers";
import {
  Web3Provider as Web3Provider4
} from "@ethersproject/providers";
...
var useGetPools = (backendUrl, networkOption) => {
  const { data, error, isLoading } = useQuery4({
...
import {
  Web3Provider as Web3Provider3
} from "@ethersproject/providers";
import { Contract as Contract2, ethers as ethers5 } from "ethers";

// src/utils/functions.tsx
import { ethers as ethers4 } from "ethers";
import { JsonRpcSigner, Web3Provider as Web3Provider2 } from "@ethersproject/providers";
...
var preciseSubtraction = (a, b, decimals = 18) => {
  const numA = ethers4.utils.parseUnits(a.toString(), decimals);
  const numB = ethers4.utils.parseUnits(b.toString(), decimals);
  const result = numA.sub(numB);
  return parseFloat(ethers4.utils.formatUnits(result, decimals));
};
var isValidExternalProvider = (externalProvider) => {
  const { type, provider, signer } = externalProvider;
  if (type === "evm") {
    if (!(provider instanceof Web3Provider2) || !(signer instanceof JsonRpcSigner))
      return false;
  }
  if (type === "solana") {
...
var getTokenAllowance = async ({
  ...
  try {
    ...
    const provider = walletProvider instanceof Web3Provider3 ? walletProvider : new ethers5.providers.Web3Provider(
      walletProvider
    );
...
function useEvmAllowance() {
  ...
  const approveErc20TokenTransfer = async (isCancel = false) => {
    ...
    const provider = walletProvider instanceof Web3Provider4 ? walletProvider : new ethers6.providers.Web3Provider(walletProvider);
    const signer = provider.getSigner();
...
var WalletProvider2 = ({
  ...
  return /* @__PURE__ */ React72.createElement(ConnectionProvider, { endpoint }, /* @__PURE__ */ React72.createElement(
...
import React74, { useMemo as useMemo4 } from "react";
...
// src/KimaProvider.tsx
import { JsonRpcSigner as JsonRpcSigner2 } from "@ethersproject/providers";
...
var KimaProvider = ({
  ...
  return /* @__PURE__ */ React76.createElement(QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React76.createElement(Provider, { store }, /* @__PURE__ */ React76.createElement(KimaContext.Provider, { value: kimaContext }, /* @__PURE__ */ React76.createElement(InternalKimaProvider, { walletConnectProjectId }, children))));
};
var KimaProvider_default = KimaProvider;

// src/components/KimaTransactionWidget.tsx
import React110, { useEffect as useEffect19 } from "react";
import { useDispatch as useDispatch24, useSelector as useSelector36 } from "react-redux";

// src/components/TransactionWidget.tsx
import React98, { useEffect as useEffect13, useState as useState8 } from "react";
...
var Progressbar = ({ step, errorStep, setFocus, loadingStep }) => {
  ...
  return /* @__PURE__ */ React77.createElement("div", { className: "kima-progressbar" }, /* @__PURE__ */ React77.createElement(
    "div",
    {
      className: `value step-${step * 100 / 4}`
    }
  ), /* @__PURE__ */ React77.createElement("div", { className: "step-indicators" }, stepInfo.map((item, index) => /* @__PURE__ */ React77.createElement(
    "div",
    {
      key: item.title,
    ...
    /* @__PURE__ */ React77.createElement("div", { className: "step-info" }, step < index && /* @__PURE__ */ React77.createElement(Lock_default, null), step >= index ? index === loadingStep ? /* @__PURE__ */ React77.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ React77.createElement(Warning_default, null) : /* @__PURE__ */ React77.createElement(Check_default, null) : null, /* @__PURE__ */ React77.createElement("span", null, item.title))
  ))));
};
...
var ExternalLink = ({ to, children, className, rest }) => /* @__PURE__ */ React78.createElement(
  "a",
  {
    className,
    href: to,
...
var Loading180Ring = ({
  ...
  return /* @__PURE__ */ React80.createElement(
    ...
    /* @__PURE__ */ React80.createElement("path", { d: "M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" }, /* @__PURE__ */ React80.createElement(
      "animateTransform",
      {
...
var PrimaryButton = ({
  ...
  return /* @__PURE__ */ React82.createElement("div", { className: "primary-button-wrapper" }, /* @__PURE__ */ React82.createElement(
    "button",
    {
    ...
    isLoading && /* @__PURE__ */ React82.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React82.createElement(ring_default, { width: 24, height: 24, fill: "white" })),
    children
  ));
};
...
var SecondaryButton = ({
  ...
  isLoading && /* @__PURE__ */ React83.createElement("div", { className: "loading-indicator" }, /* @__PURE__ */ React83.createElement(ring_default, { width: 24, height: 24, fill: "black" })),
  children
);
...
import React87, { useEffect as useEffect8, useMemo as useMemo9 } from "react";
import { useDispatch as useDispatch6, useSelector as useSelector15 } from "react-redux";
...
var DefaultPlugin = class extends PluginBase {
  ...
  Provider = ({
    ...
    return /* @__PURE__ */ React85.createElement("div", null, children);
  };
};
...
import React86, { useEffect as useEffect6, useState as useState6 } from "react";
var CopyButton = ({ text }) => {
  ...
  return /* @__PURE__ */ React86.createElement(
    ...
    copyClicked ? /* @__PURE__ */ React86.createElement(Check_default, null) : /* @__PURE__ */ React86.createElement(Copy_default, null)
  );
};
...
var WalletButton = ({ errorBelow = false }) => {
  ...
  return /* @__PURE__ */ React87.createElement(
    ...
    /* @__PURE__ */ React87.createElement("div", { className: "info-wrapper" }, /* @__PURE__ */ React87.createElement(
      "button",
      {
      ...
      !isReady && /* @__PURE__ */ React87.createElement(Wallet_default, null),
      !isReady && "Connect Wallet"
    ), isReady && /* @__PURE__ */ React87.createElement(CopyButton_default, { text: walletAddress })),
    isReady && balance !== void 0 ? /* @__PURE__ */ React87.createElement("p", { className: "balance-info" }, formatUSD(balance), " ", selectedCoin, " available") : null
  );
};
var WalletButton_default = WalletButton;

// src/components/reusable/CoinDropdown.tsx
import React89, { useEffect as useEffect10, useRef, useState as useState7 } from "react";
...
function TokenIcon({
  ...
  return /* @__PURE__ */ React88.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ React88.createElement(Icon, { width, height }));
}
...
var CoinDropdown = ({
  ...
  return /* @__PURE__ */ React89.createElement(
    ...
    /* @__PURE__ */ React89.createElement("div", { className: "coin-wrapper" }, /* @__PURE__ */ React89.createElement(TokenIcon, { symbol: tokenSymbol, width: 24, height: 24 }), /* @__PURE__ */ React89.createElement("span", { className: "coin" }, tokenSymbol)),
    /* @__PURE__ */ React89.createElement(
      "div",
      {
        className: `coin-menu ${theme.colorMode} ${collapsed ? "collapsed" : "toggled"}`
      },
      tokenList.map((token) => /* @__PURE__ */ React89.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React89.createElement(TokenIcon, { symbol: token.symbol, width: 24, height: 24 }),
        /* @__PURE__ */ React89.createElement("p", null, token.symbol)
      ))
    ),
...
import React91, { useEffect as useEffect11, useMemo as useMemo11 } from "react";
...
function ChainIcon({
  ...
  return /* @__PURE__ */ React90.createElement("div", { className: "icon" }, /* @__PURE__ */ React90.createElement(Icon, null));
}
...
var ConfirmDetails = ({
  ...
  return /* @__PURE__ */ React91.createElement("div", { className: `confirm-details ${theme.colorMode}` }, /* @__PURE__ */ React91.createElement("p", null, "Step ", isApproved ? "2" : "1", "\xA0of 2\xA0\xA0\xA0", isApproved ? "Submit transaction" : originNetwork === "FIAT" /* FIAT */ ? "Bank Details" : "Approval"), originNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ React91.createElement("div", null, /* @__PURE__ */ React91.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React91.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React91.createElement(ChainIcon, { symbol: originNetworkOption?.id }), "FIAT"), /* @__PURE__ */ React91.createElement("p", null, "ES6621000418401234567891")), /* @__PURE__ */ React91.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React91.createElement("p", null, "Kima Sandbox")), /* @__PURE__ */ React91.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "BIC:"), /* @__PURE__ */ React91.createElement("p", null, "CAIXESBBXXX")), /* @__PURE__ */ React91.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "Description:"), /* @__PURE__ */ React91.createElement("p", { className: "signature" }, signature))) : /* @__PURE__ */ React91.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "Source wallet:"), /* @__PURE__ */ React91.createElement("div", { className: "network-details" }, /* @__PURE__ */ React91.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React91.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React91.createElement(ChainIcon, { symbol: originNetworkOption?.id }), originNetworkOption.label)), /* @__PURE__ */ React91.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? targetAddress : walletAddress : dAppOption === "LPDrain" /* LPDrain */ ? targetWalletAddress : sourceWalletAddress))), /* @__PURE__ */ React91.createElement("div", { className: "detail-item amount" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "Transaction", width > 500 && /* @__PURE__ */ React91.createElement("br", null), "Details:"), /* @__PURE__ */ React91.createElement("span", { className: "amount-container" }, /* @__PURE__ */ React91.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React91.createElement("span", null, "Transfer amount"), /* @__PURE__ */ React91.createElement("div", { className: "coin-details" }, /* @__PURE__ */ React91.createElement("p", null, formatterFloat2.format(parseFloat(amountToShow) - totalFeeUsd), " ", sourceCurrency)), sourceCurrency !== targetCurrency && /* @__PURE__ */ React91.createElement("div", { className: "coin-details" }, "\u2192 ", targetCurrency)), /* @__PURE__ */ React91.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React91.createElement("span", null, "Network costs"), /* @__PURE__ */ React91.createElement("span", { className: "service-fee" }, formatterFloat2.format(totalFeeUsd), " ", sourceCurrency)), /* @__PURE__ */ React91.createElement("div", { className: "amount-details" }, /* @__PURE__ */ React91.createElement("span", null, "Total"), /* @__PURE__ */ React91.createElement("span", { className: "service-fee" }, formatterFloat2.format(parseFloat(amountToShow)), " ", targetCurrency)))), targetNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ React91.createElement("div", null, /* @__PURE__ */ React91.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React91.createElement("p", null, bankDetails.iban), /* @__PURE__ */ React91.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React91.createElement(ChainIcon, { symbol: targetNetworkOption?.id }), "FIAT")), /* @__PURE__ */ React91.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React91.createElement("p", null, bankDetails.recipient))) : /* @__PURE__ */ React91.createElement("div", { className: "detail-item" }, /* @__PURE__ */ React91.createElement("span", { className: "label" }, "Target wallet:"), /* @__PURE__ */ React91.createElement("div", { className: "network-details" }, /* @__PURE__ */ React91.createElement("div", { className: "kima-card-network-container" }, /* @__PURE__ */ React91.createElement("span", { className: `kima-card-network-label ${theme.colorMode}` }, /* @__PURE__ */ React91.createElement(ChainIcon, { symbol: targetNetworkOption?.id }), targetNetworkOption?.label)), /* @__PURE__ */ React91.createElement("p", { className: theme.colorMode }, width >= 916 ? dAppOption === "LPDrain" /* LPDrain */ ? walletAddress : targetAddress : dAppOption === "LPDrain" /* LPDrain */ ? sourceWalletAddress : targetWalletAddress))), /* @__PURE__ */ React91.createElement(
    "div",
    {
      className: `kima-card-footer ${mode === "bridge" /* bridge */ && formStep !== 0 && "confirm"}`
    },
    /* @__PURE__ */ React91.createElement("div", { className: `button-group` }, formStep !== 0 && /* @__PURE__ */ React91.createElement(
    ...
    ), allowance > 0 && formStep !== 0 ? /* @__PURE__ */ React91.createElement(
      SecondaryButton_default,
      {
    ...
    ) : null, /* @__PURE__ */ React91.createElement(
...
import React92, { useEffect as useEffect12 } from "react";
...
var CustomCheckbox = ({ text, checked, setCheck }) => {
  ...
  return /* @__PURE__ */ React93.createElement("div", { className: "kima-custom-checkbox" }, /* @__PURE__ */ React93.createElement(
    "div",
    {
      className: "custom-checkbox-content",
      onClick: () => setCheck(!checked)
    },
    /* @__PURE__ */ React93.createElement("div", { className: `custom-checkbox-icon-wrapper ${theme.colorMode}` }, checked && /* @__PURE__ */ React93.createElement(Check_default, null)),
    /* @__PURE__ */ React93.createElement("span", null, text)
  ));
};
...
var StepBox = ({ step, errorStep, loadingStep, data }) => {
  ...
  return /* @__PURE__ */ React94.createElement("div", { className: "kima-stepbox" }, /* @__PURE__ */ React94.createElement("div", { className: `content-wrapper ${theme.colorMode}` }, stepInfo2.map((item, index) => /* @__PURE__ */ React94.createElement("div", { key: item.title, className: "step-item" }, /* @__PURE__ */ React94.createElement(
    "div",
    {
      className: `info-item
    ...
    step < index && /* @__PURE__ */ React94.createElement(Lock_default, null),
    step >= index ? index === loadingStep ? /* @__PURE__ */ React94.createElement(Loader_default, { className: "loader" }) : index === errorStep ? /* @__PURE__ */ React94.createElement(Warning_default, null) : /* @__PURE__ */ React94.createElement(Check_default, null) : null,
    /* @__PURE__ */ React94.createElement("p", null, item.title)
  ), index === 0 && data?.kimaTxHash ? /* @__PURE__ */ React94.createElement("div", { className: `info-item ${theme.colorMode}` }, /* @__PURE__ */ React94.createElement("div", { className: "icon" }, /* @__PURE__ */ React94.createElement(USDK_default, { width: 30, height: 30 })), /* @__PURE__ */ React94.createElement("p", { className: "chain-name" }, "Kima TX ID:"), /* @__PURE__ */ React94.createElement("p", null, /* @__PURE__ */ React94.createElement(
    ExternalLink_default,
    {
      to: `${explorerUrl}/transactions/?tx=${data?.kimaTxHash}`
    },
    getShortenedAddress(data?.kimaTxHash || "")
  ), /* @__PURE__ */ React94.createElement(CopyButton_default, { text: data?.kimaTxHash }))) : null, index === 1 && data?.tssPullHash ? /* @__PURE__ */ React94.createElement(
    "div",
    {
      className: `info-item ${theme.colorMode} source-chain ${step >= 3 ? "paid" : ""}`
    },
    /* @__PURE__ */ React94.createElement(ChainIcon, { symbol: originNetworkOption?.id }),
    /* @__PURE__ */ React94.createElement("p", { className: "chain-name" }, CHAIN_NAMES_TO_STRING[data?.sourceChain || "ETH" /* ETHEREUM */], " ", "TX ID:"),
    /* @__PURE__ */ React94.createElement("p", null, /* @__PURE__ */ React94.createElement(
      ExternalLink_default,
      {
    ...
    ), /* @__PURE__ */ React94.createElement(CopyButton_default, { text: data?.tssPullHash || "" }))
  ) : null, index === 3 && data?.tssReleaseHash ? /* @__PURE__ */ React94.createElement("div", { className: `info-item ${theme.colorMode} target-chain` }, /* @__PURE__ */ React94.createElement(ChainIcon, { symbol: targetnNetworkOption?.id }), /* @__PURE__ */ React94.createElement("p", { className: "chain-name" }, CHAIN_NAMES_TO_STRING[data?.targetChain || "ETH" /* ETHEREUM */], " ", "TX ID:"), /* @__PURE__ */ React94.createElement("p", null, /* @__PURE__ */ React94.createElement(
    ExternalLink_default,
    {
  ...
  ), /* @__PURE__ */ React94.createElement(CopyButton_default, { text: data?.tssReleaseHash || "" }))) : null))));
};
...
var BankInput = () => {
  ...
  return /* @__PURE__ */ React95.createElement("div", { className: "bank-input" }, /* @__PURE__ */ React95.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React95.createElement("span", { className: "label" }, "IBAN:"), /* @__PURE__ */ React95.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React95.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React95.createElement("span", { className: "label" }, "Recipient:"), /* @__PURE__ */ React95.createElement(
    "input",
    {
      className: "kima-address-input",
      type: "text",
...
var TransactionStatusMessage = ({
  ...
  return /* @__PURE__ */ React97.createElement("div", { className: "transaction-status-message" }, /* @__PURE__ */ React97.createElement("h2", null, isCompleted !== "Completed" /* COMPLETED */ && "Your transaction is currently being processed.", " ", "Please copy the Transaction ID below for future reference. You can use this ID to track the transaction status or resolve any issues if needed."), /* @__PURE__ */ React97.createElement("span", { className: "transaction-copy" }, /* @__PURE__ */ React97.createElement("h3", null, transactionId), /* @__PURE__ */ React97.createElement(CopyButton_default, { text: transactionId })));
};
...
var TransactionWidget = ({ theme }) => {
  ...
  const [focus, setFocus] = useState8(-1);
  const [errorStep, setErrorStep] = useState8(-1);
  const [errorMessage, setErrorMessage] = useState8("");
  const [loadingStep, setLoadingStep] = useState8(-1);
  ...
  useEffect13(() => {
    ...
    if (status === "Available" /* AVAILABLE */ || status === "Pulled" /* PULLED */) {
      ...
      toast2.error("Unavailable", { icon: /* @__PURE__ */ React98.createElement(Error_default, null) });
      ...
      toast2.error("Failed to release tokens to target!", {
        icon: /* @__PURE__ */ React98.createElement(Error_default, null)
      });
      ...
      setLoadingStep(-1);
      console.log(data.failReason);
      toast2.error("Failed to pull tokens from source!", { icon: /* @__PURE__ */ React98.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ React98.createElement(Provider2, { store }, /* @__PURE__ */ React98.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React98.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React98.createElement("div", { className: "topbar" }, /* @__PURE__ */ React98.createElement("div", { className: "title" }, /* @__PURE__ */ React98.createElement("h3", { className: "transaction" }, "Transferring", " ", data?.amount && data.sourceChain && data.sourceSymbol && data.targetChain && data.targetSymbol && /* @__PURE__ */ React98.createElement("div", null, formatterFloat2.format(
      mode === "status" /* status */ ? data.amount : feeDeduct ? +amount || 0 + totalFeeUsd : +amount || 0 - totalFeeUsd
    ), " ", data?.sourceSymbol, " ", /* @__PURE__ */ React98.createElement("div", { className: "title-icon" }, /* @__PURE__ */ React98.createElement(ChainIcon, { symbol: data.sourceChain })), " ", "(", data?.sourceChain, ") \u2192", " ", formatterFloat2.format(
      mode === "status" /* status */ ? data.amount : feeDeduct ? +amount - totalFeeUsd || 0 : +amount || 0
    ), " ", data?.targetSymbol, " ", /* @__PURE__ */ React98.createElement("div", { className: "title-icon" }, /* @__PURE__ */ React98.createElement(ChainIcon, { symbol: data.targetChain })), " ", "(", data?.targetChain, ")"))), !minimized ? /* @__PURE__ */ React98.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React98.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React98.createElement(Minimize_default, null)
    ), loadingStep < 0 ? /* @__PURE__ */ React98.createElement("button", { className: "reset-button", onClick: resetForm }, "Reset") : null) : /* @__PURE__ */ React98.createElement("div", { className: "control-buttons" }, /* @__PURE__ */ React98.createElement("div", { className: "maximize", onClick: () => setMinimized(false) }, "View")))),
    /* @__PURE__ */ React98.createElement("div", { className: "kima-card-content" }, /* @__PURE__ */ React98.createElement("div", { className: "transaction-content" }, /* @__PURE__ */ React98.createElement(
      Progressbar_default,
      {
        step,
        focus,
    ...
    /* @__PURE__ */ React98.createElement("div", { className: "floating-footer status" }, /* @__PURE__ */ React98.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ React98.createElement("span", null, "Powered by"), /* @__PURE__ */ React98.createElement(FooterLogo_default, { fill: "black" }), /* @__PURE__ */ React98.createElement("strong", null, "Network")))
  ));
};

// src/components/TransferWidget.tsx
import React109, { useEffect as useEffect18, useState as useState13, useRef as useRef7 } from "react";
import { useDispatch as useDispatch23, useSelector as useSelector35 } from "react-redux";

// src/components/reusable/SingleForm.tsx
import React102, { useEffect as useEffect15, useMemo as useMemo13, useState as useState11 } from "react";
...
import React99, { useState as useState9, useMemo as useMemo12, useRef as useRef3, useEffect as useEffect14 } from "react";
...
var NetworkSelector = ({ type }) => {
  ...
  const excludedSourceNetworks = useSelector26(selectExcludedSourceNetworks);
  const excludedTargetNetworks = useSelector26(selectExcludedTargetNetworks);
  ...
  return /* @__PURE__ */ React99.createElement(
    ...
    /* @__PURE__ */ React99.createElement("div", { className: "network-wrapper" }, /* @__PURE__ */ React99.createElement(ChainIcon, { symbol: selectedNetwork.id }), /* @__PURE__ */ React99.createElement("span", null, selectedNetwork.label)),
    /* @__PURE__ */ React99.createElement(
      "div",
      {
        className: `network-menu custom-scrollbar ${theme?.colorMode ?? ""} ${collapsed ? "collapsed" : "toggled"}`
      },
      networks.filter((network) => network.id !== selectedNetwork.id).map((network) => /* @__PURE__ */ React99.createElement(
        "div",
        {
          key: network.id,
        ...
        /* @__PURE__ */ React99.createElement(ChainIcon, { symbol: network.id }),
        /* @__PURE__ */ React99.createElement("p", null, network.label)
      ))
    ),
    /* @__PURE__ */ React99.createElement("div", { className: `dropdown-icon ${collapsed ? "toggled" : "collapsed"}` }, /* @__PURE__ */ React99.createElement(Arrow_default, { fill: "none" }))
  );
};
var NetworkSelector_default = React99.memo(NetworkSelector);

// src/components/reusable/TransactionSearch.tsx
import React100, { useRef as useRef4, useState as useState10 } from "react";
...
var TransactionSearch = () => {
  ...
  const handleSearch = async () => {
    if (transactionId.length <= 0)
      return toast3.error("You must provide a valid transaction id", {
        icon: /* @__PURE__ */ React100.createElement(Error_default, null)
      });
  ...
  return /* @__PURE__ */ React100.createElement("div", { className: "form-item transaction-search" }, /* @__PURE__ */ React100.createElement("div", { className: "transaction-input" }, /* @__PURE__ */ React100.createElement("span", { className: "label" }, "Search Transaction:"), /* @__PURE__ */ React100.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React100.createElement(SecondaryButton_default, { clickHandler: handleSearch }, "Search"));
};
...
var OptionDivider = ({ text }) => {
  return /* @__PURE__ */ React101.createElement("div", { className: "option-divider" }, /* @__PURE__ */ React101.createElement("span", { className: "line" }), /* @__PURE__ */ React101.createElement("span", { className: "text" }, text), /* @__PURE__ */ React101.createElement("span", { className: "line" }));
};
...
var SingleForm = ({
  ...
  const targetCompliant = useSelector28(selectTargetCompliant);
  ...
  const targetCurrency = useSelector28(selectTargetCurrency);
  ...
  return /* @__PURE__ */ React102.createElement("div", { className: "single-form" }, /* @__PURE__ */ React102.createElement("div", { className: "form-item" }, /* @__PURE__ */ React102.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ React102.createElement("div", { className: "items" }, /* @__PURE__ */ React102.createElement(NetworkSelector_default, { type: "source" }), /* @__PURE__ */ React102.createElement(CoinDropdown_default, null))), /* @__PURE__ */ React102.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React102.createElement(
      ...
      /* @__PURE__ */ React102.createElement("span", { className: "label" }, "Wallet:"),
      /* @__PURE__ */ React102.createElement(WalletButton_default, null)
    ),
    mode === "bridge" /* bridge */ && /* @__PURE__ */ React102.createElement("div", { className: "form-item" }, /* @__PURE__ */ React102.createElement("span", { className: "label" }, "Target Network:"), /* @__PURE__ */ React102.createElement("div", { className: "items" }, /* @__PURE__ */ React102.createElement(NetworkSelector_default, { type: "target" }), /* @__PURE__ */ React102.createElement(CoinDropdown_default, { isSourceChain: false })))
  ), mode === "bridge" /* bridge */ && sourceNetwork !== "FIAT" /* FIAT */ ? targetNetwork === "FIAT" /* FIAT */ ? /* @__PURE__ */ React102.createElement(BankInput_default, null) : /* @__PURE__ */ React102.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React102.createElement("span", { className: "label" }, "Target Address:"), /* @__PURE__ */ React102.createElement(
    AddressInput_default,
    {
      theme: theme.colorMode,
      placeholder: "Target address"
    }
  )) : null, mode === "bridge" /* bridge */ ? /* @__PURE__ */ React102.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React102.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ React102.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ React102.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "text",
    ...
    "Max"
  ))) : /* @__PURE__ */ React102.createElement("div", { className: `form-item ${theme.colorMode}` }, /* @__PURE__ */ React102.createElement("span", { className: "label" }, "Amount:"), /* @__PURE__ */ React102.createElement("div", { className: `amount-label-container items ${theme.colorMode}` }, /* @__PURE__ */ React102.createElement(
    "input",
    {
      className: `${theme.colorMode}`,
      type: "number",
  ...
  ), /* @__PURE__ */ React102.createElement("div", { className: `coin-wrapper ${theme.colorMode}` }, /* @__PURE__ */ React102.createElement("div", { className: "icon-wrapper" }, /* @__PURE__ */ React102.createElement(TargetIcon, null)), targetCurrency))), mode === "bridge" /* bridge */ && totalFeeUsd > 0 ? /* @__PURE__ */ React102.createElement(
    ...
    /* @__PURE__ */ React102.createElement("div", { className: `button-group` }, formStep !== 0 && /* @__PURE__ */ React102.createElement(
      SecondaryButton_default,
      {
        clickHandler: onBack,
        theme: theme.colorMode,
      ...
      formStep > 0 ? "Back" : "Cancel"
    ), allowance > 0 && formStep !== 0 ? /* @__PURE__ */ React102.createElement(
      SecondaryButton_default,
      {
        clickHandler: onCancelApprove,
        isLoading: isCancellingApprove,
  ...
  ), /* @__PURE__ */ React102.createElement(OptionDivider_default, { text: "or" }), /* @__PURE__ */ React102.createElement(TransactionSearch_default, null));
};
...
import React103, { useCallback as useCallback2, useEffect as useEffect16, useMemo as useMemo14, useRef as useRef5 } from "react";
...
var SolanaWalletSelect = () => {
  ...
  return /* @__PURE__ */ React103.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React103.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React103.createElement("div", { className: "wallet-container" }, detected.map((wallet2, index) => /* @__PURE__ */ React103.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React103.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React103.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React103.createElement("span", null, wallet2.adapter.name))
  )), undetected.map((wallet2, index) => /* @__PURE__ */ React103.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React103.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React103.createElement("img", { src: wallet2.adapter.icon, alt: wallet2.adapter.name }), /* @__PURE__ */ React103.createElement("span", null, "Install ", wallet2.adapter.name))
  )))));
};
var SolanaWalletSelect_default = SolanaWalletSelect;

// plugins/solana/components/AccountDetailsModal.tsx
import React104, { useMemo as useMemo15 } from "react";
...
var AccountDetailsModal = () => {
  ...
  const sourceChain = useSelector30(selectSourceChain);
  const accountDetailsModal = useSelector30(selectAccountDetailsModal);
...
var SolanaWalletConnectModal = () => {
  ...
  return /* @__PURE__ */ React105.createElement("div", null, /* @__PURE__ */ React105.createElement(AccountDetailsModal_default, null), /* @__PURE__ */ React105.createElement(
    ...
    )))), /* @__PURE__ */ React105.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React105.createElement(SolanaWalletSelect_default, null)))
  ));
};
...
import React106, { useMemo as useMemo16 } from "react";
...
var AccountDetailsModal2 = () => {
  ...
  const sourcheChain = useSelector32(selectSourceChain);
...
import React107, { useEffect as useEffect17, useMemo as useMemo17, useRef as useRef6 } from "react";
...
var TronWalletSelect = () => {
  ...
  return /* @__PURE__ */ React107.createElement("div", { className: `wallet-select` }, /* @__PURE__ */ React107.createElement("div", { className: "slide-area hide-scrollbar", ref: sliderRef }, /* @__PURE__ */ React107.createElement("div", { className: "wallet-container" }, detected.map((wallet, index) => /* @__PURE__ */ React107.createElement(
    "div",
    {
      className: `card-item ${theme.colorMode}`,
    ...
    /* @__PURE__ */ React107.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React107.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React107.createElement("span", null, wallet.adapter.name))
  )), undetected.map((wallet, index) => /* @__PURE__ */ React107.createElement(
    ExternalLink_default,
    {
    ...
    /* @__PURE__ */ React107.createElement("div", { className: "wallet-item" }, /* @__PURE__ */ React107.createElement("img", { src: wallet.adapter.icon, alt: wallet.adapter.name }), /* @__PURE__ */ React107.createElement("span", null, "Install ", wallet.adapter.name))
  )))));
};
...
var TronWalletConnectModal = () => {
  ...
  const connectModal = useSelector34(selectTronConnectModal);
  return /* @__PURE__ */ React108.createElement("div", null, /* @__PURE__ */ React108.createElement(AccountDetailsModal_default2, null), /* @__PURE__ */ React108.createElement(
    "div",
    {
    ...
    )))), /* @__PURE__ */ React108.createElement("div", { className: "modal-content" }, /* @__PURE__ */ React108.createElement(TronWalletSelect_default, null)))
  ));
};
...
import { useDispatch as useDispatch22 } from "react-redux";
...
var TransferWidget = ({
  ...
  const transactionOption = useSelector35(selectTransactionOption);
  ...
  } = useSelector35(selectServiceFee);
  const compliantOption = useSelector35(selectCompliantOption);
  const networkOptions3 = useSelector35(selectNetworkOption);
  ...
  const pendingTxs = useSelector35(selectPendingTxs);
  ...
  const handleSubmit = async () => {
    ...
    if (error === "ValidationError" /* Error */) {
      return toast5.error(validationMessage, { icon: /* @__PURE__ */ React109.createElement(Error_default, null) });
    }
    ...
    if (!success) return toast5.error(submitMessage, { icon: /* @__PURE__ */ React109.createElement(Error_default, null) });
  };
  const onNext = () => {
    ...
    toast5.error(message, { icon: /* @__PURE__ */ React109.createElement(Error_default, null) });
  ...
  return /* @__PURE__ */ React109.createElement(
    ...
    mode === "payment" /* payment */ && !transactionOption && /* @__PURE__ */ React109.createElement("h2", { className: "invalid-option-banner" }, "We're unable to process your payment. Please ensure the necessary transaction details are provided. Contact support if the issue persists."),
    /* @__PURE__ */ React109.createElement("div", { className: "transfer-card" }, /* @__PURE__ */ React109.createElement("div", { className: "kima-card-header" }, /* @__PURE__ */ React109.createElement("div", { className: "topbar" }, /* @__PURE__ */ React109.createElement("div", { className: "title" }, /* @__PURE__ */ React109.createElement("h3", null, formStep === 0 ? titleOption?.initialTitle ? titleOption.initialTitle : mode === "payment" /* payment */ ? "New Purchase" : "New Transfer" : titleOption?.confirmTitle ? titleOption.confirmTitle : mode === "payment" /* payment */ ? "Confirm Purchase" : "Transfer Details")), /* @__PURE__ */ React109.createElement("div", { className: "control-buttons" }, pendingTxs > 0 ? /* @__PURE__ */ React109.createElement(TxButton_default, { theme }) : null, /* @__PURE__ */ React109.createElement(
      ExternalLink_default,
      {
        to: helpURL ? helpURL : "https://docs.kima.network/kima-network/try-kima-with-the-demo-app"
      },
      /* @__PURE__ */ React109.createElement("div", { className: "menu-button" }, "I need help")
    ), formStep === 0 && mode !== "payment" /* payment */ && /* @__PURE__ */ React109.createElement(
      "button",
      {
      ...
      "Reset"
    ))), mode === "payment" /* payment */ && paymentTitleOption?.title && /* @__PURE__ */ React109.createElement("h4", { className: "subtitle" }, paymentTitleOption.title)), /* @__PURE__ */ React109.createElement("div", { className: "kima-card-content", ref: mainRef }, formStep === 0 ? /* @__PURE__ */ React109.createElement(
      SingleForm_default,
      {
        ...{
          allowance,
    ...
    )), /* @__PURE__ */ React109.createElement(SolanaWalletConnectModal_default, null), /* @__PURE__ */ React109.createElement(TronWalletConnectModal_default, null), /* @__PURE__ */ React109.createElement(
      Toaster2,
      {
        position: "top-right",
        reverseOrder: false,
    ...
    ), /* @__PURE__ */ React109.createElement("div", { className: "floating-footer" }, /* @__PURE__ */ React109.createElement("div", { className: `items ${theme.colorMode}` }, /* @__PURE__ */ React109.createElement("span", null, "Powered by"), /* @__PURE__ */ React109.createElement(FooterLogo_default, { width: 50, fill: "black" }), /* @__PURE__ */ React109.createElement("strong", null, "Network"))))
  );
};
...
var KimaTransactionWidget = ({
  ...
  const submitted = useSelector36(selectSubmitted);
  ...
  return submitted ? /* @__PURE__ */ React110.createElement(TransactionWidget, { theme }) : /* @__PURE__ */ React110.createElement(
    TransferWidget,
    {
      theme,
      helpURL,
