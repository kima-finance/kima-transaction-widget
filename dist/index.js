...
function useEvmAllowance() {
  ...
  const allowanceNumber = formatterFloat2.format(
...
var FeeDeductionRadioButtons = ({ disabled }) => {
  ...
  const { totalFee } = useSelector19(selectServiceFee);
...
var ConfirmDetails = ({
  ...
  const { totalFee, targetFee, sourceFee, kimaFee } = useSelector20(selectServiceFee);
...
var TransactionWidget = ({ theme }) => {
  ...
  const { totalFee } = useSelector27(selectServiceFee);
...
var getFees = async (amount, deductFee, originChain, originAddress, originSymbol, targetChain, targetAddress, targetSymbol, backendUrl) => {
  try {
    const response = await fetchWrapper.get(
...
// src/hooks/useGetFees.tsx
var useGetFees = (amount, deductFees, sourceNetwork, sourceAddress, sourceSymbol, targetNetwork, targetAddress, targetSymbol, backendUrl) => {
...
var SingleForm = ({
  ...
  const { totalFee } = useSelector30(selectServiceFee);
  ...
  const sourceAddress = useSelector30(selectSourceAddress);
  ...
  return /* @__PURE__ */ React103.createElement("div", { className: "single-form" }, /* @__PURE__ */ React103.createElement("div", { className: "form-item" }, /* @__PURE__ */ React103.createElement("span", { className: "label" }, "Source Network:"), /* @__PURE__ */ React103.createElement("div", { className: "items" }, /* @__PURE__ */ React103.createElement(NetworkSelector_default, { type: "source" }), /* @__PURE__ */ React103.createElement(CoinDropdown_default, null))), /* @__PURE__ */ React103.createElement(
    ...
    "Max"
  ), +totalFee !== -1 && /* @__PURE__ */ React103.createElement("p", null, "Est fees: $ ", totalFee, " USD")))));
};
...
import { useDispatch as useDispatch17, useSelector as useSelector31 } from "react-redux";
...
var useSubmitTransaction = ({
  ...
  const { feeId } = useSelector37(selectServiceFee);
...
var TransferWidget = ({
  ...
  const { totalFee, decimals: feeDecimals } = useSelector38(selectServiceFee);
  ...
  const [feeOptionDisabled, setFeeOptionDisabled] = useState14(false);
