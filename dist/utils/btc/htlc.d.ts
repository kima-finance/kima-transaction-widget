...
export declare function createReclaimPsbt(reclaimerAddress: string, htlcAmount: bigint, htlcTimeout: bigint, htlcScript: Buffer, htlcOutput: UTXO, network: any, fee: bigint): string;
