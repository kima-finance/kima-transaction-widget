...
const Bank = ({ width = 32, height = 32, ...rest }) => {
  return (
    <svg
      ...
      {...rest}
    >
      <path d='M6 9.4375V20.4062' stroke='#86B8CE' stroke-width='2' />
      <path d='M12 9.4375V20.4062' stroke='#86B8CE' stroke-width='2' />
      <path d='M18 9.4375V20.4062' stroke='#86B8CE' stroke-width='2' />
      <path d='M24 9.4375V20.4062' stroke='#86B8CE' stroke-width='2' />
      <path
        d='M26 20L3 20'
        stroke='#86B8CE'
        stroke-width='2'
