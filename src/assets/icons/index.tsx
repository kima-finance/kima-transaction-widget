...
export { default as UniSatIcon } from './UniSat'
...
export { default as KimaNetworkIcon } from './KimaNetwork'
export { default as CFXIcon } from './CFX'
export { default as EURCIcon } from './EURC'
export { default as TransactionCompleteIcon } from './TransactionComplete'
export { default as USD1Icon } from './USD1'
export { default as WorldIcon } from './World'
export { default as FrontierIcon } from './Frontier'
