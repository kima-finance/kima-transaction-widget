import { ErrorIcon, FooterLogo } from '@kima-widget/assets/icons'
import { Loading180Ring } from '@kima-widget/assets/loading'
import { CopyButton, PrimaryButton } from '@kima-widget/components/reusable'
import {
  selectCCTransactionId,
  selectCCTransactionRetrying,
  selectSourceChain
} from '@kima-widget/shared/store/selectors'
import { ColorModeOptions, ThemeOptions } from '@kima-widget/shared/types'
